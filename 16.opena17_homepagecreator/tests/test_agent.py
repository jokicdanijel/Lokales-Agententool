...
class Test16Opena17_Homepagecreator:
    ...
    def test_main_agent_exists(self):
        ...
        main_file = Path("/home/danijel-jd/Dokumente/Workspace/Projekte/Gesamtprojekt/16.opena17_homepagecreator/main_homepage_agent.py")
    ...
    def test_navigation_item_nested(self):
        ...
        try:
            ...
            nav = NavigationItem(
                ...
                slug="products",
                children=[
                    NavigationItem(label="Product A", slug="product-a")
                ]
            )
