...
def test_export_site(site_id: str) -> None:
    ...
    payload = {"site_id": site_id, "format": "zip", "include_assets": True}
...
def test_deploy_site(site_id: str) -> None:
    ...
    payload = {"site_id": site_id, "target": "local", "target_path": "/tmp/test_sites", "invalidate_cache": False}
...
def test_get_structure(site_id: str) -> None:
    ...
    print(
        f"[✓] Test 6 (Site Structure): PASS - Pages: {len(data['pages'])}, Routes: {len(data['routes'])}, Size: {data['total_size_bytes']} bytes"
    )
...
def test_preview_access(site_id: str) -> None:
    ...
    # Sollte HTML sein
    assert response.headers["content-type"].startswith("text/html") or response.headers["content-type"].startswith(
...
def test_command_endpoint() -> None:
    ...
    payload = {
        ...
        "params": {
            ...
            "template": "default",
            "pages": [
                {"slug": "about", "title": "About Us", "content": "<p>About page content.</p>", "is_homepage": True}
            ],
            "branding": {"site_name": "Command Test Site", "tagline": "Generated via command endpoint"},
        },
    }
...
def test_multi_page_site() -> None:
    ...
    payload = {
        ...
        "branding": {"site_name": "Multi-Page Test", "tagline": "Testing multiple pages"},
    }
...
def test_navigation() -> None:
    ...
    payload = {
        ...
        "template": "default",
        "pages": [
            {"slug": "home", "title": "Home", "content": "<p>Home</p>", "is_homepage": True},
            {"slug": "about", "title": "About", "content": "<p>About</p>", "is_homepage": False},
        ],
        "navigation": [
        ...
        "navigation_type": "top",
        "branding": {"site_name": "Nav Test", "tagline": "Testing navigation"},
    }
    ...
    print("[✓] Test 10 (Navigation): PASS - Navigation items verified in HTML")
...
def test_custom_css_js() -> None:
    ...
    payload = {
        ...
        "template": "default",
        "pages": [
            {"slug": "home", "title": "Custom Styles", "content": "<p>Testing custom styles</p>", "is_homepage": True}
        ],
        "branding": {"site_name": "Custom Test"},
    ...
    print("[✓] Test 11 (Custom CSS/JS): PASS - Custom styles injected")
...
def test_strict_json() -> None:
    ...
    print("[✓] Test 12 (Strict JSON): PASS - Unknown fields rejected (422)")
