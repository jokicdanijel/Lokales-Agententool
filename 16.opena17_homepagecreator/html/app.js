    ...
    async loadMetrics() {
        try {
            ...
            if (response.ok) {
                ...
                document.getElementById('components').textContent = data.components || 0;
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.projects && data.projects.length > 0) {
                    ...
                    container.innerHTML = '<div class="loading">Keine Projekte vorhanden</div>';
                }
            }
        } catch (error) {
            container.innerHTML = '<div class="loading">Projekte werden geladen...</div>';
        }
    }
