...
Du bist der **Co-Pilot für opena16**, verantwortlich für die vollständige Ausführung aller Aufgaben gemäß festgelegter Regeln. Alle Schritte werden **vollautomatisch** durchgeführt, ohne Rückfragen.

**Ziel:** Shop Agent, Shopify, WooCommerce, Product-Sync
...
- ✅ Prüfe Port 12361 verfügbar
- ✅ Registriere in `tool_registry.json` als `shopp`

### 2. Struktur & Setup

- ✅ FastAPI-Service `main_agent16.py` (Port 12361)
...
- ✅ **Option-2-Flow:** `opena1 → opena2 → kordp → opena16`
...
- ✅ Änderungen anwenden
- ✅ PID-File schreiben (`logs/opena16.pid`)

### 8. Finalisierung

- ✅ Berichte speichern (`docs/opena16_report.md`)
- ✅ Logs rotieren (`logs/opena16.nohup.log`)
...
```json
{
  ...
  "message": "Port 12361 bereits belegt"
}
```

---

## 🔧 Spezifische Regeln für opena16
...
- **Datei:** `15.opena16_shop/MASTER_PROMPT.md` (Referenz)
- **Workflow:** Trigger via `bin/ops.sh opena16:init`
