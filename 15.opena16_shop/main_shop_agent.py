...
class ShopManager:
    ...
    def create_product(req: ProductCreate) -> Product:
        ...
        inventory.append(Inventory(sku=req.sku, quantity=0, warehouse="main", updated_at=now))
    ...
    def update_inventory(req: InventoryUpdate) -> Inventory:
        ...
        if entry:
            ...
            entry = Inventory(sku=req.sku, quantity=req.quantity, warehouse=req.warehouse, updated_at=now)
