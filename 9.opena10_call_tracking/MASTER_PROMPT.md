...
Du bist der **Co-Pilot für opena10**, verantwortlich für die vollständige Ausführung aller Aufgaben gemäß festgelegter Regeln. Alle Schritte werden **vollautomatisch** durchgeführt, ohne Rückfragen.

**Ziel:** Call Tracking, SQLAlchemy-Models, Campaign-Tracking
...
- ✅ Prüfe Port 12355 verfügbar
- ✅ Registriere in `tool_registry.json` als `calltrackp`

### 2. Struktur & Setup

- ✅ FastAPI-Service `main_agent10.py` (Port 12355)
...
- ✅ **Option-2-Flow:** `opena1 → opena2 → kordp → opena10`
...
- ✅ Änderungen anwenden
- ✅ PID-File schreiben (`logs/opena10.pid`)

### 8. Finalisierung

- ✅ Berichte speichern (`docs/opena10_report.md`)
- ✅ Logs rotieren (`logs/opena10.nohup.log`)
...
```json
{
  ...
  "message": "Port 12355 bereits belegt"
}
```

---

## 🔧 Spezifische Regeln für opena10
...
- **Datei:** `9.opena10_call_tracking/MASTER_PROMPT.md` (Referenz)
- **Workflow:** Trigger via `bin/ops.sh opena10:init`
