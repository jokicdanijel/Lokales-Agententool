...
const CallTrackingConfig = {
  ...
  capabilities: [
    {
      ...
      name: "Call Logging",
      icon: "📝",
      description: "Track all call events",
      endpoint: "/api/calls",
    },
    {
      id: "source_tracking",
      ...
      icon: "📡",
      description: "Identify call origins",
    ...
    },
    {
      ...
      icon: "🎯",
      description: "UTM & campaign attribution",
      endpoint: "/api/campaigns",
    },
    {
      id: "dynamic_numbers",
      name: "Dynamic Numbers",
      icon: "🔢",
      description: "Per-source phone numbers",
    ...
    },
    {
      ...
      icon: "💰",
      description: "Call-to-sale attribution",
    ...
    },
    {
      ...
      icon: "🔑",
      description: "PPC keyword attribution",
    ...
    },
    {
      ...
      name: "ROI Analysis",
      icon: "📈",
      description: "Marketing ROI calculation",
      endpoint: "/api/roi",
    },
    {
  ...
  quickActions: [
    ...
    },
    {
      ...
      icon: "➕",
      label: "Add Source",
      action: "showAddSourceModal",
    },
    {
      id: "createCampaign",
      icon: "🎯",
      label: "Campaign",
      action: "showCreateCampaignModal",
    },
