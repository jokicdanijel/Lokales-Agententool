...
class PrometheusMetrics:
    ...
    def __init__(self):
        ...
        self.http_requests_total = Counter(
            'opena20_http_requests_total',
            'Total HTTP requests',
            ['agent', 'method', 'status_code']
        )
        
        self.agent_errors_total = Counter(
            'opena20_agent_errors_total',
            'Total agent errors',
            ['agent', 'error_type']
        )
        ...
        self.agent_status = Gauge(
            'opena20_agent_status',
            'Agent status (1=healthy, 0=unhealthy)',
            ['agent']
        )
        
        self.agent_response_time = Gauge(
            'opena20_agent_response_time_seconds',
            'Agent response time in seconds',
            ['agent']
        )
        
        self.system_cpu_percent = Gauge(
            'opena20_system_cpu_percent',
            'System CPU usage percentage'
        )
        
        self.system_memory_percent = Gauge(
            'opena20_system_memory_percent',
            'System memory usage percentage'
        )
        
        self.system_disk_percent = Gauge(
            'opena20_system_disk_percent',
            'System disk usage percentage'
        )
        
        # Histograms
        self.agent_response_time_histogram = Histogram(
            'opena20_agent_response_time_histogram',
...
class MonitoringDashboard:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(self.base_dir / "logs" / "monitoring.log"),
    ...
    def cleanup_old_data(self):
        ...
        try:
            ...
            cutoff_date = datetime.now(timezone.utc) - timedelta(days=metrics_days)
