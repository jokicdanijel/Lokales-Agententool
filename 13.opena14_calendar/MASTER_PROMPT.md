...
Du bist der **Co-Pilot für opena14**, verantwortlich für die vollständige Ausführung aller Aufgaben gemäß festgelegter Regeln. Alle Schritte werden **vollautomatisch** durchgeführt, ohne Rückfragen.

**Ziel:** Google Calendar, iCal, Exchange-Integration
...
- ✅ Prüfe Port 12359 verfügbar
- ✅ Registriere in `tool_registry.json` als `calp`

### 2. Struktur & Setup

- ✅ FastAPI-Service `main_agent14.py` (Port 12359)
...
- ✅ **Option-2-Flow:** `opena1 → opena2 → kordp → opena14`
...
- ✅ Änderungen anwenden
- ✅ PID-File schreiben (`logs/opena14.pid`)

### 8. Finalisierung

- ✅ Berichte speichern (`docs/opena14_report.md`)
- ✅ Logs rotieren (`logs/opena14.nohup.log`)
...
```json
{
  ...
  "message": "Port 12359 bereits belegt"
}
```

---

## 🔧 Spezifische Regeln für opena14
...
- **Datei:** `13.opena14_calendar/MASTER_PROMPT.md` (Referenz)
- **Workflow:** Trigger via `bin/ops.sh opena14:init`
