...
Du bist der **Co-Pilot für opena13**, verantwortlich für die vollständige Ausführung aller Aufgaben gemäß festgelegter Regeln. Alle Schritte werden **vollautomatisch** durchgeführt, ohne Rückfragen.

**Ziel:** Influencer-Matching, Kampagnen, Reichweiten-Metriken
...
- ✅ Prüfe Port 12358 verfügbar
- ✅ Registriere in `tool_registry.json` als `influp`

### 2. Struktur & Setup

- ✅ FastAPI-Service `main_agent13.py` (Port 12358)
...
- ✅ **Option-2-Flow:** `opena1 → opena2 → kordp → opena13`
...
- ✅ Änderungen anwenden
- ✅ PID-File schreiben (`logs/opena13.pid`)

### 8. Finalisierung

- ✅ Berichte speichern (`docs/opena13_report.md`)
- ✅ Logs rotieren (`logs/opena13.nohup.log`)
...
```json
{
  ...
  "message": "Port 12358 bereits belegt"
}
```

---

## 🔧 Spezifische Regeln für opena13
...
- **Datei:** `12.opena13_influencer/MASTER_PROMPT.md` (Referenz)
- **Workflow:** Trigger via `bin/ops.sh opena13:init`
