...
from src.pkg.shared.persistence import AuditLog, BaseDataStore, JSONDataStore
...
class TestAuditLog:
    ...
    def test_create_audit_log(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            audit_log.log(operation="CREATE", actor="test_user", resource_type="profile", resource_id="prof_1")
    ...
    def test_read_recent(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            for i in range(10):
                audit_log.log(operation=f"OP_{i}", actor="test_user", resource_type="test", resource_id=str(i))
