...
IGNORE_DIRS = {
    ...
    ".tox", ".nox", ".coverage", "htmlcov", ".pytest_cache",
    ".mypy_cache", ".ruff_cache", "logs", "*.log"
}

IGNORE_FILES = {
    ".DS_Store", "Thumbs.db", "*.pyc", "*.pyo", "*.swp", "*.swo"
}
...
def generate_macdir(project_path: Path, output_path: Optional[Path] = None) -> dict:
...
def main():
    ...
    parser.add_argument("--output", "-o", type=Path,
                       default=None,
                       help="Output-Datei (default: <path>/MAC_DIR.json)")
    parser.add_argument("--stdout", action="store_true",
                       help="Ausgabe auf stdout statt Datei")
