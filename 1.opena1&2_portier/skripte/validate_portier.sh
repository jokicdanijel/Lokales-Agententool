#!/usr/bin/env bash
set -euo pipefail
echo "Policy validator placeholder"
...
[[ -x "1.opena1&2_portier/skripte/validate_portier.sh" ]] || { echo "❌ validate_portier.sh ist nicht ausführbar"; exit 1; }
...
try:
    p = Path("1.opena1&2_portier/config/tools_registry.json")
