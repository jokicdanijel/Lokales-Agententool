...
class Test1Opena1&2_Portier:
    def test_directory_exists(self):
        agent_dir = Path("/home/danijel-jd/Dokumente/Workspace/Projekte/Gesamtprojekt/1.opena1&2_portier")
        assert agent_dir.exists()
    
    def test_html_exists(self):
        html_file = Path("/home/danijel-jd/Dokumente/Workspace/Projekte/Gesamtprojekt/1.opena1&2_portier/html/index.html")
    ...
    def test_html_content_valid(self):
        ...
        if html_file.exists():
            ...
            assert "1.opena1&2_portier" in content
