...
from pip._internal.utils.filesystem import adjacent_tmp_file, check_path_owner, copy_directory_permissions, replace
from pip._internal.utils.misc import ExternallyManagedEnvironment, check_externally_managed, ensure_dir
