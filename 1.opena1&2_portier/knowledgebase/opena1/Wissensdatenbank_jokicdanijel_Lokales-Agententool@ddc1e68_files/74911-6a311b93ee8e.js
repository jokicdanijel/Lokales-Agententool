  ...
  [4013, 19973, 74911],
  {
    31635: (t, e, n) => {
      ...
      function s(t, e, n) {
        ...
        function d(t, e) {
          (t(e), s.shift(), s.length && l(s[0][0], s[0][1]));
        }
      }
      function a(t) {
        var e, n;
    ...
    39595: (t, e, n) => {
      ...
      function s(t = document) {
        ...
        let i = {
          ...
          unsubscribe() {
            ((e = !0), r.delete(t), n.disconnect());
          },
        };
        return (r.set(t, i), i);
      }
      function a(t) {
        for (let e of t.querySelectorAll("[data-action]")) c(e);
      ...
      function* u(t) {
        for (let e of (t.getAttribute("data-action") || "")
          .trim()
          .split(/\s+/)) {
          let t = e.lastIndexOf(":"),
      ...
      function c(t) {
        for (let e of u(t)) t.addEventListener(e.type, l);
      }
      function d(t, e) {
        let n = t.tagName.toLowerCase();
        if (t.shadowRoot) {
          for (let i of t.shadowRoot.querySelectorAll(
            `[data-target~="${n}.${e}"]`,
          ))
        ...
        p = (t, e = "property") => {
          ...
          if (!n.includes("-"))
            throw new DOMException(
              `${e}: ${String(t)} is not a valid ${e} name`,
              "SyntaxError",
            );
          return n;
        },
      ...
      let g = new Map(),
        ...
        A = new WeakMap();
      function S(t) {
        (cancelAnimationFrame(A.get(t) || 0),
          A.set(
            t,
            requestAnimationFrame(() => {
              for (let e of g.keys()) {
                let n =
                  t instanceof Element && t.matches(e) ? t : t.querySelector(e);
                if (customElements.get(e) || n) {
                  let i = n?.getAttribute("data-load-on") || "ready",
                    o = i in w ? w[i] : w.ready;
                  for (let t of g.get(e) || []) o(e).then(t);
                  (g.delete(e), A.delete(t));
                }
              }
            }),
          ));
      ...
      function k(t, e) {
        for (let [n, i] of ("string" == typeof t && e && (t = { [t]: e }),
        Object.entries(t)))
          (g.has(n) || g.set(n, new Set()), g.get(n).add(i));
        C(document);
      }
      function C(t) {
        (i ||
          (i = new MutationObserver((t) => {
            if (g.size)
              for (let e of t)
                for (let t of e.addedNodes) t instanceof Element && S(t);
          })),
          S(t),
          i.observe(t, { subtree: !0, childList: !0 }));
      }
      ...
      let CatalystDelegate = class CatalystDelegate {
        constructor(t) {
          ...
          const o = t.prototype.attributeChangedCallback;
          ...
          (Object.defineProperty(t, "observedAttributes", {
            ...
            (function (t) {
              ...
              Object.defineProperty(t, "observedAttributes", {
                configurable: !0,
                get: () => [...x(t.prototype, f)].map(i).concat(e),
                set(t) {
                  e = t;
                },
              });
            ...
            (function (t) {
              ...
              try {
                (window.customElements.define(e, t),
                  (window[t.name] = customElements.get(e)));
              } catch (t) {
                if (
                  !(t instanceof DOMException && "NotSupportedError" === t.name)
                )
                  throw t;
              }
            })(t));
        ...
        connectedCallback(t, e) {
          var n, i;
          for (let e of (t.toggleAttribute("data-catalyst", !0),
          customElements.upgrade(t),
          t.querySelectorAll("template[data-shadowroot]")))
            e.parentElement === t &&
              t
                .attachShadow({
                  mode:
                    "closed" === e.getAttribute("data-shadowroot")
                      ? "closed"
                      : "open",
                })
          ...
          (v(t),
          o.add(t),
          t.shadowRoot && (a((i = t.shadowRoot)), s(i)),
          a(t),
          s(t.ownerDocument),
          e?.call(t),
          t.shadowRoot) && (a((n = t.shadowRoot)), s(n), C(t.shadowRoot));
        }
        disconnectedCallback(t, e) {
          e?.call(t);
        }
        attributeChangedCallback(t, e, n, i, o) {
          (v(t), "data-catalyst" !== e && o && o.call(t, e, n, i));
        }
      };
      function x(t, e) {
            ...
            get() {
              ...
              if (this.shadowRoot)
                for (let i of this.shadowRoot.querySelectorAll(
                  ...
                  i.closest(t) || n.push(i);
              for (let i of this.querySelectorAll(
                `[data-targets~="${t}.${e}"]`,
              ))
                i.closest(t) === this && n.push(i);
              return n;
            },
          }));
      }
    ...
    74057: (t, e, n) => {
      n.d(e, { A: () => m });
      let i = "data-close-dialog",
        o = `[${i}]`;
      function r(t) {
        let e = Array.from(t.querySelectorAll("[autofocus]")).filter(a)[0];
      ...
      function s(t) {
        ...
        e instanceof Element &&
          ("Escape" === t.key || "Esc" === t.key
            ? (d(e, !1), t.stopPropagation())
            : "Tab" === t.key &&
              (function (t) {
                if (!(t.currentTarget instanceof Element)) return;
                let e = t.currentTarget.querySelector("details-dialog");
                if (!e) return;
                t.preventDefault();
                let n = Array.from(e.querySelectorAll("*")).filter(a);
                if (0 === n.length) return;
                let i = t.shiftKey ? -1 : 1,
                  o = e.getRootNode(),
                  r = e.contains(o.activeElement) ? o.activeElement : null,
                  s = -1 === i ? -1 : 0;
                if (r instanceof HTMLElement) {
                  let t = n.indexOf(r);
                  -1 !== t && (s = t + i);
                }
                (s < 0 ? (s = n.length - 1) : (s %= n.length), n[s].focus());
              })(t));
      }
      function a(t) {
        var e;
      ...
      function l(t) {
        let e = t.querySelector("details-dialog");
        return (
          !(e instanceof DetailsDialogElement) ||
          e.dispatchEvent(
      ...
      function c(t) {
        ...
        let n = e.querySelector("details-dialog");
        if (n instanceof DetailsDialogElement)
          if (e.hasAttribute("open")) {
            let t = "getRootNode" in n ? n.getRootNode() : document;
            (t.activeElement instanceof HTMLElement &&
              b.set(n, { details: e, activeElement: t.activeElement }),
              r(n),
              e.addEventListener("keydown", s));
          } else {
            var i, o;
            let t;
            for (let t of n.querySelectorAll("form")) t.reset();
            let r =
              ((i = e),
              (o = n),
              (t = b.get(o)) && t.activeElement instanceof HTMLElement
                ? t.activeElement
                : i.querySelector("summary"));
            (r && r.focus(), e.removeEventListener("keydown", s));
          }
      }
      function d(t, e) {
        e !== t.hasAttribute("open") &&
          (e ? t.setAttribute("open", "") : l(t) && t.removeAttribute("open"));
      }
      function h(t) {
        let e = t.currentTarget;
        if (!(e instanceof Element)) return;
        ...
        let i = n.querySelector("include-fragment:not([src])");
        if (!i) return;
        let o = n.src;
        null !== o &&
          (i.addEventListener("loadend", () => {
            e.hasAttribute("open") && r(n);
          }),
      ...
      function p(t, e, n) {
        (f(t),
          e && t.addEventListener("toggle", h, { once: !0 }),
          e && n && t.addEventListener("mouseover", h, { once: !0 }));
      }
      function f(t) {
        (t.removeEventListener("toggle", h),
          t.removeEventListener("mouseover", h));
      }
      let b = new WeakMap();
      let DetailsDialogElement = class DetailsDialogElement extends HTMLElement {
        ...
        connectedCallback() {
          ...
          (n &&
            ...
            n.addEventListener("click", u, { capture: !0 })),
            e.addEventListener("toggle", c),
            (t.details = e),
            p(e, this.src, this.preload));
        }
        disconnectedCallback() {
          ...
          let { details: e } = t;
          if (!e) return;
          (e.removeEventListener("toggle", c), f(e));
          let n = e.querySelector("summary");
          (n && n.removeEventListener("click", u, { capture: !0 }),
            (t.details = null));
        }
        toggle(t) {
          let e = b.get(this);
        ...
        attributeChangedCallback() {
          ...
          if (!t) return;
          let { details: e } = t;
          e && p(e, this.src, this.preload);
        }
      };
      let m = DetailsDialogElement;
    ...
    96907: (t, e, n) => {
      ...
      let Combobox = class Combobox {
        constructor(
          ...
          ((this.input = t),
            ...
            (this.scrollIntoViewOptions =
              null != r ? r : { block: "nearest", inline: "nearest" }),
            (this.isComposing = !1),
            ...
            (this.keyboardEventHandler = (t) =>
              (function (t, e) {
                if (
                  ...
                  switch (t.key) {
                    case "Enter":
                      o(e.input, e.list) && t.preventDefault();
                      break;
                    case "Tab":
            ...
            (this.compositionEventHandler = (t) => {
              ...
              return (
                (e = t),
                (n = this),
                void ((n.isComposing = "compositionstart" === e.type),
        ...
        indicateDefaultOption() {
          ...
          this.defaultFirstOption &&
            (null ==
              ...
              t.setAttribute("data-combobox-option-default", "true"));
        }
        navigate(t = 1) {
          let e = Array.from(
        ...
        clearSelection() {
          for (let t of (this.input.removeAttribute("aria-activedescendant"),
          this.list.querySelectorAll('[aria-selected="true"]')))
            t.removeAttribute("aria-selected");
          this.indicateDefaultOption();
        }
      ...
      function i(t) {
        ...
        let i = t.target.closest('[role="option"]');
        i &&
          "true" !== i.getAttribute("aria-disabled") &&
          ((e = i),
          (n = { event: t }),
          e.dispatchEvent(
            new CustomEvent("combobox-commit", { bubbles: !0, detail: n }),
          ));
      }
      function o(t, e) {
        ...
        return (
          !!n && ("true" === n.getAttribute("aria-disabled") || (n.click(), !0))
        );
      }
      function r(t) {
        return (
      ...
      let s = window.testScreenReaderDelay || 100;
      let Autocomplete = class Autocomplete {
        constructor(t, e, n, i = !1) {
          ...
          if (
            ...
            (this.input = e),
            (this.results = n),
            (this.combobox = new Combobox(e, n, { defaultFirstOption: i })),
            (this.feedback = t
              .getRootNode()
              .getElementById(`${this.results.id}-feedback`)),
            (this.autoselectEnabled = i),
            (this.clearButton = t
              .getRootNode()
              .getElementById(`${this.input.id || this.input.name}-clear`)),
            ...
            const t = document.querySelector(`label[for="${this.input.name}"]`);
        ...
        onKeydown(t) {
          if ("Escape" === t.key && this.container.open)
            ...
            (this.open(), t.stopPropagation(), t.preventDefault());
          }
        }
        onInputFocus() {
          this.interactingWithList || this.fetchResults();
        }
        onInputBlur() {
          this.interactingWithList || this.close();
        }
        onCommit({ target: t }) {
          if (
            !(t instanceof HTMLElement) ||
            (this.close(), t instanceof HTMLAnchorElement)
          )
            return;
        ...
        identifyOptions() {
          let t = 0;
          for (let e of this.results.querySelectorAll(
            '[role="option"]:not([id])',
          ))
        ...
        fetchResults() {
          ...
          if (!t && !this.container.fetchOnEmpty) return void this.close();
      ...
      var a,
        ...
        p = function (t, e, n, i, o) {
          ...
          return (
            "a" === i ? o.call(t, n) : o ? (o.value = n) : e.set(t, n),
            n
          );
        },
        f = function (t, e) {
      ...
      let b = globalThis.HTMLElement || null;
      let AutoCompleteEvent = class AutoCompleteEvent extends Event {
        constructor(t, e) {
          var { relatedTarget: n } = e;
          (super(t, f(e, ["relatedTarget"])), (this.relatedTarget = n));
        }
      };
      let m = new WeakMap(),
        v = null;
      let auto_complete_element_AutoCompleteElement = class auto_complete_element_AutoCompleteElement extends b {
        constructor() {
          (super(...arguments),
            a.add(this),
            l.set(this, null),
        ...
        static setCSPTrustedTypesPolicy(t) {
          v = null === t ? t : Promise.resolve(t);
        }
        get forElement() {
          var t;
          if (null == (t = h(this, l, "f")) ? void 0 : t.isConnected)
            return h(this, l, "f");
          let e = this.getAttribute("for"),
            n = this.getRootNode();
          return e && (n instanceof Document || n instanceof ShadowRoot)
            ? n.getElementById(e)
            : null;
        }
        set forElement(t) {
          (p(this, l, t, "f"), this.setAttribute("for", ""));
        }
        get inputElement() {
          var t;
          return (null == (t = h(this, u, "f")) ? void 0 : t.isConnected)
            ? h(this, u, "f")
            : this.querySelector("input");
        }
        set inputElement(t) {
          (p(this, u, t, "f"), h(this, a, "m", c).call(this));
        }
        connectedCallback() {
          this.isConnected &&
            (h(this, a, "m", c).call(this),
            new MutationObserver(() => {
              m.get(this) || h(this, a, "m", c).call(this);
            }).observe(this, { subtree: !0, childList: !0 }));
        }
        disconnectedCallback() {
          let t = m.get(this);
        ...
        async fetchResult(t) {
          var e;
          null == (e = h(this, d, "f")) || e.abort();
          let { signal: n } = p(this, d, new AbortController(), "f"),
            i = await fetch(t.toString(), {
              signal: n,
              headers: { Accept: "text/fragment+html" },
            });
          if (!i.ok) throw Error(await i.text());
          return v ? (await v).createHTML(await i.text(), i) : await i.text();
        }
        static get observedAttributes() {
        ...
        attributeChangedCallback(t, e, n) {
          ...
          if (r)
            switch (
              ((this.forElement !==
                (null == (i = m.get(this)) ? void 0 : i.results) ||
                this.inputElement !==
                  (null == (o = m.get(this)) ? void 0 : o.input)) &&
                h(this, a, "m", c).call(this),
              t)
            ) {
              case "open":
      ...
      ((l = new WeakMap()),
        ...
        (c = function () {
          var t;
          null == (t = m.get(this)) || t.destroy();
          let { forElement: e, inputElement: n } = this;
          if (!e || !n) return;
          let i = "true" === this.getAttribute("data-autoselect");
          (m.set(this, new Autocomplete(this, n, e, i)),
            e.setAttribute("role", "listbox"));
        }));
      let g = "undefined" != typeof globalThis ? globalThis : window;
      try {
        g.AutocompleteElement = g.AutoCompleteElement =
          auto_complete_element_AutoCompleteElement.define();
      } catch (t) {
        if (
          !(
            g.DOMException &&
      ...
      let y = auto_complete_element_AutoCompleteElement;
    },
  },
]);
