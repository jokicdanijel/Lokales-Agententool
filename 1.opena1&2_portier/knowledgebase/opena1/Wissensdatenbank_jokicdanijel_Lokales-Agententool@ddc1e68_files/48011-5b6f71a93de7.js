...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [4013, 8897, 18696, 19973, 48011, 96315],
  {
    5225: (e, t, n) => {
      function r(...e) {
    ...
    39595: (e, t, n) => {
      ...
      function u(e) {
        for (let t of l(e)) e.addEventListener(t.type, c);
      }
      function f(e, t) {
              ...
              for (let t of m.keys()) {
                ...
                if (customElements.get(t) || n) {
                  let r = n?.getAttribute("data-load-on") || "ready",
                    o = r in S ? S[r] : S.ready;
                  for (let e of m.get(t) || []) o(t).then(e);
                  (m.delete(t), O.delete(e));
                }
              }
            }),
          ));
      ...
      function A(e, t) {
        ...
        Object.entries(e)))
          (m.has(n) || m.set(n, new Set()), m.get(n).add(r));
        E(document);
      }
      function E(e) {
        (r ||
      ...
      let CatalystDelegate = class CatalystDelegate {
        constructor(e) {
          ...
          (Object.defineProperty(e, "observedAttributes", {
            ...
            (function (e) {
              ...
              Object.defineProperty(e, "observedAttributes", {
                configurable: !0,
                get: () => [...P(e.prototype, p)].map(r).concat(t),
                set(e) {
                  t = e;
                },
              });
        ...
        connectedCallback(e, t) {
          ...
          a(e.ownerDocument),
          t?.call(e),
          e.shadowRoot) && (s((n = e.shadowRoot)), a(n), E(e.shadowRoot));
        }
        disconnectedCallback(e, t) {
          t?.call(e);
        }
        attributeChangedCallback(e, t, n, r, o) {
          (g(e), "data-catalyst" !== t && o && o.call(e, t, n, r));
        }
      };
      function P(e, t) {
      ...
      ((r.prototype.logDefaultIndexUsed = function () {}),
            ...
            for (
              ...
              ((a = (u = l[r]).key),
                (s = (function (e, t) {
                  ...
                  (((s = Object.create(i)).map = new o()), d.push(s)),
                i === this.indexes.default && this.logDefaultIndexUsed(n),
                (c = s.map.get(a)) || ((c = []), s.map.set(a, c)),
                c.push(n));
            (this.size++, h.push(e));
          }
        }),
        (r.prototype.remove = function (e, t) {
          if ("string" == typeof e) {
            ...
            for (o = 0, n = f(this.indexes, e); o < n.length; o++)
        ...
        (r.prototype.queryAll = function (e) {
          ...
          for (t = 0, r = f.length; t < r; t++)
            for (n = 0, i = f[t], o = (a = this.matches(i)).length; n < o; n++)
              (l[(c = a[n]).id]
                ? (s = l[c.id])
                : ((s = {
                    id: c.id,
          ...
          if (t) {
            ...
            if (n.length) {
              (v(e, "stopPropagation", w),
                v(e, "stopImmediatePropagation", S),
                x(e, O));
              for (var r = 0, o = n.length; r < o && !b.get(e); r++) {
                var i = n[r];
                g.set(e, i.node);
                for (var a = 0, s = i.observers.length; a < s && !y.get(e); a++)
