  ...
  [10172],
  {
    ...
    13195: (t, e, i) => {
      ...
      function a(t) {
        ...
        if (t.value === e) t.setCustomValidity("");
          ...
          let n = e;
          (i && (n = i + n), t.setCustomValidity(n));
        }
      }
      ((0, n.eC)("[data-required-value]", function (t) {
        a(t.currentTarget);
      }),
        (0, r.on)("change", "[data-required-value]", function (t) {
          let e = t.currentTarget;
          (a(e), l(e.form));
        }),
        (0, n.eC)("[data-required-trimmed]", function (t) {
          let e = t.currentTarget;
          "" === e.value.trim()
            ? e.setCustomValidity(e.getAttribute("data-required-trimmed"))
            : e.setCustomValidity("");
        }),
        (0, r.on)("change", "[data-required-trimmed]", function (t) {
          let e = t.currentTarget;
          ("" === e.value.trim()
            ? e.setCustomValidity(e.getAttribute("data-required-trimmed"))
            : e.setCustomValidity(""),
      ...
      ((0, s.lB)("button[data-disable-invalid]", {
        constructor: HTMLButtonElement,
        initialize(t) {
          let e = t.form;
          e &&
            (o.get(e) ||
              (e.addEventListener("change", () => l(e)), o.set(e, !0)),
        ...
        (0, s.lB)(
          ...
          function (t) {
            let e =
              "radio" === t.type && t.form
                ? t.form.elements.namedItem(t.name).value
                : null;
            function i(i) {
              let n = t.form;
              if (i && "radio" === t.type && n && e)
                for (let i of n.elements.namedItem(t.name))
                  i instanceof HTMLInputElement &&
                    i.setCustomValidity(t.value === e ? "unchanged" : "");
              else
                t.setCustomValidity(
                  t.value === (e || t.defaultValue) ? "unchanged" : "",
                );
            }
            (t.addEventListener("input", i),
    ...
    13523: (t, e, i) => {
      ...
      function l(t) {
        let e = {};
        return (
          void 0 !== t && (e["X-Fetch-Nonce-To-Validate"] = t),
          void 0 === t
            ? (e[s] = o())
            : r.has(t)
              ? (e[s] = t)
              : (e[s] = Array.from(r).join(",")),
          e
        );
      }
      function u() {
      ...
      if (
        ...
        if (t)
          try {
            ...
            console.error("Error parsing client-env", t);
          }
      }
    },
    26053: (t, e, i) => {
      (i(84947), i(20761), i(74057), i(91707), i(62044), i(90204));
      var n = i(94147);
      (i(78143), i(27552), i(72705), i(81028), i(44911), i(92284));
      var s = i(51987),
        r = i(71315);
      (r.cg &&
        (r.cg.IncludeFragmentElement.prototype.fetch = function (t) {
          let e = this.getAttribute("data-nonce") || "";
          return ((0, s.tV)(t.headers, e), window.fetch(t));
        }),
        i(72180));
      var a = i(31635),
        o = i(39595);
      let l = class GitCloneHelpElement extends HTMLElement {
        updateURL(t) {
          let e = t.currentTarget,
            i = e.getAttribute("data-url") || "";
          if (
            ((this.helpField.value = i),
            e.matches(".js-git-protocol-clone-url"))
          )
            for (let t of this.helpTexts) t.textContent = i;
          for (let t of this.cloneURLButtons) t.classList.remove("selected");
          e.classList.add("selected");
        }
      };
      ((0, a.Cg)([o.aC], l.prototype, "helpField", void 0),
        (0, a.Cg)([o.zV], l.prototype, "helpTexts", void 0),
        (0, a.Cg)([o.zV], l.prototype, "cloneURLButtons", void 0),
        (l = (0, a.Cg)([o.p_], l)));
      var u = i(35750),
        d = i(18150),
        h = i(85242),
      ...
      let v = class MarkedTextElement extends HTMLElement {
        ...
        get ownerInput() {
          let t = this.ownerDocument.getElementById(
            this.getAttribute("data-owner-input") || "",
          );
        ...
        connectedCallback() {
          (this.handleEvent(),
            ...
            (0, h._)(this, f, new MutationObserver(() => this.handleEvent())));
        }
        handleEvent() {
          ((0, u._)(this, g) && cancelAnimationFrame((0, u._)(this, g)),
            (0, h._)(
              this,
              g,
        ...
        disconnectedCallback() {
          (this.ownerInput?.removeEventListener("input", this),
            (0, u._)(this, f).disconnect());
        }
        mark() {
          let t = this.textContent || "",
            e = this.query;
          if (t === (0, u._)(this, m) && e === (0, u._)(this, p)) return;
          ((0, h._)(this, m, t),
            (0, h._)(this, p, e),
            (0, u._)(this, f).disconnect());
          let i = 0,
          ...
          for (let s of (
            ...
            if (Number(s) !== s || s < i || s > t.length) continue;
            ("" !== t.slice(i, s) &&
              n.appendChild(document.createTextNode(t.slice(i, s))),
              (i = s + 1));
            let e = document.createElement("mark");
            ((e.textContent = t[s]), n.appendChild(e));
          }
          (n.appendChild(document.createTextNode(t.slice(i))),
            this.replaceChildren(n),
            (0, u._)(this, f).observe(this, {
              attributes: !0,
              childList: !0,
              subtree: !0,
            }));
        ...
        constructor(...t) {
          (super(...t),
            (0, d._)(this, m, { writable: !0, value: "" }),
            (0, d._)(this, p, { writable: !0, value: "" }),
            (0, d._)(this, f, { writable: !0, value: void 0 }),
            (0, d._)(this, g, { writable: !0, value: void 0 }),
            (0, c._)(this, "positions", void 0));
        }
      };
      ((0, c._)(v, "observedAttributes", ["query", "data-owner-input"]),
        window.customElements.get("marked-text") ||
          ((window.MarkedTextElement = v),
      ...
      function E(t) {
        ...
        let o =
          ...
          (i = {
            minimumCharacterCount: Number(
              s.getAttribute("minimum-character-count"),
            ),
          ...
          ((n = {
            ...
            hasMinimumPassphraseLength:
              0 !== i.passphraseLength && e.length >= i.passphraseLength,
        ...
        if (o.valid) {
          ...
          t && (t.classList.remove("errored"), t.classList.add("successed"));
        } else
          "true" !== s.getAttribute("skip-custom-validity") &&
            r.setCustomValidity(s.getAttribute("invalid-message") || "Invalid");
        ((function (t, e) {
          let i = t.querySelector("[data-more-than-n-chars]"),
            ...
            o =
              t
                ...
                ?.split(" ")
                .filter((t) => t.length > 0) || [];
          for (let t of [i, n, s, r]) t?.classList.remove(...a, ...o);
          if (e.hasMinimumPassphraseLength && i) i.classList.add(...o);
          else if (e.valid)
            (n.classList.add(...o),
              s.classList.add(...o),
              r.classList.add(...o));
          else {
            let t = e.hasMinimumCharacterCount ? o : a,
              l = e.hasNumber ? o : a,
              u = e.hasLowerCase ? o : a;
            (i?.classList.add(...a),
              n.classList.add(...t),
              s.classList.add(...l),
              r.classList.add(...u));
      ...
      (window.customElements.get("password-strength") ||
        ((window.PasswordStrengthElement = w),
      ...
      let y = class PollIncludeFragmentElement extends n.T {
        ...
        refetch() {
          return (this.cancelPolling(), super.refetch());
        }
        connectedCallback() {
        ...
        constructor(...t) {
          (super(...t),
            (0, c._)(this, "intervalMilliseconds", 1e3),
            (0, c._)(this, "backoffMultiplier", 1.5),
            (0, c._)(this, "pollingTimeout", null));
        }
      };
      ((0, a.Cg)([o.aC], y.prototype, "retryButton", void 0),
        (0, a.Cg)([o.CF], y.prototype, "intervalMilliseconds", void 0),
        (0, a.Cg)([o.CF], y.prototype, "backoffMultiplier", void 0),
        (y = (0, a.Cg)([o.p_], y)));
      var C = i(35908);
      let _ = (t) => void 0 === t || /\n/.test(t),
        x = [
        ...
        A = class SlashCommandExpander {
          ...
          deactivate() {
            ...
            return (
              !!t &&
              !!e &&
              (this.createLink?.removeEventListener(
                "hotkey-fire",
          ...
          setMenu(t, e) {
            (this.deactivate(),
              (this.menu = e),
              (this.createLink = e.querySelector(
                ".js-slash-command-menu-create-link",
              )),
              e.id ||
            ...
            let i = e.querySelector(".js-command-list-container"),
              n = { tabInsertsSuggestions: !1 };
            i
              ? (this.combobox = new C.A(this.input, i, n))
              : (this.combobox = new C.A(this.input, e, n));
            let { top: s, left: r } = (function (t, e = t.selectionEnd) {
                let { mirror: i, marker: n } = (function (t, e) {
                    ...
                    if (r && r.parentElement === t.parentElement)
                      ...
                      ((r = document.createElement("div")), k.set(t, r));
                      let e = window.getComputedStyle(t),
                        i = x.slice(0);
                      "textarea" === s
                        ? i.push("white-space:pre-wrap;")
                        : i.push("white-space:nowrap;");
                    ...
                    if (
                      ...
                      if (!t.parentElement)
                        throw Error(
                          "textField must have a parentElement to mirror",
                        );
                ...
                return (
                  ...
                  { top: r.top - s.top, left: r.left - s.left }
                );
            ...
            ((e.style.top = `${s + a}px`),
              ...
              this.createLink?.addEventListener(
                "hotkey-fire",
                this.onCreateCommandLinkKeyDown,
              ),
          ...
          replaceCursorMark(t) {
            let e = /%cursor%/gm,
              i = e.exec(t);
            return i
              ? { cursor: i.index, value: t.replace(e, "") }
              : { cursor: null, value: t };
          }
          async onCommit({ target: t }) {
            ...
            let e = this.match;
            if (!e) return;
            let n = { item: t, key: e.key, value: null },
...
` === s
          ...
          async notifyProviders(t) {
            ...
            return (
              r(this.expander, t.key, n, t.text),
              (await Promise.all(e))
                .filter((t) => t.matched)
                .map((t) => t.fragment)[0]
            );
          ...
          constructor(t, e) {
            ((0, c._)(this, "expander", void 0),
              (0, c._)(this, "input", void 0),
              (0, c._)(this, "menu", void 0),
              (0, c._)(this, "createLink", void 0),
              (0, c._)(this, "oninput", void 0),
              (0, c._)(this, "onkeydown", void 0),
              (0, c._)(this, "onpaste", void 0),
              (0, c._)(this, "oncommit", void 0),
              (0, c._)(this, "onblur", void 0),
              (0, c._)(this, "onmousedown", void 0),
              (0, c._)(this, "combobox", void 0),
              (0, c._)(this, "match", void 0),
              (0, c._)(this, "justPasted", void 0),
              (0, c._)(this, "interactingWithMenu", void 0),
              (this.expander = t),
              (this.input = e),
              (this.combobox = null),
              (this.menu = null),
              ...
              (this.onCreateCommandLinkKeyDown =
                this.onCreateCommandLinkKeyDown.bind(this)),
              (this.interactingWithMenu = !1),
        ...
        S = class SlashCommandExpanderElement extends HTMLElement {
          getKeys() {
          ...
          reconnect() {
            if (
              null !== this.querySelector(".js-slash-command-menu:not(.d-none)")
            )
              return;
            let t = M.get(this);
            (t && (t.destroy(), M.delete(this)), this.connectedCallback());
          }
          disconnectedCallback() {
            let t = M.get(this);
          ...
          setMenu(t, e = !1) {
            ...
            !i ||
              (i.match &&
                (e && (i.interactingWithMenu = !0), i.setMenu(i.match, t)));
          }
          closeMenu() {
            let t = M.get(this);
            t && t.setValue("");
          ...
          isLoading() {
            let t = this.getElementsByClassName(
              "js-slash-command-expander-loading",
            )[0];
            if (t) {
              let e = t.cloneNode(!0);
          ...
          showError() {
            let t = this.getElementsByClassName(
              "js-slash-command-expander-error",
            )[0];
            if (t) {
              let e = t.cloneNode(!0);
              (e.classList.remove("d-none"), this.setMenu(e));
      ...
      window.customElements.get("slash-command-expander") ||
        ((window.SlashCommandExpanderElement = S),
        window.customElements.define("slash-command-expander", S));
      let T = class TextSuggesterElement extends HTMLElement {
        acceptSuggestion() {
      ...
      ((0, a.Cg)([o.aC], T.prototype, "input", void 0),
        (0, a.Cg)([o.aC], T.prototype, "suggestionContainer", void 0),
        (0, a.Cg)([o.aC], T.prototype, "suggestion", void 0),
        (T = (0, a.Cg)([o.p_], T)));
      var q = new WeakMap(),
        I = new WeakMap(),
        N = new WeakMap(),
      ...
      let H = class VirtualFilterInputElement extends HTMLElement {
        ...
        get filtered() {
          if ((0, u._)(this, F)) return (0, u._)(this, F);
          ...
          return (0, h._)(this, F, (0, u._)(this, F) || new Set());
        }
        set filtered(t) {
          (0, h._)(this, F, t);
        }
        ...
        reset() {
          (this.filtered.clear(), (0, h._)(this, z, new Set()));
        }
        clear() {
          this.input &&
            ((this.input.value = ""),
        ...
        attributeChangedCallback(t, e, i) {
          let n = this.isConnected && this.src,
            ...
            r = e !== i;
          (("src" === t || "data-property" === t) &&
            r &&
            ((0, h._)(this, N, null),
            (0, u._)(this, V) && clearTimeout((0, u._)(this, V))),
            n &&
            s &&
            ("src" === t ||
              "loading" === t ||
              ...
              "data-property" === t) &&
            r
              ? (cancelAnimationFrame((0, u._)(this, I)),
                (0, h._)(
                  this,
                  I,
                  requestAnimationFrame(() => this.load()),
                ))
              : "aria-owns" === t && (0, h._)(this, F, null));
        }
        connectedCallback() {
          this.src &&
            "eager" === this.loading &&
        ...
        handleEvent(t) {
          "input" === t.type &&
            ...
            (0, h._)(
              ...
              window.setTimeout(
                () => this.filterItems(),
                (this.input?.value?.length, 300),
              ),
            ));
        }
        async load() {
          ((0, u._)(this, q)?.abort(),
            (0, h._)(this, q, new AbortController()));
          let { signal: t } = (0, u._)(this, q);
          if (!this.src) throw Error("missing src");
          if ((await new Promise((t) => setTimeout(t, 0)), !t.aborted)) {
            ...
            try {
              ...
              if (location.origin + this.src !== e.url) return;
              if (!e.ok)
                throw Error(
                  `Failed to load resource: the server responded with a status of ${e.status}`,
                );
              ((0, h._)(this, z, new Set((await e.json())[this.property])),
                (0, h._)(this, N, null),
        ...
        filterItems() {
          let t,
            ...
            i = (0, u._)(this, N);
          if (((0, h._)(this, N, e), e !== i)) {
            for (let n of (this.dispatchEvent(
              new CustomEvent("virtual-filter-input-filter"),
            ),
            i && e.includes(i)
              ? (t = this.filtered)
              : ((t = (0, u._)(this, z)), this.filtered.clear()),
            t))
              this.filter(n, e)
                ? this.filtered.add(n)
                : this.filtered.delete(n);
            this.dispatchEvent(
        ...
        constructor(...t) {
          (super(...t),
            (0, d._)(this, q, { writable: !0, value: void 0 }),
            (0, d._)(this, I, { writable: !0, value: 0 }),
            (0, d._)(this, N, { writable: !0, value: null }),
            (0, d._)(this, V, { writable: !0, value: void 0 }),
            (0, d._)(this, z, { writable: !0, value: new Set() }),
            (0, d._)(this, F, { writable: !0, value: null }),
            (0, c._)(this, "filter", (t, e) => String(t).includes(e)));
        }
      };
      window.customElements.get("virtual-filter-input") ||
        ((window.VirtualFilterInputElement = H),
        window.customElements.define("virtual-filter-input", H));
      let W = new IntersectionObserver((t) => {
        for (let e of t)
          e.isIntersecting &&
            e.target instanceof K &&
            "eager" === e.target.updating &&
            e.target.update();
      });
      var B = new WeakMap(),
        R = new WeakMap(),
      ...
      let K = class VirtualListElement extends HTMLElement {
        ...
        get updating() {
          return "lazy" === this.getAttribute("data-updating")
            ? "lazy"
            : "eager";
        }
        set updating(t) {
        ...
        get size() {
          return (0, u._)(this, R).size;
        }
        get range() {
          let t = this.getBoundingClientRect().height,
            { scrollTop: e } = this,
            i = `${e}-${t}`;
          if ((0, u._)(this, j).has(i)) return (0, u._)(this, j).get(i);
          let n = 0,
            s = 0,
            r = 0,
            a = 0,
            o = (0, u._)(this, P);
          for (let i of (0, u._)(this, R)) {
            let l = o.get(i) || (0, u._)(this, O);
            if (r + l < e) ((r += l), (n += 1), (s += 1));
            else if (a - l < t) ((a += l), (s += 1));
            else if (a >= t) break;
          }
          return [n, s];
        }
        ...
        update() {
          ((0, u._)(this, D) && cancelAnimationFrame((0, u._)(this, D)),
            !(0, u._)(this, B) && this.hasAttribute("data-sorted")
              ? (0, h._)(
                  this,
                  D,
              ...
              : (0, h._)(this, D, requestAnimationFrame(this.updateSync)));
        }
        renderItem(t) {
          let e = { item: t, fragment: document.createDocumentFragment() };
          return (
            this.dispatchEvent(
              new CustomEvent("virtual-list-render-item", { detail: e }),
            ),
        ...
        recalculateHeights(t) {
          ...
          (e.replaceChildren(),
            n && ((0, h._)(this, O, n), (0, u._)(this, P).set(t, n)));
        }
        getIndexByElementId(t) {
          if (!t) return -1;
          let e = 0;
          for (let [, i] of (0, u._)(this, X)) {
            if (i.id === t || i.querySelector(`#${t}`)) return e;
            e++;
          }
          return -1;
        }
        updateSync() {
          ...
          if (
            i < e ||
            !this.dispatchEvent(
              new CustomEvent("virtual-list-update", { cancelable: !0 }),
            )
          )
            return;
          let n = new Map(),
            ...
            l = 0,
            d = 0;
          for (let t of (0, u._)(this, R)) {
            if (
              (-1 !== r ||
                (Number.isFinite((0, u._)(this, O)) &&
                  0 !== (0, u._)(this, O)) ||
                this.recalculateHeights(t),
              (r += 1),
              (d = (0, u._)(this, P).get(t) || (0, u._)(this, O)),
              r < e)
            ) {
              ((o += d), (l = o));
              continue;
            ...
            let h = null;
            if (s.has(t)) h = s.get(t);
            else {
              if (!(h = this.renderItem(t))) continue;
              (h
                .querySelector("[aria-setsize]")
                ?.setAttribute(
                  "aria-setsize",
                  (0, u._)(this, R).size.toString(),
                ),
                h
                  .querySelector("[aria-posinset]")
                  ?.setAttribute("aria-posinset", (r + 1).toString()),
                s.set(t, h));
            }
            (h
              .querySelector("[tabindex]")
              ?.setAttribute("data-scrolltop", l.toString()),
              (l += d),
              n.set(t, h));
          }
          (t.replaceChildren(...n.values()), (t.style.paddingTop = `${o}px`));
          let h = this.size * (0, u._)(this, O);
          t.style.height = `${h || 0}px`;
          let c = !1,
            m = this.getBoundingClientRect().bottom;
          for (let [t, e] of n) {
            let { height: i, bottom: n } = e.getBoundingClientRect();
            ((c = c || n >= m), (0, u._)(this, P).set(t, i));
          }
        ...
        resetRenderCache() {
          (0, h._)(this, X, new Map());
        }
        has(t) {
          return (0, u._)(this, R).has(t);
        }
        add(t) {
          return (
            (0, u._)(this, R).add(t),
            (0, h._)(this, B, !1),
            Number.isFinite((0, u._)(this, O)) || this.recalculateHeights(t),
        ...
        delete(t) {
          let e = (0, u._)(this, R).delete(t);
          return (
            (0, h._)(this, B, !1),
            (0, u._)(this, P).delete(t),
            this.resetRenderCache(),
            this.dispatchEvent(new Event("virtual-list-data-updated")),
            "eager" === this.updating && this.update(),
            e
        ...
        forEach(t, e) {
          for (let i of this) t.call(e, i, i, this);
        }
        entries() {
          return (0, u._)(this, R).entries();
        }
        values() {
          return (0, u._)(this, R).values();
        }
        keys() {
          return (0, u._)(this, R).keys();
        }
        [Symbol.iterator]() {
          return (0, u._)(this, R)[Symbol.iterator]();
        }
        sort(t) {
          return (
            (0, h._)(this, R, new Set(Array.from(this).sort(t))),
            (0, h._)(this, B, !0),
            this.dispatchEvent(new Event("virtual-list-data-updated")),
            "eager" === this.updating && this.update(),
            this
        ...
        constructor(...t) {
          (super(...t),
            (0, d._)(this, B, { writable: !0, value: !1 }),
            (0, d._)(this, R, { writable: !0, value: new Set() }),
            (0, d._)(this, P, { writable: !0, value: new Map() }),
            (0, d._)(this, O, { writable: !0, value: 1 / 0 }),
            (0, d._)(this, j, { writable: !0, value: new Map() }),
            (0, d._)(this, X, { writable: !0, value: new Map() }),
            (0, d._)(this, D, { writable: !0, value: 0 }),
            (0, c._)(this, Symbol.toStringTag, "VirtualListElement"));
        }
      };
      let ActiveDescendantChangedEvent = class ActiveDescendantChangedEvent extends Event {
        constructor(t, e) {
          (super("virtual-list-activedescendant-changed"),
            (0, c._)(this, "index", void 0),
            (0, c._)(this, "id", void 0),
            (this.index = t),
            (this.id = e));
        }
      };
      let RenderedEvent = class RenderedEvent extends Event {
        constructor(t) {
          (super("virtual-list-rendered"),
            (0, c._)(this, "rowsCache", void 0),
            (this.rowsCache = t));
        }
      };
      window.customElements.get("virtual-list") ||
        ((window.VirtualListElement = K),
        window.customElements.define("virtual-list", K));
    },
    51987: (t, e, i) => {
      i.d(e, { jC: () => l, kt: () => a, tV: () => o });
      var n = i(87057),
        s = i(69599),
        r = i(13523);
      function a(t) {
        let e = { "X-Requested-With": "XMLHttpRequest", ...(0, r.wE)(t) };
        return (
          (0, s.G7)("client_version_header") &&
            (e = { ...e, [n.S]: (0, n.O)() }),
          e
        );
      }
      function o(t, e) {
        for (let [i, n] of Object.entries(a(e))) t.set(i, n);
      }
      function l(t) {
        return { "X-GitHub-App-Type": t };
      }
    },
    56038: (t, e, i) => {
      i.d(e, { Kn: () => a, XC: () => s, cg: () => r, fV: () => o });
    ...
    69599: (t, e, i) => {
      i.d(e, { G7: () => l, XY: () => u, fQ: () => o });
      var n = i(5225),
        s = i(21067);
      function r() {
        return new Set((0, s._$)().featureFlags);
      }
      let a =
        i(71315).X3 ||
        (function () {
    ...
    72180: (t, e, i) => {
      ...
      let s = (t, e, i) => {
        ...
        r = (t, e, i) => {
          t.textContent = "";
          let s = 0;
          for (let r of (0, n.Xq)(e, i)) {
            ("" !== i.slice(s, r) &&
              t.appendChild(document.createTextNode(i.slice(s, r))),
              (s = r + 1));
            let e = document.createElement("mark");
            ((e.textContent = i[r]), t.appendChild(e));
          }
        ...
        l = new WeakMap(),
        u = (t) => {
          if (!l.has(t) && t instanceof HTMLElement) {
            let e = (
        ...
        d = class FuzzyListElement extends HTMLElement {
                ...
                if ("childList" === s.type && s.addedNodes.length) {
                  for (let t of s.addedNodes)
                    if (t instanceof HTMLLIElement && !e.has(t)) {
                      let s = u(t);
                      ((i = i || (0, n.qA)(this.value, s)), e.add(t));
                    }
                }
              i && this.sort();
            });
            s.observe(t, { childList: !0 });
            let r = { handler: s, items: e, lazyItems: new Map(), timer: null };
            o.set(this, r);
          }
          disconnectedCallback() {
            let t = o.get(this);
            t && (t.handler.disconnect(), o.delete(this));
          }
          addLazyItems(t, e) {
            let i = o.get(this);
            if (!i) return;
            let { lazyItems: s } = i,
              { value: r } = this,
              a = !1;
            for (let i of t) (s.set(i, e), (a = a || (!!r && (0, n.qA)(r, i))));
            a && this.sort();
          }
          sort() {
            let t = a.get(this);
            ...
            if (h) {
              for (let t of m) {
                let e = s(h, u(t), i);
                e !== -1 / 0 && v.push({ item: t, score: e });
              }
              for (let [t, e] of p) {
                let n = s(h, t, i);
                n !== -1 / 0 && v.push({ text: t, render: e, score: n });
              }
              ...
              for (let e of m) {
                if (t >= d) break;
                (v.push({ item: e, score: 1 }), (t += 1));
              }
              for (let [e, i] of p) {
                if (t >= d) break;
                (v.push({ text: e, render: i, score: 1 }), (t += 1));
              }
            }
            requestAnimationFrame(() => {
              if (e.aborted) return;
                ...
                s = () => {
                  ...
                  for (let t = i; t < a; t += 1) {
                    ...
                    if ("render" in e && "text" in e) {
                      ...
                      ((i = t(n)), m.add(i), l.set(i, n), p.delete(n));
                    } else "item" in e && (i = e.item);
                    i instanceof HTMLElement &&
                      (f && r((n && i.querySelector(n)) || i, f ? h : "", u(i)),
                      o.appendChild(i));
                  }
                  i = a;
                  let d = !1;
                  ...
                  if (this.getAttribute("data-tab-only-first")) {
                    ...
                    for (let e of t) e.setAttribute("tabindex", "-1");
                    t.item(0)?.setAttribute("tabindex", "0");
                  } else
                    for (let t of o.querySelectorAll('button[tabindex="-1"]'))
          ...
          set markSelector(t) {
            t
              ? this.setAttribute("mark-selector", t)
    ...
    87363: (t, e, i) => {
      ...
      function a(t) {
        ...
        if (e instanceof HTMLElement && e.nodeType !== Node.DOCUMENT_NODE)
          for (let t of r.matches(e)) t.data.call(null, e);
      }
      function o(t, e) {
        (s || ((s = !0), document.addEventListener("focus", a, !0)),
          r.add(t, e),
      ...
      function l(t, e, i) {
        function n(e) {
          ...
          s && (s.removeEventListener(t, i), s.removeEventListener("blur", n));
        }
        o(e, function (e) {
          (e.addEventListener(t, i), e.addEventListener("blur", n));
        });
      }
      function u(t, e) {
        function i(t) {
        ...
        o(t, function (t) {
          (t.addEventListener("input", e), t.addEventListener("blur", i));
        });
      }
    },
    92454: (t, e, i) => {
      ...
      (i.d(e, { u: () => n }),
        (0, i(21403).lB)(".js-remove-unless-platform", function (t) {
          let e, i;
  ...
  (t) => {
    (t.O(0, [11683, 43784, 4712, 81028, 74911, 91853, 78143, 52430], () =>
      t((t.s = 26053)),
    ),
      t.O());
  },
