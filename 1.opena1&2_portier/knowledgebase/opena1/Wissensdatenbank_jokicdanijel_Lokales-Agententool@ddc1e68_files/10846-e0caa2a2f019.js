...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [10846],
  {
      ...
      let s = function (e) {
        return (0, r.A)(function (t, n) {
          var r = -1,
            ...
            o = s > 2 ? n[2] : void 0;
          for (
            i = e.length > 3 && "function" == typeof i ? (s--, i) : void 0,
              o &&
                (0, a.A)(n[0], n[1], o) &&
                ((i = s < 3 ? void 0 : i), (s = 1)),
              t = Object(t);
    ...
    14674: (e, t, n) => {
      ...
      (((a = f || (f = {})).controlCharacterInInputStream =
        "control-character-in-input-stream"),
        (a.noncharacterInInputStream = "noncharacter-in-input-stream"),
        (a.surrogateInInputStream = "surrogate-in-input-stream"),
        (a.nonVoidHtmlElementStartTagWithTrailingSolidus =
          "non-void-html-element-start-tag-with-trailing-solidus"),
        (a.endTagWithAttributes = "end-tag-with-attributes"),
        (a.endTagWithTrailingSolidus = "end-tag-with-trailing-solidus"),
        (a.unexpectedSolidusInTag = "unexpected-solidus-in-tag"),
        (a.unexpectedNullCharacter = "unexpected-null-character"),
        (a.unexpectedQuestionMarkInsteadOfTagName =
          "unexpected-question-mark-instead-of-tag-name"),
        (a.invalidFirstCharacterOfTagName =
          "invalid-first-character-of-tag-name"),
        (a.unexpectedEqualsSignBeforeAttributeName =
          "unexpected-equals-sign-before-attribute-name"),
        (a.missingEndTagName = "missing-end-tag-name"),
        (a.unexpectedCharacterInAttributeName =
          "unexpected-character-in-attribute-name"),
        (a.unknownNamedCharacterReference =
          "unknown-named-character-reference"),
        (a.missingSemicolonAfterCharacterReference =
          "missing-semicolon-after-character-reference"),
        (a.unexpectedCharacterAfterDoctypeSystemIdentifier =
          "unexpected-character-after-doctype-system-identifier"),
        (a.unexpectedCharacterInUnquotedAttributeValue =
          "unexpected-character-in-unquoted-attribute-value"),
        (a.eofBeforeTagName = "eof-before-tag-name"),
        (a.eofInTag = "eof-in-tag"),
        (a.missingAttributeValue = "missing-attribute-value"),
        (a.missingWhitespaceBetweenAttributes =
          "missing-whitespace-between-attributes"),
        (a.missingWhitespaceAfterDoctypePublicKeyword =
          "missing-whitespace-after-doctype-public-keyword"),
        (a.missingWhitespaceBetweenDoctypePublicAndSystemIdentifiers =
          "missing-whitespace-between-doctype-public-and-system-identifiers"),
        (a.missingWhitespaceAfterDoctypeSystemKeyword =
          "missing-whitespace-after-doctype-system-keyword"),
        (a.missingQuoteBeforeDoctypePublicIdentifier =
          "missing-quote-before-doctype-public-identifier"),
        (a.missingQuoteBeforeDoctypeSystemIdentifier =
          "missing-quote-before-doctype-system-identifier"),
        (a.missingDoctypePublicIdentifier =
          "missing-doctype-public-identifier"),
        (a.missingDoctypeSystemIdentifier =
          "missing-doctype-system-identifier"),
        (a.abruptDoctypePublicIdentifier = "abrupt-doctype-public-identifier"),
        (a.abruptDoctypeSystemIdentifier = "abrupt-doctype-system-identifier"),
        (a.cdataInHtmlContent = "cdata-in-html-content"),
        (a.incorrectlyOpenedComment = "incorrectly-opened-comment"),
        (a.eofInScriptHtmlCommentLikeText =
          "eof-in-script-html-comment-like-text"),
        (a.eofInDoctype = "eof-in-doctype"),
        (a.nestedComment = "nested-comment"),
        (a.abruptClosingOfEmptyComment = "abrupt-closing-of-empty-comment"),
        (a.eofInComment = "eof-in-comment"),
        (a.incorrectlyClosedComment = "incorrectly-closed-comment"),
        (a.eofInCdata = "eof-in-cdata"),
        (a.absenceOfDigitsInNumericCharacterReference =
          "absence-of-digits-in-numeric-character-reference"),
        (a.nullCharacterReference = "null-character-reference"),
        (a.surrogateCharacterReference = "surrogate-character-reference"),
        (a.characterReferenceOutsideUnicodeRange =
          "character-reference-outside-unicode-range"),
        (a.controlCharacterReference = "control-character-reference"),
        (a.noncharacterCharacterReference = "noncharacter-character-reference"),
        (a.missingWhitespaceBeforeDoctypeName =
          "missing-whitespace-before-doctype-name"),
        (a.missingDoctypeName = "missing-doctype-name"),
        (a.invalidCharacterSequenceAfterDoctypeName =
          "invalid-character-sequence-after-doctype-name"),
        (a.duplicateAttribute = "duplicate-attribute"),
        (a.nonConformingDoctype = "non-conforming-doctype"),
        (a.missingDoctype = "missing-doctype"),
        (a.misplacedDoctype = "misplaced-doctype"),
        (a.endTagWithoutMatchingOpenElement =
          "end-tag-without-matching-open-element"),
        (a.closingOfElementWithOpenChildElements =
          "closing-of-element-with-open-child-elements"),
        (a.disallowedContentInNoscriptInHead =
          "disallowed-content-in-noscript-in-head"),
        (a.openElementsLeftAfterEof = "open-elements-left-after-eof"),
        (a.abandonedHeadElementChild = "abandoned-head-element-child"),
        (a.misplacedStartTagForHeadElement =
          "misplaced-start-tag-for-head-element"),
        (a.nestedNoscriptInHead = "nested-noscript-in-head"),
        (a.eofInElementThatCanContainOnlyText =
      ...
      let Preprocessor = class Preprocessor {
        ...
        getError(e, t) {
          let { line: n, col: r, offset: a } = this,
            s = r + t,
            i = a + t;
          return {
            code: e,
        ...
        advance() {
          ...
          return e === _.CARRIAGE_RETURN
            ? ((this.isEol = !0), (this.skipNextNewLine = !0), _.LINE_FEED)
            : e === _.LINE_FEED && ((this.isEol = !0), this.skipNextNewLine)
              ? (this.line--,
                (this.skipNextNewLine = !1),
                this._addGap(),
                this.advance())
              : ((this.skipNextNewLine = !1),
                G(e) && (e = this._processSurrogate(e)),
        ...
        _checkForProblematicCharacters(e) {
          x(e)
            ...
            : Y(e) && this._err(f.noncharacterInInputStream);
        }
        retreat(e) {
      ...
      (((i = I || (I = {}))[(i.NUM = 35)] = "NUM"),
        ...
        ((o = C || (C = {}))[(o.VALUE_LENGTH = 49152)] = "VALUE_LENGTH"),
        (o[(o.BRANCH_LENGTH = 16256)] = "BRANCH_LENGTH"),
        (o[(o.JUMP_TABLE = 127)] = "JUMP_TABLE"),
        ((l = g || (g = {}))[(l.EntityStart = 0)] = "EntityStart"),
      ...
      let EntityDecoder = class EntityDecoder {
          ...
          switch (this.state) {
            case g.EntityStart:
              if (e.charCodeAt(t) === I.NUM)
                return (
                  (this.state = g.NumericStart),
                  (this.consumed += 1),
                  this.stateNumericStart(e, t + 1)
                );
              return (
                (this.state = g.NamedEntity),
        ...
        stateNumericStart(e, t) {
          return t >= e.length
            ...
            : (32 | e.charCodeAt(t)) === I.LOWER_X
              ? ((this.state = g.NumericHex),
                (this.consumed += 1),
                this.stateNumericHex(e, t + 1))
              : ((this.state = g.NumericDecimal),
        ...
        addToNumericResult(e, t, n, r) {
          if (t !== n) {
            let a = n - t;
            ((this.result =
              this.result * Math.pow(r, a) +
              Number.parseInt(e.substr(t, a), r)),
              (this.consumed += a));
          }
        }
        stateNumericHex(e, t) {
        ...
        stateNamedEntity(e, t) {
          let { decodeTree: n } = this,
            r = n[this.treeIndex],
            a = (r & C.VALUE_LENGTH) >> 14;
          for (; t < e.length; t++, this.excess++) {
            let s = e.charCodeAt(t);
            if (
              ((this.treeIndex = (function (e, t, n, r) {
                let a = (t & C.BRANCH_LENGTH) >> 7,
                  s = t & C.JUMP_TABLE;
                if (0 === a) return 0 !== s && r === s ? n : -1;
                if (s) {
                  let t = r - s;
                ...
                return -1;
              })(n, r, this.treeIndex + Math.max(1, a), s)),
              this.treeIndex < 0)
            )
            ...
            if (0 != (a = ((r = n[this.treeIndex]) & C.VALUE_LENGTH) >> 14)) {
              if (s === I.SEMI)
        ...
        emitNamedEntityData(e, t, n) {
          ...
          return (
            this.emitCodePoint(1 === t ? r[e] & ~C.VALUE_LENGTH : r[e + 1], n),
      ...
      (((E = D || (D = {})).HTML = "http://www.w3.org/1999/xhtml"),
        ...
        (p[(p.SEARCH = 94)] = "SEARCH"),
        (p[(p.SECTION = 95)] = "SECTION"),
        (p[(p.SELECT = 96)] = "SELECT"),
        (p[(p.SOURCE = 97)] = "SOURCE"),
        (p[(p.SMALL = 98)] = "SMALL"),
        (p[(p.SPAN = 99)] = "SPAN"),
        (p[(p.STRIKE = 100)] = "STRIKE"),
        (p[(p.STRONG = 101)] = "STRONG"),
        (p[(p.STYLE = 102)] = "STYLE"),
        (p[(p.SUB = 103)] = "SUB"),
        (p[(p.SUMMARY = 104)] = "SUMMARY"),
        (p[(p.SUP = 105)] = "SUP"),
        (p[(p.TABLE = 106)] = "TABLE"),
        (p[(p.TBODY = 107)] = "TBODY"),
        (p[(p.TEMPLATE = 108)] = "TEMPLATE"),
        (p[(p.TEXTAREA = 109)] = "TEXTAREA"),
        (p[(p.TFOOT = 110)] = "TFOOT"),
        (p[(p.TD = 111)] = "TD"),
        (p[(p.TH = 112)] = "TH"),
        (p[(p.THEAD = 113)] = "THEAD"),
      ...
      function V(e) {
        var t;
        return null != (t = X.get(e)) ? t : k.UNKNOWN;
      }
      let z = k,
        j = {
          [D.HTML]: new Set([
          ...
          [D.SVG]: new Set([z.TITLE, z.FOREIGN_OBJECT, z.DESC]),
          [D.XLINK]: new Set(),
          [D.XML]: new Set(),
          [D.XMLNS]: new Set(),
        },
        J = new Set([z.H1, z.H2, z.H3, z.H4, z.H5, z.H6]),
        Z = new Set([
          L.STYLE,
          L.SCRIPT,
          L.XMP,
      ...
      function $(e, t) {
        return Z.has(e) || (t && e === L.NOSCRIPT);
      }
      (((d = b || (b = {}))[(d.DATA = 0)] = "DATA"),
        (d[(d.RCDATA = 1)] = "RCDATA"),
        (d[(d.RAWTEXT = 2)] = "RAWTEXT"),
        (d[(d.SCRIPT_DATA = 3)] = "SCRIPT_DATA"),
        (d[(d.PLAINTEXT = 4)] = "PLAINTEXT"),
        (d[(d.TAG_OPEN = 5)] = "TAG_OPEN"),
        (d[(d.END_TAG_OPEN = 6)] = "END_TAG_OPEN"),
        (d[(d.TAG_NAME = 7)] = "TAG_NAME"),
        (d[(d.RCDATA_LESS_THAN_SIGN = 8)] = "RCDATA_LESS_THAN_SIGN"),
        (d[(d.RCDATA_END_TAG_OPEN = 9)] = "RCDATA_END_TAG_OPEN"),
        (d[(d.RCDATA_END_TAG_NAME = 10)] = "RCDATA_END_TAG_NAME"),
        (d[(d.RAWTEXT_LESS_THAN_SIGN = 11)] = "RAWTEXT_LESS_THAN_SIGN"),
        (d[(d.RAWTEXT_END_TAG_OPEN = 12)] = "RAWTEXT_END_TAG_OPEN"),
        (d[(d.RAWTEXT_END_TAG_NAME = 13)] = "RAWTEXT_END_TAG_NAME"),
        (d[(d.SCRIPT_DATA_LESS_THAN_SIGN = 14)] = "SCRIPT_DATA_LESS_THAN_SIGN"),
        (d[(d.SCRIPT_DATA_END_TAG_OPEN = 15)] = "SCRIPT_DATA_END_TAG_OPEN"),
        (d[(d.SCRIPT_DATA_END_TAG_NAME = 16)] = "SCRIPT_DATA_END_TAG_NAME"),
        (d[(d.SCRIPT_DATA_ESCAPE_START = 17)] = "SCRIPT_DATA_ESCAPE_START"),
        (d[(d.SCRIPT_DATA_ESCAPE_START_DASH = 18)] =
          "SCRIPT_DATA_ESCAPE_START_DASH"),
        (d[(d.SCRIPT_DATA_ESCAPED = 19)] = "SCRIPT_DATA_ESCAPED"),
        (d[(d.SCRIPT_DATA_ESCAPED_DASH = 20)] = "SCRIPT_DATA_ESCAPED_DASH"),
        (d[(d.SCRIPT_DATA_ESCAPED_DASH_DASH = 21)] =
          "SCRIPT_DATA_ESCAPED_DASH_DASH"),
        (d[(d.SCRIPT_DATA_ESCAPED_LESS_THAN_SIGN = 22)] =
          "SCRIPT_DATA_ESCAPED_LESS_THAN_SIGN"),
        (d[(d.SCRIPT_DATA_ESCAPED_END_TAG_OPEN = 23)] =
          "SCRIPT_DATA_ESCAPED_END_TAG_OPEN"),
        (d[(d.SCRIPT_DATA_ESCAPED_END_TAG_NAME = 24)] =
          "SCRIPT_DATA_ESCAPED_END_TAG_NAME"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPE_START = 25)] =
          "SCRIPT_DATA_DOUBLE_ESCAPE_START"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPED = 26)] = "SCRIPT_DATA_DOUBLE_ESCAPED"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPED_DASH = 27)] =
          "SCRIPT_DATA_DOUBLE_ESCAPED_DASH"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPED_DASH_DASH = 28)] =
          "SCRIPT_DATA_DOUBLE_ESCAPED_DASH_DASH"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPED_LESS_THAN_SIGN = 29)] =
          "SCRIPT_DATA_DOUBLE_ESCAPED_LESS_THAN_SIGN"),
        (d[(d.SCRIPT_DATA_DOUBLE_ESCAPE_END = 30)] =
          "SCRIPT_DATA_DOUBLE_ESCAPE_END"),
        (d[(d.BEFORE_ATTRIBUTE_NAME = 31)] = "BEFORE_ATTRIBUTE_NAME"),
        (d[(d.ATTRIBUTE_NAME = 32)] = "ATTRIBUTE_NAME"),
        (d[(d.AFTER_ATTRIBUTE_NAME = 33)] = "AFTER_ATTRIBUTE_NAME"),
        (d[(d.BEFORE_ATTRIBUTE_VALUE = 34)] = "BEFORE_ATTRIBUTE_VALUE"),
        (d[(d.ATTRIBUTE_VALUE_DOUBLE_QUOTED = 35)] =
          "ATTRIBUTE_VALUE_DOUBLE_QUOTED"),
        (d[(d.ATTRIBUTE_VALUE_SINGLE_QUOTED = 36)] =
          "ATTRIBUTE_VALUE_SINGLE_QUOTED"),
        (d[(d.ATTRIBUTE_VALUE_UNQUOTED = 37)] = "ATTRIBUTE_VALUE_UNQUOTED"),
        (d[(d.AFTER_ATTRIBUTE_VALUE_QUOTED = 38)] =
          "AFTER_ATTRIBUTE_VALUE_QUOTED"),
        (d[(d.SELF_CLOSING_START_TAG = 39)] = "SELF_CLOSING_START_TAG"),
        (d[(d.BOGUS_COMMENT = 40)] = "BOGUS_COMMENT"),
        (d[(d.MARKUP_DECLARATION_OPEN = 41)] = "MARKUP_DECLARATION_OPEN"),
        (d[(d.COMMENT_START = 42)] = "COMMENT_START"),
        (d[(d.COMMENT_START_DASH = 43)] = "COMMENT_START_DASH"),
        (d[(d.COMMENT = 44)] = "COMMENT"),
        (d[(d.COMMENT_LESS_THAN_SIGN = 45)] = "COMMENT_LESS_THAN_SIGN"),
        (d[(d.COMMENT_LESS_THAN_SIGN_BANG = 46)] =
          "COMMENT_LESS_THAN_SIGN_BANG"),
        (d[(d.COMMENT_LESS_THAN_SIGN_BANG_DASH = 47)] =
          "COMMENT_LESS_THAN_SIGN_BANG_DASH"),
        (d[(d.COMMENT_LESS_THAN_SIGN_BANG_DASH_DASH = 48)] =
          "COMMENT_LESS_THAN_SIGN_BANG_DASH_DASH"),
        (d[(d.COMMENT_END_DASH = 49)] = "COMMENT_END_DASH"),
        (d[(d.COMMENT_END = 50)] = "COMMENT_END"),
        (d[(d.COMMENT_END_BANG = 51)] = "COMMENT_END_BANG"),
        (d[(d.DOCTYPE = 52)] = "DOCTYPE"),
        (d[(d.BEFORE_DOCTYPE_NAME = 53)] = "BEFORE_DOCTYPE_NAME"),
        (d[(d.DOCTYPE_NAME = 54)] = "DOCTYPE_NAME"),
        (d[(d.AFTER_DOCTYPE_NAME = 55)] = "AFTER_DOCTYPE_NAME"),
        (d[(d.AFTER_DOCTYPE_PUBLIC_KEYWORD = 56)] =
          "AFTER_DOCTYPE_PUBLIC_KEYWORD"),
        (d[(d.BEFORE_DOCTYPE_PUBLIC_IDENTIFIER = 57)] =
          "BEFORE_DOCTYPE_PUBLIC_IDENTIFIER"),
        (d[(d.DOCTYPE_PUBLIC_IDENTIFIER_DOUBLE_QUOTED = 58)] =
          "DOCTYPE_PUBLIC_IDENTIFIER_DOUBLE_QUOTED"),
        (d[(d.DOCTYPE_PUBLIC_IDENTIFIER_SINGLE_QUOTED = 59)] =
          "DOCTYPE_PUBLIC_IDENTIFIER_SINGLE_QUOTED"),
        (d[(d.AFTER_DOCTYPE_PUBLIC_IDENTIFIER = 60)] =
          "AFTER_DOCTYPE_PUBLIC_IDENTIFIER"),
        (d[(d.BETWEEN_DOCTYPE_PUBLIC_AND_SYSTEM_IDENTIFIERS = 61)] =
          "BETWEEN_DOCTYPE_PUBLIC_AND_SYSTEM_IDENTIFIERS"),
        (d[(d.AFTER_DOCTYPE_SYSTEM_KEYWORD = 62)] =
          "AFTER_DOCTYPE_SYSTEM_KEYWORD"),
        (d[(d.BEFORE_DOCTYPE_SYSTEM_IDENTIFIER = 63)] =
          "BEFORE_DOCTYPE_SYSTEM_IDENTIFIER"),
        (d[(d.DOCTYPE_SYSTEM_IDENTIFIER_DOUBLE_QUOTED = 64)] =
          "DOCTYPE_SYSTEM_IDENTIFIER_DOUBLE_QUOTED"),
        (d[(d.DOCTYPE_SYSTEM_IDENTIFIER_SINGLE_QUOTED = 65)] =
          "DOCTYPE_SYSTEM_IDENTIFIER_SINGLE_QUOTED"),
        (d[(d.AFTER_DOCTYPE_SYSTEM_IDENTIFIER = 66)] =
          "AFTER_DOCTYPE_SYSTEM_IDENTIFIER"),
        (d[(d.BOGUS_DOCTYPE = 67)] = "BOGUS_DOCTYPE"),
        (d[(d.CDATA_SECTION = 68)] = "CDATA_SECTION"),
        (d[(d.CDATA_SECTION_BRACKET = 69)] = "CDATA_SECTION_BRACKET"),
        (d[(d.CDATA_SECTION_END = 70)] = "CDATA_SECTION_END"),
        (d[(d.CHARACTER_REFERENCE = 71)] = "CHARACTER_REFERENCE"),
        (d[(d.AMBIGUOUS_AMPERSAND = 72)] = "AMBIGUOUS_AMPERSAND"));
      let ee = {
        DATA: b.DATA,
        RCDATA: b.RCDATA,
        RAWTEXT: b.RAWTEXT,
      ...
      function en(e) {
        return (e >= _.LATIN_SMALL_A && e <= _.LATIN_SMALL_Z) || et(e);
      }
      function er(e) {
        return en(e) || (e >= _.DIGIT_0 && e <= _.DIGIT_9);
      }
      function ea(e) {
        return (
          e === _.SPACE ||
      ...
      function es(e) {
        return ea(e) || e === _.SOLIDUS || e === _.GREATER_THAN_SIGN;
      }
      let Tokenizer = class Tokenizer {
              ...
              t.onParseError
                ? {
                    ...
                    validateNumericCharacterReference: (e) => {
                      let t = (function (e) {
                        if (e === _.NULL) return f.nullCharacterReference;
                        if (e > 1114111)
                          return f.characterReferenceOutsideUnicodeRange;
                        if (G(e)) return f.surrogateCharacterReference;
                        if (Y(e)) return f.noncharacterCharacterReference;
                        if (x(e) || e === _.CARRIAGE_RETURN)
                          return f.controlCharacterReference;
                        return null;
                      })(e);
                      t && this._err(t, 1);
                    },
        ...
        _leaveAttrName() {
          ...
          null === W(n, this.currentAttr.name)
        ...
        _emitEOFToken() {
          ...
          (e &&
            ...
            this.handler.onEof({ type: N.EOF, location: e }),
            (this.active = !1));
        }
        ...
        _emitChars(e) {
          this._appendCharToCurrentCharacterToken(N.CHARACTER, e);
        }
        _startCharacterReference() {
          ((this.returnState = this.state),
            ...
            this.entityDecoder.startEntity(
              this._isCharacterReferenceInAttribute() ? S.Attribute : S.Legacy,
            ));
        }
        ...
        _stateTagName(e) {
          ...
          switch (e) {
            ...
            case _.EOF:
              ...
              break;
            default:
              t.tagName += String.fromCodePoint(et(e) ? e + 32 : e);
          }
        }
        ...
        _stateScriptDataEscapeStart(e) {
          e === _.HYPHEN_MINUS
            ? ((this.state = b.SCRIPT_DATA_ESCAPE_START_DASH),
              this._emitChars("-"))
            : ((this.state = b.SCRIPT_DATA), this._stateScriptData(e));
        }
        ...
        _stateScriptDataEscaped(e) {
          switch (e) {
            ...
            case _.NULL:
              ...
              break;
            case _.EOF:
              (this._err(f.eofInScriptHtmlCommentLikeText),
                this._emitEOFToken());
              break;
            default:
              this._emitCodePoint(e);
        ...
        _stateScriptDataEscapedDash(e) {
          switch (e) {
            ...
            case _.EOF:
              ...
              break;
            default:
              ((this.state = b.SCRIPT_DATA_ESCAPED), this._emitCodePoint(e));
          }
        }
        ...
        _stateScriptDataDoubleEscapeStart(e) {
          if (
            this.preprocessor.startsWith(w, !1) &&
            es(this.preprocessor.peek(w.length))
          ) {
            this._emitCodePoint(e);
        ...
        _stateAttributeName(e) {
          switch (e) {
            ...
            case _.NULL:
              ...
              break;
            default:
              this.currentAttr.name += String.fromCodePoint(et(e) ? e + 32 : e);
          }
        }
        ...
        _stateBogusComment(e) {
          ...
          switch (e) {
            case _.GREATER_THAN_SIGN:
              ((this.state = b.DATA), this.emitCurrentComment(t));
              break;
            case _.EOF:
        ...
        _stateMarkupDeclarationOpen(e) {
          this._consumeSequenceIfMatch("--", !0)
            ? (this._createCommentToken(3), (this.state = b.COMMENT_START))
            : this._consumeSequenceIfMatch(H, !1)
              ? ((this.currentLocation = this.getCurrentLocation(H.length + 1)),
                (this.state = b.DOCTYPE))
              : this._consumeSequenceIfMatch(U, !0)
                ? this.inForeignNode
                  ? (this.state = b.CDATA_SECTION)
                  : (this._err(f.cdataInHtmlContent),
                    this._createCommentToken(U.length + 1),
        ...
        _stateCommentStart(e) {
          switch (e) {
            ...
            default:
              ((this.state = b.COMMENT), this._stateComment(e));
          }
        }
        ...
        _stateComment(e) {
          ...
          switch (e) {
            case _.HYPHEN_MINUS:
              ...
              break;
            case _.LESS_THAN_SIGN:
              ((t.data += "<"), (this.state = b.COMMENT_LESS_THAN_SIGN));
              break;
            case _.NULL:
              (this._err(f.unexpectedNullCharacter), (t.data += "\uFFFD"));
              break;
        ...
        _stateCommentLessThanSign(e) {
          ...
          switch (e) {
            case _.EXCLAMATION_MARK:
              ((t.data += "!"), (this.state = b.COMMENT_LESS_THAN_SIGN_BANG));
              break;
            case _.LESS_THAN_SIGN:
              t.data += "<";
              break;
        ...
        _stateCommentLessThanSignBangDash(e) {
          e === _.HYPHEN_MINUS
            ...
            : ((this.state = b.COMMENT_END_DASH), this._stateCommentEndDash(e));
        }
        ...
        _stateCommentEndBang(e) {
          ...
          switch (e) {
            case _.HYPHEN_MINUS:
              ((t.data += "--!"), (this.state = b.COMMENT_END_DASH));
              break;
            case _.GREATER_THAN_SIGN:
        ...
        _stateDoctypeName(e) {
          ...
          switch (e) {
            ...
            case _.FORM_FEED:
              ...
              break;
            case _.GREATER_THAN_SIGN:
              ((this.state = b.DATA), this.emitCurrentDoctype(t));
              break;
            case _.NULL:
            ...
            case _.EOF:
              ...
              break;
            default:
              t.name += String.fromCodePoint(et(e) ? e + 32 : e);
          }
        }
          ...
          switch (e) {
            ...
            case _.QUOTATION_MARK:
              (this._err(f.missingWhitespaceAfterDoctypePublicKeyword),
                (t.publicId = ""),
                (this.state = b.DOCTYPE_PUBLIC_IDENTIFIER_DOUBLE_QUOTED));
              break;
            case _.APOSTROPHE:
              (this._err(f.missingWhitespaceAfterDoctypePublicKeyword),
                (t.publicId = ""),
                (this.state = b.DOCTYPE_PUBLIC_IDENTIFIER_SINGLE_QUOTED));
              break;
            case _.GREATER_THAN_SIGN:
          ...
          switch (e) {
            ...
            case _.QUOTATION_MARK:
              (this._err(
                ...
                (t.systemId = ""),
                (this.state = b.DOCTYPE_SYSTEM_IDENTIFIER_DOUBLE_QUOTED));
              break;
            case _.APOSTROPHE:
              (this._err(
                f.missingWhitespaceBetweenDoctypePublicAndSystemIdentifiers,
                ...
                (t.systemId = ""),
                (this.state = b.DOCTYPE_SYSTEM_IDENTIFIER_SINGLE_QUOTED));
              break;
            case _.EOF:
              (this._err(f.eofInDoctype),
                (t.forceQuirks = !0),
        ...
        _stateBetweenDoctypePublicAndSystemIdentifiers(e) {
          ...
          switch (e) {
            ...
            case _.FORM_FEED:
              break;
            case _.GREATER_THAN_SIGN:
              (this.emitCurrentDoctype(t), (this.state = b.DATA));
              break;
            case _.QUOTATION_MARK:
              ((t.systemId = ""),
                (this.state = b.DOCTYPE_SYSTEM_IDENTIFIER_DOUBLE_QUOTED));
        ...
        _stateCharacterReference() {
          ...
          0 === e
            ? ((this.preprocessor.pos = this.entityStartPos),
              ...
              (this.state =
                !this._isCharacterReferenceInAttribute() &&
                er(this.preprocessor.peek(1))
                  ? b.AMBIGUOUS_AMPERSAND
                  : this.returnState))
        ...
        _stateAmbiguousAmpersand(e) {
          er(e)
            ? this._flushCodePointConsumedAsCharacterReference(e)
            : (e === _.SEMICOLON && this._err(f.unknownNamedCharacterReference),
              (this.state = this.returnState),
              this._callState(e));
        }
      };
      let ei = new Set([
        ...
        ec = new Set([...el, k.OL, k.UL]),
        eE = new Set([...el, k.BUTTON]),
        eh = new Set([k.ANNOTATION_XML, k.MI, k.MN, k.MO, k.MS, k.MTEXT]),
        eT = new Set([k.DESC, k.FOREIGN_OBJECT, k.TITLE]),
        eu = new Set([k.TR, k.TEMPLATE, k.HTML]),
        ep = new Set([k.TBODY, k.TFOOT, k.THEAD, k.TEMPLATE, k.HTML]),
        ed = new Set([k.TABLE, k.TEMPLATE, k.HTML]),
        em = new Set([k.TD, k.TH]);
      let OpenElementStack = class OpenElementStack {
        ...
        popUntilNumberedHeaderPopped() {
          this.popUntilPopped(J, D.HTML);
        }
        popUntilTableCellPopped() {
          this.popUntilPopped(em, D.HTML);
        }
        ...
        clearBackToTableContext() {
          this.clearBackTo(ed, D.HTML);
        }
        clearBackToTableBodyContext() {
          this.clearBackTo(ep, D.HTML);
        }
        clearBackToTableRowContext() {
          this.clearBackTo(eu, D.HTML);
        }
        remove(e) {
          let t = this._indexOf(e);
          t >= 0 &&
        ...
        hasInScope(e) {
          return this.hasInDynamicScope(e, el);
        }
        hasInListItemScope(e) {
          return this.hasInDynamicScope(e, ec);
        }
        hasInButtonScope(e) {
          return this.hasInDynamicScope(e, eE);
        }
        hasNumberedHeaderInScope() {
          for (let e = this.stackTop; e >= 0; e--) {
            ...
            switch (this.treeAdapter.getNamespaceURI(this.items[e])) {
              case D.HTML:
                if (J.has(t)) return !0;
                if (el.has(t)) return !1;
                break;
              case D.SVG:
                if (eT.has(t)) return !1;
                break;
              case D.MATHML:
        ...
        generateImpliedEndTags() {
          for (; void 0 !== this.currentTagId && ei.has(this.currentTagId); )
            this.pop();
        }
        generateImpliedEndTagsThoroughly() {
          for (; void 0 !== this.currentTagId && eo.has(this.currentTagId); )
            this.pop();
        }
        generateImpliedEndTagsWithExclusion(e) {
          for (
            ...
            void 0 !== this.currentTagId &&
            this.currentTagId !== e &&
            eo.has(this.currentTagId);
          )
            this.pop();
        }
      };
      (((m = P || (P = {}))[(m.Marker = 0)] = "Marker"),
        (m[(m.Element = 1)] = "Element"));
      let eA = { type: P.Marker };
      ...
      let e_ = {
          ...
          insertText(e, t) {
            ...
            e_.appendChild(e, e_.createTextNode(t));
          },
          insertTextBefore(e, t, n) {
            let r = e.childNodes[e.childNodes.indexOf(n) - 1];
            r && e_.isTextNode(r)
              ? (r.value += t)
              : e_.insertBefore(e, e_.createTextNode(t), n);
          },
          adoptAttributes(e, t) {
      ...
      function eP(e) {
        for (let t = 0; t < e.attrs.length; t++) {
          let n = eO.get(e.attrs[t].name);
          null != n && (e.attrs[t].name = n);
        }
      }
      function eM(e) {
        for (let t = 0; t < e.attrs.length; t++) {
          let n = eR.get(e.attrs[t].name);
          n &&
      ...
      (((A = M || (M = {}))[(A.INITIAL = 0)] = "INITIAL"),
        (A[(A.BEFORE_HTML = 1)] = "BEFORE_HTML"),
        (A[(A.BEFORE_HEAD = 2)] = "BEFORE_HEAD"),
        (A[(A.IN_HEAD = 3)] = "IN_HEAD"),
        (A[(A.IN_HEAD_NO_SCRIPT = 4)] = "IN_HEAD_NO_SCRIPT"),
        (A[(A.AFTER_HEAD = 5)] = "AFTER_HEAD"),
        (A[(A.IN_BODY = 6)] = "IN_BODY"),
        (A[(A.TEXT = 7)] = "TEXT"),
        (A[(A.IN_TABLE = 8)] = "IN_TABLE"),
        (A[(A.IN_TABLE_TEXT = 9)] = "IN_TABLE_TEXT"),
        (A[(A.IN_CAPTION = 10)] = "IN_CAPTION"),
        (A[(A.IN_COLUMN_GROUP = 11)] = "IN_COLUMN_GROUP"),
        (A[(A.IN_TABLE_BODY = 12)] = "IN_TABLE_BODY"),
        (A[(A.IN_ROW = 13)] = "IN_ROW"),
        (A[(A.IN_CELL = 14)] = "IN_CELL"),
        (A[(A.IN_SELECT = 15)] = "IN_SELECT"),
        (A[(A.IN_SELECT_IN_TABLE = 16)] = "IN_SELECT_IN_TABLE"),
        (A[(A.IN_TEMPLATE = 17)] = "IN_TEMPLATE"),
        (A[(A.AFTER_BODY = 18)] = "AFTER_BODY"),
        (A[(A.IN_FRAMESET = 19)] = "IN_FRAMESET"),
        (A[(A.AFTER_FRAMESET = 20)] = "AFTER_FRAMESET"),
        (A[(A.AFTER_AFTER_BODY = 21)] = "AFTER_AFTER_BODY"),
        (A[(A.AFTER_AFTER_FRAMESET = 22)] = "AFTER_AFTER_FRAMESET"));
      let ey = {
          startLine: -1,
          startCol: -1,
          startOffset: -1,
        ...
        eB = new Set([k.TABLE, k.TBODY, k.TFOOT, k.THEAD, k.TR]),
        eF = {
          scriptingEnabled: !0,
      ...
      let parser_Parser = class parser_Parser {
        constructor(e, t, n = null, r = null) {
          ((this.fragmentContext = n),
            ...
            (this.fragmentContextID = n
              ? V(this.treeAdapter.getTagName(n))
              : k.UNKNOWN),
        ...
        static getFragmentParser(e, t) {
          let n = { ...eF, ...t };
          null != e ||
            (e = n.treeAdapter.createElement(L.TEMPLATE, D.HTML, []));
          let r = n.treeAdapter.createElement("documentmock", D.HTML, []),
            a = new this(n, r, e);
          return (
            a.fragmentContextID === k.TEMPLATE &&
        ...
        onItemPush(e, t, n) {
          var r, a;
          (null == (a = (r = this.treeAdapter).onItemPush) || a.call(r, e),
        ...
        switchToPlaintextParsing() {
          ((this.insertionMode = M.TEXT),
            ...
            (this.tokenizer.state = ee.PLAINTEXT));
        }
        ...
        _initTokenizerForFragmentParsing() {
          if (
            ...
            switch (this.fragmentContextID) {
              case k.TITLE:
              case k.TEXTAREA:
                this.tokenizer.state = ee.RCDATA;
                break;
              case k.STYLE:
              case k.XMP:
              case k.IFRAME:
              ...
              case k.NOFRAMES:
              case k.NOSCRIPT:
                this.tokenizer.state = ee.RAWTEXT;
                break;
              case k.SCRIPT:
                this.tokenizer.state = ee.SCRIPT_DATA;
                break;
              case k.PLAINTEXT:
                this.tokenizer.state = ee.PLAINTEXT;
            }
        ...
        _insertFakeRootElement() {
          let e = this.treeAdapter.createElement(L.HTML, D.HTML, []);
          (this.options.sourceCodeLocationInfo &&
        ...
        _isIntegrationPoint(e, t, n) {
          ...
          return (
            ((!n || n === D.HTML) &&
              (function (e, t, n) {
                if (t === D.MATHML && e === k.ANNOTATION_XML) {
                  for (let e = 0; e < n.length; e++)
                    if (n[e].name === O.ENCODING) {
        ...
        _isSpecialElement(e, t) {
          return j[this.treeAdapter.getNamespaceURI(e)].has(t);
        }
        onCharacter(e) {
              ...
              !(function (e, t) {
                ...
                let n = t.forceQuirks
                  ...
                  : (function (e) {
                      ...
                      let { publicId: n } = e;
                      if (null !== n) {
                        if (((n = n.toLowerCase()), eC.has(n))) return R.QUIRKS;
                        let e = null === t ? eI : eN;
                        if (eD(n, e)) return R.QUIRKS;
                        if (eD(n, (e = null === t ? eg : eS)))
            ...
            ? (function (e, t) {
                ...
                if (
                  ((n = t.tagID) === k.FONT &&
                    t.attrs.some(
                      ({ name: e }) =>
                        e === O.COLOR || e === O.SIZE || e === O.FACE,
                    )) ||
                  ek.has(n)
                )
                  (tp(e), e._startTagOutsideForeignContent(t));
                else {
                  ...
                  if (r === D.MATHML) eb(t);
                    ...
                    let e;
                    (null != (e = eL.get(t.tagName)) &&
                      ((t.tagName = e), (t.tagID = V(t.tagName))),
                      eP(t));
                  }
                  (eM(t),
                    t.selfClosing
          ...
          switch (this.insertionMode) {
            ...
            case M.BEFORE_HEAD:
              ...
              switch (p.tagID) {
                case k.HTML:
                  ...
                  break;
                case k.HEAD:
                  (u._insertElement(p, D.HTML),
                    (u.headElement = u.openElements.current),
                    (u.insertionMode = M.IN_HEAD));
                  break;
                default:
                  ex(u, p);
              }
            ...
            case M.IN_HEAD_NO_SCRIPT:
              ...
              switch (m.tagID) {
                ...
                case k.STYLE:
                  ...
                  break;
                case k.NOSCRIPT:
                  d._err(m, f.nestedNoscriptInHead);
                  break;
                default:
                  eQ(d, m);
              }
            ...
            case M.AFTER_HEAD:
              ...
              switch (_.tagID) {
                case k.HTML:
                  ...
                  break;
                case k.BODY:
                  (A._insertElement(_, D.HTML),
                    (A.framesetOk = !1),
                    (A.insertionMode = M.IN_BODY));
                  break;
                case k.FRAMESET:
                  (A._insertElement(_, D.HTML),
                    (A.insertionMode = M.IN_FRAMESET));
                  break;
                case k.BASE:
                case k.BASEFONT:
                case k.BGSOUND:
                ...
                case k.TEMPLATE:
                case k.TITLE:
                  (A._err(_, f.abandonedHeadElementChild),
                    A.openElements.push(A.headElement, k.HEAD),
                    eY(A, _),
                    A.openElements.remove(A.headElement));
                  break;
                case k.HEAD:
                  A._err(_, f.misplacedStartTagForHeadElement);
                  break;
                default:
                  eK(A, _);
              }
            ...
            case M.IN_CAPTION:
              ...
              ((r = this),
                (N = (a = e).tagID),
                tt.has(N)
                  ? r.openElements.hasInTableScope(k.CAPTION) &&
                    (r.openElements.generateImpliedEndTags(),
                    r.openElements.popUntilTagNamePopped(k.CAPTION),
                    r.activeFormattingElements.clearToLastMarker(),
                    (r.insertionMode = M.IN_TABLE),
                    e4(r, a))
                  : e0(r, a));
              break;
            case M.IN_COLUMN_GROUP:
            ...
            case M.IN_CELL:
              ...
              ((s = this),
                (I = (i = e).tagID),
                tt.has(I)
                  ? (s.openElements.hasInTableScope(k.TD) ||
                      s.openElements.hasInTableScope(k.TH)) &&
                    (s._closeTableCell(), ti(s, i))
                  : e0(s, i));
              break;
            case M.IN_SELECT:
              tl(this, e);
            ...
            case M.IN_SELECT_IN_TABLE:
              ...
              ((o = this),
                ...
                C === k.TD ||
                C === k.TH
                  ? (o.openElements.popUntilTagNamePopped(k.SELECT),
                    o._resetInsertionMode(),
                    o._processStartTag(l))
                  : tl(o, l));
              break;
            case M.IN_TEMPLATE:
              var g = this,
              ...
              switch (S.tagID) {
                ...
                case k.TFOOT:
                case k.THEAD:
                  ((g.tmplInsertionModeStack[0] = M.IN_TABLE),
                    (g.insertionMode = M.IN_TABLE),
                    e4(g, S));
                  break;
                case k.COL:
                  ((g.tmplInsertionModeStack[0] = M.IN_COLUMN_GROUP),
                    (g.insertionMode = M.IN_COLUMN_GROUP),
                    tn(g, S));
                  break;
                case k.TR:
                  ((g.tmplInsertionModeStack[0] = M.IN_TABLE_BODY),
                    (g.insertionMode = M.IN_TABLE_BODY),
                    ta(g, S));
                  break;
                case k.TD:
                case k.TH:
                  ((g.tmplInsertionModeStack[0] = M.IN_ROW),
                    (g.insertionMode = M.IN_ROW),
                    ti(g, S));
                  break;
                default:
                  ((g.tmplInsertionModeStack[0] = M.IN_BODY),
                    (g.insertionMode = M.IN_BODY),
                    e0(g, S));
              }
              break;
            case M.AFTER_BODY:
              ((c = this), (E = e).tagID === k.HTML ? e0(c, E) : tT(c, E));
              break;
            case M.IN_FRAMESET:
              var O = this,
                R = e;
              switch (R.tagID) {
                case k.HTML:
                  ...
                  break;
                case k.FRAMESET:
                  O._insertElement(R, D.HTML);
                  break;
                case k.FRAME:
                  (O._appendElement(R, D.HTML), (R.ackSelfClosing = !0));
                  break;
                case k.NOFRAMES:
                  eY(O, R);
              }
            ...
            case M.AFTER_FRAMESET:
              ...
              break;
            case M.AFTER_AFTER_BODY:
              ((h = this), (T = e).tagID === k.HTML ? e0(h, T) : tu(h, T));
              break;
            case M.AFTER_AFTER_FRAMESET:
              var P = this,
                y = e;
            ...
            this.currentNotInHTML
              ? (function (e, t) {
                  if (t.tagID === k.P || t.tagID === k.BR) {
                    (tp(e), e._endTagOutsideForeignContent(t));
                    return;
                  }
          ...
          switch (this.insertionMode) {
            ...
            case M.BEFORE_HEAD:
              ...
              ((s = this),
                ...
                n === k.BR
                  ? ex(s, i)
                  : s._err(i, f.endTagWithoutMatchingOpenElement));
              break;
            case M.IN_HEAD:
              var r,
                a,
              ...
              switch (m.tagID) {
                case k.HEAD:
                  (d.openElements.pop(), (d.insertionMode = M.AFTER_HEAD));
                  break;
                case k.BODY:
                case k.BR:
                case k.HTML:
                ...
                case k.TEMPLATE:
                  ...
                  break;
                default:
                  d._err(m, f.endTagWithoutMatchingOpenElement);
              }
              break;
            case M.IN_HEAD_NO_SCRIPT:
              var A = this,
              ...
              switch (_.tagID) {
                case k.NOSCRIPT:
                  (A.openElements.pop(), (A.insertionMode = M.IN_HEAD));
                  break;
                case k.BR:
                  eQ(A, _);
                  break;
                default:
                  A._err(_, f.endTagWithoutMatchingOpenElement);
              }
              break;
            case M.AFTER_HEAD:
              var N = this,
              ...
              switch (I.tagID) {
                ...
                case k.TEMPLATE:
                  ...
                  break;
                default:
                  N._err(I, f.endTagWithoutMatchingOpenElement);
              }
              break;
            case M.IN_BODY:
              e3(this, e);
            ...
            case M.TEXT:
              ((o = this),
                e.tagID === k.SCRIPT &&
                  (null == (l = o.scriptHandler) ||
                    l.call(o, o.openElements.current)),
                o.openElements.pop(),
                (o.insertionMode = o.originalInsertionMode));
              break;
            case M.IN_TABLE:
              e6(this, e);
              break;
            ...
            case M.IN_CAPTION:
              ...
              switch (S) {
                case k.CAPTION:
                case k.TABLE:
                  C.openElements.hasInTableScope(k.CAPTION) &&
                    (C.openElements.generateImpliedEndTags(),
                    C.openElements.popUntilTagNamePopped(k.CAPTION),
                    C.activeFormattingElements.clearToLastMarker(),
                    (C.insertionMode = M.IN_TABLE),
                    S === k.TABLE && e6(C, g));
                  break;
                case k.BODY:
                case k.COL:
            ...
            case M.IN_COLUMN_GROUP:
              ...
              switch (O.tagID) {
                case k.COLGROUP:
                  D.openElements.currentTagId === k.COLGROUP &&
                    (D.openElements.pop(), (D.insertionMode = M.IN_TABLE));
                  break;
                case k.TEMPLATE:
                  eW(D, O);
                  break;
            ...
            case M.IN_CELL:
              ...
              switch (b) {
                case k.TD:
                case k.TH:
                  R.openElements.hasInTableScope(b) &&
                    (R.openElements.generateImpliedEndTags(),
                    R.openElements.popUntilTagNamePopped(b),
                    R.activeFormattingElements.clearToLastMarker(),
                    (R.insertionMode = M.IN_ROW));
                  break;
                case k.TABLE:
                case k.TBODY:
                case k.TFOOT:
            ...
            case M.IN_SELECT_IN_TABLE:
              ...
              ((c = this),
                ...
                P === k.TD ||
                P === k.TH
                  ? c.openElements.hasInTableScope(P) &&
                    (c.openElements.popUntilTagNamePopped(k.SELECT),
                    c._resetInsertionMode(),
                    c.onEndTag(E))
                  : tc(c, E));
              break;
            case M.IN_TEMPLATE:
              ((h = this), (T = e).tagID === k.TEMPLATE && eW(h, T));
              break;
            case M.AFTER_BODY:
              th(this, e);
              break;
            case M.IN_FRAMESET:
              ((u = this),
                e.tagID === k.FRAMESET &&
                  !u.openElements.isRootHtmlElementCurrent() &&
                  (u.openElements.pop(),
                  u.fragmentContext ||
                    u.openElements.currentTagId === k.FRAMESET ||
                    (u.insertionMode = M.AFTER_FRAMESET)));
              break;
            case M.AFTER_FRAMESET:
              ((p = this),
                e.tagID === k.HTML &&
                  (p.insertionMode = M.AFTER_AFTER_FRAMESET));
              break;
            case M.AFTER_AFTER_BODY:
              tu(this, e);
          }
        ...
        onEof(e) {
          switch (this.insertionMode) {
            ...
            case M.TEXT:
              ...
              ((t = this),
                (n = e),
                t._err(n, f.eofInElementThatCanContainOnlyText),
                t.openElements.pop(),
      ...
      function eU(e, t) {
        for (let n = 0; n < 8; n++) {
          ...
          let a = (function (e, t, n) {
              ...
              for (let s = 0, i = a; i !== n; s++, i = a) {
                a = e.openElements.getCommonAncestor(i);
                let n = e.activeFormattingElements.getElementEntry(i),
                  o = n && s >= 3;
                !n || o
          ...
          (e.treeAdapter.detachNode(a),
            s &&
              (function (e, t, n) {
                let r = V(e.treeAdapter.getTagName(t));
            ...
            (function (e, t, n) {
              let r = e.treeAdapter.getNamespaceURI(n.element),
                { token: a } = n,
                s = e.treeAdapter.createElement(a.tagName, r, a.attrs);
              (e._adoptNodes(t, s),
                e.treeAdapter.appendChild(t, s),
                e.activeFormattingElements.insertElementAfterBookmark(s, a),
                e.activeFormattingElements.removeEntry(n),
                e.openElements.remove(n.element),
                e.openElements.insertAfter(t, s, a.tagID));
            })(e, r, n));
        }
      }
      function eH(e, t) {
      ...
      function ew(e, t) {
        (e._err(t, f.missingDoctype, !0),
          e.treeAdapter.setDocumentMode(e.document, R.QUIRKS),
          (e.insertionMode = M.BEFORE_HTML),
          e._processToken(t));
      }
      function eG(e, t) {
      ...
      function eY(e, t) {
        switch (t.tagID) {
          ...
          case k.META:
            ...
            break;
          case k.TITLE:
            e._switchToTextParsing(t, ee.RCDATA);
            break;
          case k.NOSCRIPT:
            e.options.scriptingEnabled
              ? e._switchToTextParsing(t, ee.RAWTEXT)
          ...
          case k.STYLE:
            ...
            break;
          case k.SCRIPT:
            e._switchToTextParsing(t, ee.SCRIPT_DATA);
            break;
          case k.TEMPLATE:
            (e._insertTemplate(t),
      ...
      function e0(e, t) {
        switch (t.tagID) {
          ...
          case k.A:
            let n;
            ((n = e.activeFormattingElements.getElementEntryInScopeWithTagName(
              L.A,
            )) &&
              (eU(e, t),
              e.openElements.remove(n.element),
          ...
          case k.H6:
            (e.openElements.hasInButtonScope(k.P) && e._closePElement(),
              void 0 !== e.openElements.currentTagId &&
                J.has(e.openElements.currentTagId) &&
                e.openElements.pop(),
              e._insertElement(t, D.HTML));
            break;
          case k.P:
          ...
          case k.BODY:
            let a;
            (a = e.openElements.tryPeekProperlyNestedBodyElement()) &&
              0 === e.openElements.tmplCount &&
              ((e.framesetOk = !1), e.treeAdapter.adoptAttributes(a, t.attrs));
            break;
          case k.FORM:
            let s;
            ((s = e.openElements.tmplCount > 0),
              (!e.formElement || s) &&
                (e.openElements.hasInButtonScope(k.P) && e._closePElement(),
                e._insertElement(t, D.HTML),
          ...
          case k.NOBR:
            (e._reconstructActiveFormattingElements(),
              e.openElements.hasInScope(k.NOBR) &&
                (eU(e, t), e._reconstructActiveFormattingElements()),
              e._insertElement(t, D.HTML),
              e.activeFormattingElements.pushElement(
                e.openElements.current,
                t,
          ...
          case k.MATH:
            ...
            break;
          case k.TABLE:
            (e.treeAdapter.getDocumentMode(e.document) !== R.QUIRKS &&
          ...
          case k.SOURCE:
            ...
            break;
          case k.IMAGE:
            ((t.tagName = L.IMG), (t.tagID = k.IMG), ej(e, t));
            break;
          case k.BUTTON:
          ...
          case k.MARQUEE:
            ...
            break;
          case k.IFRAME:
            ((e.framesetOk = !1), e._switchToTextParsing(t, ee.RAWTEXT));
            break;
          case k.SELECT:
            (e._reconstructActiveFormattingElements(),
              e._insertElement(t, D.HTML),
          ...
          case k.FRAMESET:
            let i;
            ((i = e.openElements.tryPeekProperlyNestedBodyElement()),
              e.framesetOk &&
                i &&
          ...
          case k.TEXTAREA:
            (e._insertElement(t, D.HTML),
              (e.skipNextNewLine = !0),
              (e.tokenizer.state = ee.RCDATA),
              (e.originalInsertionMode = e.insertionMode),
              (e.framesetOk = !1),
              (e.insertionMode = M.TEXT));
            break;
          case k.NOSCRIPT:
            e.options.scriptingEnabled ? eZ(e, t) : e$(e, t);
            break;
          case k.PLAINTEXT:
            (e.openElements.hasInButtonScope(k.P) && e._closePElement(),
              e._insertElement(t, D.HTML),
              (e.tokenizer.state = ee.PLAINTEXT));
            break;
          case k.COL:
          case k.TH:
          case k.TD:
      ...
      function e1(e, t) {
        ...
        for (let t = e.openElements.stackTop; t > 0; t--) {
          ...
          if (
            r === s &&
            (r !== k.UNKNOWN || e.treeAdapter.getTagName(a) === n)
          ) {
          ...
          if (e._isSpecialElement(a, s)) break;
        }
      }
      function e3(e, t) {
        switch (t.tagID) {
          ...
          case k.HTML:
            e.openElements.hasInScope(k.BODY) &&
              ((e.insertionMode = M.AFTER_BODY), th(e, t));
            break;
          case k.FORM:
            !(function (e) {
      ...
      function e2(e, t) {
        e.tmplInsertionModeStack.length > 0 ? tE(e, t) : ev(e, t);
      }
      function e5(e, t) {
        if (
          void 0 !== e.openElements.currentTagId &&
          eB.has(e.openElements.currentTagId)
        )
          switch (
      ...
      function e4(e, t) {
        switch (t.tagID) {
          ...
          case k.THEAD:
            ...
            break;
          case k.INPUT:
            (eJ(t) ? e._appendElement(t, D.HTML) : e9(e, t),
              (t.ackSelfClosing = !0));
            break;
          case k.CAPTION:
            (e.openElements.clearBackToTableContext(),
      ...
      function te(e, t) {
        ...
        if (e.hasNonWhitespacePendingCharacterToken)
          for (; n < e.pendingCharacterTokens.length; n++)
            e9(e, e.pendingCharacterTokens[n]);
        else
          for (; n < e.pendingCharacterTokens.length; n++)
      ...
      function tT(e, t) {
        ((e.insertionMode = M.IN_BODY), eX(e, t));
      }
      function tu(e, t) {
        ((e.insertionMode = M.IN_BODY), eX(e, t));
      }
    ...
    26937: (e, t, n) => {
      ...
      let i = function (e, t, n) {
        ((void 0 === n || (0, s.A)(e[t], n)) && (void 0 !== n || t in e)) ||
          (0, a.A)(e, t, n);
      };
      var o = n(91913),
        l = n(80154),
        ...
        S = C.call(Object);
      let D = function (e) {
        if (!(0, N.A)(e) || "[object Object]" != (0, _.A)(e)) return !1;
        var t = (0, f.A)(e);
        if (null === t) return !0;
      ...
      var L = n(22031),
        k = n(12931);
      let b = function (e, t, n, r, a, s, o) {
          var _ = R(e, n),
            f = R(t, n),
            N = o.get(f);
          if (N) return void i(e, n, N);
          var I = s ? s(_, f, n + "", e, t, o) : void 0,
            C = void 0 === I;
          if (C) {
            var g = (0, u.A)(f),
              S = !g && (0, d.A)(f),
            ...
            ((I = f), g || S || b)
              ...
              : D(f) || (0, T.A)(f)
                ? ((I = _), (0, T.A)(_))
                  ? (I = (0, L.A)(_, (0, k.A)(_)))
                  : (!(0, A.A)(_) || (0, m.A)(_)) && (I = (0, h.A)(f))
                : (C = !1);
          }
          (C && (o.set(f, I), a(I, f, r, s, o), o.delete(f)), i(e, n, I));
        },
        P = function e(t, n, a, s, l) {
          t !== n &&
            (0, o.A)(
              n,
              function (o, c) {
                if ((l || (l = new r.A()), (0, A.A)(o))) b(t, n, c, a, e, s, l);
                else {
                  var E = s ? s(R(t, c), o, c + "", t, n, l) : void 0;
                  (void 0 === E && (E = o), i(t, c, E));
                }
              },
              k.A,
            );
      ...
      let l = [
          function (e, t, n, r) {
            if (
              "code" === t.type &&
              (0, i.m)(t, r) &&
              ("list" === e.type || (e.type === t.type && (0, i.m)(e, r)))
            )
              return !1;
...
*])`,
          ...
          { character: "*", inConstruct: "phrasing", notInConstruct: c },
          {
            atBreak: !0,
            character: "+",
            after: `(?:[ 	\r
...
-])`,
          ...
          { character: "_", inConstruct: "phrasing", notInConstruct: c },
          { atBreak: !0, character: "`" },
          {
            character: "`",
            inConstruct: [
      ...
      function f(e, t) {
        let n,
          ...
          o = -1,
          l = 0;
        for (; (n = r.exec(i)); ) a.push(n.index);
        for (; ++o < a.length; )
          (l !== a[o] && s.push(e.slice(l, a[o])), s.push("\\"), (l = a[o]));
      ...
      function N(e) {
        ...
        return {
          move: function (e) {
            ...
            return (
              (a += n.length - 1),
              (s = 1 === n.length ? s + i.length : 1 + i.length + r),
              t
            );
          },
          current: function () {
            return { now: { line: a, column: s }, lineShift: r };
          },
          shift: function (e) {
            r += e;
          },
      ...
      function I(e, t) {
        ...
        (!(function e(t, n) {
          ...
          let l,
            c = -1;
          if (n.extensions)
            for (; ++c < n.extensions.length; ) e(t, n.extensions[c]);
          for (l in n)
            if (a.call(n, l))
              switch (l) {
                case "extensions":
                ...
                case "unsafe":
                case "join":
                  ((r = t[l]), (s = n[l]) && r.push(...s));
                  break;
                case "handlers":
                  ((i = t[l]), (o = n[l]) && Object.assign(i, o));
                  break;
                default:
                  t.options[l] = n[l];
              }
          ...
          n.options.tightDefinitions && n.join.push(S),
          (n.handle = (0, r.A)("type", {
            invalid: C,
            unknown: g,
            handlers: n.handlers,
          })));
        let i = n.handle(e, void 0, n, {
          before: `
`,
          after: `
`,
        ...
        return (
          i &&
            10 !== i.charCodeAt(i.length - 1) &&
            13 !== i.charCodeAt(i.length - 1) &&
            (i += `
`),
          i
        );
      ...
      function D(e, t) {
        return (function (e, t, n) {
          ...
          for (; ++o < s.length; ) {
            let E,
              h = s[o];
            if (((a[a.length - 1] = o), o + 1 < s.length)) {
              let n = t.handle.handlers[s[o + 1].type];
              (n && n.peek && (n = n.peek),
                (E = n
                  ? n(s[o + 1], e, t, {
                      before: "",
...
` === l) &&
              ...
              (l = " "),
              (c = t.createTracker(n)).move(i.join("")));
            let T = t.handle(h, e, t, { ...c.current(), after: E, before: l });
            r &&
              r === T.slice(0, 1) &&
              (T = (0, p.T)(r.charCodeAt(0)) + T.slice(1));
            let u = t.attentionEncodeSurroundingInfo;
            ((t.attentionEncodeSurroundingInfo = void 0),
              ...
              u &&
                (i.length > 0 &&
                  ...
                  (i[i.length - 1] =
                    i[i.length - 1].slice(0, -1) + (0, p.T)(l.charCodeAt(0))),
                u.after && (r = E)),
              c.move(T),
              i.push(T),
              (l = T.slice(-1)));
...
`;
      ...
      function R(e, t) {
        return (function (e, t, n) {
          ...
          for (; ++o < e.unsafe.length; ) {
            let t,
              n = e.unsafe[o];
            if (!(0, A.q)(e.stack, n)) continue;
            let s = e.compilePattern(n);
            for (; (t = s.exec(r)); ) {
              let e = "before" in n || !!n.atBreak,
                r = "after" in n,
                s = t.index + (e ? t[1].length : 0);
              a.includes(s)
                ? (i[s].before && !e && (i[s].before = !1),
                  i[s].after && !r && (i[s].after = !1))
                : (a.push(s), (i[s] = { before: e, after: r }));
            }
          }
          a.sort(_);
          ...
          for (o = -1; ++o < a.length; ) {
            ...
            !(e < l) &&
              ...
              (a[o - 1] !== e - 1 ||
                ...
                i[e - 1].before ||
                i[e - 1].after) &&
              (l !== e && s.push(f(r.slice(l, e), "\\")),
              (l = e),
              !/[!-/:-@[-`{-~]/.test(r.charAt(e)) ||
              (n.encode && n.encode.includes(r.charAt(e)))
                ? (s.push((0, p.T)(r.charCodeAt(e))), l++)
                : s.push("\\"));
          }
          return (s.push(f(r.slice(l, c), n.after)), s.join(""));
        })(this, e, t);
      }
    },
    36380: (e, t, n) => {
      n.d(t, { A: () => a });
      var r = n(26937);
      let a = (0, n(3767).A)(function (e, t, n, a) {
        (0, r.A)(e, t, n, a);
      });
    },
    37732: (e, t, n) => {
      n.d(t, { a: () => i });
      let r = new Set(["children", "localName", "ref", "style", "className"]),
        a = new WeakMap(),
        s = (e, t, n, r, s) => {
          let i,
            o,
          ...
          void 0 === l || n === r
            ? null == n && t in HTMLElement.prototype
              ? e.removeAttribute(t)
              : (e[t] = n)
            : (void 0 === (i = a.get(e)) && a.set(e, (i = new Map())),
              (o = i.get(l)),
              void 0 !== n
                ? void 0 === o
                  ? (i.set(l, (o = { handleEvent: n })),
                    e.addEventListener(l, o))
                  : (o.handleEvent = n)
                : void 0 !== o && (i.delete(l), e.removeEventListener(l, o)));
        };
      function i(e = window.React, t, n, a, o) {
        let l, c, E;
        void 0 === t
          ? (({ tagName: c, elementClass: E, events: a, displayName: o } = e),
            (l = e.react))
          : ((l = e), (E = n), (c = t));
        let h = l.Component,
          T = l.createElement,
          u = new Set(Object.keys(null != a ? a : {}));
        let v = class v extends h {
          constructor() {
          ...
          t(e) {
            if (null !== this.o)
              for (let t in this.i)
                s(this.o, t, this.props[t], e ? e[t] : void 0, a);
          }
          componentDidMount() {
            var e;
            (this.t(),
              null == (e = this.o) || e.removeAttribute("defer-hydration"));
          }
          ...
          render() {
            ...
            for (let [e, a] of Object.entries(t))
              r.has(e)
                ? (n["className" === e ? "class" : e] = a)
                : u.has(e) || e in E.prototype
                  ? (this.i[e] = a)
                  : (n[e] = a);
            return ((n.suppressHydrationWarning = !0), T(c, n));
          }
        };
        v.displayName = null != o ? o : E.name;
        let p = l.forwardRef((e, t) =>
          T(v, { ...e, _$Gl: t }, null == e ? void 0 : e.children),
        );
    ...
    44358: (e, t, n) => {
      function r(e, t) {
        var n, r, a;
        let s = e.value.slice(0, null != (n = e.selectionStart) ? n : void 0),
          i = e.value.slice(null != (r = e.selectionEnd) ? r : void 0),
          o = !0;
        e.contentEditable = "true";
        try {
          o = document.execCommand("insertText", !1, t);
        } catch (e) {
          o = !1;
        }
        if (
          ...
          o &&
            !e.value
              .slice(0, null != (a = e.selectionStart) ? a : void 0)
              .endsWith(t) &&
            (o = !1),
          !o)
        ) {
      ...
      function c(e) {
        ...
        let n,
          a = e.clipboardData,
          { currentTarget: s } = e;
        if (o(s) || !a || !a.types.includes("text/html")) return;
        let i = e.currentTarget;
        if (
          !(i instanceof HTMLTextAreaElement) ||
          (0 !== (n = (t = i).selectionStart || 0) &&
            "@" === t.value.substring(n - 1, n))
        )
          return;
        let l = a.getData("text/plain"),
          c = a.getData("text/html"),
          h = c.replace(/\u00A0/g, " ").replace(/\uC2A0/g, " ");
        if (!c || !(l = l.trim())) return;
        let T = new DOMParser().parseFromString(h, "text/html"),
          u = (function (e, t) {
            let n = t.firstChild(),
              r = e,
              a = 0,
            ...
            for (; n && s < 1e4; ) {
              ...
              let e = E(n)
                ...
                : (null == n ? void 0 : n.wholeText) || "";
              if (!(i = e) || (null == i ? void 0 : i.trim().length) === 0) {
                n = t.nextNode();
                continue;
              }
              if (!E(n)) {
              ...
              if (o >= 0) {
                let t = (function (e, t) {
                  ...
                  return (function (e) {
                    var t;
                    return (
                      (null == (t = e.textContent) ? void 0 : t.slice(0, 1)) ===
                    ...
                    (function (e) {
                      ...
                      return (
                        (null == (t = e.textContent)
                          ? void 0
                          : t.slice(0, 1)) === "@" &&
                        "team" === e.getAttribute("data-hovercard-type")
                      );
                    })(e)
                    ? t
                    : (n = e).className.indexOf("commit-link") >= 0 ||
                        (n.getAttribute("data-hovercard-type") &&
                          "user" !== n.getAttribute("data-hovercard-type")) ||
                        ((r = s),
                        (a = t),
                        (r = "/" === r.slice(-1) ? r.slice(0, -1) : r),
                        (a = "/" === a.slice(-1) ? a.slice(0, -1) : a),
                        r.toLowerCase() === a.toLowerCase())
                      ? s
                      : `[${t}](${s})`;
                })(n, e);
                ((r = r.slice(0, o) + t + r.slice(o + e.length)),
                  (a = o + t.length));
              }
              n = t.nextNode();
            }
            ...
            l,
            T.createTreeWalker(T.body, NodeFilter.SHOW_ALL, (e) =>
              e.parentNode && E(e.parentNode)
                ? NodeFilter.FILTER_REJECT
                : NodeFilter.FILTER_ACCEPT,
            ),
          );
        u !== l && (e.stopPropagation(), e.preventDefault(), r(i, u));
      }
      function E(e) {
        var t;
        return (
          (null == (t = e.tagName) ? void 0 : t.toLowerCase()) === "a" &&
          e.hasAttribute("href")
        );
      }
      function h(e) {
      ...
      function T(e) {
        ...
        if (!t || Array.from(t.types).indexOf("Files") >= 0 || !m(t)) return;
        let n = A(t);
        if (!n.some(f)) return;
        (e.stopPropagation(), e.preventDefault());
        let a = e.currentTarget;
        a instanceof HTMLTextAreaElement && r(a, n.map(d).join(""));
      }
      function u(e) {
        let t = e.dataTransfer;
        t && (t.dropEffect = "link");
      ...
      function p(e) {
        ...
        s instanceof HTMLTextAreaElement && r(s, a.map(d).join(""));
      }
      function d(e) {
        return f(e)
          ? `
...
`
      ...
      function A(e) {
        return (e.getData("text/uri-list") || "").split(`\r
`);
      }
      let _ = /\.(gif|png|jpe?g)$/i;
      function f(e) {
        return _.test(e);
      }
      let N = new WeakMap();
      function I(e, t) {
        ...
        (N.set(
          e,
          (null == (n = null == t ? void 0 : t.defaultPlainTextPaste)
            ? void 0
            : n.urlLinks) === !0,
        ),
          e.addEventListener("paste", C));
      ...
      function C(e) {
        ...
        let i,
          ...
          E = o(l);
        if ((!c && E) || (c && !E)) return;
        let h = e.clipboardData;
        if (!h || !Array.from(h.types).includes("text/plain")) return;
        let T = e.currentTarget;
        if (!(T instanceof HTMLTextAreaElement)) return;
        let u = h.getData("text/plain");
        if (
          !u ||
          !g(u) ||
          ((i = (n = T).selectionStart || 0) > 1 &&
            "](" === n.value.substring(i - 2, i))
        )
          return;
        let p = T.value.substring(T.selectionStart, T.selectionEnd);
        !p.length ||
          g(p.trim()) ||
          (e.stopPropagation(),
          e.preventDefault(),
          r(T, ((a = p), (s = u.trim()), `[${a}](${s})`)));
      }
      function g(e) {
        try {
          let t = new URL(e);
          return S(t.href).trim() === S(e).trim();
        } catch (e) {
          return !1;
        }
      }
      ...
      function O(e) {
        ...
        (e.stopPropagation(), e.preventDefault());
        let a = e.currentTarget;
        a instanceof HTMLTextAreaElement && r(a, n);
      }
      function R(e) {
        let t = e.dataTransfer;
        t && (t.dropEffect = "copy");
      ...
      function L(e) {
        let { currentTarget: t } = e;
        if (o(t) || !e.clipboardData) return;
        let n = b(e.clipboardData);
        if (!n) return;
        (e.stopPropagation(), e.preventDefault());
        let a = e.currentTarget;
        a instanceof HTMLTextAreaElement && r(a, n);
      ...
      function b(e) {
        ...
        let i = (function (e) {
          let t = Array.from(e.querySelectorAll("tr")),
            n = t.shift();
          if (!n) return "";
          let r = Array.from(n.querySelectorAll("td, th")).map(k),
            a = r.map(() => "--"),
            s = `${r.join(" | ")}
${a.join(" | ")}
`,
            i = t.map((e) =>
              Array.from(e.querySelectorAll("td")).map(k).join(" | "),
            ).join(`
`);
          return `
${s}${i}
...
`;
        ...
        if (i) return [n, i, a].join("").replace(/<meta.*?>/, "");
      }
      function P(e) {
      ...
      function M(e) {
        ...
        let s = n.getData("text/x-gfm");
        s && (e.stopPropagation(), e.preventDefault(), r(a, s));
      }
      function y(e, t) {
        for (let n of (e.addEventListener("keydown", s), [D, h, I, P, l]))
          n(e, t);
        return (
          e.addEventListener("paste", i),
          {
            unsubscribe: () => {
              (e.removeEventListener("keydown", s),
                e.removeEventListener("paste", i),
                e.removeEventListener("dragover", R),
                e.removeEventListener("drop", O),
                e.removeEventListener("paste", L),
                e.removeEventListener("paste", c),
                e.removeEventListener("dragover", u),
                e.removeEventListener("drop", T),
    ...
    52301: (e, t, n) => {
      ...
      function f(e) {
        let t = {},
          n = {};
        for (let [r, a] of Object.entries(e.properties)) {
          let s = new DefinedInfo(
            r,
      ...
      function G(e, t) {
        ...
        switch (t.nodeName) {
          case "#comment":
            return ((n = { type: "comment", value: t.data }), Y(e, t, n), n);
          case "#document":
          case "#document-fragment": {
            ...
            if (
              ...
              ((0, s.ok)(a, "expected `start`"),
                (0, s.ok)(i, "expected `end`"),
                (n.position = { start: a, end: i }));
            }
            return n;
          }
          case "#documentType":
            return (Y(e, t, (n = { type: "doctype" })), n);
          case "#text":
            return ((n = { type: "text", value: t.value }), Y(e, t, n), n);
          default:
            return (function (e, t) {
              let n = e.schema;
              e.schema = t.namespaceURI === U.svg ? k : L;
              let r = -1,
                a = {};
              for (; ++r < t.attrs.length; ) {
                let e = t.attrs[r],
                  n = (e.prefix ? e.prefix + ":" : "") + e.name;
                H.call(w, n) || (a[n] = e.value);
              }
              let s = ("svg" === e.schema.space ? i.s : i.h)(
                t.tagName,
                a,
                x(e, t.childNodes),
              );
              if ((Y(e, t, s), "template" === s.tagName)) {
                let n = t.sourceCodeLocation,
                  r = n && n.startTag && W(n.startTag),
                  a = n && n.endTag && W(n.endTag),
                  i = G(e, t.content);
                (r &&
                  a &&
                  e.file &&
                  (i.position = { start: r.end, end: a.start }),
                  (s.content = i));
              }
              return ((e.schema = n), s);
            })(e, t);
      ...
      function Y(e, t, n) {
        if ("sourceCodeLocation" in t && t.sourceCodeLocation && e.file) {
          let r = (function (e, t, n) {
            let r = W(n);
            if ("element" === t.type) {
              let a = t.children[t.children.length - 1];
              if (
                (r &&
                  !n.endTag &&
                  a &&
                  a.position &&
                  a.position.end &&
                  (r.end = Object.assign({}, a.position.end)),
                e.verbose)
              ) {
                let r,
                  a = {};
                ...
                (0, s.ok)(n.startTag, "a start tag should exist");
                let i = W(n.startTag),
                  o = n.endTag ? W(n.endTag) : void 0,
                  c = { opening: i };
                (o && (c.closing = o),
                  (c.properties = a),
                  (t.data = { position: c }));
      ...
      function W(e) {
        let t = q({
          ...
          n = q({ line: e.endLine, column: e.endCol, offset: e.endOffset });
        ...
        J = (0, z.A)("type", {
          handlers: {
            root: function (e, t) {
              ...
              return ((n.childNodes = Z(e.children, n, t)), $(e, n), n);
            },
                  ...
                  if ("children" !== a && j.call(e.properties, a)) {
                    let t = (function (e, t, n) {
                      ...
                      if (
                        ...
                        return;
                      Array.isArray(n) &&
                        (n = r.commaSeparated ? (0, Q.A)(n) : (0, V.A)(n));
                      let a = {
                        name: r.attribute,
                        value: !0 === n ? "" : String(n),
                      };
                      if (r.space && "html" !== r.space && "svg" !== r.space) {
                        ...
                        (e < 0
                          ? (a.prefix = "")
                          : ((a.name = a.name.slice(e + 1)),
                            (a.prefix = r.attribute.slice(0, e))),
                          (a.namespace = U[r.space]));
                      }
                      return a;
                    })(o, a, e.properties[a]);
                    t && l.push(t);
      ...
      function $(e, t) {
        ...
        n &&
          n.start &&
          n.end &&
          ((0, s.ok)("number" == typeof n.start.offset),
          (0, s.ok)("number" == typeof n.end.offset),
      ...
      function eo(e, t) {
        ...
        let a,
          s,
          i = !!(
            (a = "root" === (r = e).type ? r.children[0] : r) &&
            ("doctype" === a.type ||
              ("element" === a.type && "html" === a.tagName.toLowerCase()))
          ),
          o = (0, z.A)("type", {
            handlers: {
              root: ec,
          ...
          l = {
            parser: i ? new et.iX(ei) : et.iX.getFragmentParser(void 0, ei),
            handle(e) {
              o(e, l);
            },
            stitches: !1,
        ...
        (o(e, l), em(l, (0, en.PW)()));
        let c =
          ((n = i ? l.parser.document : l.parser.getFragment()),
          G(
            {
              file: (s = { file: l.options.file }).file || void 0,
              location: !1,
              schema: "svg" === s.space ? k : L,
              verbose: s.verbose || !1,
            },
            n,
          ));
        return (l.stitches &&
          (0, er.YR)(c, "comment", function (e, t, n) {
            if (e.value.stitch && n && void 0 !== t)
              return ((n.children[t] = e.value.stitch), t);
          }),
        "root" === c.type &&
          1 === c.children.length &&
          c.children[0].type === e.type)
          ? c.children[0]
          : c;
      }
      function el(e, t) {
      ...
      function eE(e, t) {
        ((function (e, t) {
          ...
          if (t.parser.tokenizer.state === et.V_.PLAINTEXT) return;
          em(t, (0, en.PW)(e));
          let r = t.parser.openElements.current,
            a = "namespaceURI" in r ? r.namespaceURI : U.html;
          a === U.html && "svg" === n && (a = U.svg);
          let s = J(
              { ...e, children: [] },
              "svg" === { space: a === U.svg ? "svg" : "html" }.space
                ? K.JW
                : K.qy,
            ),
            i = {
              type: et.ou.k.START_TAG,
              tagName: n,
              tagID: et.qy.getTagID(n),
              selfClosing: !1,
              ackSelfClosing: !1,
          ...
          (function (e, t) {
            let n = e.tagName.toLowerCase();
            if (
              (!t.parser.tokenizer.inForeignNode && ee.includes(n)) ||
              t.parser.tokenizer.state === et.V_.PLAINTEXT
            )
              return;
            em(t, (0, en.Y)(e));
            let r = {
              type: et.ou.k.END_TAG,
              tagName: n,
              tagID: et.qy.getTagID(n),
              selfClosing: !1,
              ackSelfClosing: !1,
            ...
            ((t.parser.currentToken = r),
              ...
              n === t.parser.tokenizer.lastStartTagName &&
                (t.parser.tokenizer.state === et.V_.RCDATA ||
                  t.parser.tokenizer.state === et.V_.RAWTEXT ||
                  t.parser.tokenizer.state === et.V_.SCRIPT_DATA) &&
                (t.parser.tokenizer.state = et.V_.DATA));
          })(e, t));
      }
      function eh(e, t) {
        t.parser.tokenizer.state > 4 && (t.parser.tokenizer.state = 0);
        let n = { type: et.ou.k.CHARACTER, chars: e.value, location: e_(e) };
        (em(t, (0, en.PW)(e)),
      ...
      function eu(e, t) {
        let n = e.value,
          r = { type: et.ou.k.COMMENT, data: n, location: e_(e) };
        (em(t, (0, en.PW)(e)),
          (t.parser.currentToken = r),
          t.parser._processToken(t.parser.currentToken));
      }
      function ep(e, t) {
        if (
          ...
          t.parser.tokenizer.write(
            t.options.tagfilter ? e.value.replace(ea, "&lt;$1$2") : e.value,
            !1,
          ),
      ...
      function ed(e, t) {
        if (t.options.passThrough && t.options.passThrough.includes(e.type)) {
          ...
          ((t.stitches = !0),
            ...
            eu({ type: "comment", value: { stitch: r } }, t));
        } else {
          let t = "";
          throw (
            es.has(e.type) &&
      ...
      function em(e, t) {
        ...
        (n &&
          ...
          (e.parser.tokenizer.returnState = et.V_.DATA),
      ...
      function e_(e) {
        let t = (0, en.PW)(e) || {
          ...
          n = (0, en.Y)(e) || { line: void 0, column: void 0, offset: void 0 };
        return {
          startLine: t.line,
          startCol: t.column,
          startOffset: t.offset,
    ...
    59518: (e, t, n) => {
      ...
      function o(e) {
        let t;
        return (
          ((t = "string" == typeof e ? e.charCodeAt(0) : e) >= 97 &&
            t <= 122) ||
          (t >= 65 && t <= 90) ||
          s(e)
        );
      ...
      function E(e, t) {
        ...
        T.position &&
          ("start" in T.position || "indent" in T.position
            ? ((E = T.position.indent), (n = T.position.start))
            : (n = T.position));
        let _ = (n ? n.line : 0) || 1,
          f = (n ? n.column : 0) || 1,
          N = g();
        for (d--; ++d <= e.length; )
          if (
            ...
            let _ = "",
              O = "",
              R = "",
              L = "named" === t ? o : "decimal" === t ? s : i;
            for (m--; ++m <= e.length; ) {
              let n = e.charCodeAt(m);
              if (!L(n)) break;
              ((R += String.fromCharCode(n)),
                "named" === t && r.includes(R) && ((_ = R), (O = (0, l.s)(R))));
            }
            let k = 59 === e.charCodeAt(m);
            if (k) {
              m++;
              let e = "named" === t && (0, l.s)(R);
              e && ((_ = R), (O = e));
            }
            let b = 1 + m - c,
              P = "";
            if (k || !1 !== T.nonTerminated)
              if (R)
                if ("named" === t) {
                  if (k && !O) S(5, 1);
                  else if (
                    (_ !== R && ((b = 1 + (m = E + _.length) - E), (k = !1)),
                    !k)
                  ) {
                    let t = _ ? 1 : 3;
                    if (T.attribute) {
                  ...
                  var I, C;
                  k || S(2, b);
                  let e = Number.parseInt(R, "hexadecimal" === t ? 16 : 10);
                  if (((I = e) >= 55296 && I <= 57343) || I > 1114111)
                    (S(7, b), (P = String.fromCharCode(65533)));
                  else if (e in a) (S(6, b), (P = a[e]));
                  else {
                    let t = "";
                    ((((C = e) >= 1 && C <= 8) ||
                      11 === C ||
                      ...
                      e > 65535 &&
                        ...
                        (e = 56320 | (1023 & e))),
                      (P = t + String.fromCharCode(e)));
                  }
                }
              else "named" !== t && S(4, b);
            if (P) {
              (D(), (N = g()), (d = m - 1), (f += m - c + 1), p.push(P));
              let t = g();
              (t.offset++,
                T.reference &&
                  T.reference.call(
                    T.referenceContext || void 0,
                    P,
                    { start: N, end: t },
                    e.slice(c - 1, m),
                  ),
              ...
              ((R = e.slice(c - 1, m)), (A += R), (f += R.length), (d = m - 1));
          } else
            (10 === h && (_++, m++, (f = 0)),
              Number.isNaN(h) ? D() : ((A += String.fromCharCode(h)), f++));
        return p.join("");
        function g() {
          return { line: _, column: f, offset: d + ((n ? n.offset : 0) || 0) };
        }
        function S(e, t) {
          let n;
          T.warning &&
            ...
            (n.column += t),
            (n.offset += t),
            T.warning.call(T.warningContext || void 0, c[e], n, e));
        }
        function D() {
          A &&
            (p.push(A),
            T.text &&
              T.text.call(T.textContext || void 0, A, { start: N, end: g() }),
            (A = ""));
        }
      }
    },
    ...
    63633: (e, t, n) => {
      ...
      let T = function (e, t) {
        ...
        return h(
          ...
          function () {
            for (
              var t = arguments, a = -1, s = o(t.length - n, 0), l = Array(s);
              ++a < s;
            )
              l[a] = t[n + a];
            a = -1;
            for (var c = Array(n + 1); ++a < n; ) c[a] = t[a];
            return ((c[n] = r(l)), i(e, this, c));
          }),
          e + "",
        );
      };
    ...
    72569: (e, t, n) => {
      ...
      function o(e, t) {
        let n = { type: "root", children: [] },
          r = l({ schema: t ? { ...s.j, ...t } : s.j, stack: [] }, e);
        return (
          r &&
            (Array.isArray(r)
              ? 1 === r.length
      ...
      function l(e, t) {
        if (t && "object" == typeof t)
          switch ("string" == typeof t.type ? t.type : "") {
            case "comment":
              var n,
                r,
                a = e,
                s = t;
              if (a.schema.allowComments) {
                let e = "string" == typeof s.value ? s.value : "",
                  t = e.indexOf("--\x3e"),
                  n = { type: "comment", value: t < 0 ? e : e.slice(0, t) };
                return (T(n, s), n);
              }
              return;
            case "doctype":
            ...
            case "element":
              return (function (e, t) {
                ...
                e.stack.push(n);
                let r = c(e, t.children),
                  a = (function (e, t) {
                    let n,
                      r = e.stack[e.stack.length - 1],
                      a = e.schema.attributes,
                      s = e.schema.required,
                      o = a && i.call(a, r) ? a[r] : void 0,
                      l = a && i.call(a, "*") ? a["*"] : void 0,
                ...
                if (
                  ...
                  ((s = !0),
                  e.schema.ancestors && i.call(e.schema.ancestors, n))
                ) {
                ...
                if (!s)
                  return e.schema.strip && !e.schema.strip.includes(n)
                    ? r
                    : void 0;
                let o = {
                  type: "element",
            ...
            case "root":
              let h;
              return (
                T((h = { type: "root", children: c(e, (n = t).children) }), n),
                h
              );
            case "text":
              let p;
        ...
        return t
          ? Array.isArray(r)
            ? (function (e, t, n, r) {
                ...
                for (; ++a < r.length; ) {
                  let i = h(e, t, n, r[a]);
                  ("number" == typeof i || "string" == typeof i) && s.push(i);
                }
                return s;
              })(e, t, n, r)
            : h(e, t, n, r)
      ...
      function h(e, t, n, r) {
        if (
          ...
          (function (e, t, n) {
            let r =
              e.schema.protocols && i.call(e.schema.protocols, t)
            ...
            for (; ++E < r.length; ) {
              let e = r[E];
              if (s === e.length && a.slice(0, e.length) === e) return !0;
            }
            return !1;
          })(e, n, r)
        ) {
      ...
      function T(e, t) {
        let n = (0, a.G1)(t);
        (t.data && (e.data = (0, r.Ay)(t.data)), n && (e.position = n));
      }
      function u(e, t) {
        let n,
          r = -1;
    ...
    90204: (e, t, n) => {
      ...
      function o(e, t) {
        let n = [...e].map((e) => e.codePointAt(0));
        return (
          n[1] && (l(n[1]) || 65039 === n[1]) ? (n[1] = t) : n.splice(1, 0, t),
        ...
        connectedCallback() {
          if (null === this.image && !GEmojiElement.emojiSupportFunction()) {
            ...
            if (t) {
              ...
              let r =
                ((e = this),
                ((n = document.createElement("img")).className = "emoji"),
                (n.alt = e.getAttribute("alias") || ""),
                (n.height = 20),
                (n.width = 20),
                n);
      ...
      function E(e) {
        ...
        if (0 === t.length) e.textContent = i(e.textContent || "");
        else if (1 === t.length) {
          let n = t[0];
          e.textContent =
            0 === n ? i(e.textContent || "") : s(e.textContent || "", n);
        } else
    ...
    91913: (e, t, n) => {
      n.d(t, { A: () => r });
      let r = function (e, t, n) {
        for (var r = -1, a = Object(e), s = n(e), i = s.length; i--; ) {
          var o = s[++r];
