...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [19718],
  {
    13195: (e, t, s) => {
      ...
      ((0, i.lB)("button[data-disable-invalid]", {
        constructor: HTMLButtonElement,
        initialize(e) {
          let t = e.form;
          t &&
            (l.get(t) ||
              (t.addEventListener("change", () => a(t)), l.set(t, !0)),
    ...
    98032: (e, t, s) => {
      ...
      function y(e) {
        ...
        if ((0, a.Av)(t) && !confirm(s)) return !1;
        for (let e of t.querySelectorAll("input, textarea"))
          ((e.value = e.defaultValue),
            e.classList.contains("session-resumable-canceled") &&
              (e.classList.add("js-session-resumable"),
      ...
      ((0, m.lB)(".js-comment-header-actions-deferred-include-fragment", {
        subscribe: (e) =>
          (0, l.Rt)(
            e,
            "loadstart",
        ...
        (0, m.lB)(".js-comment .contains-task-list", {
          add: (e) => {
            g(e.closest(".js-comment"));
          },
        }),
        (0, n.on)("click", ".js-comment-edit-button", function (e) {
          ...
          let s = j(t);
          s
            ? s.addEventListener("include-fragment-replaced", () => f(t), {
                once: !0,
              })
            : f(t);
        ...
        (0, n.on)("click", ".js-cancel-issue-edit", function (e) {
          e.currentTarget
            ...
            .querySelector(".js-comment-form-error").hidden = !0;
        }),
        (0, c.JW)(
        ...
        (0, c.JW)(".js-comment .js-comment-update", async function (e, t) {
          let s,
            n = e.closest(".js-comment"),
            r = n.querySelector(".js-comment-update-error"),
            ...
            if (422 === e.response.status) {
              ...
              if (t.errors) {
                r instanceof HTMLElement &&
                  ((r.textContent = `There was an error posting your comment: ${t.errors.join(", ")}`),
                  (r.hidden = !1));
                return;
              }
            } else throw e;
          ...
          let c = n.querySelector(".js-comment-body"),
            u =
              null != c &&
              "async" ===
                e.getAttribute("data-submitting-tracking-block-update") &&
              (0, a.it)(c, !0, !0);
          if (
            (c && m.body && !u && (0, i.Eu)(c, m.body, { keepInputValues: !0 }),
            null != m.source)
          ) {
            ...
            if (
              ...
              if (document.querySelector(".js-merge-pr.is-merging")) {
                let e = document.querySelector(
                  ".js-merge-pull-request textarea",
                );
          ...
          if (g) {
            let e = await (0, o.Ts)(document, m.editUrl);
            (0, i.r9)(g, e);
          }
        }),
        (0, m.lB)(".js-comment-body-error", {
          add: (e) => {
            d && d.length > 0 && p(e);
          },
        }),
              ...
              if (e.response.status >= 400 && e.response.status < 500) {
                if (e.response.html) {
                  ...
                  n instanceof HTMLElement &&
                    ((n.textContent = t), (n.hidden = !1));
                }
              } else throw e;
            }
          },
        ),
        (0, c.JW)(".js-comment-delete", async function (e, t) {
          await t.json();
          let s =
              e.closest(".js-comment-container") ||
              e.closest(".js-line-comments"),
            n =
              s &&
              s.querySelectorAll(
          ...
          s &&
            (1 !== s.querySelectorAll(".js-comment").length || n) &&
            (s = e.closest(".js-comment"));
          let i =
            s?.closest(".js-comment-container") ||
            s?.closest(".js-line-comments");
          if (
            (s?.remove(), i && 1 === i.querySelectorAll(".js-comment").length)
          )
        ...
        (0, c.JW)(".js-issue-update", async function (e, t) {
          let s,
            n = e.closest(".js-details-container"),
          ...
          let r = s.json;
          if (null != r.issue_title) {
            n.querySelector(".js-issue-title").textContent = r.issue_title;
            let e = n.closest(".js-issues-results");
            if (e) {
              if (e.querySelector(".js-merge-pr.is-merging")) {
                let t = e.querySelector(
                  ".js-merge-pull-request .js-merge-title",
                );
                t instanceof HTMLInputElement &&
                  t.value === t.defaultValue &&
                  (t.value = t.defaultValue = r.default_merge_commit_title);
                ...
                t instanceof HTMLInputElement &&
                  t.value === t.defaultValue &&
                  (t.value = t.defaultValue = r.default_squash_commit_title);
              }
              let t = e.querySelector("button[value=merge]");
              t &&
                t.setAttribute(
                  "data-input-title-value",
                  r.default_merge_commit_title,
                );
              let s = e.querySelector("button[value=squash]");
              s &&
                s.setAttribute(
                  "data-input-title-value",
                  r.default_squash_commit_title,
                );
            }
          }
          for (let t of ((document.title = r.page_title), e.elements))
            (t instanceof HTMLInputElement ||
              t instanceof HTMLTextAreaElement) &&
              (t.defaultValue = t.value);
        }),
        (0, c.JW)(".js-comment-minimize", async function (e, t) {
          await t.json();
          ...
          if (n && n.classList.contains("js-update-minimized-content")) {
            ...
            let s = e
              .closest(".js-minimizable-comment-group")
              .querySelector(".minimized-comment");
            (s && s.classList.remove("d-none"),
              s && s.classList.add("js-comment"));
          }
        }),
        (0, c.JW)(".js-comment-unminimize", async function (e, t) {
          await t.json();
        ...
        (0, n.on)(
          ...
          (e) => {
            let t = e.detail.relatedTarget.getAttribute(
              "data-edit-history-url",
            );
            if (!t) return;
            e.preventDefault();
            let s = (0, o.Ts)(document, t);
            (0, r.r)({
              content: s,
