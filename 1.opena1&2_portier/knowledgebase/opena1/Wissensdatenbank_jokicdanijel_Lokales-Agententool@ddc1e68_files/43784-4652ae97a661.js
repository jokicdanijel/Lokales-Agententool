      ...
      ((n.prototype.logDefaultIndexUsed = function () {}),
        (n.prototype.add = function (e, t) {
          ...
          if ("string" == typeof e) {
            for (
              n = 0,
                r = { id: this.uid++, selector: e, data: t },
                c = d(this.indexes, e);
              n < c.length;
              n++
            )
              ((s = (u = c[n]).key),
                (a = (function (e, t) {
                  ...
                  (((a = Object.create(i)).map = new o()), h.push(a)),
    ...
    21403: (e, t, r) => {
            ...
            ? ((function (e, t) {
                if (t instanceof e.elementConstructor) {
                  ...
                  if ((r || ((r = []), u.set(t, r)), -1 === r.indexOf(e.id))) {
                    var n = void 0;
                    if (
                      (e.initialize && (n = e.initialize.call(void 0, t)), n)
                    ) {
                      var o = d.get(t);
              ...
              (function (e, t) {
                if (t instanceof e.elementConstructor) {
                  var r = f.get(t);
                  if ((r || ((r = []), f.set(t, r)), -1 === r.indexOf(e.id))) {
                    e.elements.push(t);
                    var n = d.get(t),
                      o = n ? n["" + e.id] : null;
        ...
        for (var n = 0; n < r.length; n++) {
          ...
          if ("querySelectorAll" in o)
            for (var l = e.selectorSet.queryAll(o), c = 0; c < l.length; c++)
              for (
                var u = l[c], d = u.data, h = u.elements, f = 0;
                f < h.length;
                f++
              )
                t.push([b, h[f], d]);
        ...
        if ("querySelectorAll" in r) {
          ...
          if (s)
            for (var a = 0; a < s.length; a++) {
              ...
              l &&
                !e.selectorSet.matchesSelector(r, l.selector) &&
                t.push([y, r, l]);
            }
        }
      }
      ...
      function k(e) {
        ...
        ((this.rootNode = 9 === e.nodeType ? e.documentElement : e),
          ...
          (this.observers = []),
          (this.selectorSet = new n.A()),
          (this.mutationObserver = new MutationObserver(N.bind(this, this))),
          (this._scheduleAddRootNodes = a(
            this.ownerDocument,
            C.bind(this, this),
          )),
          (this._handleThrottledChangedTargets = a(
            this.ownerDocument,
            q.bind(this, this),
          )),
          this.rootNode.addEventListener("change", _.bind(this, this), !1),
          (t = this.ownerDocument),
          (r = M.bind(this, this)),
          "interactive" === (o = t.readyState) || "complete" === o
            ? l(t, r)
            : t.addEventListener("DOMContentLoaded", l(t, r)));
      }
      function M(e) {
      ...
      function N(e, t) {
        for (var r = [], n = 0; n < t.length; n++) {
          ...
          "childList" === o.type
            ...
            : "attributes" === o.type && x(e, r, o.target);
        }
        ((function (e) {
          if (null === m) {
        ...
        for (var r = [], n = 0; n < t.length; n++)
          for (
            var o = t[n],
              i = o.form
                ? o.form.elements
                : e.rootNode.querySelectorAll("input"),
              s = 0;
            s < i.length;
            s++
          )
      ...
      ((k.prototype.disconnect = function () {
        ...
        (k.prototype.triggerObservers = function (e) {
          ...
          if ("querySelectorAll" in e) {
            x(this, t, e);
            for (var r = e.querySelectorAll("*"), n = 0; n < r.length; n++)
              x(this, t, r[n]);
          }
          v(this, t);
        }));
      ...
      function F() {
        var e;
        return (!D && (D = new k(window.document)), (e = D)).observe.apply(
          e,
          arguments,
        );
      }
