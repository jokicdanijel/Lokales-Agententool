        ...
        return {
          onFetch: (t, s) => {
            let r = t.options,
              ...
              h = t.state.data?.pageParams || [],
              l = { pages: [], pageParams: [] },
              c = 0,
              f = async () => {
                let s = !1,
                  f = (0, i.ZM)(t.options, t.fetchOptions),
                  d = async (e, r, a) => {
                    let n;
                    ...
                    return {
                      pages: l(e.pages, o, h),
                      pageParams: l(e.pageParams, r, h),
                    };
                  };
                if (u && o.length) {
                  let e = "backward" === u,
                    t = { pages: o, pageParams: h },
                    s = (e ? n : a)(r, t);
                  l = await d(t, s, e);
                } else {
                  let t = e ?? o.length;
                  do {
                    let e = 0 === c ? (h[0] ?? r.initialPageParam) : a(r, l);
                    if (c > 0 && null == e) break;
                    ((l = await d(l, e)), c++);
                  } while (c < t);
                }
    ...
    65490: (e, t, s) => {
      ...
      var i = s(24880),
        ...
        l = class {
          ...
          #c;
          constructor(e = {}) {
            ((this.#r = e.queryCache || new r.$()),
              (this.#a = e.mutationCache || new a.q()),
          ...
          mount() {
            (this.#h++,
              1 === this.#h &&
                ((this.#l = n.m.subscribe(async (e) => {
                  e && (await this.resumePausedMutations(), this.#r.onFocus());
                })),
                (this.#c = u.t.subscribe(async (e) => {
          ...
          ensureQueryData(e) {
            ...
            return void 0 === r
              ? this.fetchQuery(e)
              : (e.revalidateIfStale &&
                  s.isStaleByTime((0, i.d2)(t.staleTime, s)) &&
          ...
          setQueryData(e, t, s) {
            let r = this.defaultQueryOptions({ queryKey: e }),
              ...
              u = (0, i.Zw)(t, n);
            if (void 0 !== u)
              return this.#r.build(this, r).setData(u, { ...s, manual: !0 });
          }
          ...
          cancelQueries(e, t = {}) {
            let s = { revert: !0, ...t };
            return Promise.all(
              o.jG.batch(() => this.#r.findAll(e).map((e) => e.cancel(s))),
            )
              .then(i.lQ)
              .catch(i.lQ);
          }
          ...
          fetchQuery(e) {
            ...
            return s.isStaleByTime((0, i.d2)(t.staleTime, s))
              ? s.fetch(t)
          ...
          setQueryDefaults(e, t) {
            this.#u.set((0, i.EN)(e), { queryKey: e, defaultOptions: t });
          }
          getQueryDefaults(e) {
            let t = [...this.#u.values()],
              s = {};
            return (
              t.forEach((t) => {
                (0, i.Cp)(e, t.queryKey) && Object.assign(s, t.defaultOptions);
              }),
              s
            );
          }
    ...
    97665: (e, t, s) => {
      ...
      var i = s(96540),
        ...
        u = ({ client: e, children: t }) => (
          ...
          (0, r.jsx)(a.Provider, { value: e, children: t })
        );
    },
  },
]);
