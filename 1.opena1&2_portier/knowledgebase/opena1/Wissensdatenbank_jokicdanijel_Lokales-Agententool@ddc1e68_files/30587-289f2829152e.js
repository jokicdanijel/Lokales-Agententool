        ...
        l = class extends u.Q {
          ...
          onSubscribe() {
            1 === this.listeners.size &&
              ...
              o(this.#s, this.options) ? this.#y() : this.updateResult(),
              this.#R());
          }
          onUnsubscribe() {
          ...
          #b() {
            this.#o && (c.zs.clearTimeout(this.#o), (this.#o = void 0));
          }
          #v() {
            this.#d && (c.zs.clearInterval(this.#d), (this.#d = void 0));
          }
          createResult(e, t) {
            let r,
              s = this.#s,
            ...
            if (t._optimisticResults) {
              let r = this.hasListeners(),
                u = !r && o(e, t),
                a = r && p(e, s, t, i);
              ((u || a) && (R = { ...R, ...(0, n.k)(y.data, e.options) }),
            ...
            if (
              ...
              let e;
              (u?.isPlaceholderData && t.placeholderData === l?.placeholderData
                ? ((e = u.data), (g = !0))
                : (e =
                    "function" == typeof t.placeholderData
                      ...
                      : t.placeholderData),
                void 0 !== e &&
                  ((m = "success"), (r = (0, h.pl)(u?.data, e, t)), (b = !0)));
            }
            ...
            this.#t &&
              ((v = this.#t), (r = this.#c), (Q = Date.now()), (m = "error"));
            let I = "fetching" === R.fetchStatus,
              ...
              C = {
                ...
                isFetchedAfterMount:
                  R.dataUpdateCount > d.dataUpdateCount ||
                  R.errorUpdateCount > d.errorUpdateCount,
                isFetching: I,
                isRefetching: I && !E,
                isLoadingError: T && !S,
          ...
          updateResult() {
            ...
            if (
              ((this.#u = this.#s.state),
              (this.#a = this.options),
              void 0 !== this.#u.data && (this.#l = this.#s),
              (0, h.f8)(t, e))
            )
              return;
            this.#n = t;
      ...
      function o(e, t, r) {
        ...
        if (
          (s.useSyncExternalStore(
            s.useCallback(
              (e) => {
                let t = v ? R.subscribe(i.jG.batchCalls(e)) : n.lQ;
        ...
        if (
          ...
          throw b.error;
        if (
          (p.getDefaultOptions().queries?._experimental_afterQuery?.(f, b),
          f.experimental_prefetchInRender && !n.S$ && (0, l.nE)(b, o))
        ) {
          let e = y
            ? (0, l.iL)(f, R, d)
