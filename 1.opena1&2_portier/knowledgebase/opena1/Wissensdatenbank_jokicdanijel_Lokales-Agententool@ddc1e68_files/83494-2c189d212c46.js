...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [83494],
  {
    16643: (e, t, i) => {
      ...
      let a = new Set(["enter", "tab"]),
        o = (e) => {
          let t = (0, s.useRef)(!1),
            i = (0, s.useCallback)((e) => {
              ("compositionstart" === e.type && (t.current = !0),
                "compositionend" === e.type && (t.current = !1));
            }, []),
            o = (0, s.useCallback)(
              (i) => {
                let s = i.nativeEvent,
                  o = s && "isComposing" in s && s.isComposing,
                  r = "Process" === i.key;
                if ((0, n.U0)() && 229 === i.keyCode) return;
                let d = t.current || o || r;
                (a.has(i.key.toLowerCase()) && d) || e(i);
              },
              [e],
            );
          return (0, s.useMemo)(
    ...
    18651: (e, t, i) => {
      ...
      function d() {
        ...
        if (n.cg) {
          ...
          let l = "";
          try {
            l = i?.userAgentData?.platform || i.platform;
          } catch {}
          (-1 !==
          ["Macintosh", "MacIntel", "MacPPC", "Mac68K", "macOS"].indexOf(l)
            ? (e = a)
            : -1 !== ["iPhone", "iPad", "iPod"].indexOf(l)
              ? (e = "iOS")
              : -1 !== ["Win32", "Win64", "Windows", "WinCE"].indexOf(l)
                ? (e = o)
                : /Android/.test(d)
                  ? (e = s)
                  : /Linux/.test(l) && (e = r),
            (t = i?.userAgentData?.mobile ?? (e === s || "iOS" === e)));
        }
        return {
          os: e,
          isAndroid: e === s,
    ...
    44569: (e, t, i) => {
      ...
      let a = () => {
        ...
        o = (e) =>
          ...
          (!(0, n.U0)() && e.includes("Alt") && e.includes("Shift")),
        r = new Set([
          "button",
          "checkbox",
          "color",
    ...
    77890: (e, t, i) => {
      ...
      function r() {
        let e = new Map();
        for (let t of new Set(Array.from(o.values()).flat())) {
          let i = a.dx.getServiceId(t);
          if (!e.has(i)) {
            let t = (0, a.tp)(i);
            e.set(i, { service: { id: t.id, name: t.name }, commands: [] });
          }
          let n = (0, a.fL)(t);
          n &&
            n.defaultBinding &&
    ...
    83494: (e, t, i) => {
        ...
        u.send({
          ...
          target_element_html:
            t.target instanceof HTMLElement
              ? ((n = (i = t.target).tagName.toLowerCase()),
                (s = Array.from(i.attributes)
                  .map((e) => `${e.name}="${e.value.replaceAll('"', '\\"')}"`)
                  .join(" ")),
                `<${n}${s ? ` ${s}` : ""}>`)
              : void 0,
          keybinding: (0, a.xJ)(e.commandId),
        });
      }
      let p = new Map();
      function f(e, t) {
        let i = (0, d.useMemo)(() => new Map(), []),
          n = "global" === e ? p : i;
        (0, d.useEffect)(() => {
          for (let [e, i] of (0, a.eY)(s.J.keys(t))) {
            let t = n.get(i)?.filter((t) => t !== e) ?? [];
            (t.length &&
              console.warn(
                `The keybinding (${i}) for the "${e}" command conflicts with the keybinding for the already-registered command(s) "${t.join(", ")}". This may result in unpredictable behavior.`,
              ),
              n.set(i, t.concat(e)));
          }
          return () => {
            for (let [e, i] of (0, a.eY)(s.J.keys(t))) {
              let t = (function (e, t) {
                let i = !1;
                return e.filter((e) => e !== t || !!i || ((i = !0), !1));
              })(n.get(i) ?? [], e);
              t?.length ? n.set(i, t) : n.delete(i);
            }
          };
        }, [t, n]);
      }
      var g = i(87465),
        h = i(44569);
      function v(e, t, { triggerOnDefaultPrevented: i = !1 } = {}) {
        let n = (0, d.useMemo)(() => new g.KK(), []),
          s = (0, d.useMemo)(() => {
            let t = new Map();
            for (let i of e) {
              let e = (0, a.xJ)(i);
        ...
        return (0, d.useCallback)(
          (e) => {
            let a = "nativeEvent" in e ? e.nativeEvent : e;
            if ((!i && a.defaultPrevented) || o.current === a) return;
            if (((o.current = a), !(0, h.$$)(a))) return void n.reset();
            n.registerKeypress(a);
            let r = s.get(n.sequence) ?? s.get((0, g.Vy)(a));
            !r ||
              ((t(r, a) ?? !0) &&
                (n.reset(),
                e.preventDefault(),
        ...
        w = ({ commands: e }) => {
                ...
                if (n instanceof KeyboardEvent) {
                  ...
                  let e,
                    i = (e = [
                      ...
                      ? e[e.length - 1]
                      : null;
                  if (i && !((a = t.current) && i.contains(a))) return !1;
                }
                let o = e[i];
                if (o) {
                  let e = new s.k(i);
          ...
          return (
            ...
            (0, d.useEffect)(() => {
              let e = (e) => {
                let t =
                  "detail" in e && "object" == typeof e.detail
                    ? e.detail
                    : void 0;
                if (!t) return;
                let n =
                    "commandId" in t &&
                    "string" == typeof t.commandId &&
                    a.dx.is(t.commandId)
                      ? t.commandId
                      : void 0,
                  s =
                    "domEvent" in t &&
                    (t.domEvent instanceof KeyboardEvent ||
                      t.domEvent instanceof MouseEvent)
                      ? t.domEvent
                      : void 0;
                n && s && i(n, s);
              };
            ...
            (0, o.jsx)("div", { ref: t, className: "d-none" })
          );
        };
      try {
        w.displayName || (w.displayName = "GlobalCommands");
      } catch {}
      let y = (0, d.createContext)({
          triggerCommand(e, t, i = !1) {
            if (i) return !1;
            document.dispatchEvent(
              new CustomEvent(b, { detail: { commandId: e, domEvent: t } }),
            );
          },
      ...
      let S = ({ commandId: e, ...t }) => {
        let i = (0, a.xJ)(e);
        return i ? (0, o.jsx)(C.U, { keys: i, ...t }) : null;
      };
      try {
        S.displayName || (S.displayName = "CommandKeybindingHint");
      } catch {}
      let B = (0, d.forwardRef)(
        (
          {
            commandId: e,
            children: t,
          ...
          return c
            ? (0, o.jsxs)(r.l.Item, {
                ...d,
                onSelect: (t) => u(e, t.nativeEvent),
                ref: l,
                children: [
                  t ?? (0, o.jsx)("span", { children: c.name }),
                  i
                    ? (0, o.jsx)(r.l.Description, { truncate: !0, children: i })
                    : null,
                  n ? (0, o.jsx)(r.l.LeadingVisual, { children: n }) : null,
                  null !== s &&
                    (0, o.jsxs)(r.l.TrailingVisual, {
                      children: [
                        (0, o.jsx)("span", {
                          className: "sr-only",
                          children: "(",
                        ...
                        s ??
                          (0, o.jsx)(S, { commandId: e, format: "condensed" }),
                        (0, o.jsx)("span", {
                          className: "sr-only",
                          children: ")",
                        }),
      ...
      B.displayName = "ActionList.CommandItem";
      var E = i(21373);
      let q = (0, d.forwardRef)(
        (
          {
            commandId: e,
            children: t,
          ...
          let c = (0, a.fL)(e),
            { triggerCommand: u } = x();
          if (!c) return null;
          let m = s ?? ("primary" === d.variant ? "onPrimary" : "normal");
          return (0, o.jsx)(E.Q, {
            ...d,
            onClick: (t) => {
              (r?.(t), t.defaultPrevented || u(e, t.nativeEvent));
            },
            trailingVisual:
              (i ?? n)
                ? () =>
      ...
      q.displayName = "CommandButton";
      try {
        (n = HintVisual).displayName || (n.displayName = "HintVisual");
      } catch {}
      var I = i(26108);
      let M = (0, d.forwardRef)(
        ({ commandId: e, "aria-label": t, onClick: i, ...n }, s) => {
          let r = (0, a.fL)(e),
            { triggerCommand: d } = x();
          return r
            ? (0, o.jsx)(I.K, {
                "aria-label": t ?? r.name,
                onClick: (t) => {
                  (i?.(t), t.defaultPrevented || d(e, t.nativeEvent));
                },
                ref: s,
                keybindingHint: (0, a.xJ)(e),
                ...n,
              })
            : null;
        },
      );
      M.displayName = "CommandIconButton";
      var j = i(16643),
        O = i(31223),
        A = i(21513);
      let N = new Map(),
        L = (0, d.forwardRef)(({ commands: e, ...t }, i) => {
          let n = (0, O.M)(e),
            a = x(),
            r = (0, d.useCallback)(
              (e, t, i = !1) => {
                let o = n.current[e];
                if (!o) return a.triggerCommand(e, t, i);
                {
                  let i = new s.k(e);
                  try {
                    o(i);
          ...
          (f("scoped", e), (0, l.J)(e));
          let [c, u] = (0, d.useState)(N),
            p = (0, d.useCallback)(
              (e, t) =>
                u((i) => {
                  let n = i.get(e);
                  return t.length === n?.length && t.every((e, t) => n[t] === e)
                    ? i
                    : new Map([...i, [e, t]]);
                }),
              [],
            ...
            g = (0, d.useMemo)(() => {
              let t = new Set(Array.from(c.values()).flat());
              return s.J.keys(e).filter((i) => void 0 !== e[i] && !t.has(i));
            }, [e, c]),
            h = (0, d.useMemo)(
              () => ({ triggerCommand: r, registerLimitedKeybindingScope: p }),
              [r, p],
            );
          return (0, o.jsx)(k, {
            value: h,
            children: (0, o.jsx)(P, { commandIds: g, ...t, ref: i }),
          });
        });
      L.displayName = "ScopedCommands";
      let P = (0, d.forwardRef)(
        (
          {
            commandIds: e,
            as: t,
            limited: i = !1,
            triggerOnDefaultPrevented: n,
            ...s
          },
          a,
        ) => {
          let r = x(),
            l = v(
              e,
              (0, d.useCallback)((e, t) => r.triggerCommand(e, t, i), [r, i]),
              { triggerOnDefaultPrevented: n },
            ),
            c = (0, j._)(l),
            u = (0, d.useRef)(null);
          ...
          let m =
            void 0 !== t || void 0 !== s.className
              ? void 0
              : { display: "contents" };
          return (0, o.jsx)(t ?? "div", { style: m, ...s, ...c, ref: u });
        },
      );
      P.displayName = "KeyboardScope";
      let J = (0, d.forwardRef)(({ commandIds: e, ...t }, i) => {
        let n = x(),
          s = (0, d.useId)();
        return (
          (0, d.useEffect)(
            () => n.registerLimitedKeybindingScope(s, e),
            [n, e, s],
          ),
          (0, d.useEffect)(
            () => () => n.registerLimitedKeybindingScope(s, []),
            [n, s],
          ),
          (0, o.jsx)(P, { limited: !0, commandIds: e, ...t, ref: i })
        );
      });
      J.displayName = "LimitKeybindingScope";
      let _ = Object.assign(L, { LimitKeybindingScope: J });
      try {
        _.displayName || (_.displayName = "ScopedCommands");
      } catch {}
    },
    87465: (e, t, i) => {
      i.d(t, {
      ...
      let s = /(?:^|,)((?:[^,]|,(?=\+| |$))*(?:,(?=,))?)/g;
      function a(e) {
        return Array.from(e.matchAll(s)).map(([, e]) => e);
      }
    },
    99772: (e, t, i) => {
      i.d(t, { J: () => a, k: () => CommandEvent });
      var n = i(50467),
        s = i(82299);
      let CommandEvent = class CommandEvent {
        constructor(e) {
          ((0, n._)(this, "commandId", void 0), (this.commandId = e));
        }
      };
      let a = {
        entries: (e) =>
          Object.entries(e).filter((e) => s.dx.is(e[0]) && void 0 !== e[1]),
        keys: (e) => Object.keys(e).filter(s.dx.is),
      };
    },
  },
]);
//# sourceMappingURL=83494-6cc515e835a1.js.map
