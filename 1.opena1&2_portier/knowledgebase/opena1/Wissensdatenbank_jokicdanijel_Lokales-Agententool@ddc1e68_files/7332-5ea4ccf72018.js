...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [7332],
  {
    7332: (e, t, s) => {
      ...
      var i = HTMLFormElement.prototype;
      function r(e, t, s) {
        throw new e(
            ...
            (i = (s =
              (t = e.target) instanceof Element
                ...
                : t instanceof Node
                  ? t.parentElement
                  : null)
              ? s.closest("input, button")
              : null)
              ? void 0
              : i.type) == "submit"
              ? i
              : null;
        r && r.form && n.set(r.form, r);
      }
      !(function () {
        let e;
      ...
      let a = null,
        l =
          null !=
          (X = null == (Q = globalThis.trustedTypes) ? void 0 : Q.emptyHTML)
            ? X
            : "";
      (((x = J || (J = {})).eager = "eager"), (x.lazy = "lazy"));
      let FrameElement = class FrameElement extends HTMLElement {
        ...
        get isPreview() {
          var e, t;
          return null ==
            (t = null == (e = this.ownerDocument) ? void 0 : e.documentElement)
            ? void 0
      ...
      function p(e) {
        if ("false" == e.getAttribute("data-turbo-eval")) return e;
        {
          ...
          return (
            ...
            null !== e.textContent &&
              (null !== a
                ? (t.textContent = a.createScript(e.textContent))
                : (t.textContent = e.textContent)),
            (t.async = !1),
            (function (e, t) {
              for (let { name: s, value: i } of t.attributes)
                if ("src" === s && null !== a) {
                  let t = a.createScriptURL(i);
                  e.setAttribute(s, t);
      ...
      function g(e, { target: t, cancelable: s, detail: i } = {}) {
      ...
      function b(e, ...t) {
        ...
        let r = ((s = e),
          (i = t),
          s.reduce(
            (e, t, s) => e + t + (void 0 == i[s] ? "" : i[s]),
            "",
          )).replace(/^\n/, "").split(`
`),
          n = r[0].match(/^\s+/),
          o = n ? n[0].length : 0;
        return r.map((e) => e.slice(o)).join(`
`);
      }
      function S() {
      ...
      let FetchRequest = class FetchRequest {
        ...
        get fetchOptions() {
          var e;
          return {
            method: G[this.method].toUpperCase(),
            credentials: "same-origin",
            headers: this.headers,
            redirect: "follow",
            body: this.isIdempotent ? null : this.body,
            signal: this.abortSignal,
            referrer: null == (e = this.delegate.referrer) ? void 0 : e.href,
          };
        }
        get defaultHeaders() {
        ...
        willDelegateErrorHandling(e) {
          return !g("turbo:fetch-request-error", {
            target: this.target,
            cancelable: !0,
      ...
      let StreamMessage = class StreamMessage {
          ...
          this.fragment = (function (e) {
            for (let t of e.querySelectorAll("turbo-stream")) {
              ...
              for (let t of e.templateElement.content.querySelectorAll(
                ...
                "application/json" !== t.type && t.replaceWith(p(t));
              t.replaceWith(e);
            }
            return e;
          })(e);
        ...
        static wrap(e) {
          ...
          return new this(
            (((t = document.createElement("template")).innerHTML = e),
            t.content),
          );
        }
      };
      ((StreamMessage.contentType = "text/vnd.turbo-stream.html"),
        ((_ = Z || (Z = {}))[(_.initialized = 0)] = "initialized"),
        (_[(_.requesting = 1)] = "requesting"),
        (_[(_.waiting = 2)] = "waiting"),
        (_[(_.receiving = 3)] = "receiving"),
        (_[(_.stopping = 4)] = "stopping"),
        (_[(_.stopped = 5)] = "stopped"),
        ((j = ee || (ee = {})).urlEncoded =
          "application/x-www-form-urlencoded"),
        (j.multipart = "multipart/form-data"),
        (j.plain = "text/plain"));
      let FormSubmission = class FormSubmission {
        constructor(e, t, s, i = !1) {
          ((this.state = Z.initialized),
            (this.delegate = e),
            (this.formElement = t),
            (this.submitter = s),
        ...
        get action() {
          ...
          let t =
            "string" == typeof this.formElement.action
              ...
              : null;
          return (
            null == (e = this.submitter) ? void 0 : e.hasAttribute("formaction")
          )
            ? this.submitter.getAttribute("formaction") || ""
            : this.formElement.getAttribute("action") || t || "";
        }
        get body() {
          return this.enctype == ee.urlEncoded || this.method == G.get
        ...
        async start() {
          let { initialized: e, requesting: t } = Z,
            s = w("data-turbo-confirm", this.submitter, this.formElement);
          if (
            ("string" != typeof s ||
        ...
        requestStarted(e) {
          ...
          ((this.state = Z.waiting),
            null == (t = this.submitter) || t.setAttribute("disabled", ""),
            g("turbo:submit-start", {
        ...
        requestFinished(e) {
          ...
          ((this.state = Z.stopped),
            null == (t = this.submitter) || t.removeAttribute("disabled"),
            g("turbo:submit-end", {
              target: this.formElement,
          ...
          ((this.started = !1),
            ...
            (this.submitBubbled = (e) => {
              if (!e.defaultPrevented) {
                var t, s;
                let i = e.target instanceof HTMLFormElement ? e.target : void 0,
                ...
                i &&
                  ...
                  this.delegate.willSubmitForm(i, r) &&
                  (e.preventDefault(),
                  e.stopImmediatePropagation(),
                  this.delegate.formSubmitted(i, r));
              }
            }),
            (this.delegate = e),
            (this.eventTarget = t));
          ...
          let s,
            i =
              ...
              (s = document.createElement("meta")).setAttribute(
                "name",
                "turbo-permanent-placeholder",
              ),
              s.setAttribute("content", t.id),
              s);
          e.replaceWith(i);
        }
      ...
      let Renderer = class Renderer {
        ...
        focusFirstAutofocusableElement() {
          ...
          (e = t) && "function" == typeof e.focus && t.focus();
        }
        enteringBardo(e) {
          !this.activeElement &&
      ...
      let FrameRenderer = class FrameRenderer extends Renderer {
        ...
        static renderElement(e, t) {
          ...
          let r = null == (s = t.ownerDocument) ? void 0 : s.createRange();
    ...
    `;
          ...
          (super(...arguments),
            (this.detailsByOuterHTML = this.children
              ...
              .map((e) => {
                var t;
                return (
                  (t = e).hasAttribute("nonce") && t.setAttribute("nonce", ""),
                  t
                );
              })
              .reduce((e, t) => {
                ...
                let r,
                  ...
                  o =
                    n in e
                      ...
                      : {
                          type:
                            "script" == (s = t).localName
                              ? "script"
                              : "style" == (r = (i = s).localName) ||
                                  ("link" == r &&
        ...
        findMetaElementByName(e) {
          return Object.keys(this.detailsByOuterHTML).reduce(
            (t, s) => {
              ...
              return ((i = n),
              (r = e),
              "meta" == i.localName && i.getAttribute("name") == r)
                ? n
                : t;
            },
            void 0,
      ...
      let PageSnapshot = class PageSnapshot extends Snapshot {
        ...
        static fromResponse(e, t = l) {
          if (!e || null == a) return this.fromHTMLString(t);
          let s = a.createHTML(t, e);
        ...
        get rootLocation() {
          var e;
          return h(null != (e = this.getSetting("root")) ? e : "/");
        }
      ...
      ((($ = et || (et = {})).visitStart = "visitStart"),
        ($.requestStart = "requestStart"),
        ($.requestEnd = "requestEnd"),
        ($.visitEnd = "visitEnd"),
        ((z = es || (es = {})).initialized = "initialized"),
        (z.started = "started"),
        (z.canceled = "canceled"),
        (z.failed = "failed"),
      ...
      (((K = ei || (ei = {}))[(K.networkFailure = 0)] = "networkFailure"),
        (K[(K.timeoutFailure = -1)] = "timeoutFailure"),
        (K[(K.contentTypeMismatch = -2)] = "contentTypeMismatch"));
      let Visit = class Visit {
        constructor(e, t, s, i = {}) {
          ((this.identifier = S()),
            ...
            (this.state = es.initialized),
            (this.delegate = e),
            (this.location = t),
            (this.restorationIdentifier = s || S()));
          const {
            action: r,
            historyChanged: n,
            referrer: o,
        ...
        start() {
          this.state == es.initialized &&
            (this.recordTimingMetric(et.visitStart),
            (this.state = es.started),
        ...
        cancel() {
          this.state == es.started &&
            ...
            this.cancelRender(),
            (this.state = es.canceled));
        }
        complete() {
          this.state == es.started &&
            (this.recordTimingMetric(et.visitEnd),
            (this.state = es.completed),
            this.followRedirect(),
        ...
        fail() {
          this.state == es.started &&
            ((this.state = es.failed), this.adapter.visitFailed(this));
        }
        changeHistory() {
          var e;
          if (!this.historyChanged && this.updateHistory) {
            let t = R(
              this.location.href ===
                (null == (e = this.referrer) ? void 0 : e.href)
                ? "replace"
                : this.action,
            );
        ...
        issueRequest() {
          this.hasPreloadedResponse()
            ...
            : this.shouldIssueRequest() &&
              !this.request &&
              ((this.request = new FetchRequest(this, G.get, this.location)),
        ...
        startRequest() {
          (this.recordTimingMetric(et.requestStart),
        ...
        finishRequest() {
          (this.recordTimingMetric(et.requestEnd),
        ...
        followRedirect() {
          ...
          this.redirectedToLocation &&
            !this.followedRedirect &&
            (null == (e = this.response) ? void 0 : e.redirected) &&
        ...
        async requestSucceededWithResponse(e, t) {
          ...
          void 0 == s
            ? this.recordResponse({
                statusCode: ei.contentTypeMismatch,
                redirected: i,
              })
      ...
      let BrowserAdapter = class BrowserAdapter {
        ...
        visitProposedToLocation(e, t) {
          this.navigator.startVisit(
            e,
            (null == t ? void 0 : t.restorationIdentifier) || S(),
            t,
          );
        }
        visitStarted(e) {
        ...
        visitRequestFailedWithStatusCode(e, t) {
          switch (t) {
            case ei.networkFailure:
            case ei.timeoutFailure:
            case ei.contentTypeMismatch:
              return this.reload({
        ...
        reload(e) {
          var t;
          (g("turbo:reload", { detail: e }),
            (window.location.href =
              (null == (t = this.location) ? void 0 : t.toString()) ||
              window.location.href));
        }
        get navigator() {
      ...
      let FrameRedirector = class FrameRedirector {
        ...
        shouldInterceptLinkClick(e, t, s) {
          return (
            ...
            this.frameAllowsVisitingLocation(e, h(t), s)
          );
        }
        ...
        shouldSubmit(e, t) {
          ...
          let i = d(e, t),
            ...
            n = h(null != (s = null == r ? void 0 : r.content) ? s : "/");
          return (
      ...
      let History = class History {
          ...
          ((this.restorationIdentifier = S()),
            ...
            (this.onPopState = (e) => {
              if (this.shouldHandlePopState()) {
                let { turbo: t } = e.state || {};
                if (this.shouldRestore(e.state) && t) {
        ...
        assumeControlOfScrollRestoration() {
          ...
          this.previousScrollRestoration ||
            ((this.previousScrollRestoration =
              null != (e = history.scrollRestoration) ? e : "auto"),
      ...
      let Navigator = class Navigator {
        ...
        locationWithActionIsSamePage(e, t) {
          ...
          return (
            "replace" !== t &&
            u(e) === u(this.view.lastRenderedLocation) &&
        ...
        getActionForFormSubmission(e) {
          let { formElement: t, submitter: s } = e,
            i = w("data-turbo-action", s, t);
          return m(i) ? i : "advance";
        }
      };
      (((Y = er || (er = {}))[(Y.initial = 0)] = "initial"),
        (Y[(Y.loading = 1)] = "loading"),
        (Y[(Y.interactive = 2)] = "interactive"),
        (Y[(Y.complete = 3)] = "complete"));
      let PageObserver = class PageObserver {
        constructor(e) {
          ((this.stage = er.initial),
            (this.started = !1),
        ...
        start() {
          this.started ||
            (this.stage == er.initial && (this.stage = er.loading),
        ...
        pageIsInteractive() {
          this.stage == er.loading &&
            ((this.stage = er.interactive),
            this.delegate.pageBecameInteractive());
        }
        pageIsComplete() {
          (this.pageIsInteractive(),
            this.stage == er.interactive &&
              ((this.stage = er.complete), this.delegate.pageLoaded()));
        }
        get readyState() {
      ...
      let StreamMessageRenderer = class StreamMessageRenderer {
        render({ fragment: e }) {
          Bardo.preservingPermanentElements(
            this,
            (function (e) {
              let t = P(document.documentElement),
                s = {};
              for (let i of t) {
                let { id: t } = i;
                for (let r of e.querySelectorAll("turbo-stream")) {
                  let e = A(r.templateElement.content, t);
                  e && (s[t] = [i, e]);
                }
              }
              return s;
        ...
        constructor(e) {
          ((this.sources = new Set()),
            ...
            (this.inspectFetchResponse = (e) => {
              ...
              let s = (function (e) {
                var t;
                let s = null == (t = e.detail) ? void 0 : t.fetchResponse;
                if (s instanceof FetchResponse) return s;
              })(e);
              s &&
                (null != (t = s.contentType) ? t : "").startsWith(
                  StreamMessage.contentType,
                ) &&
                (e.preventDefault(), this.receiveMessageResponse(s));
            }),
        ...
        removeCurrentHeadProvisionalElements() {
          for (let e of this.currentHeadProvisionalElements)
            !(function (e) {
              for (let t in e)
                if ("_" === t[0] && "_" === t[1]) {
                  for (let e of el) if (t.startsWith(e)) return !0;
                }
              return !1;
      ...
      let SnapshotCache = class SnapshotCache {
        ...
        read(e) {
          return this.snapshots[u(e)];
        }
        write(e, t) {
          this.snapshots[u(e)] = t;
        }
        touch(e) {
          let t = u(e),
      ...
      let Session = class Session {
        ...
        locationIsVisitable(e, t) {
          ...
          let r;
          return (
            (r = (i = (s = t).origin + s.pathname).endsWith("/") ? i : i + "/"),
            (e.href === h(r).href || e.href.startsWith(r)) &&
              this.isVisitable(e)
          );
        }
        ...
        visitProposedToLocation(e, t) {
          (k(e), this.adapter.visitProposedToLocation(e, t));
        }
        visitStarted(e) {
          (e.acceptsStreamResponse || E(document.documentElement),
            k(e.location),
            e.silent ||
        ...
        willSubmitForm(e, t) {
          ...
          return (
            ...
            this.locationIsVisitable(h(s), this.snapshot.rootLocation)
          );
        }
        formSubmitted(e, t) {
        ...
        viewWillCacheSnapshot() {
          var e;
          (null == (e = this.navigator.currentVisit) ? void 0 : e.silent) ||
        ...
        notifyApplicationAfterVisitingLocation(e, t) {
          return g("turbo:visit", { detail: { url: e.href, action: t } });
        }
        ...
        notifyApplicationAfterFrameLoad(e) {
          return g("turbo:frame-load", { target: e });
        }
        notifyApplicationAfterFrameRender(e, t) {
          return g("turbo:frame-render", {
        ...
        elementIsNavigatable(e) {
          ...
          if (this.drive || s)
            if (t) return "false" != t.getAttribute("data-turbo");
            else return !0;
          return !!t && "true" == t.getAttribute("data-turbo");
        }
        getActionForLink(e) {
          let t = e.getAttribute("data-turbo-action");
          return m(t) ? t : "advance";
        }
        get snapshot() {
      ...
      function N(e) {
        H.connectStreamSource(e);
      }
      function D(e) {
        H.disconnectStreamSource(e);
      }
      function W(e) {
        H.setProgressBarDelay(e);
      }
      var x,
        U,
        _,
        ...
        en = Object.freeze({
          ...
          visit: V,
          connectStreamSource: N,
          disconnectStreamSource: D,
          renderStreamMessage: function (e) {
            H.renderStreamMessage(e);
          },
          clearCache: function () {
            (console.warn(
          ...
          StreamActions: M,
          setCSPTrustedTypesPolicy: function (e) {
            a = e;
          },
        });
      let FrameController = class FrameController {
        ...
        async loadResponse(e) {
          ...
          try {
            ...
            if (t) {
              let s;
              if (null == a) s = v(t).body;
              else {
                let i = a.createHTML(t, e.response);
                s = v(i).body;
              }
              ...
              if (i) {
                ...
                (this.view.renderPromise && (await this.view.renderPromise),
                  ...
                  (this.complete = !0),
                  H.frameRendered(e, this.element),
                  H.frameLoaded(this.element),
                  this.fetchResponseLoaded(e));
              } else
        ...
        prepareHeadersForRequest(e, t) {
          ...
          ((e["Turbo-Frame"] = this.id),
            (null == (s = this.currentNavigationElement)
              ? void 0
        ...
        formSubmissionFinished({ formElement: e }) {
          y(e, this.findFrameElement(e));
        }
        allowsImmediateRender({ element: e }, t) {
          let {
            defaultPrevented: s,
            detail: { render: i },
          } = g("turbo:before-frame-render", {
            target: this.element,
          ...
          if (
            ...
            e.delegate.fetchResponseLoaded = (s) => {
              if (e.src) {
                ...
                (this.action && (o.action = this.action), H.visit(e.src, o));
              }
            };
          }
        }
        ...
        willHandleFrameMissingFromResponse(e) {
          ...
          let t = e.response,
            s = async (e, t = {}) => {
              e instanceof Response ? this.visitResponse(e) : H.visit(e, t);
            };
          return !g("turbo:frame-missing", {
            target: this.element,
        ...
        async extractForeignFrameElement(e) {
          ...
          try {
            if ((t = ea(e.querySelector(`turbo-frame#${s}`), this.sourceURL)))
              return t;
            if (
              (t = ea(
        ...
        formActionIsVisitable(e, t) {
          let s = d(e, t);
          return H.locationIsVisitable(h(s), this.rootLocation);
        }
        shouldInterceptNavigation(e, t) {
          let s =
            w("data-turbo-frame", t, e) || this.element.getAttribute("target");
          if (
            (e instanceof HTMLFormElement &&
          ...
          return (
            !!H.elementIsNavigatable(e) && (!t || !!H.elementIsNavigatable(t))
          );
        }
        get id() {
        ...
        get rootLocation() {
          ...
          return h(null != (e = null == t ? void 0 : t.content) ? e : "/");
        }
        frameAllowsVisitingLocation(e, { href: t }, s) {
          return !g("turbo:frame-click", {
            target: e,
        ...
        ignoringChangesToAttribute(e, t) {
          (this.ignoredAttributes.add(e),
            t(),
            this.ignoredAttributes.delete(e));
        }
      ...
      function ea(e, t) {
        if (e) {
          ...
          if (null != s && null != t && h(s).href == h(t).href)
            throw Error(
      ...
      let StreamElement = class StreamElement extends HTMLElement {
        ...
        async render() {
          var e;
          return null != (e = this.renderPromise)
            ? e
            : (this.renderPromise = (async () => {
                let e = this.beforeRenderEvent;
                this.dispatchEvent(e) &&
                  (await f(), await e.detail.render(this));
              })());
        }
        disconnect() {
          try {
        ...
        get duplicateChildren() {
          ...
          let t = this.targetElements
              ...
              .filter((e) => !!e.id),
            s = [
              ...((null == (e = this.templateContent) ? void 0 : e.children) ||
                []),
            ]
              .filter((e) => !!e.id)
              .map((e) => e.id);
        ...
        get description() {
          var e, t;
          return null !=
            (t = (null != (e = this.outerHTML.match(/<[^>]+>/)) ? e : [])[0])
            ? t
            : "<turbo-stream>";
        }
      ...
      let StreamSourceElement = class StreamSourceElement extends HTMLElement {
        ...
        disconnectedCallback() {
          this.streamSource && D(this.streamSource);
        }
        get src() {
          return this.getAttribute("src") || "";
        }
      ...
      `,
        ...
        (window.Turbo = en),
        O());
      let el = ["__reactFiber$", "__reactProps$", "__reactContainer$"];
    },
  },
]);
