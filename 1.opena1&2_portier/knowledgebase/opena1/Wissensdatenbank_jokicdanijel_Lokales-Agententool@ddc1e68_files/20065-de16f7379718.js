...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [20065, 91707],
  {
    ...
    13937: (t, e, i) => {
      ...
      function c(t) {
        if (!(t.target instanceof HTMLFormElement) || t.defaultPrevented)
          return;
        let e = t.target,
          i = (function (t) {
            let e = [],
        ...
        let o = (function (t, e) {
            let i = {
              method: e?.formMethod || t.method || "GET",
              url: t.action,
              headers: new Headers({ "X-Requested-With": "XMLHttpRequest" }),
              body: null,
            };
            if ("GET" === i.method.toUpperCase()) {
              let e = (function (t) {
                let e = new URLSearchParams();
                for (let [i, n] of [...new FormData(t).entries()])
                  e.append(i, n.toString());
                return e.toString();
              })(t);
              e && (i.url += (~i.url.indexOf("?") ? "&" : "?") + e);
            } else i.body = new FormData(t);
            return i;
          })(e, t instanceof SubmitEvent ? t.submitter : null),
          [l, u, c] = r();
        (t.preventDefault(),
          h(i, e, o, l).then(
            async (t) => {
              if (t) {
                for (let t of a) await t(e);
                d(o)
                  .then(u, c)
                  .catch(() => {})
                  .then(() => {
      ...
      async function h(t, e, i, n) {
        ...
        for (let a of t) {
          let [t, o] = r(),
            ...
            u = {
              text: l,
              json: () => (i.headers.set("Accept", "application/json"), l()),
              html: () => (i.headers.set("Accept", "text/html"), l()),
            };
          await Promise.race([t, a(e, u, i)]);
        }
        return s;
      }
      async function d(t) {
        let e = await window.fetch(t.url, {
            method: t.method,
            ...
            get html() {
              ...
              return (
                ...
                (this.html =
                  ((n = document),
                  (r = this.text),
                  ((t = n.createElement("template")).innerHTML = r),
                  n.importNode(t.content, !0))),
                this.html
              );
            },
          };
        if (((i.text = await e.text()), e.ok)) return i;
        throw new ErrorWithResponse("request failed", i);
      }
    },
    35908: (t, e, i) => {
      i.d(e, { A: () => Combobox });
        ...
        constructor(
          ...
          ((this.input = t),
            ...
            (this.scrollIntoViewOptions =
              null != s ? s : { block: "nearest", inline: "nearest" }),
            (this.isComposing = !1),
              ...
              (t.removeAttribute("data-combobox-option-default"),
                a === t
                  ? (this.input.setAttribute("aria-activedescendant", a.id),
                    ...
                    a.scrollIntoView(this.scrollIntoViewOptions))
    ...
    91707: (t, e, i) => {
      (i.r(e), i.d(e, { Attachment: () => Attachment, default: () => f }));
      let Attachment = class Attachment {
        ...
        static traverse(t, e) {
          ...
          return (
            ...
            Array.from(s.items).some((t) => {
              ...
              : Promise.resolve(
                  n(Array.from(i.files || [])).map((t) => new Attachment(t)),
                )
          );
        }
        static from(t) {
        ...
        saved(t) {
          ...
          ((this.state = "saved"),
            (this.id = null != (e = null == t ? void 0 : t.id) ? e : null),
            (this.href = null != (i = null == t ? void 0 : t.href) ? i : null),
            (this.name = null != (n = null == t ? void 0 : t.name) ? n : null));
        }
        isPending() {
      ...
      let FileAttachmentElement = class FileAttachmentElement extends HTMLElement {
        connectedCallback() {
          (this.addEventListener("dragenter", o),
            this.addEventListener("dragover", o),
            this.addEventListener("dragleave", l),
            this.addEventListener("drop", u),
            this.addEventListener("paste", h),
            this.addEventListener("change", d));
        }
        disconnectedCallback() {
          (this.removeEventListener("dragenter", o),
            this.removeEventListener("dragover", o),
            this.removeEventListener("dragleave", l),
            this.removeEventListener("drop", u),
            this.removeEventListener("paste", h),
      ...
      function o(t) {
        ...
        (a && clearTimeout(a),
          (a = window.setTimeout(() => e.removeAttribute("hover"), 200)));
      ...
      function u(t) {
        ...
        let i = t.dataTransfer;
        i && s(i) && (e.attach(i), t.stopPropagation(), t.preventDefault());
      }
      let c = /^image\/(gif|png|jpeg)$/;
      function h(t) {
        ...
        let i = (function (t) {
          for (let e of t)
            if ("file" === e.kind && c.test(e.type)) return e.getAsFile();
          return null;
        })(t.clipboardData.items);
        i && (e.attach([i]), t.preventDefault());
      }
      function d(t) {
        let e = t.currentTarget;
        if (!(e instanceof FileAttachmentElement)) return;
        ...
        if (n && i.id !== n) return;
        let r = i.files;
        r && 0 !== r.length && (e.attach(r), (i.value = ""));
      }
