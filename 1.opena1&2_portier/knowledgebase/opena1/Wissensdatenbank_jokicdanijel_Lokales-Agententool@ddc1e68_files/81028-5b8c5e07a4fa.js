...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  {
    81028: (t, e, i) => {
      (i.r(e), i.d(e, { default: () => TextExpanderElement }));
          ...
          ((this.input = t),
            ...
            (this.keyboardEventHandler = (t) =>
              (function (t, e) {
                if (
                  ...
                  switch (t.key) {
                    case "Enter":
                      s(e.input, e.list) && t.preventDefault();
                      break;
                    case "Tab":
            ...
            (this.compositionEventHandler = (t) => {
              ...
              return (
                (e = t),
                (i = this),
                void ((i.isComposing = "compositionstart" === e.type),
              ...
              (t.removeAttribute("data-combobox-option-default"),
                r === t
                  ? (this.input.setAttribute("aria-activedescendant", r.id),
                    ...
                    r.scrollIntoView(this.scrollIntoViewOptions))
      ...
      let InputStyleClone = class InputStyleClone extends EventTarget {
        ...
        static for(t) {
          let e = l.get(t);
          return (e || ((e = new InputStyleClone(t)), l.set(t, e)), e);
        }
        constructor(t) {
          (super(),
            ...
            this.#o.appendChild(this.#r),
            (this.#r.style.pointerEvents = "none"),
            (this.#r.style.userSelect = "none"),
            (this.#r.style.overflow = "hidden"),
            (this.#r.style.display = "block"),
            (this.#r.style.visibility = "hidden"),
            t instanceof HTMLTextAreaElement
              ? ((this.#r.style.whiteSpace = "pre-wrap"),
                (this.#r.style.wordWrap = "break-word"))
              : ((this.#r.style.whiteSpace = "nowrap"),
                (this.#r.style.display = "table-cell"),
                (this.#r.style.verticalAlign = "middle")),
            t.after(this.#o),
            this.#e(),
            this.#l(),
            this.#t.observe(t, { attributeFilter: ["style", "dir"] }),
            this.#i.observe(t),
            document.addEventListener("scroll", this.#a, { capture: !0 }),
            window.addEventListener("resize", this.#a, { capture: !0 }),
        ...
        disconnect() {
          (this.#o?.remove(),
            this.#t.disconnect(),
            this.#i.disconnect(),
            document.removeEventListener("scroll", this.#a, { capture: !0 }),
            window.removeEventListener("resize", this.#a, { capture: !0 }));
          let t = this.#u;
          t &&
            (t.removeEventListener("input", this.#h, { capture: !0 }),
            l.delete(t));
        }
        get #u() {
          return this.#s?.deref();
        ...
        #m() {
          this.#c((t) => {
            ...
            ((this.#r.style.height = e.height),
              (this.#r.style.width = e.width),
              t.clientHeight !== this.#r.clientHeight &&
                (this.#r.style.height = `calc(${e.height} + ${t.clientHeight - this.#r.clientHeight}px)`),
              t.clientWidth !== this.#r.clientWidth &&
                (this.#r.style.width = `calc(${e.width} + ${t.clientWidth - this.#r.clientWidth}px)`));
            let i = t.getBoundingClientRect(),
              n = this.#r.getBoundingClientRect();
            ((this.#d = this.#d + i.left - n.left),
              (this.#p = this.#p + i.top - n.top),
              (this.#r.style.transform = `translate(${this.#d}px, ${this.#p}px)`),
              (this.#r.scrollTop = t.scrollTop),
              (this.#r.scrollLeft = t.scrollLeft),
        ...
        #e() {
          this.#c((t) => {
            let e = window.getComputedStyle(t);
            for (let t of a) this.#r.style[t] = e[t];
            this.#n();
          });
        }
        #l() {
          this.#c((t) => {
            ((this.#r.textContent = t.value), this.#m());
          });
        }
        #h = () => this.#l();
        #a = (t) => {
          this.#c((e) => {
            (t.target === document ||
              t.target === window ||
              (t.target instanceof Node && t.target.contains(e))) &&
              this.#n();
          });
        };
      };
      ...
      let InputRange = class InputRange {
        ...
        cloneRange() {
          return new InputRange(this.#v, this.startOffset, this.endOffset);
        }
        ...
        #x() {
          let t = document.createRange(),
            e = this.#r.element.childNodes[0];
          return (
            e && (t.setStart(e, this.startOffset), t.setEnd(e, this.endOffset)),
            t
          );
        }
      };
      ...
      let TextExpander = class TextExpander {
        ...
        activate(t, e) {
          ...
          (this.input === document.activeElement ||
            this.input ===
              (null ==
              (n = null == (i = document.activeElement) ? void 0 : i.shadowRoot)
                ? void 0
                : n.activeElement)) &&
            (this.deactivate(),
            (this.menu = e),
        ...
        positionMenu(t, e) {
          let i = new InputRange(this.input, e).getBoundingClientRect(),
        ...
        onCommit({ target: t }) {
          ...
          let n = this.input.value.substring(0, i.position - i.key.length),
            s = this.input.value.substring(i.position + i.text.length),
          ...
          if (
            ...
            return;
          let r = null != (e = this.expander.getAttribute("suffix")) ? e : " ";
          o.continue && (r = "");
          let l = `${o.value}${r}`;
          this.input.value = n + l + s;
          let a = n.length + l.length;
          (this.deactivate(),
            this.input.focus({ preventScroll: !0 }),
            (this.input.selectionStart = a),
            (this.input.selectionEnd = a),
            o.continue || ((this.lookBackIndex = a), (this.match = null)),
            this.expander.dispatchEvent(
        ...
        findMatch() {
          let t = this.input.selectionEnd || 0,
            e = this.input.value;
          for (let { key: i, multiWord: n } of (t <= this.lookBackIndex &&
          ...
          this.expander.keys)) {
            let s = (function (
              ...
              e,
              i,
              { multiWord: n, lookBackIndex: s, lastMatchPosition: o } = {
                multiWord: !1,
                lookBackIndex: 0,
                lastMatchPosition: null,
              },
            ) {
              let l = t.lastIndexOf(e, i - 1);
              if (-1 === l || l < s) return;
              if (n) {
                if (null != o) {
                  if (o === l) return;
...
`,
                  ...
                  return;
              } else if (t.lastIndexOf(" ", i - 1) > l) return;
              let a = t[l - 1];
              if (!a || r.test(a))
                return {
                  text: t.substring(l + e.length, i),
                  position: l + e.length,
                };
            })(e, i, t, {
              multiWord: n,
            ...
            if (s) return { text: s.text, key: i, position: s.position };
          }
        }
      ...
      let TextExpanderElement = class TextExpanderElement extends HTMLElement {
        get keys() {
          ...
          return e.map((t) => ({ key: t, multiWord: s || n.includes(t) }));
        }
        set keys(t) {
