...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [41155],
  {
    ...
    46865: (e, t, i) => {
      ...
      function s(e, t, i) {
        return e.dispatchEvent(
          new CustomEvent(t, { bubbles: !0, cancelable: i }),
        );
      }
      function n(e, t) {
        (t &&
      ...
      function l(e, t) {
        for (let i in t) {
          ...
          s instanceof HTMLInputElement
            ? (s.value = o)
            : s instanceof HTMLTextAreaElement && (s.value = o);
        }
      }
      function r(e) {
      ...
      function c(e, t) {
        ...
        for (let [e, o] of u(t)) i.append(e, o);
        return i.toString();
      }
      function d(e) {
    ...
    51987: (e, t, i) => {
      ...
      function l(e, t) {
        for (let [i, o] of Object.entries(a(t))) e.set(i, o);
      }
      function r(e) {
    ...
    56038: (e, t, i) => {
      i.d(t, { Kn: () => a, XC: () => s, cg: () => n, fV: () => l });
      let o = "undefined" != typeof FORCE_SERVER_ENV && FORCE_SERVER_ENV,
        s = "undefined" == typeof document || o ? void 0 : document,
        n = "undefined" == typeof window || o ? void 0 : window,
      ...
      function o(e) {
        ...
        if (e.name) {
          ...
          (i ||
            ...
            i.classList.add("js-submit-button-value"),
            t.prepend(i)),
            (i.name = e.name),
            (i.value = s));
        } else i && i.remove();
    ...
    91762: (e, t, i) => {
      var o = i(50467),
        ...
        l = i(46865),
        r = i(51987);
      let u = class NotificationsListSubscriptionFormElement extends HTMLElement {
        async submitCustomForm(e) {
          (await this.submitForm(e), this.closeMenu());
        }
        async submitForm(e) {
          (e.preventDefault(), (0, a.a)());
          let t = e.currentTarget,
            i = new FormData(t),
            o = await self.fetch(t.action, {
              method: t.method,
              body: i,
              headers: { ...(0, r.kt)(), Accept: "application/json" },
            });
          if (!o.ok) return void (0, a.n)();
          let s = await o.json(),
            n = i.get("do");
          ("string" == typeof n && this.updateCheckedState(n),
            "string" == typeof n && this.updateMenuButtonCopy(n),
            this.updateSocialCount(s.count),
            this.applyInputsCheckedPropertiesToAttributesForNextFormReset(),
            this.closeMenu());
        }
        updateMenuButtonCopy(e) {
          ((this.unwatchButtonCopy.hidden =
            "subscribed" !== e && "custom" !== e),
            (this.stopIgnoringButtonCopy.hidden = "ignore" !== e),
            (this.watchButtonCopy.hidden =
              "subscribed" === e || "custom" === e || "ignore" === e));
        }
        applyInputsCheckedPropertiesToAttributesForNextFormReset() {
          for (let e of [...this.threadTypeCheckboxes])
        ...
        updateCheckedState(e) {
          ...
          if ("custom" === e)
            ...
            for (let e of (this.customButton.setAttribute(
              "aria-checked",
              "false",
            ),
        ...
        handleDialogLabelToggle(e) {
          let t = e.detail.wasChecked,
            i = e.detail.toggledLabelId,
            o = e.detail.templateLabelElementClone;
          if (t) {
            for (let e = 0; e < this.subscriptionsLabels.length; e++)
              if (
                this.subscriptionsLabels[e].getAttribute("data-label-id") === i
              ) {
                this.subscriptionsLabels[e].remove();
                break;
              }
            ...
            (o.removeAttribute("hidden"),
              ...
              this.subscriptionsContainer.appendChild(o));
        }
        openCustomDialog(e) {
          (e.preventDefault(),
            e.stopPropagation(),
            ...
            setTimeout(() => {
              this.customDialog
                .querySelector("input[type=checkbox][autofocus]")
                ?.focus();
            }, 0));
        }
        enableApplyButtonAndCheckbox() {
          this.customDialog.querySelectorAll(
            '[data-type="label"]:not([hidden])',
          ).length > 0 &&
        ...
        resetFilterLabelsDialog(e) {
          ...
          (this.subscriptionsContainer.replaceChildren(
            ...Object.values(this.lastAppliedLabels),
          ),
        ...
        enableIssuesCheckbox() {
          ...
          (e &&
            this.threadTypeCheckboxes.length > 0 &&
            (this.threadTypeCheckboxes[0].checked = e),
        ...
        saveCurrentLabelsState() {
          ...
          for (let e = 0; e < this.subscriptionsLabels.length; e++) {
            let t = this.subscriptionsLabels[e].getAttribute("data-label-id");
            t &&
              ((this.lastAppliedLabels[t] =
                this.subscriptionsLabels[e].cloneNode(!0)),
        ...
        constructor(...e) {
          (super(...e), (0, o._)(this, "lastAppliedLabels", {}));
        }
      };
      ((0, s.Cg)([n.aC], u.prototype, "details", void 0),
        (0, s.Cg)([n.aC], u.prototype, "menu", void 0),
        (0, s.Cg)([n.aC], u.prototype, "customButton", void 0),
        (0, s.Cg)([n.aC], u.prototype, "customDialog", void 0),
        (0, s.Cg)([n.aC], u.prototype, "filterLabelsDialog", void 0),
        (0, s.Cg)([n.zV], u.prototype, "subscriptionButtons", void 0),
        (0, s.Cg)([n.zV], u.prototype, "subscriptionsLabels", void 0),
        (0, s.Cg)([n.aC], u.prototype, "labelInputs", void 0),
        (0, s.Cg)([n.aC], u.prototype, "subscriptionsSubtitle", void 0),
        (0, s.Cg)([n.aC], u.prototype, "socialCount", void 0),
        (0, s.Cg)([n.aC], u.prototype, "unwatchButtonCopy", void 0),
        (0, s.Cg)([n.aC], u.prototype, "stopIgnoringButtonCopy", void 0),
        (0, s.Cg)([n.aC], u.prototype, "watchButtonCopy", void 0),
        (0, s.Cg)([n.zV], u.prototype, "threadTypeCheckboxes", void 0),
        (0, s.Cg)([n.aC], u.prototype, "customSubmit", void 0),
        (0, s.Cg)([n.aC], u.prototype, "subscriptionsContainer", void 0),
        (0, s.Cg)([n.zV], u.prototype, "dialogLabelItems", void 0),
        (u = (0, s.Cg)([n.p_], u)));
      ...
      ((0, s.Cg)([n.aC], c.prototype, "details", void 0),
        (c = (0, s.Cg)([n.p_], c)));
      let NotificationsDialogLabelItemElement = class NotificationsDialogLabelItemElement extends HTMLElement {
              ...
              this.dispatchEvent(
                new CustomEvent("notifications-dialog-label-toggled", {
                  detail: {
                    ...
                    templateLabelElementClone:
                      this.hiddenLabelTemplate.cloneNode(!0),
                  },
                  bubbles: !0,
                }),
              ));
      ...
      ((0, o._)(NotificationsDialogLabelItemElement, "attrPrefix", ""),
        (0, s.Cg)(
          [n.aC],
          NotificationsDialogLabelItemElement.prototype,
          "label",
          void 0,
        ),
        (0, s.Cg)(
        ...
        (NotificationsDialogLabelItemElement = (0, s.Cg)(
          [n.p_],
