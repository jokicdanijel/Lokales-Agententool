...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [42892],
  {
    24880: (t, e, i) => {
      ...
      function d(t, e) {
        let { exact: i, status: s, predicate: n, mutationKey: r } = t;
        if (r) {
          if (!e.options.mutationKey) return !1;
          if (i) {
            if (f(e.options.mutationKey) !== f(r)) return !1;
          } else if (!y(e.options.mutationKey, r)) return !1;
        }
            ...
            try {
              if (s) e();
                ...
                (this.#o({ type: "pending", variables: t, isPaused: n }),
                  await this.#r.config.onMutate?.(t, this, i));
    ...
    52775: (t, e, i) => {
      ...
      var s = {
        ...
        n = new (class {
          ...
          setTimeout(t, e) {
            return this.#u.setTimeout(t, e);
          }
          clearTimeout(t) {
            this.#u.clearTimeout(t);
          }
          setInterval(t, e) {
            return this.#u.setInterval(t, e);
          }
          clearInterval(t) {
            this.#u.clearInterval(t);
          }
        })();
      function r(t) {
        setTimeout(t, 0);
    ...
    58904: (t, e, i) => {
      ...
      function l(t) {
        let e,
          ...
          d = () =>
            s.m.isFocused() &&
            ("always" === t.networkMode || n.t.isOnline()) &&
            t.canRun(),
    ...
    71692: (t, e, i) => {
      ...
      var s = i(52775),
        ...
        r = class {
          ...
          clearGcTimeout() {
            this.#c && (s.zs.clearTimeout(this.#c), (this.#c = void 0));
          }
        };
    },
    79757: (t, e, i) => {
        ...
        o = class extends a.k {
          ...
          constructor(t) {
            (super(),
              ...
              (this.observers = []),
              (this.#s = t.client),
              (this.#p = this.#s.getQueryCache()),
              (this.queryKey = t.queryKey),
              (this.queryHash = t.queryHash),
              (this.#l = h(this.options)),
          ...
          isActive() {
            return this.observers.some(
              (t) => !1 !== (0, s.Eh)(t.options.enabled, this),
            );
          }
          isDisabled() {
          ...
          isStatic() {
            return (
              ...
              this.observers.some(
                (t) => "static" === (0, s.d2)(t.options.staleTime, this),
              )
            );
          }
          isStale() {
          ...
          async fetch(t, e) {
            ...
            let n = new AbortController(),
              a = (t) => {
                Object.defineProperty(t, "signal", {
                  enumerable: !0,
                  get: () => ((this.#y = !0), n.signal),
                });
              },
              o = () => {
                let t,
                  i = (0, s.ZM)(this.options, e),
                  n =
                    (a(
                      (t = {
                        client: this.#s,
                    ...
                    t);
                return ((this.#y = !1), this.options.persister)
            ...
            (this.options.behavior?.onFetch(u, this),
              ...
              ("idle" === this.state.fetchStatus ||
                ...
                this.#o({ type: "fetch", meta: u.fetchOptions?.meta }),
              (this.#a = (0, r.II)({
                ...
                onCancel: (t) => {
                  (t instanceof r.cc &&
                    t.revert &&
                    this.setState({ ...this.#d, fetchStatus: "idle" }),
                    n.abort());
                },
                onFail: (t, e) => {
                  this.#o({ type: "failed", failureCount: t, error: e });
            ...
            let e = (e) => {
              switch (t.type) {
                ...
                case "success":
                  ...
                  return ((this.#d = t.manual ? i : void 0), i);
                case "error":
                  let s = t.error;
                  return {
                    ...e,
    ...
    94658: (t, e, i) => {
      ...
      function r(t) {
        let e;
        if ((t.then((t) => ((e = t), t), s.lQ)?.catch(s.lQ), void 0 !== e))
          return { data: e };
      }
    },
    96035: (t, e, i) => {
...
//# sourceMappingURL=42892-4dd551f79d51.js.map
