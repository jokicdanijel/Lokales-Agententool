  ...
  [4290, 19973, 44959],
  {
    14940: (e, t, n) => {
      ...
      function o(e) {
        ...
        let o =
          ...
          (t.textContent = e),
          t);
        return (n.appendChild(o), r(o), n.removeChild(o), Promise.resolve());
      }
      async function i(e) {
          ...
          if (n) (await o(n), i());
            ...
            if (
              !(
                ...
                ("ShadowRoot" in window && n instanceof ShadowRoot)
              )
            )
              return;
            let s = n.getElementById(t);
            s &&
              (await ((a = s) instanceof HTMLInputElement ||
      ...
      n.d(t, { S: () => clipboard_copy_element_ClipboardCopyElement });
      ...
      let u = "undefined" != typeof globalThis ? globalThis : window;
      try {
        u.ClipboardCopyElement =
    ...
    39595: (e, t, n) => {
      ...
      let CatalystDelegate = class CatalystDelegate {
        ...
        connectedCallback(e, t) {
          ...
          (b(e),
          o.add(e),
          e.shadowRoot && (s((r = e.shadowRoot)), a(r)),
          s(e),
          a(e.ownerDocument),
          t?.call(e),
          e.shadowRoot) && (s((n = e.shadowRoot)), a(n), C(e.shadowRoot));
        }
    ...
    50515: (e, t, n) => {
      ...
      let r = {
        ...
        i = { " ": "Space", "+": "Plus" };
      function a(e, t = navigator.platform) {
        var n, l, u;
        let { ctrlKey: d, altKey: f, metaKey: h, shiftKey: p, key: g } = e,
          m = [];
        for (let [e, t] of [d, f, h, p].entries()) t && m.push(s[e]);
        if (!s.includes(g)) {
          let e = m.includes("Alt") && c.test(t) && null != (n = r[g]) ? n : g,
            a = m.includes("Shift") && c.test(t) && null != (l = o[e]) ? l : e,
            s = null != (u = i[a]) ? u : a;
          m.push(s);
        }
        return m.join("+");
      ...
      function l(e, t) {
        let n, r, o;
        {
          var i,
            ...
            l =
              ...
              (o = c.test(
                null !=
                  (s =
                    null != a ? a : null == r ? void 0 : r.navigator.platform)
                  ? s
                  : "",
              )
                ? "Meta"
          ...
          for (let e of ["Control", "Alt", "Meta", "Shift"])
            l.includes(e) && d.push(e);
          return (u && d.push(u), d.join("+"));
        }
      }
      ...
      let SequenceTracker = class SequenceTracker {
        ...
        registerKeypress(e) {
          ((this._path = [...this._path, a(e)]), this.startTimer());
        }
        reset() {
          var e;
          (this.killTimer(),
      ...
      function b(e, t) {
        0 === Object.keys(f.children).length &&
    ...
    97797: (e, t, n) => {
      ...
      ((r.prototype.logDefaultIndexUsed = function () {}),
            ...
            for (
              ...
              ((a = (u = c[r]).key),
                (s = (function (e, t) {
                  ...
                  (((s = Object.create(i)).map = new o()), f.push(s)),
                i === this.indexes.default && this.logDefaultIndexUsed(n),
                (l = s.map.get(a)) || ((l = []), s.map.set(a, l)),
                l.push(n));
            (this.size++, h.push(e));
          }
        }),
        ...
        (r.prototype.queryAll = function (e) {
          ...
          for (t = 0, r = d.length; t < r; t++)
            for (n = 0, i = d[t], o = (a = this.matches(i)).length; n < o; n++)
              (c[(l = a[n]).id]
                ? (s = c[l.id])
                : ((s = {
                    id: l.id,
          ...
          if (t) {
            ...
            if (n.length) {
              ...
              for (var r = 0, o = n.length; r < o && !g.get(e); r++) {
                var i = n[r];
                b.set(e, i.node);
                for (var a = 0, s = i.observers.length; a < s && !m.get(e); a++)
      ...
      function C(e, t, n) {
        var o =
          ...
          a = i ? p : h,
          s = a[e];
        (s || ((s = new r()), (a[e] = s), document.addEventListener(e, A, i)),
          s.add(t, n));
      }
      function S(e, t, n) {
...
//# sourceMappingURL=4290-030607d0bdad.js.map
