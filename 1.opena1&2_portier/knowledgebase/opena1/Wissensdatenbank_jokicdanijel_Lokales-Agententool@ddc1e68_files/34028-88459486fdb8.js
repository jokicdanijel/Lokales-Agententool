  ...
  [34028, 71555, 74807],
  {
    3398: (c, e, t) => {
      ...
      let i = ({
          ...
          (0, a.jsx)(l.EY, {
            ...
            className: (0, r.$)(
              i ? (0, r.$)("sr-only", o) : o,
              "InputLabel-module__Text--xY8s7",
            ),
            ...d,
            children: t
              ? (0, a.jsxs)("span", {
                  className: "InputLabel-module__Box--dyD6H",
                  children: [
                    (0, a.jsx)("div", {
                      className: "InputLabel-module__Box_1--HuT0E",
                      children: c,
                    }),
        ...
        n = i;
      try {
        i.displayName || (i.displayName = "InputLabel");
      } catch {}
    },
    8625: (c, e, t) => {
      t.d(e, { H: () => l });
      var a = t(96540);
      let l = ({ inputRef: c, fallbackEventHandler: e }) =>
        (0, a.useCallback)(
          (t, a, l) => {
            var r, i;
            let n,
            ...
            let d = a ?? [
              ...
              m =
                void 0 === l
                  ? ((r = s.selectionStart ?? s.value.length),
                    (i = t.length),
                    (n = d[1] - d[0]),
                    r < d[0] ? r : r < d[1] ? d[0] + i : r + (i - n))
                  : Array.isArray(l)
                    ? l[0]
                    : l,
              z = Array.isArray(l) ? l[1] : m,
              u = !1;
            try {
              if (document.activeElement !== s)
                throw Error("Input must be focused to use execCommand");
              (s.setSelectionRange(d[0], d[1]),
                (u =
                  "" === t
                    ? document.execCommand("delete", !1)
                    : document.execCommand("insertText", !1, t)),
                s.setSelectionRange(m, z));
            } catch {
              u = !1;
            }
            if (
              ...
              let a,
                l = s.value.slice(0, d[0]) + t + s.value.slice(d[1]),
                r = new InputEvent("input", { bubbles: !1 });
              ((c.current.value = l),
                c.current.setSelectionRange(m, z),
                c.current.dispatchEvent(r),
                e(
                  ((a = c.current),
                  {
                    ...r,
                    ...
                    isDefaultPrevented: () => r.defaultPrevented,
    ...
    9880: (c, e, t) => {
      ...
      let o = { triggerChar: "@" },
        d = (c) => ({
          ...
          render: (e) =>
            (0, a.jsxs)(i.l.Item, {
              ...
              children: [
                c.avatarUrl &&
                  (0, a.jsx)(i.l.LeadingVisual, {
                    children: (0, a.jsx)(r.r, { size: 16, src: c.avatarUrl }),
                  }),
                (0, a.jsx)("span", {
                  className:
                    "use-mention-suggestions-module__identifierText--jeSK0",
                  children: c.identifier,
                }),
                " ",
                (0, a.jsx)(i.l.Description, {
                  truncate: !0,
        ...
        m = (c, e) => {
          let t = Math.max(
            (0, l.dt)(c, e.identifier),
            (0, l.dt)(c, e.description),
          );
          return t === l.IP
            ? t
            : t > 0 && e.participant
        ...
        z = (c, e) =>
          c.participant && !e.participant
            ? -1
            : e.participant && !c.participant
              ? 1
              : c.identifier.localeCompare(e.identifier),
        u = (c) => ({
          calculateSuggestions: (0, n.useMemo)(() => (0, s.C)(c, m, z, d), [c]),
          trigger: o,
        });
    },
    10242: (c, e, t) => {
      ...
      let r = ({ feedbackUrl: c }) =>
        (0, a.jsx)(l.A, {
          className: "FeedbackLink-module__link--Ga4DP",
          href: c,
          children: "Give feedback",
        });
      try {
        r.displayName || (r.displayName = "FeedbackLink");
      } catch {}
    },
    13659: (c, e, t) => {
      t.d(e, { Z: () => n });
      var a = t(74848),
        ...
        i = t(84174);
      let n = ({
        children: c = "Private preview",
        feedbackUrl: e,
        className: t,
      }) =>
        (0, a.jsx)(i.V, {
          className: t,
          label: (0, a.jsx)(l.A, { variant: "secondary", children: c }),
          link: e ? (0, a.jsx)(r.A, { feedbackUrl: e }) : void 0,
        });
      try {
        n.displayName || (n.displayName = "AlphaLabel");
      } catch {}
    },
    16049: (c, e, t) => {
      t.d(e, { QM: () => p, fU: () => h, jw: () => f, zL: () => n });
      var a = t(69599),
        l = t(51987),
        r = t(96379),
        i = t(96540);
      let n = [
        ...
        d = [".webp"];
      async function m(c, e, t) {
        let a = new FormData(),
          { name: l, size: i, type: n } = c;
        return (
          e && a.append("repository_id", e),
          t &&
            (a.append("upload_container_type", "project"),
            a.append("upload_container_id", t)),
          a.append("name", l),
          a.append("size", i.toString()),
          a.append("content_type", n),
          await (0, r.DI)("/upload/policies/assets", {
            body: a,
            method: "POST",
          })
        );
      }
      async function z(c, e, t) {
        let {
            upload_authenticity_token: a,
            upload_url: l,
            header: r,
            form: i,
            same_origin: n,
          ...
          s = new FormData();
        for (let c in (n && s.append("authenticity_token", a), i))
          s.append(c, i[c]);
        return (s.append("file", e), t)
          ? (({ url: c, formData: e, headers: t, onProgress: a }) =>
              new Promise((l, r) => {
                let i = new XMLHttpRequest();
                for (let [e, a] of (i.open("POST", c),
                (i.responseType = "blob"),
                Object.entries(t)))
                  void 0 !== a && i.setRequestHeader(e, a);
                (a(0),
                  (i.upload.onprogress = (c) => a(c.loaded)),
                  (i.onerror = () => r(TypeError("Network request failed"))),
                  (i.onabort = () =>
                    r(new DOMException("Aborted", "AbortError"))),
                  (i.onload = () => {
                    try {
                      let c = i.response ?? i.responseText ?? "",
                        e = ((c) => {
                          let e = new Headers();
                          for (let t of c.trim().split(/\r?\n/)) {
                            if (!t) continue;
                            let c = t.indexOf(":");
                            if (-1 === c) continue;
                            let a = t.slice(0, c).trim(),
                              l = t.slice(c + 1).trim();
                            a && e.append(a, l);
                          }
                          return e;
                  ...
                  i.send(e));
              }))({ url: l, formData: s, headers: r, onProgress: t })
          : await fetch(l, { headers: { ...r }, method: "post", body: s });
      }
      async function u(c, e) {
        let t =
            "string" == typeof c.asset_upload_url ? c.asset_upload_url : null,
          a =
            "string" == typeof c.asset_upload_authenticity_token
              ? c.asset_upload_authenticity_token
              : null;
        if (t && a) {
          let c = new FormData();
          return (
            c.append("authenticity_token", a),
            await fetch(t, {
              method: "PUT",
              body: c,
              credentials: "same-origin",
              headers: { Accept: "application/json", ...(0, l.kt)() },
            })
          );
        }
        return e;
      }
      async function p(c, e, t, a) {
        let l = await m(c, e, t);
        if (!l.ok) throw Error("Upload failed");
        let r = await l.json(),
          i = await z(r, c, a);
        if (!i.ok) throw Error("Upload failed");
        let n = await u(r, i);
        if (!n.ok) throw Error("Upload failed");
        let { href: s } = await n.json();
        if ("string" != typeof s) throw Error("Upload failed");
        return (a?.(c.size), { url: s, file: c });
      }
      function f(c) {
        let e = [
            ...n,
            ...((0, a.G7)("webp_support") ? d : []),
            ...s,
            ...((0, a.G7)("issues_expanded_file_types") ? o : []),
          ],
          t = [...n, ...((0, a.G7)("webp_support") ? d : [])];
        return c ? e : t;
      }
      function h(c, e) {
        return (0, i.useCallback)(async (t, a) => p(t, c, e, a), [c, e]);
      }
    },
    26076: (c, e, t) => {
      t.d(e, { G: () => h });
      var a = t(74848),
        ...
        d = t(50463);
      let m = (c) => {
          let e = c.match(/^ {0,3}(`{3,}|~{3,})[^`]*$/);
          return e ? e[1] : null;
        },
        z = (c, e) => RegExp(`^ {0,3}${e}${e[0]}* *$`).test(c),
        u = (c) => "string" == typeof c?.taskBox,
        p = (c) => ({ ...c, taskBox: "[ ]" === c.taskBox ? "[x]" : "[ ]" });
      var f = t(34164);
      let h = (0, l.forwardRef)(function (
        {
          ...
          disabled: M = !1,
          onLinkClick: g,
          openLinksInNewTab: v = !1,
          teamHovercardsEnabled: x = !1,
          className: y,
        },
        C,
      ) {
        let [w, b] = (0, l.useState)(null),
          k = (0, l.useRef)(null);
        (0, r.T)(C, k);
        let j = (0, l.useCallback)((c) => {
          ((k.current = c), b(c));
        }, []);
        return (
          (({
            ...
            let n = (0, l.useCallback)(
                (c) => () => {
                  let e = i.current.split(/\r?\n/),
                    a = null;
                  for (let l = 0, r = 0; l < e.length; l++) {
                    let n = e[l];
                    if (a) {
                      if (z(n, a)) {
                        a = null;
...
`);
              ...
              (0, l.useEffect)(
                function () {
                  ...
                  for (let [e, t] of s.entries()) {
                    let a = n(e);
                    t.addEventListener("change", a, { signal: c.signal });
                  }
                  return () => {
                    c.abort();
                  };
          ...
          (0, l.useMemo)(
            () =>
              e
                ? (0, a.jsx)("div", {
                    className:
                      "MarkdownViewer-module__MarkdownViewerContainer--h7BF_",
                ...
                : (0, a.jsx)(n.vb, {
                    ...
                    html: c,
                    ...(x ? { "data-team-hovercards-enabled": !0 } : {}),
                  }),
            [y, e, x, c, j],
          )
        );
      ...
      try {
        h.displayName || (h.displayName = "MarkdownViewer");
      } catch {}
    },
    41185: (c, e, t) => {
      t.d(e, { H: () => l, T: () => r });
      ...
      function r() {
        return [
          a.$t.readOnly.of(!0),
          a.$t.transactionFilter.of((c) =>
            c.docChanged && !c.annotation(l) ? [] : c,
          ),
        ];
      }
    },
    ...
    44854: (c, e, t) => {
      ...
      try {
        s.displayName || (s.displayName = "MarkdownEditorContext");
      } catch {}
      let o = ({ children: c }) => (0, r.jsx)(r.Fragment, { children: c });
      o.displayName = "MarkdownEditor.Actions";
      let d = (0, n.forwardRef)((c, e) => {
        let { disabled: t } = (0, n.useContext)(s);
        return (0, r.jsx)(i.Q, { disabled: t, ...c, ref: e });
      });
      d.displayName = "MarkdownEditor.ActionButton";
      var m = t(38621),
        z = t(57919);
      let u = ({ children: c }) => {
          let [e, t] = (0, z.H)(c, { footerButtons: f });
          return (0, r.jsxs)("div", {
            className: "Footer-module__footer--rjRmQ",
            "data-testid": "markdown-editor-footer",
            children: [
              (0, r.jsxs)("div", {
                className: "Footer-module__footerWrapper--ObMEq",
                children: [
                  (0, r.jsx)(h, {}),
                  e.footerButtons &&
                    (0, r.jsx)("div", {
                      className: "Footer-module__footerButtonWrapper--TedKn",
                      children: e.footerButtons,
                    }),
                ],
              }),
              (0, r.jsx)("div", {
                className: "Footer-module__childrenStyling--cH0iq",
                children: t,
              }),
            ],
          });
        },
        p = ({ children: c }) => (0, r.jsx)(u, { children: c });
      p.displayName = "MarkdownEditor.Footer";
      let f = (0, n.forwardRef)((c, e) => {
        let { disabled: t } = (0, n.useContext)(s);
        return (0, r.jsx)(i.Q, { size: "small", disabled: t, ...c, ref: e });
      });
      f.displayName = "MarkdownEditor.FooterButton";
      let h = (0, n.memo)(() => {
        let { uploadButtonProps: c, fileDraggedOver: e } = (0, n.useContext)(s);
        return c ? (0, r.jsx)(M, { fileDraggedOver: e, ...c }) : null;
      });
      h.displayName = "MarkdownEditor.DefaultFooterButtons";
      let M = (0, n.memo)(({ fileDraggedOver: c, ...e }) => {
        let { disabled: t, fileUploadProgress: a } = (0, n.useContext)(s),
          l = a?.[0],
          o = a?.[1],
          d = !!o,
          z =
            1 === o
              ? "Uploading your file..."
              : `Uploading your files... (${l}/${o})`;
        return (0, r.jsxs)(i.Q, {
          variant: "invisible",
          loadingAnnouncement: d ? z : void 0,
          leadingVisual: m.PaperclipIcon,
          loading: d,
          size: "small",
          className: "Footer-module__footerButton--zxnP6",
          onMouseDown: (c) => {
            c.preventDefault();
          },
          disabled: t,
          ...
          children: [
            (0, r.jsx)("span", {
              className: "Footer-module__condensed--o9bUn",
              children: "Add Files",
            }),
            (0, r.jsx)("span", {
              className: "Footer-module__spacious--VlAKA",
              children: c
                ? "Drop to add files"
      ...
      M.displayName = "MarkdownEditor.FileUploadButton";
      try {
        u.displayName || (u.displayName = "CoreFooter");
      } catch {}
      var g = t(3398);
      let v = ({ ...c }) => {
        let { disabled: e, required: t } = (0, n.useContext)(s);
        return (0, r.jsx)(g.A, {
          as: "legend",
          disabled: e,
          required: t,
          className: "Label-module__inputLabel--EMji4",
          ...c,
        });
      };
      v.displayName = "MarkdownEditor.Label";
      let x = (c) => (0, r.jsx)(v, { ...c });
      var y = t(69599),
        C = t(21728),
        w = t(45230),
      ...
      let T = (c, e) => {
          try {
            ...
            if (t && t.node) {
              ...
              try {
                (c.setStart(t.node, t.offset), c.setEnd(t.node, t.offset));
              } catch {
                return null;
              }
        ...
        L = b.Z9.fromClass(
          ...
          class {
            update(c) {
              if (!c.selectionSet) return;
              let e = T(c.view, c.state.selection.main.head);
              e &&
                e.left > 0 &&
                (0, E._)(this, l, {
            ...
            get lastStableCaretPos() {
              return (0, S._)(this, l);
            }
            constructor() {
              (0, I._)(this, l, { writable: !0, value: null });
            }
          }),
          {
            eventObservers: {
              click(c, e) {
                this.lastStableCaretPos &&
                  (function (c, e) {
                    let t = c.state.selection.main;
                    if (!t.empty) return;
                    let a = T(c, t.head);
                    if (!a) return;
                    let l = {
                        x: a.left + window.scrollX,
                        y: a.top + window.scrollY,
                      },
                      r = Math.hypot(l.x - e.x, l.y - e.y);
                    if (l.x > 0 && r >= 25) {
                      var i, n;
                      let e,
                        t,
                        r =
                          (e = document.elementFromPoint(a.left, a.top)) &&
                          c.dom.contains(e)
                        ...
                        s =
                          ...
                          ((t = document.createElement("div")).className =
                            "caret-flash-module__caretFlash--Y2C9R"),
                          (t.style.left = `${i}px`),
                          (t.style.top = `${n}px`),
                          t.setAttribute("data-testid", "caretFlash"),
                          t.style.setProperty("--text-font-size", r),
                          t.addEventListener(
                            "animationend",
                            () => {
                              t.remove();
                  ...
                  })(e, this.lastStableCaretPos);
              },
            },
          },
        );
      var A = t(53839);
      let P = class DropIndicatorWidget extends b.xO {
          toDOM() {
            let c = document.createElement("div");
            return (
              (c.className = "drop-indicator-module__dropIndicator--f94gz"),
              c
            );
          }
          eq() {
        ...
        D = A.sU.define({
          create: () => null,
          update: (c, e) => {
            for (let c of e.effects) if (c.is(R)) return c.value;
            return c;
          },
        });
      function $(c) {
        return null === c
          ? b.NZ.none
          : b.NZ.set([b.NZ.widget({ widget: new P(), side: -1 }).range(c)]);
      }
      let O = A.sU.define({
        create: (c) => $(c.field(D)),
        update: (c, e) =>
          e.effects.some((c) => c.is(R)) ? $(e.state.field(D)) : c,
        provide: (c) => b.Lz.decorations.from(c),
      });
      function F(c) {
        return c.dataTransfer?.types.includes("Files") ?? !1;
      }
      let H = [
        D,
        O,
        b.Lz.domEventHandlers({
          dragenter: (c, e) =>
            !!F(c) && (e.dispatch({ effects: [R.of(0)] }), !0),
          dragover(c, e) {
            if (!F(c)) return !1;
            let t = e.posAtCoords({ x: c.clientX, y: c.clientY });
            return (
              null !== t &&
              (e.dispatch({ effects: [R.of(t)] }),
          ...
          dragleave(c, e) {
            ...
            return (
              !(t && e.dom.contains(t)) &&
              (e.dispatch({ effects: [R.of(null)] }), !1)
            );
          },
          drop(c, e) {
            if (!F(c)) return !1;
            let t = e.posAtCoords({ x: c.clientX, y: c.clientY });
            return null !== t && (e.dispatch({ effects: [R.of(t)] }), !0);
          },
        }),
      ];
      var B = t(47970),
        V = t(76814);
      let U = {
          first: { prefix: "", digits: 1, suffix: ". " },
          parse(c) {
            let e = c.match(
              /^(?<prefix>\s*)(?<digits>\d{1,9})(?<suffix>[.)]\s*)$/,
            )?.groups;
            return e ? { ...e, digits: parseInt(e.digits, 10) } : void 0;
          },
          serialize: (c) => `${c.prefix}${c.digits}${c.suffix}`,
          increment: (c) => ({
            ...c,
            digits: Math.min(c.digits + 1, 0x3b9ac9ff),
          }),
          reset: (c) => ({ ...c, digits: 1 }),
        },
        W = { prefix: "[", value: "x", suffix: "] " },
        q = { prefix: "[", value: " ", suffix: "] " },
        K = (c) =>
          c.match(/^(?<prefix>\[)(?<value>[ xX])(?<suffix>\]\s*)$/)?.groups;
      function G(c) {
        let e = U.parse(c);
        return e ? U.serialize(U.increment(e)) : c;
      }
      function Z(c) {
        let e = U.parse(c);
        return e ? U.serialize(U.reset(e)) : c;
      }
      function Q(c) {
        return c ? U.serialize(U.first) : "* ";
      }
      function Y(c) {
      ...
      function X(c) {
        ...
        return (
          (0, B.YR)(c, (c) =>
            e.listItemPrefix
              ? ("delimiter" === c.type &&
                  "taskListCheck" === c.tokenType &&
                  (e.taskListPrefix = c),
                V.dc)
              : ("delimiter" === c.type &&
                    "listItemPrefix" === c.tokenType &&
                    (e.listItemPrefix = c),
                  "list" === c.type)
                ? V._Z
                : void 0,
...
`,
      ...
      function ca(c) {
        return (
          void 0 !== c.position &&
          void 0 !== c.position.start &&
          void 0 !== c.position.end &&
          "number" == typeof c.position.start.offset &&
          "number" == typeof c.position.end.offset
        );
      }
      function cl(c, e) {
        return ca(c) && ca(e)
          ? c.position.start.offset !== e.position.start.offset
            ? c.position.start.offset - e.position.start.offset
            : c.position.end.offset - e.position.end.offset
          : 0;
      }
      function cr(c, e, t, a) {
        return (c >= t && c < a) || (e > t && e <= a) || (c < t && e > a);
      }
      function ci(c, e, t) {
        let a = [];
        return (
          (0, B.YR)(c, (c) => {
            if (ca(c))
              if (!cr(e, t, c.position.start.offset, c.position.end.offset))
                return V._Z;
              else a.push(c);
          }),
          a
      ...
      function cn(c, e, t) {
        return c.children.filter(
          (c) =>
            ca(c) && cr(e, t, c.position?.start.offset, c.position.end.offset),
        );
      }
      function cs(c, e, t, a, l) {
        return l ? c >= t && e <= a : c >= t && e <= a && (c !== t || e !== a);
      }
      function co(c, e, t, a) {
        let l = [];
        return (
          (0, B.YR)(c, (c) => {
            if (ca(c))
              if (!cs(e, t, c.position.start.offset, c.position.end.offset, a))
                return V._Z;
              else l.push(c);
          }),
          l
      ...
      function cd(c, e) {
        ...
        return (
          (0, B.YR)(c, (c) => {
            if (ca(c))
              if (
                !cs(e, e, c.position.start.offset, c.position.end.offset) ||
                "text" === c.type ||
                "delimiter" === c.type
              )
                return V._Z;
      ...
      function cm(c, e) {
        return {
          column: c.column + e.column - 1,
          line: c.line + e.line - 1,
          offset: (c.offset ?? 0) + (e.offset ?? 0),
        };
      }
      function cz(c, e, t) {
        (c.children ?? (c.children = []),
          c.children.splice(e, 0, t),
          ca(c) &&
            ca(t) &&
            (t.position.start.offset < c.position.start.offset
              ? Object.assign(c.position.start, t.position.start)
              : t.position.end.offset > c.position.end.offset &&
                Object.assign(c.position.end, t.position.end)));
      }
      function cu(c, e) {
        return (
          ca(c) && ca(e) && c.position.end.offset === e.position.start.offset
        );
      }
      function cp(c, e, t = !1) {
        let a = c.children?.splice(e, 1)[0];
        return (
          t &&
            a &&
            ca(c) &&
            ca(a) &&
            (a.position.start.offset === c.position.start.offset
              ? Object.assign(c.position.start, a.position.end)
              : a.position.end.offset === c.position.end.offset &&
                Object.assign(c.position.end, a.position.start)),
          a
        );
      }
      function cf(c, e) {
        if (c === e) return !0;
        if (c.size !== e.size) return !1;
        for (let t of c) if (!e.has(t)) return !1;
        return !0;
      }
      let ch =
        () =>
        (...c) =>
          new Set(c);
      function cM(c) {
        return c.endsWith("/") ? c.slice(0, c.length - 1) : c;
      }
      let cg = ch()(
          "break",
          "delete",
      ...
      function cx(c) {
        ((0, V.VG)(c, "list", (c, e) => {
          let t = e.at(-1),
            a = (t?.children?.indexOf(c) ?? -1) + 1;
          if (!t || 0 === a) return;
          let l = c.children.at(-1);
          for (
            ;
            l?.type === "delimiter" && "blockQuotePrefix" === l.tokenType;
          )
            (!(function (c, e = !1) {
              cp(c, -1, e);
            })(c, !0),
          ...
          (0, B.YR)(c, (c) => {
            let e = null;
            for (let [l, r] of (function* (c) {
              if (c.children)
                for (let e = c.children.length - 1; e >= 0; e--) {
                  let t = c.children[e];
                  t && (yield [e, t]);
                }
            })(c)) {
              ...
              if ("listItem" === r.type) {
                for (; e?.type === "delimiter" && cv.has(e.tokenType); )
                  (cp(c, l + 1),
                    (a = e),
                    cz(r, r.children?.length ?? 0, a),
                    (e = c.children?.[l + 1] ?? null));
                e &&
                  !cu(r, e) &&
                  ca(r) &&
                  ca(e) &&
                  (r.position.end = { ...e.position.start });
              }
              e = r;
            }
          }));
      ...
      var cy = new WeakMap(),
        cC = new WeakMap(),
        cw = new WeakMap();
      let MarkdownLine = class MarkdownLine {
        get prefixes() {
          var c, e, t;
          let a;
          return (0, E._)(
            ...
            (0, S._)(this, cw) ??
              ...
              (0, B.YR)(c, (c) => {
                if (!ca(c)) return;
                let l = c.position.start.offset,
                  r = c.position.end.offset;
                if (!cr(e, t, l, r)) return V._Z;
                l >= e && r <= t && a.push(c);
              }),
              a).filter((c) => "delimiter" === c.type && cv.has(c.tokenType)),
          );
        }
        get contentStart() {
          return this.prefixes.at(-1)?.position?.end.offset ?? this.start;
        }
        get content() {
          return (0, S._)(this, cC).slice(this.contentStart, this.end);
        }
        get isBlank() {
          return void 0 !== K(this.content) || 0 === this.content.trim().length;
        }
        previous() {
          return 0 === this.start
            ? null
            : MarkdownLine.atOffset(
                (0, S._)(this, cy),
                (0, S._)(this, cC),
                this.start - 1,
              );
        ...
        next() {
          return this.end >= (0, S._)(this, cC).length
            ? null
            : MarkdownLine.atOffset(
                (0, S._)(this, cy),
                (0, S._)(this, cC),
        ...
        overlaps(c, e) {
          return (
            (c >= this.start && c < this.end) ||
            (e > this.start && e <= this.end) ||
            (c <= this.start && e >= this.end)
          );
        }
        static atOffset(c, e, t) {
          let a =
            t < 0 || t > e.length ? null : { start: cc(e, t), end: ce(e, t) };
          return a && new MarkdownLine(c, e, a.start, a.end);
        }
        static linesAtRange(c, e, t, a) {
          return ct(e, t, a).map(
            ({ start: t, end: a }) => new MarkdownLine(c, e, t, a),
          );
        }
        constructor(c, e, t, a) {
          ((0, J._)(this, "start", void 0),
            (0, J._)(this, "end", void 0),
            (0, I._)(this, cy, { writable: !0, value: void 0 }),
            (0, I._)(this, cC, { writable: !0, value: void 0 }),
            (0, I._)(this, cw, { writable: !0, value: null }),
            (0, E._)(this, cy, c),
            (0, E._)(this, cC, e),
            (this.start = t),
            (this.end = a));
      ...
      var cb = t(52301),
        ...
        cj = t(7711),
        c_ = t(74313);
      let cN = "dataDelimiter";
      function cS(c) {
        let e = [];
        for (let t of c.children ?? []) "delimiter" === t.type && e.push(t);
        return e;
      }
      let cI = { tableDelimiter: "td", tableDelimiterRow: "tr" };
      function cE(c) {
        let e = { [cN]: c.tokenType },
          t = c.children?.length ? c.children.map(cE) : c.raw,
          a = (0, c_.h)(cI[c.tokenType] ?? "span", e, t);
        return (
          ca(c) &&
            (a.position = {
      ...
      let cT = (c, e) => {
          ...
          if ("element" === t.type) {
            let c = cS(e).map(cE);
            t.children?.length
              ? (t.children = [...t.children, ...c].sort(cl))
              : (t.children = c);
          } else if ("text" === e.type) return [t, ...cS(e).map(cE)];
          return t;
        },
        cL = {
          handlers: {
      ...
      var cP = t(91775),
        cR = t(55035);
      function cD(c, e) {
        return "element" === c.type && c.tagName === e;
      }
      function c$(c) {
        if (!c) return {};
        let e = {};
        for (let t of Object.getOwnPropertyNames(c))
          e[(0, cP.I)(cR.qy, t).attribute] = c[t];
        return e;
      }
      let cO = new Set([
        "github.com",
      ...
      function cF(c) {
        (0, B.YR)(c, "element", (c, e, t) => {
          if (!t || "number" != typeof e || !cD(c, "p")) return;
          let a = c.children.filter(
            (c) =>
              "element" === c.type ||
              ("text" === c.type && "" !== c.value.trim()),
          );
          if (1 !== a.length) return;
          let l = a[0];
          if (l?.type !== "element" || !cD(l, "a")) return;
          let r = l.properties?.href;
          if (
            !(function (c) {
      ...
      let cV = (0, t(36380).A)(
        ...
        cH.j,
        {
          ...
          tagNames: ["video"],
          attributes: {
            video: ["controls", "src", "preload", "playsinline", "aria-label"],
          },
        },
        { attributes: { "*": [cA] } },
        { attributes: { "*": [cN] } },
        (c, e) => (Array.isArray(c) && Array.isArray(e) ? c.concat(e) : void 0),
      );
      var cU = t(86350),
        cW = t(54157),
        cq = t(84600);
      ...
      function cG(c) {
        if (c.data.delimiterStack?.length) return c.data.delimiterStack.at(-1);
        let e = c.stack.at(-1);
        if (e?.type === "fragment") {
          let e = c.stack.at(-2);
      ...
      let cZ = function (c) {
          ...
          if (t) {
            ...
            (t.children ?? (t.children = []),
              t.children.push(e),
              (a = this.data).delimiterStack ?? (a.delimiterStack = []),
              this.data.delimiterStack.push(e));
          }
          return !1;
        },
        cQ = function (c) {
          let e = this.data.delimiterStack?.pop();
          if (e?.tokenType !== c.type)
            throw Error(`Expected open '${c.type}' delimiter on stack`);
          return ((this.data.lastExitedDelimiterToken = c), !1);
        },
        cY = function (c) {
          let e = cG(this);
          return (
            e?.type === "code" &&
              this.data.lastExitedDelimiterToken?.type === "codeFencedFence" &&
              cZ.call(this, c),
            !1
          );
        },
        ...
        cJ = function (c) {
          let e = cG(this),
            t = e?.children?.at(-1);
          return (
            c.end.offset - c.start.offset == 1 &&
            t?.type === "delimiter" &&
            "listItemPrefix" === t.tokenType &&
            ca(t) &&
            c.start.offset === t.position.end.offset
              ? ((t.position.end = { ...c.end }),
                (t.raw += this.sliceSerialize(c)))
              : cZ.call(this, c),
            !1
          );
        },
        ...
        c0 = function (c) {
          ...
          if (
            ...
            !(
              (e = t.children[1]) &&
              "delimiter" === e.type &&
              "whitespace" === e.tokenType
            )
          ) {
            this.exit(c);
            let e = this.stack.at(-1);
            (e.children.pop(),
              e.children.push({
                type: "paragraph",
                position: t.position,
                ...
                ? (function (c) {
                    ...
                    return (
                      new c3._F(
                        ...
                        {
                          onCharacter: ({ location: c }) => a("text", c),
                          onWhitespaceCharacter: ({ location: c }) =>
                            a("text", c),
                          onNullCharacter: ({ location: c }) => a("text", c),
                          onStartTag: ({ location: c }) => a("startTag", c),
                          onEndTag: ({ location: c }) => a("endTag", c),
                          onDoctype: ({ location: c }) => a("doctype", c),
                          onComment: ({ location: c }) => a("comment", c),
                          onEof: c2.l,
                          onParseError: c2.l,
                        },
                      ).write(c, !0),
                    ...
                    let t = c.value.slice(
                      ...
                      a = {
                        start: cm(c.position.start, e.position.start),
                        end: cm(c.position.start, e.position.end),
                      };
                    switch (e.type) {
                      case "text":
                        return [{ type: "text", value: t, position: a }];
                      case "endTag":
                        return [
                          {
                            type: "delimiter",
                      ...
                      case "comment":
                      case "doctype":
                        return [{ type: "html", value: t, position: a }];
                    }
                  })
                : []),
            );
      ...
      function c6(c) {
        let e = c.doc.toString(),
          t = (function (
            c,
            { enabledExtensions: e = c5.enabledExtensions } = c5,
          ) {
            return (0, cU.Y)(c, "utf-8", {
              extensions: [(0, cq.T)()],
              mdastExtensions: [
                (0, cW.C)(),
                e.delimiters
                  ? {
                      enter: {
                        ...Object.fromEntries(cK.map((c) => [c, cZ])),
                        lineEnding: cY,
                        linePrefix: cJ,
                      },
                      exit: {
                        ...Object.fromEntries(cK.map((c) => [c, cQ])),
                        lineEnding: cX,
                        linePrefix: c1,
                      },
                    }
                  : [],
                e.containDelimiters ? { transforms: [cx] } : [],
                e.splitHtml ? { transforms: [c4] } : [],
                e.skipEmptyHeadings ? { exit: { atxHeading: c0 } } : [],
              ],
            });
          })(e),
          a = (function (c, e, t = !0) {
            let a,
              ...
              r,
              i,
              n = (0, ck._)(c, { ...cL, allowDangerousHtml: !0 });
            if (
              ((0, B.YR)(n, "element", (c) => {
                let e = null;
                for (let t of c.children)
                  if ("element" === t.type) {
                    if (
                      e &&
                      (function (c, e) {
                        if (c.tagName !== e.tagName) return !1;
                        if (!c.properties && !e.properties) return !0;
                        if (!c.properties || !e.properties) return !1;
                        let t = Object.keys(c.properties).filter(
                          (c) => c !== cA,
                        );
                        if (
                          t.length !==
                          Object.keys(e.properties).filter((c) => c !== cA)
                            .length
                        )
                          return !1;
                        for (let a of t)
                          if (c.properties[a] !== e.properties[a]) return !1;
                        return !0;
                      })(t, e)
                    ) {
                      let c =
                        "number" == typeof e.properties?.[cA]
                          ? e.properties[cA]
                          : -1;
                      t.properties[cA] = c + 1;
                    }
...
`)),
              ...
              (0, V.VG)(
                s,
                (c, e) => {
                  if (e.length <= i) return V.dc;
                  ((i = e.length),
                    "element" === c.type &&
                      ca(c) &&
                      !(c.position.end.offset >= r.offset) &&
                      (c.position.end = { ...r }));
                },
                !0,
              ));
        ...
        return { markdownTree: t, htmlTree: a };
      }
      let c7 = A.Pe.define(),
        c8 = b.Z9.define((c) => {
          let e = null;
          return {
            update: (t) => {
              t.docChanged &&
                (e && clearTimeout(e),
                (e = setTimeout(() =>
                  c.dispatch({ effects: c7.of(c6(c.state)) }),
                )));
            },
          };
        }),
        c9 = A.sU.define({
          create: c6,
          update: (c, e) => e.effects.find((c) => c.is(c7))?.value ?? c,
          provide: () => [c8],
        });
      function ec(c) {
        return c.field(c9).markdownTree;
      }
      function ee(c) {
        return c.field(c9).htmlTree;
      }
      function et(c) {
        return c.effects.some((c) => c.is(c7));
      }
      function ea(c) {
        return A.EY.of([c]);
      }
...
`),
      ...
      let er = [
          ...
          ...((a = [
            ...
            { mac: "Mod-Backspace" },
            { mac: "Mod-Delete" },
            ...[{ key: "Ctrl-a" }, { key: "Ctrl-e" }, { key: "Ctrl-k" }].map(
              (c) => ({ mac: c.key }),
            ),
          ]),
          w.ZR.filter(
            (c) =>
              !a.find(
                (e) =>
                  (e.mac && c.mac && e.mac === c.mac) ||
                  ("key" in e && c.key && e.key === c.key),
              ),
          )),
        ],
        ei = [
          A.$t.lineSeparator.of(String.fromCodePoint(57344)),
          A.Nb.low(b.w4.of(er)),
        ],
        en = A.YH.define(),
        es = [
          ...
          A.$t.transactionFilter.of((c) => {
            ...
            if (
              ...
              return c;
            let t = ec(c.startState),
              a = c.startState.doc.toString(),
              l = [];
            c.changes.iterChanges((c, r, i, n, s) => {
              let o = s.toString();
              if (
                !o.includes(`
`)
              ...
              let d = (function (c, e) {
                switch (e) {
                  case "escapeBlockquote":
                    return c.slice(
                      0,
                      c.findLastIndex(
                        (c) => "blockQuotePrefix" === c.tokenType,
                      ),
                    );
                  case "escapeList":
                    return c.slice(
              ...
              })(MarkdownLine.atOffset(t, a, c)?.prefixes ?? [], e)
                .map((c) =>
                  "listItemPrefix" === c.tokenType ? Y(c.raw) : c.raw,
                )
                .join("");
              if ("" === d) return;
              let m = ea(d);
              for (let e of (function (c, e) {
                let t = [],
                  a = c.indexOf(e);
                for (; -1 !== a; )
                  (t.push(a), (a = c.indexOf(e, a + e.length)));
                return t;
              })(
                o,
                `
`,
                ...
                l.push({ from: c + e + 1, insert: m });
            });
            let r = A.VR.of(l, c.newDoc.length);
            return [
              c,
              {
                sequential: !0,
                changes: r,
                annotations: [en.of("all")],
                selection: c.newSelection.map(r, 1),
              },
            ];
          }),
        ],
        eo = (c) =>
          c.map((c) =>
            c.prefixes.filter((c) => "blockQuotePrefix" === c.tokenType),
          ),
        ed = (c) => {
          if (
            1 !== c.state.selection.ranges.length ||
            !c.state.selection.main.empty
          )
            return !1;
          let e = c.state.doc.toString(),
            t = c.state.selection.main.anchor,
            a = ec(c.state),
            l = MarkdownLine.atOffset(a, e, t);
          if (!l?.isBlank) return !1;
          let r = l.prefixes.at(-1);
          if (r?.tokenType !== "blockQuotePrefix") return !1;
          let i = r.position?.start.offset ?? l.start,
            n = "",
            s = i;
          return (
            l.previous()?.isBlank === !1 &&
              ((n += `
`),
              (s += 1)),
            l.next()?.isBlank === !1 &&
...
`),
            c.dispatch({
              changes: [{ from: i, to: l.end, insert: ea(n) }],
              selection: A.OF.single(s),
              annotations: [en.of("escapeBlockquote")],
      ...
      function em(c) {
        return 1 === c.selection.ranges.length && !c.selection.main.empty;
      }
      function ez(c) {
        let e = c.selection.main.anchor,
          t = c.doc.toString(),
          a =
            t.slice(0, e).lastIndexOf(`
`) + 1,
          l = t.indexOf(
            `
`,
        ...
        return (-1 === l && (l = t.length), { from: a, to: l });
      }
      function eu(c, e) {
        let t = e,
          a = e;
        for (; t > 0 && c[t - 1] && !/\s/.test(c[t - 1]); ) t--;
        for (; a < c.length && c[a] && !/\s/.test(c[a]); ) a++;
        return { start: t, end: a };
      }
      function ep(c) {
        let e = c.state.selection.main.anchor,
          t = cd(ec(c.state), e);
        return t?.type === "code";
      }
      let ef = (c) => {
          let { from: e } = ez(c.state);
          return (
            !!ep(c) &&
            (em(c.state)
              ? c.dispatch(
                  c.state.changeByRange((c) => ({
                    changes: [{ from: e, insert: ea("	") }],
                    range: A.OF.range(c.from + 1, c.to + 1),
                    userEvent: "input.type",
                    scrollIntoView: !0,
                  })),
                )
        ...
        eh = (c) => {
          let e = c.state.selection.main.anchor,
            t = c.state.doc.toString(),
            { from: a, to: l } = ez(c.state);
          if (ep(c)) {
            let r = t.slice(a, l);
            return r.startsWith("	")
              ? (c.dispatch({
                  changes: [{ from: a, to: a + 1, insert: ea("") }],
                  userEvent: "input.type",
                  scrollIntoView: !0,
                }),
                !0)
              : !r.startsWith("    ") ||
                  (c.dispatch({
                    changes: [{ from: a, to: a + 4, insert: ea("") }],
                    selection: A.OF.single(e - 4),
                    userEvent: "input.type",
                    scrollIntoView: !0,
                  }),
                  !0);
        ...
        eM = (c, e, t) => [...ci(c, e, t)].find((c) => "heading" === c.type),
        eg = (c, e) => {
          let t;
          c.hasFocus || c.focus();
          let a = ec(c.state),
            l = c.state.doc.toString(),
            r = c.state.selection.main,
            i = MarkdownLine.linesAtRange(a, l, r.from, r.to),
            n = `${"#".repeat(e)} `,
            s = i.map((c) => eM(a, c.start, c.end)),
            o = !(s.length > 0 && s.every((c) => c?.depth === e)),
            d = [];
          for (let c of i) {
            let e = eM(a, c.start, c.end),
              l = null;
            if (e)
              for (let t of e.children ?? []) {
                if (!ca(t) || "delimiter" !== t.type) continue;
                let e = "atxHeadingSequence" === t.tokenType,
                  a = "setextHeadingLine" === t.tokenType;
                if (e || a) {
                  if (((l = t), e))
                    d.push({
                      from: t.position.start.offset,
                      to: t.position.end.offset + 1,
                    });
                  else {
                    let e = c.next();
                    e && d.push({ from: e.start, to: e.end });
                  }
                  break;
                }
              }
            if (o) {
              d.push({ from: c.start, insert: n });
              let e =
                l &&
                ca(l) &&
                cs(
        ...
        ev = { strong: "**", emphasis: "_", inlineCode: "`", delete: "~~" },
        ex = {
          "*": "*",
          _: "_",
          $: "$",
      ...
      function eC(c) {
        let e = ec(c),
          t = c.selection.main;
        return co(e, t.from, t.to, !0);
      }
      let ew = A.sU.define({
        create: eC,
        update: (c, e) =>
          !e.startState.selection.eq(e.newSelection) || et(e) ? eC(e.state) : c,
        provide: () => [c9],
      });
      function eb(c) {
        return c.field(ew);
      ...
      function ek(c) {
        let e = new Set();
        for (let t of c) e.add(t.type);
        return e;
      }
      let ej = (c, e) => eb(c.state).findLast((c) => c.type === e),
        e_ = (c) =>
          c.children ? c.children.filter((c) => "delimiter" === c.type) : [],
        eN = (c, e) => {
          let t = e_(e).filter(ca);
          if (0 === t.length) return;
          let a = t.map((c) => ({
            from: c.position.start.offset,
            to: c.position.end.offset,
          }));
          c.dispatch({ changes: a, userEvent: "input", scrollIntoView: !0 });
        },
        eS = (c, e, t) => {
          c.dispatch(
            c.state.changeByRange((c) => ({
              changes: [
                { from: c.from, insert: e },
                { from: c.to, insert: t },
              ],
              range: A.OF.range(c.from + e.length, c.to + e.length),
              userEvent: "input",
              scrollIntoView: !0,
            })),
          );
        ...
        eI = (c, e) => {
          c.hasFocus || c.focus();
          let t = ej(c, e);
          if (t) return (eN(c, t), !0);
          let a = ev[e];
          if (em(c.state)) eS(c, a, a);
          else {
            let e = [...eb(c.state)].find((c) => "text" === c.type);
            ((c, e, t, a) => {
              let l = c.state.selection.main.anchor,
                r = a?.value && ca(a),
                { text: i, offset: n } = r
                  ? { text: a.value, offset: l - a.position.start.offset }
                  : { text: c.state.doc.toString(), offset: l },
                s = r ? a.position.start.offset : 0,
                { start: o, end: d } = eu(i, n);
              c.dispatch({
                changes: [
                  { from: o + s, insert: ea(e) },
                  { from: d + s, insert: ea(t) },
                ],
                selection: { anchor: l + e.length },
                userEvent: "input",
                scrollIntoView: !0,
              });
            })(c, a, a, e);
        ...
        eE = (c) => {
          let e = c?.children?.some(
              (c) => "delimiter" === c.type && "labelMarker" === c.tokenType,
            ),
            t = c?.children?.some(
              (c) => "delimiter" === c.type && "resource" === c.tokenType,
            );
          return e && t;
        };
      function eT(c, e, t) {
        let a = [];
        for (let l of c.children.slice(e + 1))
          if ("listItem" === l.type) {
            let c = X(l).listItemPrefix;
            if (!c || !ca(c)) continue;
            let e = null === t ? Z(c.raw) : G(t);
            (a.push({
              from: c.position.start.offset,
              to: c.position.end.offset,
              insert: e,
      ...
      function eL(c) {
        return c.filter((c) => "listItem" === c.type && ca(c));
      }
      function eA(c) {
        if (1 !== c.selection.ranges.length) return null;
        let e = c.selection.main.from,
          t = c.selection.main.to,
          a = co(ec(c), e, t),
          l = a.findLastIndex((c) => "list" === c.type),
          r = a[l];
        if (!r) return null;
        let i = eL(cn(r, e, t));
        ...
        for (let c of n)
          if ("listItem" === c.type) {
            let e = s.at(-1);
            e && (e.item = c);
          } else "list" === c.type && s.push({ list: c, item: void 0 });
        return { list: r, selectedItems: i, parents: s };
      }
      let eP = (c) => {
          if (1 !== c.state.selection.ranges.length) return !1;
          let e = ec(c.state),
            t = c.state.doc.toString(),
            a = eA(c.state);
          if (!a) return !1;
          let l = a?.parents.at(-1),
            r = l && X(l.item).listItemPrefix?.raw,
            i = a.selectedItems.map((c) =>
              MarkdownLine.linesAtRange(
                e,
                t,
                c.position.start.offset,
                c.position.end.offset - 1,
              ).map((c, e) => {
                let t =
                    0 === e
                      ? c.prefixes.findLast(
                          (c) => "listItemPrefix" === c.tokenType,
                        )
                      : void 0,
                  a = c.prefixes.findLast(
                    (c) => "listItemIndent" === c.tokenType,
                  ),
                  l =
                    0 === e
                      ? c.prefixes.find((c) => "taskListCheck" === c.tokenType)
                      : void 0,
                  i =
            ...
            n = a.list.children.indexOf(a.selectedItems.at(-1));
          n > -1 && i.push(eT(a.list, n, null));
          let s = [];
          if (l) {
            let c = l.list.children.indexOf(l.item);
            i.push(eT(l.list, c, r ?? ""));
          } else {
            for (let c of a.selectedItems) {
              let { taskListPrefix: e } = X(c);
              e &&
                ca(e) &&
                i.push({
                  from: e.position.start.offset,
                  to: e.position.end.offset,
                });
            }
            let c = MarkdownLine.atOffset(
              e,
              t,
              a.selectedItems[0].position.start.offset - 1,
            );
            c?.prefixes.some(
              (c) =>
                "listItemPrefix" === c.tokenType ||
...
`,
            ...
            let l = MarkdownLine.atOffset(
              e,
              t,
              a.selectedItems.at(-1).position.end.offset + 1,
            );
            (l?.prefixes.some(
              (c) =>
                "listItemPrefix" === c.tokenType ||
...
`,
        ...
        eR = (c) => {
          ...
          if (
            ...
            return !1;
          let t = c.state.doc.toString(),
            a = c.state.selection.main.anchor,
            l = ec(c.state),
            r = MarkdownLine.atOffset(l, t, a);
          return (
            !!r &&
            ((e = r.prefixes.at(-1)),
            !!r.isBlank && e?.tokenType === "listItemPrefix") &&
            eP(c)
          );
        };
      function eD(c, e, t, a) {
        let l = [],
          r = null;
        for (let i of eL(t.children))
          for (let [t, n] of MarkdownLine.linesAtRange(
            c,
            e,
            i.position.start.offset,
            i.position.end.offset - 1,
          ).entries())
            if (0 === t) {
              let c = n?.prefixes.find((c) => "listItemPrefix" === c.tokenType);
              if (!c || !ca(c)) continue;
              let e = r ? G(r) : Q(a);
              (l.push({
                from: c.position.start.offset,
              ...
              let c = n?.prefixes.find((c) => "listItemIndent" === c.tokenType);
              if (!c || !r || !ca(c) || c.raw.length === r.length) continue;
              l.push({
                from: c.position.start.offset,
                to: c.position.end.offset,
                insert: ea(Y(r)),
      ...
      let e$ = (c) => (e) => {
          let t = ec(e.state),
            a = e.state.doc.toString(),
            l = e.state.selection.main,
            r = Array.from(co(t, l.from, l.to, !0)).findLast(
              (c) => "list" === c.type,
            );
          if (r)
            if ((r.ordered ?? !1) !== c)
              ...
              return ((c) => {
                let e = ec(c.state),
                  ...
                  a = eA(c.state);
                if (!a) return !1;
                let l = a.parents.length,
                  r = [];
                for (let c of eL(a.list.children))
                  for (let a of MarkdownLine.linesAtRange(
                    e,
                    t,
                    c.position.start.offset,
                    c.position.end.offset - 1,
                    ...
                    let c = (function (c, e) {
                      for (let t of c.prefixes)
                        if (
                          "listItemIndent" === t.tokenType ||
                          "listItemPrefix" === t.tokenType
                        ) {
                          if (0 === e) return t;
                          e--;
          ...
          let i = cn(t, l.from, l.to),
            n = 0;
          for (; 1 === i.length && "blockquote" === i[0].type; )
            ((i = cn(i[0], l.from, l.to)), n++);
          let s = null,
            o = [];
          for (let [e, r] of i.entries()) {
            ...
            let d = ca(r)
              ...
              : [];
            for (let [t, a] of d.entries()) {
              if (a.isBlank) continue;
              let m = (function (c, e) {
                if (0 === e) return c.start;
                for (let t of c.prefixes)
                  if ("blockQuotePrefix" === t.tokenType && 0 == --e)
                    return t.position?.end.offset ?? c.start;
                return c.start;
              })(a, n);
              if ("paragraph" !== r.type || a.overlaps(l.from, l.to)) {
                if (0 === t || "paragraph" === r.type) {
                  let e = a.previous(),
                    t = e && e.isBlank;
                  null === s &&
                    e &&
...
`),
                  ...
                  let l = null === s || t ? Q(c) : G(s);
                  (o.push({ from: m, insert: ea(l) }), (s = l));
                } else s && o.push({ from: m, insert: ea(Y(s)) });
                if (e === i.length - 1 && t === d.length - 1) {
                  let c = a.next();
                  c &&
                    !c.isBlank &&
                    o.push({
...
`),
          ...
          return (
            e.dispatch({ changes: o, scrollIntoView: !0, userEvent: "input" }),
            !0
          );
        },
        eO = e$(!1),
        eF = e$(!0);
      function eH(c, e) {
        let t = c.children.filter((c) => "listItem" === c.type);
      ...
      let eB = (c) => {
          ...
          let l = (function (c) {
            ...
            for (; !a; ) {
              let c = l.pop();
              if (!c) return null;
              ((e = c.list), (t = [c.item]), (a = eH(e, c.item)));
            }
            return { list: e, items: t, previousSibling: a };
          })(a);
          if (!l || !l.items[0]) return !0;
          let r = X(l.previousSibling).listItemPrefix?.raw ?? "* ",
            i = " ".repeat(r.length),
            n = l.previousSibling.children
              ?.findLast((c) => "list" === c.type)
              ?.children?.findLast((c) => "listItem" === c.type),
            s = n
              ? G(X(n).listItemPrefix?.raw ?? "* ")
              : Z(X(l.items[0]).listItemPrefix?.raw ?? "* "),
            o = l.items.map((c) => {
              if (!ca(c)) return [];
              let a = -1;
              return MarkdownLine.linesAtRange(
                e,
                t,
                c.position.start.offset,
                c.position.end.offset - 1,
                ...
                if (0 === e) {
                  a = c.prefixes.findIndex(
                    (c) => "listItemPrefix" === c.tokenType,
                  );
                  let e = {
                    from: c.prefixes[a]?.position?.start?.offset ?? c.start,
                    to: c.prefixes[a]?.position?.end?.offset ?? c.contentStart,
                    insert: `${i}${s}`,
                  };
                  return ((s = G(s)), e);
                }
            ...
            d = l.list.children.indexOf(l.items.at(-1));
          return (
            o.push(eT(l.list, d, r)),
            c.dispatch({ scrollIntoView: !0, userEvent: "input", changes: o }),
            !0
          );
        },
        eV = (c) => {
          let e,
            ...
            a = t?.selectedItems[0];
          if (!a) return !1;
          let { listItemPrefix: l, taskListPrefix: r } = X(a),
            i = l?.raw;
          if (!i) return !1;
          let n = G(i);
          (n.endsWith(" ") || (n += " "),
            r && (n += ((e = q), `${e.prefix}${e.value}${e.suffix}`)));
          let s = t.selectedItems.at(-1),
            o = t.list.ordered ? eT(t.list, t.list.children.indexOf(s), n) : [];
          return (
            c.dispatch(
              c.state.replaceSelection(`
${n}`),
              {
                annotations: [en.of("escapeList")],
                userEvent: "input",
                scrollIntoView: !0,
                changes: o,
              },
        ...
        eU = (c) => {
          ...
          return (
            t?.type === "link" &&
            (window.open(t.url, "_blank", "noopener,noreferrer"), !0)
          );
        },
        eW = {
          key: "Mod-k",
          run: (c) => {
            let e, t, a;
            c.hasFocus || c.focus();
            let l = c.state.selection.main,
              r = ej(c, "link");
            if (r && eE(r)) return (eN(c, r), !0);
            let { start: i, end: n } = em(c.state)
              ? { start: l.from, end: l.to }
              : eu(c.state.doc.toString(), l.anchor);
            return (
              r
                ? ((e = "[]("), (t = ")"), (a = i + 1))
                : ((e = "["), (t = "]()"), (a = n + 3)),
        ...
        eq = { key: "Mod-b", run: (c) => eI(c, "strong") },
        eK = { key: "Mod-i", run: (c) => eI(c, "emphasis") },
        eG = { key: "Mod-e", run: (c) => eI(c, "inlineCode") },
        eZ = {
          key: "Mod-Shift-.",
          run: (c) => {
            let e, t;
            ...
            if (
              ((e = 0 === n.length),
              (t = n.some((c) => 0 === c.length)),
              e || t)
            ) {
              if (1 === i.length && i[0]?.isBlank)
                return (
                  c.dispatch({
                    changes: [{ from: r.from, insert: ea("> ") }],
              ...
              let e = [];
              for (let c of i)
                c.prefixes.some((c) => "blockQuotePrefix" === c.tokenType) ||
                  e.push({ from: c.start, insert: ea("> ") });
              c.dispatch({
                changes: e,
                userEvent: "input",
                scrollIntoView: !0,
              ...
              let e = [...new Set(n.map((c) => c.length))].sort(
                  (c, e) => c - e,
                ),
                t = ci(a, r.from, r.to).find((c) => "blockquote" === c.type);
              if (!t || !ca(t)) return !0;
              let i = t.position.start.offset,
                s = t.position.end.offset,
                o = eo(MarkdownLine.linesAtRange(a, l, i, s)),
                d = [];
              for (let c of o) {
                let t = !1,
                  a = 0;
                ...
                l &&
                  ...
                  a < c.length &&
                  ca(l) &&
                  d.push({ from: l.position.start.offset, insert: ea(" ") });
              }
              c.dispatch({
                changes: d,
                userEvent: "input",
        ...
        eQ = { key: "Mod-8", run: eO },
        eY = { key: "Mod-7", run: eF },
        eX = { key: "Mod-Alt-1", run: (c) => eg(c, 1) },
        eJ = { key: "Mod-Alt-2", run: (c) => eg(c, 2) },
        e1 = { key: "Mod-Alt-3", run: (c) => eg(c, 3) },
        e0 = { key: "Mod-Alt-4", run: (c) => eg(c, 4) },
        e2 = { key: "Mod-Alt-5", run: (c) => eg(c, 5) },
        e3 = { key: "Mod-Alt-6", run: (c) => eg(c, 6) },
        e4 = { key: "Mod-Shift-x", run: (c) => eI(c, "delete") },
        e5 = Object.keys(ex).map((c) => ({
          key: c,
          run: (e) => {
      ...
      var e6 = t(18651);
      let e7 = A.Pe.define(),
        e8 = (0, e6.U0)() ? "Meta" : "Ctrl",
        e9 = b.Lz.domEventObservers({
          keydown(c, e) {
            c.key !== e8 || tt(e.state) || e.dispatch({ effects: e7.of(!0) });
          },
          keyup(c, e) {
            c.key === e8 && tt(e.state) && e.dispatch({ effects: e7.of(!1) });
          },
          blur(c, e) {
            tt(e.state) && e.dispatch({ effects: e7.of(!1) });
          },
        }),
        tc = A.sU.define({
          create: () => !1,
          update: (c, e) => e.effects.find((c) => c.is(e7))?.value ?? c,
          provide: () => [e9],
        }),
        te = [tc];
      function tt(c) {
      ...
      var ta = t(31164);
      let tl = A.Pe.define(),
        tr = b.Lz.domEventObservers({
          keydown(c, e) {
            "Shift" !== c.key ||
              ts(e.state) ||
              e.dispatch({ effects: tl.of(!0) });
          },
          keyup(c, e) {
            "Shift" === c.key &&
              ts(e.state) &&
              e.dispatch({ effects: tl.of(!1) });
          },
          blur(c, e) {
            ts(e.state) && e.dispatch({ effects: tl.of(!1) });
          },
        }),
        ti = A.sU.define({
          create: () => !1,
          update: (c, e) => e.effects.find((c) => c.is(tl))?.value ?? c,
          provide: () => [tr],
        }),
        tn = [ti];
      function ts(c) {
      ...
      let to = ch()(
        ...
        td = [
          tn,
          b.Lz.clipboardInputFilter.of(function (c, e) {
            var t, a;
            let l;
            if (
              ts(e) ||
              ...
              !(function (c) {
                try {
                  let e = new URL(c);
                  return cM(e.href).trim() === cM(c).trim();
                } catch {
                  return !1;
                }
              })(c)
              ...
              return c;
            let { from: r, to: i } = e.selection.main,
              n = ec(e);
            return cd(n, r) === cd(n, i) &&
              ((t =
                co(n, r, i, !1).findLast(
                  (c) => "text" !== c.type && "delimiter" !== c.type,
                ) ?? n),
              to.has(t.type))
              ? ((a = {
                  type: "link",
                  children: [{ type: "text", value: e.sliceDoc(r, i) }],
                  url: c,
                }),
                (l = (0, ta.l)(a)),
                "root" !== a.type && (l = l.slice(0, -1)),
                l)
              : c;
          }),
        ];
      var tm = t(71381);
      let tz = [
        b.Lz.contentAttributes.of({
          spellcheck: "true",
          autocorrect: "on",
          autocapitalize: "sentences",
          writingsuggestions: "true",
        }),
        (0, tm.u)({ indentUnit: 2, indentWithTabs: !1, lineWrapping: !0 }),
        A.$t.languageData.of(() => [{ wordChars: "'" }]),
      ];
      var tu = t(59518),
        tp = new WeakMap();
      let CharacterReferenceWidget = class CharacterReferenceWidget
        extends b.xO
      {
        toDOM() {
          let c = document.createElement("span");
          return ((c.textContent = (0, tu.L)((0, S._)(this, tp))), c);
        }
        eq(c) {
          return (0, S._)(c, tp) === (0, S._)(this, tp);
        }
        constructor(c) {
          (super(),
            (0, I._)(this, tp, { writable: !0, value: void 0 }),
            (0, E._)(this, tp, c));
        }
      };
      var tf = new WeakMap(),
        th = new WeakMap();
      let VoidElementWidget = class VoidElementWidget extends b.xO {
        toDOM(c) {
          let e = document.createElement((0, S._)(this, tf).tagName);
          for (let [c, t] of Object.entries(c$((0, S._)(this, tf).properties)))
            e.setAttribute(c, String(t));
          return ((0, S._)(this, th) && e.classList.add((0, S._)(this, th)), e);
        }
        eq(c) {
          return (
            c instanceof VoidElementWidget &&
            (0, S._)(c, tf).tagName === (0, S._)(this, tf).tagName &&
            JSON.stringify((0, S._)(c, tf).properties) ===
              JSON.stringify((0, S._)(this, tf).properties) &&
            (0, S._)(c, th) === (0, S._)(this, th)
          );
        }
        ignoreEvent() {
          return !1;
        ...
        constructor(c, e) {
          (super(),
            (0, I._)(this, tf, { writable: !0, value: void 0 }),
            (0, I._)(this, th, { writable: !0, value: void 0 }),
            (0, E._)(this, tf, c),
            (0, E._)(this, th, e));
        }
      };
      let tM = new VoidElementWidget((0, c_.h)("span")),
        tg = A.Pe.define(),
        tv = A.sU.define({
          create: () => new Set(),
          update(c, e) {
            let t = c;
            for (let a of e.effects) a.is(tg) && (t = new Set([...c, a.value]));
            return t;
          },
        }),
        tx = [tv];
      let VideoElementWidget = class VideoElementWidget extends VoidElementWidget {
        toDOM(c) {
          let e = super.toDOM(c);
          return (
            e.addEventListener("error", () => {
              var t;
              ((t = e.src), c.dispatch({ effects: [tg.of(t)] }));
            }),
            e
          );
        }
      ...
      let ty = A.Pe.define(),
        tC = b.Lz.focusChangeEffect.of((c, e) => ty.of(e)),
        tw = A.sU.define({
          create: () => !1,
          update: (c, e) => e.effects.find((c) => c.is(ty))?.value ?? c,
          provide: () => [tC],
        }),
        tb = [tw],
        tk = A.Pe.define(),
        tj = b.Lz.domEventObservers({
          mousedown: (c, e) => {
            (e.dom.ownerDocument.addEventListener(
              "mouseup",
              () => {
                e.dispatch({ effects: tk.of(!1) });
              },
              { once: !0, capture: !0 },
            ),
              e.dispatch({ effects: tk.of(!0) }));
          },
        }),
        t_ = A.sU.define({
          create: () => !1,
          update: (c, e) => e.effects.find((c) => c.is(tk))?.value ?? c,
          provide: () => [tj],
        }),
        tN = [t_];
      function tS(c) {
        return c.field(tw) ? c.selection : null;
      }
      let tI = A.sU.define({
        create: tS,
        update: (c, e) => (e.state.field(t_) ? c : tS(e.state)),
        provide: () => [tb, tN],
      });
      function tE(c) {
        return c.field(tI);
      ...
      function tT(c) {
        let e = tE(c),
          t = ee(c),
          a = new Set();
        for (let c of e?.ranges ?? [])
          for (let e of ci(t, c.from, c.to)) a.add(e);
        return a;
      }
      let tL = A.sU.define({
        create: tT,
        update: (c, e) => {
          let t, a;
          return ((t = tE(e.startState)),
          (t !== (a = tE(e.state)) && (null === t || null === a || !t.eq(a))) ||
            et(e))
            ? tT(e.state)
            : c;
        },
      ...
      let tP = (c) => c.some((c) => c.active && "element" === c.node.type),
        tR = new Set([
          "h1",
          "h2",
          "h3",
      ...
      function tD(c) {
        ...
        return (
          (0, V.VG)(e, (e, l) => {
            if (!ca(e)) return;
            let r = l.map((c) => ({ node: c, active: t.has(c) })),
              i = (function (c, e, t, a) {
                switch (c.type) {
                  case "comment":
                    return {
                      tagName: "code",
                      class: "style-contents-module__comment--vr2yb",
                    };
                  case "element":
                    return (function (c, e, t, a) {
                      var l;
                      let r = (0, N.$)(
                        e && "style-contents-module__activeBlock--pGRde",
                        tR.has(c.tagName) &&
                          "style-contents-module__block--xt63X",
                      );
                      switch (c.tagName) {
                        case "a":
                          if (
                            ...
                            c.children.some(
                              (c) =>
                                "element" === c.type &&
                                c.properties?.dataDelimiter === "resource",
                            )
                          )
                            return;
                          break;
                        case "table":
                          if (e) return { tagName: "div", class: r };
                          break;
                        case "tr":
                        case "th":
                        case "td":
                        case "thead":
                        case "tbody":
                          if (t.some((c) => c.active && cD(c.node, "table")))
                            return;
                          break;
                        case "details":
                          return { tagName: "div", class: r };
                        case "summary":
                          return {
                            tagName: "div",
                            class: "style-contents-module__summary--SGmJn",
                          };
                        case "img":
                        case "hr":
                          return e
                            ? { tagName: "div", class: r }
                            : { widget: new VoidElementWidget(c, r) };
                        case "video":
                          return e ||
                            ((l =
                              "string" == typeof c.properties?.src
                                ? c.properties.src
                                : ""),
                            a.field(tv).has(l))
                            ? {
                                ...
                                class: (0, N.$)(
                                  r,
                                  "style-contents-module__muted--NlAx0",
                                ),
                              }
                            : { widget: new VideoElementWidget(c, r) };
                        case "br":
                          return;
                        case "span": {
                          let e,
                            a =
                              "string" == typeof (e = c.properties?.[cN])
                                ? e
                                : null;
                          if (!a) break;
                          let l =
                            c.children[0]?.type === "text"
                              ? c.children[0].value
                              : "";
                          if ("characterReference" === a && !tP(t))
                            return { widget: new CharacterReferenceWidget(l) };
                          if ("resourceDestination" === a && tP(t))
                            return { tagName: "a", attributes: { href: l } };
                          if ("taskListCheck" === a && !tP(t)) {
                            let c = K(l)?.value.toLowerCase() === "x";
                            return {
                              widget: new VoidElementWidget({
                                type: "element",
                                tagName: "input",
                                properties: {
                                  type: "checkbox",
                          ...
                          if (
                            ...
                            c.children.some(
                              (c) =>
                                "element" === c.type &&
                                "span" === c.tagName &&
                                c.properties?.dataDelimiter ===
                                  "setextHeadingLine" &&
                                c.children?.[0]?.type === "text" &&
                                1 === c.children[0].value.trim().length,
                            )
                          )
                            return { tagName: "div", class: r };
                      }
                      let { className: i, ...n } = c.properties;
                      return {
                        tagName: c.tagName,
                        class: (0, N.$)(r, i),
                        attributes: c$(n),
            ...
            if (i) {
              let c =
                "widget" in i
                  ? b.NZ.replace(i)
                  : b.NZ.mark({ ...i, inclusive: !0 });
              ((c.startSide = l.length),
                a.add(e.position.start.offset, e.position.end.offset, c));
            }
          }),
          ca(e) &&
            a.add(
              e.position.end.offset,
              e.position.end.offset,
              b.NZ.widget({ widget: tM, side: 1e4 }),
            ),
          a.finish()
        );
      }
      let t$ = A.sU.define({
        ...
        update: (c, e) => {
          let t = et(e);
          if (e.docChanged && !t) return c.map(e.changes);
          return t || !cf(tA(e.startState), tA(e.state)) ? tD(e.state) : c;
        },
        provide: (c) => [c9, tL, b.Lz.outerDecorations.from(c), tx],
      });
      let UploadPlaceholderWidget = class UploadPlaceholderWidget extends b.xO {
        eq(c) {
          let e = this.data,
            t = c.data;
          return (
            e.fileName === t.fileName &&
            e.mediaKind === t.mediaKind &&
            e.progressPercent === t.progressPercent &&
            e.previewUrl === t.previewUrl
          );
        }
        toDOM() {
          let c = document.createElement("div");
          ((c.className = "upload-placeholder-module__container--tvm5W"),
            c.setAttribute("role", "status"),
            c.setAttribute("aria-live", "polite"),
            c.setAttribute("aria-label", `Uploading ${this.data.fileName}`));
          let e = document.createElement("div");
          if (
            ((e.className = "upload-placeholder-module__preview--IwQZs"),
            c.append(e),
            this.data.previewUrl && this.data.mediaKind)
          )
            if ("video" === this.data.mediaKind) {
              let c = document.createElement("video");
              ((c.src = this.data.previewUrl),
                (c.className =
                  "upload-placeholder-module__previewVideo--uYPCC"),
                (c.muted = !0),
                (c.playsInline = !0),
                (c.preload = "metadata"),
                c.setAttribute("aria-hidden", "true"),
                (c.style.maxWidth = "96px"),
                (c.style.maxHeight = "96px"),
                (c.style.height = "auto"),
                e.append(c));
            } else {
              let c = document.createElement("img");
              ((c.src = this.data.previewUrl),
                (c.alt = this.data.fileName),
                (c.className =
                  "upload-placeholder-module__previewImage--jYY6X"),
                (c.style.maxWidth = "96px"),
                (c.style.maxHeight = "96px"),
                (c.style.height = "auto"),
                e.append(c));
            ...
            let c = document.createElement("span");
            ((c.className =
              "upload-placeholder-module__previewFallback--iCkdi"),
              (c.textContent = (function (c, e) {
                if (e) {
                  let [, c] = e.split("/");
                ...
                let t = c.split(".");
                return (
                  (t.length > 1 ? t.at(-1) : void 0)?.toUpperCase() ?? "FILE"
                );
              })(this.data.fileName, this.data.mimeType)),
              e.append(c));
          }
          let t = document.createElement("div");
          ((t.className = "upload-placeholder-module__body--X7fy0"),
            c.append(t));
          let a = document.createElement("div");
          ((a.className = "upload-placeholder-module__fileName--srJaB"),
            (a.textContent = this.data.fileName),
            t.append(a));
          let l = document.createElement("progress");
          return (
            (l.className = "upload-placeholder-module__progress--qzTL0"),
            (l.max = 100),
            l.setAttribute("aria-label", "Upload progress"),
            "number" == typeof this.data.progressPercent
              ? ((l.value = this.data.progressPercent),
                (l.textContent = `${this.data.progressPercent}%`))
              : (l.removeAttribute("value"), (l.textContent = "")),
            t.append(l),
            c
          );
        }
        ...
        constructor(c) {
          (super(), (0, J._)(this, "data", void 0), (this.data = c));
        }
      };
      let tO = A.Pe.define(),
        tF = A.Pe.define(),
        tH = A.Pe.define(),
        tB = A.sU.define({
          create: () => ({ entries: new Map(), decorations: b.NZ.none }),
          update: (c, e) => {
            let t = new Map(c.entries),
              a = !1,
              l = new Set();
            for (let c of e.effects)
              if (c.is(tO)) {
                let { id: e, ...l } = c.value;
                (t.set(e, l), (a = !0));
              } else if (c.is(tF) && t.has(c.value.id)) {
                let e = t.get(c.value.id);
                (t.set(c.value.id, {
                  ...e,
                  data: { ...e.data, ...c.value.data },
                }),
                  (a = !0));
              } else if (c.is(tH) && t.has(c.value.id)) {
                let e = t.get(c.value.id);
                for (let [a, r] of (t.delete(c.value.id), t))
                  r.position === e.position && r.order > e.order && l.add(a);
                a = !0;
              }
            if (e.docChanged && t.size > 0)
              for (let [c, r] of t) {
                let i = e.changes.mapPos(
                  r.position,
                  l.has(c) ? 1 : -1,
                  A.iR.TrackDel,
                );
                i !== r.position &&
                  (null === i ? t.delete(c) : t.set(c, { ...r, position: i }),
                  (a = !0));
              }
            if (!a) return c;
            let r = new A.vB();
            for (let c of Array.from(t.values()).sort((c, e) =>
              c.position !== e.position
                ? c.position - e.position
                : c.order - e.order,
            )) {
              let e = b.NZ.replace({
                widget: new UploadPlaceholderWidget(c.data),
              });
              ((e.startSide = c.order), r.add(c.position, c.position, e));
            }
            return { entries: t, decorations: r.finish() };
          },
          provide: (c) => b.Lz.decorations.from(c, (c) => c.decorations),
        }),
        tV = [tB];
      function tU(c) {
        return (
          c.target instanceof HTMLAnchorElement && (c.metaKey || c.ctrlKey)
        );
      }
      function tW(c) {
        if (tU(c)) {
      ...
      function tq(c, e) {
        ...
        return (
          i[1] !== e || i[2] !== c
            ? ((a = () => c?.dispatch({ effects: s.reconfigure(e) })),
              (l = [c, e, s]),
              (i[1] = e),
              (i[2] = c),
              (i[3] = a),
      ...
      let tK = (0, n.createContext)(null);
      function tG(c) {
        let e,
          t = (0, C.c)(3),
          { children: a, value: l } = c;
        return (
          t[0] !== a || t[1] !== l
            ? ((e = (0, r.jsx)(tK.Provider, { value: l, children: a })),
              (t[0] = a),
              (t[1] = l),
              (t[2] = e))
            : (e = t[2]),
      ...
      try {
        tK.displayName || (tK.displayName = "SelectionContext");
      } catch {}
      try {
        tG.displayName || (tG.displayName = "SelectionContextProvider");
      } catch {}
      var tZ = t(26382),
        tQ = t(13659),
        tY = t(53419),
        tX = t(59121);
      let tJ = "ViewSwitch-module__segmentedControl--HEitU",
        t1 = "ViewSwitch-module__active--OpjBM",
        t0 = (c) => {
          let e,
            t,
            a,
          ...
          v[0] !== y
            ? ((e = (c) => {
                ((0, tY.BI)("markdown_editor.select_view", { mode: c }),
                  y?.(c));
              }),
              (v[0] = y),
              (v[1] = e))
          ...
          let k = e,
            j = "edit" === x && t1;
          v[2] !== j
            ? ((t = (0, N.$)(tJ, j)), (v[2] = j), (v[3] = t))
            : (t = v[3]);
          let _ = "edit" === x;
          (v[4] === Symbol.for("react.memo_cache_sentinel")
            ? ((a = (0, r.jsx)(m.CodeIcon, {})), (v[4] = a))
            : (a = v[4]),
            v[5] !== k
              ? ((l = () => k?.("edit")), (v[5] = k), (v[6] = l))
              : (l = v[6]),
            v[7] !== b || v[8] !== t || v[9] !== _ || v[10] !== l
              ? ((i = (0, r.jsx)(tX.I.IconButton, {
                  className: t,
                  selected: _,
                  value: "edit",
          ...
          let S = "preview" === x && t1;
          v[12] !== S
            ? ((n = (0, N.$)(tJ, S)), (v[12] = S), (v[13] = n))
            : (n = v[13]);
          let I = "preview" === x;
          (v[14] === Symbol.for("react.memo_cache_sentinel")
            ? ((s = (0, r.jsx)(m.EyeIcon, {})), (v[14] = s))
            : (s = v[14]),
            v[15] !== k
              ? ((o = () => k?.("preview")), (v[15] = k), (v[16] = o))
              : (o = v[16]),
            v[17] !== w
              ? ((d = () => w?.()),
                (z = () => w?.()),
          ...
          let E = "hybrid" === x && t1;
          v[27] !== E
            ? ((p = (0, N.$)(tJ, E)), (v[27] = E), (v[28] = p))
            : (p = v[28]);
          let T = "hybrid" === x;
          return (
            v[29] === Symbol.for("react.memo_cache_sentinel")
              ? ((f = (0, r.jsx)(m.ComposeIcon, {})), (v[29] = f))
              : (f = v[29]),
            v[30] !== k
              ? ((h = () => k?.("hybrid")), (v[30] = k), (v[31] = h))
              : (h = v[31]),
            v[32] !== b || v[33] !== p || v[34] !== T || v[35] !== h
              ? ((M = (0, r.jsx)(tX.I.IconButton, {
                  className: p,
                  value: "hybrid",
                  selected: T,
                ...
                (v[36] = M))
              : (M = v[36]),
            v[37] !== u || v[38] !== M || v[39] !== i
              ? ((g = (0, r.jsx)("nav", {
                  children: (0, r.jsxs)(tX.I, {
      ...
      try {
        t0.displayName || (t0.displayName = "ViewSwitch");
      } catch {}
      function t2(c) {
        let e,
          t,
          a,
          l = (0, C.c)(6),
          { onChangeViewMode: i, children: n } = c;
        return (
          l[0] === Symbol.for("react.memo_cache_sentinel")
            ? ((e = (0, r.jsx)(tQ.Z, {})), (l[0] = e))
            : (e = l[0]),
          l[1] !== i
            ? ((t =
                i &&
                (0, r.jsx)(t0, { selectedView: "hybrid", onViewSelect: i })),
              (l[1] = i),
              (l[2] = t))
            : (t = l[2]),
          l[3] !== n || l[4] !== t
            ? ((a = (0, r.jsxs)("div", {
                className: "Header-module__header--Sdz_S",
                children: [n, e, t],
              })),
              (l[3] = n),
              (l[4] = t),
      ...
      try {
        t2.displayName || (t2.displayName = "Header");
      } catch {}
      function t3(c) {
        let e,
          t,
          ...
          n,
          s = (0, C.c)(8),
          { onChangeViewMode: o } = c;
        return (
          s[0] !== o
            ? ((e = (0, r.jsx)(t2, { onChangeViewMode: o })),
              (s[0] = o),
              (s[1] = e))
            : (e = s[1]),
          s[2] === Symbol.for("react.memo_cache_sentinel")
            ? ((t = (0, r.jsx)(tZ.E.Visual, {
                children: (0, r.jsx)(m.AlertIcon, { size: "medium" }),
              })),
              (a = (0, r.jsx)(tZ.E.Heading, {
          ...
          s[4] === Symbol.for("react.memo_cache_sentinel")
            ? ((l = { textAlign: "center", maxWidth: "700px" }), (s[4] = l))
            : (l = s[4]),
          s[5] === Symbol.for("react.memo_cache_sentinel")
            ? ((i = (0, r.jsxs)(tZ.E, {
                children: [
                  t,
                  a,
                  (0, r.jsxs)(tZ.E.Description, {
                    style: l,
                    children: [
                      "The hybrid Markdown editing experience is temporarily unavailable due to an unknown error. Please",
                      " ",
                      (0, r.jsx)("a", {
                        href: "https://github-grid.enterprise.slack.com/archives/C08M545RDCN",
                        children: "report this error",
                      }),
                      " to the team along with browser console logs, if possible.",
                    ],
                  }),
                ],
              })),
            ...
            : (i = s[5]),
          s[6] !== e
            ? ((n = (0, r.jsxs)(r.Fragment, { children: [e, i] })),
              (s[6] = e),
              (s[7] = n))
            : (n = s[7]),
          n
      ...
      try {
        t3.displayName || (t3.displayName = "ErrorFallback");
      } catch {}
      var t4 = t(38102),
        t5 = t(91446),
        t6 = t(98211);
      let t7 = /^([^/]+)\/([^;]+)/,
        t8 = (c) => {
          if (c.startsWith("."))
            return (e) => e.name.toLowerCase().endsWith(c.toLowerCase());
          {
            let e = t7.exec(c);
            if (null === e) return () => !1;
            let [, t, a] = e;
            return (c) => {
              let [, e, l] = t7.exec(c.type) ?? [];
              return (
      ...
      function t9(c) {
        let e = (0, n.useMemo)(
            () => c.acceptedFileTypes?.map(t8),
            [c.acceptedFileTypes],
          ),
          t = (0, n.useCallback)((c) => e?.some((e) => e(c)) ?? !0, [e]);
        return (0, n.useCallback)(
          function (e) {
            ...
            if (c.multi) {
              let a = [],
                l = [];
              for (let c of e) t(c) ? a.push(c) : l.push(c);
              c.onSelect(a, l);
            } else {
              let a = e[0];
              a && t(a) ? c.onSelect(a, void 0) : c.onSelect(void 0, a);
            }
            return !0;
          },
          [t, c.multi, c.onSelect],
        );
      }
      function ac(c) {
        let e,
          t = (function (c) {
            let e = t9(c),
              { multi: t, acceptedFileTypes: a } = c,
              l = (0, n.useCallback)(() => {
                let c = document.createElement("input");
                (c.setAttribute("type", "file"),
                  c.setAttribute("multiple", t ? "true" : "false"),
                  a && c.setAttribute("accept", a.join(", ")),
                  c.addEventListener(
                    "change",
                    (c) => {
                      let t = c.target;
                      t instanceof HTMLInputElement && t.files && e(t.files);
                    },
                    { once: !0 },
                  ),
                  c.click());
              }, [a, t, e]);
            return (0, n.useMemo)(() => ({ onClick: l }), [l]);
          })(c),
          a =
            ((e = t9(c)),
            (0, n.useMemo)(
              () => ({
                onPaste: (c) => {
                  e(c.clipboardData.files) && c.preventDefault();
                },
              }),
              [e],
            )),
          [l, r] = (function (c) {
            let e = t9(c),
              [t, a] = (0, n.useState)(!1),
              l = (0, n.useCallback)(() => a(!1), []),
              r = (0, n.useCallback)((c) => {
                ae(c) && (a(!0), c.stopPropagation(), c.preventDefault());
              }, []),
              i = (0, n.useCallback)((c) => {
                ae(c) &&
                  (c.stopPropagation(),
              ...
              s = (0, n.useCallback)(
                (c) => {
                  e(c.dataTransfer.files) && (c.preventDefault(), a(!1));
                },
                [e],
              );
            return [
      ...
      let ae = (c) =>
          c.dataTransfer.types.includes("Files") ||
          Array.from(c.dataTransfer.items).some((c) => "file" === c.kind),
        at = new Set(["image/bmp", "image/tiff", "image/heic", "image/heif"]),
        aa = (c) =>
          c.type.toLowerCase().startsWith("image/") &&
          !at.has(c.type.toLowerCase()),
        al = (c) => {
          if (!c) return c;
          let e = c.trim();
          if (!e || "undefined" == typeof window || !window.location?.origin)
            return e;
          try {
...
\`\`\``,
        as = (c) => {
          ...
          let e = ec(c.state),
            t = c.state.doc.toString(),
            a = c.state.selection.main,
            { from: l, to: r } = a,
            i = ej(c, "code");
          if (i) return (eN(c, i), !0);
          let n = [],
            s = [...ci(e, l, r)]
              .filter((c) => "code" === c.type)
              .flatMap((c) => {
                let e = e_(c).filter(ca);
                return e.map((c, t) => ({
                  from:
                    t === e.length - 1
                      ? c.position.start.offset - 1
                      : c.position.start.offset,
                  to: c.position.end.offset,
                }));
              }),
          ...
          let m = ct(t, l, r),
            z = m.at(0)?.start,
            u = m.at(-1)?.end,
            p = void 0 !== o && void 0 !== z ? Math.min(z, o) : z,
            f = void 0 !== d && void 0 !== u ? Math.max(u, d) : u;
          if (void 0 === p || void 0 === f) return !1;
          n.push({ from: p, insert: ea(ai) }, { from: f, insert: ea(an) });
          let h = a.empty && MarkdownLine.atOffset(e, t, a.from)?.isBlank;
          return (
            c.dispatch({
              changes: n,
              selection: h ? { anchor: p + ai.length } : void 0,
              userEvent: "input",
              scrollIntoView: !0,
            }),
            !0
        ...
        ao = (c) => {
          let e,
            ...
            s,
            o = (0, C.c)(10),
            { acceptedFileTypes: d, onFileSelect: z } = c,
            u = n.useRef(null);
          ...
          o[1] !== z
            ? ((t = async (c) => {
                let e = c.currentTarget.files;
                if (e)
                  for (let c of e)
                    try {
                      await z(c);
                    } catch {}
                c.currentTarget && (c.currentTarget.value = "");
              }),
              (o[1] = z),
              (o[2] = t))
            : (t = o[2]);
          ...
          return (
            o[3] === Symbol.for("react.memo_cache_sentinel")
              ? ((a = (0, r.jsx)(ar.A.IconButton, {
                  variant: "invisible",
                  icon: m.PaperclipIcon,
              ...
              : (a = o[3]),
            o[4] !== d
              ? ((l = d?.join(",")), (o[4] = d), (o[5] = l))
              : (l = o[5]),
            o[6] === Symbol.for("react.memo_cache_sentinel")
              ? ((i = { display: "none" }), (o[6] = i))
              : (i = o[6]),
            o[7] !== f || o[8] !== l
      ...
      ao.displayName = "HybridMarkdownEditor.FileUploadToolbarButton";
      let ad = (c) => {
        let e,
          t,
          a,
          ...
          m = (0, C.c)(20);
        m[0] !== c
          ? (({ command: e, view: l, matchingNodeFilter: t, ...a } = c),
            (m[0] = c),
            (m[1] = e),
            (m[2] = t),
            (m[3] = a),
            (m[4] = l))
          : ((e = m[1]), (t = m[2]), (a = m[3]), (l = m[4]));
        let z = "object" == typeof e,
          u = z ? e.run : e,
          p = (function () {
            let c = (0, n.useContext)(tK);
            if (!c)
              throw Error(
        ...
        m[5] !== t || m[6] !== p
          ? ((i = p.some(t)), (m[5] = t), (m[6] = p), (m[7] = i))
          : (i = m[7]);
        let f = i;
        if (m[8] !== e || m[9] !== z) {
          var h;
          ((s = z
            ? ((h = e), h.key?.replaceAll("+", "Plus")?.replaceAll("-", "+"))
            : void 0),
            (m[8] = e),
            (m[9] = z),
            (m[10] = s));
      ...
      ad.displayName = "MarkdownEditor.ToolbarButton";
      let az = (c) => {
        let e,
          t,
          a,
          ...
          h,
          M = (0, C.c)(30),
          { view: g, acceptedFileTypes: v, handleFileUpload: x } = c;
        return (
          M[0] !== g
            ? ((e = (0, r.jsx)(ad, {
                view: g,
              ...
              (M[4] = l),
              (M[5] = i))
            : ((e = M[1]), (t = M[2]), (a = M[3]), (l = M[4]), (i = M[5])),
          M[6] === Symbol.for("react.memo_cache_sentinel")
            ? ((n = (0, r.jsx)(ar.A.Divider, {})), (M[6] = n))
            : (n = M[6]),
          M[7] !== g
            ? ((s = (0, r.jsx)(ad, {
                view: g,
                "aria-label": "Unordered list",
                icon: m.ListUnorderedIcon,
                command: eQ,
                matchingNodeFilter: ag,
              })),
              (o = (0, r.jsx)(ad, {
                view: g,
                "aria-label": "Ordered list",
                icon: m.ListOrderedIcon,
                command: eY,
                matchingNodeFilter: av,
              })),
              (M[7] = g),
              (M[8] = s),
              (M[9] = o))
          ...
          M[14] !== g
            ? ((u = (0, r.jsx)(ad, {
                ...
                icon: m.CodeSquareIcon,
                command: as,
                matchingNodeFilter: ax,
              })),
              (p = (0, r.jsx)(ad, {
                view: g,
                ...
                icon: m.HeadingIcon,
                command: e1,
                matchingNodeFilter: ay,
              })),
              (f = (0, r.jsx)(ad, {
                view: g,
                "aria-label": "Strikethrough",
                icon: m.StrikethroughIcon,
                command: e4,
                matchingNodeFilter: aC,
              })),
              (M[14] = g),
              (M[15] = u),
              (M[16] = p),
              (M[17] = f))
            : ((u = M[15]), (p = M[16]), (f = M[17])),
          M[18] !== e ||
          M[19] !== z ||
          M[20] !== u ||
          M[21] !== p ||
          ...
          M[28] !== o
            ? ((h = (0, r.jsxs)(ar.A, {
                ...
                className: "Toolbar-module__actionBar--Igyiz",
                gap: "none",
                children: [e, t, a, l, i, n, s, o, d, z, u, p, f],
              })),
              (M[18] = e),
              (M[19] = z),
              (M[20] = u),
      ...
      function au(c) {
        return "strong" === c.type;
      }
      function ap(c) {
        return "emphasis" === c.type;
      }
      function af(c) {
        return "link" === c.type && eE(c);
      }
      function ah(c) {
        return "inlineCode" === c.type;
      }
      function aM(c) {
        return "blockquote" === c.type;
      }
      function ag(c) {
        return "list" === c.type && !c.ordered;
      }
      function av(c) {
        return "list" === c.type && !!c.ordered;
      }
      ...
      function ay(c) {
        return "heading" === c.type && 3 === c.depth;
      }
      function aC(c) {
        return "delete" === c.type;
      }
      az.displayName = "HybridMarkdownEditor.Toolbar";
      let aw = ["image/*", "video/*"],
        ab = (0, n.forwardRef)(function (
          {
            value: c,
            onChange: e,
            disabled: t,
          ...
          let [u, p] = (0, n.useState)(ey),
            f = (0, _.M)(e),
            h = (0, n.useCallback)(
              (c) => {
                (c.docChanged && f.current?.(c.state.doc.toString()),
                  c.transactions.some(
                    (c) =>
                      !cf(ek(c.startState.field(ew)), ek(c.state.field(ew))),
                  ) && p(eb(c.state)));
              },
              [f],
            ),
            ...
            v = tq(
              M,
              (0, n.useMemo)(() => (0, b.qf)(l ?? ""), [l]),
            ),
            x = tq(
              M,
              (0, n.useMemo)(() => (t ? (0, k.T)() : []), [t]),
            ),
            y = tq(
              M,
              (0, n.useMemo)(
            ...
            C = (0, _.M)(m),
            j = (0, n.useCallback)(() => !!C.current && (C.current(), !0), [C]),
            S = (0, n.useMemo)(
              () => [
                tz,
                ei,
                ...
                [
                  b.Lz.domEventHandlers({
                    click: tW,
                    mousedown: (c) => {
                      if (tU(c)) return (c.preventDefault(), !0);
                    },
                  }),
                ],
                (0, w.b6)(),
                b.Lz.updateListener.of(h),
                y,
                te,
                b.Lz.contentAttributes.from(tc, (c) => ({
                  class: (0, N.$)(
                    "HybridMarkdownEditor-module__content--IkUxV",
                    "markdown-body",
                    c && "HybridMarkdownEditor-module__modPressed--Yxc01",
                  ),
                })),
                v,
                x,
                (function ({ primaryAction: c }) {
                  return b.w4.of([
                    ...
                    ...e5,
                    { key: "Tab", run: ef },
                    { key: "Shift-Tab", run: eh },
                    { key: "Shift-Tab", run: eP },
                    { key: "Tab", run: eB },
                    { key: "Mod-[", run: eP },
                    { key: "Mod-]", run: eB },
                  ]);
            ...
            E = (({
              ...
              ((0, n.useEffect)(() => {
                if (s) {
                  z.current = !1;
                  let c = setTimeout(() => (z.current = !0), 1e3);
              ...
              let u = (0, t6.U)((c) => {
                    ...
                    (o(
                      (0, r.jsxs)(r.Fragment, {
                        children: [
                          ...
                          (0, r.jsx)("span", {
                            children: " for supported file types.",
                          }),
                        ],
                      }),
                    ),
                ...
                p = (0, n.useCallback)(
                  (c, e) => {
                    ...
                    m.current &&
                      ...
                      t.dispatch({
                        effects: [
                          tF.of({ id: c, data: { progressPercent: e } }),
                        ],
                      }));
                  },
                  [m],
                ...
                f = (0, n.useCallback)(
                  (c) => {
                    let e = m.current;
                    if (!e || 0 === c.length) return;
                    let t = e.state.field(D, !1) ?? null;
                    for (let [l, r] of (null !== t
                      ? e.dispatch({ effects: [R.of(null)] })
                      : (t = e.state.selection.main.from),
                    e.focus(),
                    c.entries())) {
                      var a;
                      ((a = {
                        ...
                        e.dispatch({
                          effects: [
                            tO.of(a),
                            b.Lz.scrollIntoView(a.position, { y: "nearest" }),
                          ],
                        }));
                    }
                  },
                ...
                h = (0, n.useCallback)(
                  (c, e, t) => {
                    ...
                    if (a)
                      try {
                        let l = ((c, e, t) => {
                          let a = e.url && al(e.url);
                          if (!a)
                            throw Error(`Failed to upload "${e.file.name}"`);
                          switch (c.mediaKind) {
                            case "video":
                              return a;
                            case "image":
                              return (0, t5.TG)(
                                t || { width: 0, height: 0, pixelsPerInch: 1 },
                                a,
                                "Image",
                              );
                            case void 0:
                              return (0, t5.iQ)(e.file.name, a);
                          }
                        })(c, e, t);
                        !(function (c, e, t) {
                          let a =
                            c.state.field(tB).entries.get(e)?.position ?? null;
                          if (null === a) return;
                          let l = c.state.doc.toString(),
                            r = (function (c, e) {
                              if (
                                0 === e ||
                                (`
...
`;
                          ...
                          c.dispatch({
                            effects: [tH.of({ id: e })],
                            changes: { from: a, insert: ea(`${r}${t}${i}`) },
                          });
                        })(a, c.id, l);
                      } catch (c) {
                        throw (c instanceof Error && o(c.message), c);
                      } finally {
                ...
                M = (0, t6.U)((c, e, t) => {
                  (e.url && console.info("Uploaded file available at:", e.url),
                    h(c, e, t));
                }),
                g = (0, n.useCallback)(
                  (c) =>
                    c.map(async (c) => {
                      let e = { url: null, file: c.file },
                        t = null;
                      try {
                        e = (await a?.(c.file, (e) => {
                          let t =
                            c.file.size > 0
                              ? Math.round((e / c.file.size) * 100)
                              : 0;
                          p(c.id, Math.min(t, 99));
                        })) ?? { file: c.file, url: null };
                      } catch {
                        e = { file: c.file, url: null };
                      }
                      if (e.url && ("image" === c.mediaKind || aa(e.file)))
                        try {
                          t = await (0, t5.pF)(e.file);
                        } catch {
                          ((t = { width: 0, height: 0, pixelsPerInch: 1 }),
                            (0, t4.N7)("Failed to get image size from file", {
                ...
                v = (0, n.useCallback)(
                  async (c, e) => {
                    if (c.length > 0) {
                      let e = c.length,
                        t = c.map((c, t) => {
                          let a = `upload-placeholder-${d.current++}`,
                            l = c.type.toLowerCase().startsWith("video/")
                              ? "video"
                              : aa(c)
                                ? "image"
                                : void 0,
                            r = l ? URL.createObjectURL(c) : void 0;
                          return {
                            id: a,
                            file: c,
                            order: t + 1,
                      ...
                      (f(t), await Promise.all(g(t)));
                    }
                    u(e);
                  },
                  [u, f, g],
                ),
                x = ac({ acceptedFileTypes: l, multi: !0, onSelect: v });
              return (
                (t || !e) &&
                  (x = {
                    clickTargetProps: { onClick: c2.l },
                    dropTargetProps: {
                      onDragEnter: c2.l,
                      onDragLeave: c2.l,
                      onDrop: c2.l,
          ...
          return (
            ...
            (0, n.useEffect)(function () {
              M?.state.doc.toString() !== c &&
                e &&
                M?.update([
                  M.state.update({
                    changes: { from: 0, to: M.state.doc.length, insert: c },
                  }),
                ]);
            }),
            (0, n.useImperativeHandle)(
              ...
              () => ({
                ...
                reset: () =>
                  M?.dispatch({
                    changes: { from: 0, to: M.state.doc.length, insert: "" },
                  }),
                scrollIntoView: (c) => M?.dom?.scrollIntoView(c),
                moveCursorToEnd: () =>
                  M?.dispatch({ selection: { anchor: M.state.doc.length } }),
              }),
              [M],
            ),
            (0, r.jsxs)(r.Fragment, {
                ...
                (0, r.jsx)(t2, {
                  ...
                  children: (0, r.jsx)(tG, {
                    ...
                    children: (0, r.jsx)(az, {
                      view: M,
                      acceptedFileTypes: s,
                      handleFileUpload: E?.handleFileUpload,
                    }),
                  }),
                }),
                (0, r.jsx)("div", {
                  ref: I,
                  className: E?.isDraggedOver
                    ? "HybridMarkdownEditor-module__isDraggedOver--HtKSP"
                    : void 0,
                  ...(T ?? {}),
                  ...(E?.pasteTargetProps ?? {}),
                }),
        ...
        ak = (0, n.forwardRef)(function (c, e) {
          let t,
            a,
            l,
            i,
          ...
          return (
            s[0] !== c
              ? (({ onChangeViewMode: t, ...a } = c),
                (s[0] = c),
                (s[1] = t),
                (s[2] = a))
              : ((t = s[1]), (a = s[2])),
            s[3] !== t
              ? ((l = (0, r.jsx)(t3, { onChangeViewMode: t })),
                (s[3] = t),
                (s[4] = l))
              : (l = s[4]),
            s[5] !== t || s[6] !== e || s[7] !== a
              ? ((i = (0, r.jsx)(ab, { ref: e, onChangeViewMode: t, ...a })),
                (s[5] = t),
                (s[6] = e),
                (s[7] = a),
                (s[8] = i))
            ...
            s[9] !== l || s[10] !== i
              ? ((n = (0, r.jsx)("div", {
                  className: "HybridMarkdownEditor-module__container--P0pK8",
                  children: (0, r.jsx)(j.t, { fallback: l, children: i }),
                })),
                (s[9] = l),
                (s[10] = i),
                (s[11] = n))
      ...
      try {
        ab.displayName || (ab.displayName = "InnerHybridMarkdownEditor");
      } catch {}
      try {
        ab.displayName || (ab.displayName = "InnerHybridMarkdownEditor");
      } catch {}
      try {
        ak.displayName || (ak.displayName = "HybridMarkdownEditor");
      } catch {}
      try {
        ak.displayName || (ak.displayName = "HybridMarkdownEditor");
      } catch {}
      var aj = t(26076),
        a_ = t(16643),
        aN = t(72511);
      let aS = (0, n.memo)(({ children: c }) =>
        (0, r.jsx)(aN.A, {
          variant: "danger",
          full: !0,
          className: "ErrorMessage-module__flash--Fb4_Y",
          children: c,
        }),
      );
      aS.displayName = "MarkdownEditor.ErrorMessage";
      let aI = (c) => (0, tY.BI)("markdown_editor.format", { tool: c }),
        aE = (0, n.forwardRef)(({ forInputId: c }, e) => {
          (0, n.useEffect)(() => {
            t.e(78143).then(t.bind(t, 78143));
          }, []);
          let a = (0, n.useRef)(null),
            ...
            f = (0, n.useRef)(null);
          return (
            (0, n.useImperativeHandle)(e, () => ({
              header: () => {
                (a.current?.click(), aI("header"));
              },
              bold: () => {
                (l.current?.click(), aI("bold"));
              },
              italic: () => {
                (i.current?.click(), aI("italic"));
              },
              quote: () => {
                (s.current?.click(), aI("quote"));
              },
              code: () => {
                (o.current?.click(), aI("code"));
              },
              link: () => {
                (d.current?.click(), aI("link"));
              },
              unorderedList: () => {
                (m.current?.click(), aI("unorderedList"));
              },
              orderedList: () => {
                (z.current?.click(), aI("orderedList"));
              },
              taskList: () => {
                (u.current?.click(), aI("taskList"));
              },
              mention: () => {
                (p.current?.click(), aI("mention"));
              },
              reference: () => {
                (f.current?.click(), aI("reference"));
              },
            })),
            (0, r.jsxs)("markdown-toolbar", {
              for: c,
              style: { display: "none" },
              children: [
                (0, r.jsx)("md-header", { ref: a }),
                (0, r.jsx)("md-bold", { ref: l }),
                (0, r.jsx)("md-italic", { ref: i }),
                (0, r.jsx)("md-quote", { ref: s }),
                (0, r.jsx)("md-code", { ref: o }),
                (0, r.jsx)("md-link", { ref: d }),
                (0, r.jsx)("md-unordered-list", { ref: m }),
                (0, r.jsx)("md-ordered-list", { ref: z }),
                (0, r.jsx)("md-task-list", { ref: u }),
                (0, r.jsx)("md-mention", { ref: p }),
                (0, r.jsx)("md-ref", { ref: f }),
              ],
            })
          );
        });
      aE.displayName = "MarkdownEditor.FormattingTools";
      let aT = "MarkdownEditor-module__fullHeight--No1e6";
      t(90204);
      var aL = t(44358),
        aA = t(71555),
        aP = t(66964),
        ...
        aV = t(5524),
        aU = t(74508);
      let aW = { triggerChar: "#", multiWord: !0 },
        aq = (c) => ({
          value: c.id,
          render: (e) =>
            (0, r.jsxs)(aV.l.Item, {
              ...
              children: [
                c.iconHtml &&
                  (0, r.jsx)(aV.l.LeadingVisual, {
                    children: (0, r.jsx)(aB.BC, { html: c.iconHtml }),
                  }),
                (0, r.jsx)("span", {
                  className:
                    "use-reference-suggestions-module__suggestionTitle--NZoUv",
                  children: (0, r.jsx)(aB.BC, { html: c.titleHtml }),
                }),
                " ",
                (0, r.jsxs)(aV.l.Description, {
                  truncate: !0,
                  children: ["#", c.id],
                }),
              ],
        ...
        aK = (c, e) => (0, aH.dt)(c, `${e.id} ${e.titleText}`),
        aG = (c, e) => 0,
        aZ = [],
        aQ = (0, n.forwardRef)(
          (
            ...
            var k;
            let j = (0, n.useMemo)(() => ({ tone: u }), [u]),
              { trigger: _, calculateSuggestions: S } = (0, aO.x)(z ?? aZ, j),
              { trigger: I, calculateSuggestions: E } = (0, aF.P)(p ?? aZ),
              { trigger: T, calculateSuggestions: L } =
                ((k = f ?? aZ),
                {
                  calculateSuggestions: (0, n.useMemo)(() => {
                    let c = (0, aU.C)(k, aK, aG, aq);
                    return (e) => (/^\d+\s/.test(e) ? [] : c(e));
                  }, [k]),
                  trigger: aW,
                }),
              A = (0, n.useMemo)(
                () => [
                  { trigger: _, suggestionsCalculator: S },
                  { trigger: I, suggestionsCalculator: E },
                  { trigger: T, suggestionsCalculator: L },
                ],
                [S, E, L, _, I, T],
              ),
              {
            ...
            ((0, aD.T)(b, $),
              (0, n.useEffect)(() => {
                let c =
                  $.current &&
                  (0, aL.B1)($.current, {
                    defaultPlainTextPaste: { urlLinks: y },
                  });
            ...
            return (
              ...
              (0, r.jsx)(aA.a, {
                ...
                onShowSuggestions: (c) => {
                  (R ||
                    (0, tY.BI)(
                      "markdown_editor.show_autocomplete_suggestions",
                      { trigger: c.trigger.triggerChar },
                    ),
                    D(c));
                },
                onHideSuggestions: () => D(null),
                style: { flex: "auto" },
                ...
                children: (0, r.jsx)(a$.Ay, {
                  ...
                  onKeyDown: o,
                  disabled: a,
                  "aria-label": h ? void 0 : "Markdown value",
                  "aria-labelledby": h,
                  onChange: e,
                  onInput: t,
                  value: c,
                  className: (0, N.$)(
                    C,
                    "MarkdownInput-module__textArea--kLNLR",
                    !v && "MarkdownInput-module__displayNone--tQubM",
                    d && "MarkdownInput-module__fullHeight--HWXka",
                    x && "MarkdownInput-module__monospace--ktxaS",
                    m && "MarkdownInput-module__isDraggedOver--hTZEP",
                  ),
                  rows: M,
                  style: O,
                  ...w,
      ...
      aQ.displayName = "MarkdownInput";
      var aY = t(71315),
        aX = t(5839),
        aJ = t(26108);
      let a1 = (0, n.forwardRef)((c, e) => {
        let { disabled: t } = (0, n.useContext)(s);
        return (0, r.jsx)(aJ.K, {
          ref: e,
          variant: "invisible",
          ...
          ...c,
          className: "ToolbarButton-module__iconButton--o0jFl",
        });
      });
      a1.displayName = "MarkdownEditor.ToolbarButton";
      let a0 = (0, n.createContext)(null),
        a2 = () => {
          let c = (0, n.useContext)(a0),
            e = (0, y.G7)("issues_lazy_load_comment_box_suggestions");
          (0, n.useImperativeHandle)(c?.ref, () => ({
            openMenu: () => {
              a(!0);
            },
          }));
          ...
          (0, n.useEffect)(() => {
            !e &&
              (i(""),
              t &&
                ((0, tY.BI)("markdown_editor.open_saved_replies"),
                c?.onOpen()));
          }, [c, e, t]);
          let [l, i] = (0, n.useState)(""),
            s = c?.savedReplies
              ...
              .map((c, e) => ({
                ...
                trailingVisual: e < 9 ? `Ctrl + ${e + 1}` : void 0,
                className: "SavedReplies-module__SavedReplies--K6yeB",
              })),
            o = (e) => {
              a(!1);
              let t = c?.savedReplies.find(({ name: c }) => c === e?.text);
              t && c?.onSelect(t);
            },
            d = (0, n.useCallback)(
              (t) => {
          ...
          return s
            ? (0, r.jsx)(aX.X, {
                ...
                overlayProps: {
                  ...
                  onKeyDown: (c) => {
                    let e = parseInt(c.key, 10);
                    s &&
                      c.ctrlKey &&
                      !Number.isNaN(e) &&
                      e >= 1 &&
                      e <= 9 &&
                      (c.stopPropagation(), c.preventDefault(), o(s[e - 1]));
                  },
                },
                secondaryAction: (0, r.jsx)(aX.X.SecondaryActionLink, {
                  href: `${aY.fV.origin}/settings/replies`,
                  children: "Create new",
                }),
              })
            : (0, r.jsx)(r.Fragment, {});
      ...
      try {
        a0.displayName || (a0.displayName = "SavedRepliesContext");
      } catch {}
      try {
        a2.displayName || (a2.displayName = "SavedRepliesButton");
      } catch {}
      var a3 = t(11683),
        a4 = t(45800);
      let a5 = "Toolbar-module__divider--Kctb6",
        a6 = "Toolbar-module__group--dOhAD",
        a7 = (0, n.memo)(() => {
          let { formattingToolsRef: c } = (0, n.useContext)(s);
          return (0, r.jsxs)(r.Fragment, {
            children: [
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.header(),
                    icon: m.HeadingIcon,
                    "aria-label": "Heading",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.bold(),
                    icon: m.BoldIcon,
                    "aria-label": "Bold",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.italic(),
                    icon: m.ItalicIcon,
                    "aria-label": "Italic",
                  }),
                  (0, r.jsx)("div", { className: a5 }),
                ],
              }),
              (0, r.jsxs)("div", {
                className: a6,
                children: [
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.quote(),
                    icon: m.QuoteIcon,
                    "aria-label": "Quote",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.code(),
                    icon: m.CodeIcon,
                    "aria-label": "Code",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.link(),
                    icon: m.LinkIcon,
                    "aria-label": "Link",
                  }),
                  (0, r.jsx)("div", { className: a5 }),
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.unorderedList(),
                    icon: m.ListUnorderedIcon,
                    "aria-label": "Unordered list",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.orderedList(),
                    icon: m.ListOrderedIcon,
                    "aria-label": "Numbered list",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.taskList(),
                    icon: m.TasklistIcon,
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.mention(),
                    icon: m.MentionIcon,
                    "aria-label": "Mention",
                  }),
                  (0, r.jsx)(a1, {
                    onClick: () => c.current?.reference(),
                    icon: m.CrossReferenceIcon,
      ...
      a7.displayName = "MarkdownEditor.DefaultToolbarButtons";
      let a8 = ({ children: c }) => {
          ...
          return (
            (0, a4.G)({
              ...
              bindKeys: a3.z0.ArrowHorizontal | a3.z0.HomeAndEnd,
            ...
            (0, r.jsx)("div", {
              ...
              "aria-label": "Formatting tools",
              role: "toolbar",
              className: "Toolbar-module__toolbar--TBvFM",
              children: c,
            })
          );
        },
        a9 = ({ children: c }) => (0, r.jsx)(a8, { children: c });
      a9.displayName = "MarkdownEditor.Toolbar";
      try {
        a8.displayName || (a8.displayName = "CoreToolbar");
      } catch {}
      var lc = t(88567);
      let le = /^(?:\t| ? ?)(.*)/;
      var lt = t(8625),
...
|$)`);
      function ln(c, e, t = 0) {
        let a = e.substring(t, e.length),
          l = c.exec(a);
        return l ? l.index + t : -1;
      }
      let ls = (c) => (0, lc.nf)(`Uploading "${c.name}"...`),
        lo = () => {},
        ld = ({
          emitChange: c,
          value: e,
          ...
          let [o, d] = (0, n.useState)(void 0),
            m = (0, n.useRef)(!1);
          ((0, n.useEffect)(() => {
            if (o) {
              m.current = !1;
              let c = setTimeout(() => (m.current = !0), 1e3);
              return () => clearTimeout(c);
            }
          }, [o]),
            (0, n.useEffect)(() => {
...
`
                      : `
`;
                  })(t.current.value, t.current.selectionStart),
                  l = (function (c, e) {
                    if (
                      c.length === e ||
                      (`
...
`,
                    ...
                    return /\S/.test(c.substring(e, t))
                      ? `

`
                      : `
`;
                  })(t.current.value, t.current.selectionEnd);
                c(
                  `${a}${e.map(ls).join(`
`)}${l}`,
                );
            ...
            M = (0, t6.U)(({ file: e, url: a }, l) => {
              (p((c) => c && [c[0] + 1, c[1]]),
                ((e, a, l) => {
                  if (!t?.current) return;
                  let r = ls(e),
                    i = t.current.value.indexOf(r);
                  -1 !== i &&
                    c(
                      a
                        ? e.type.startsWith("video/")
                          ...
                          : e.type.startsWith("image/") &&
                              !["image/bmp", "image/tiff"].includes(e.type)
                            ? (0, lc.TG)(
                                l || { width: 0, height: 0, ppi: 1 },
                                a,
                                "Image",
                              )
                            : (0, lc.iQ)(e.name, a)
                        : (0, lc.nf)(`Failed to upload "${e.name}"`),
                      [i, i + r.length],
                    );
                })(e, a, l));
            }),
            g = (0, n.useCallback)(
              (c) =>
                c.map(async (c) => {
                  let e = { url: null, file: c },
                    t = null;
                  try {
                    e = (await l?.(c)) ?? { file: c, url: null };
                  } catch {
                    e = { file: c, url: null };
                  }
                  if (e.url)
            ...
            v = ac({
              acceptedFileTypes: i,
              multi: !0,
              onSelect: (0, n.useCallback)(
                async (c, e) => {
                  (c.length > 0 &&
                    (p([1, c.length]), h(c), await Promise.all(g(c)), f()),
                    z(e));
                },
                [z, h, g, f],
              ),
          ...
          return (
            a &&
              (v = {
                ...
                pasteTargetProps: { onPaste: lo },
                isDraggedOver: !1,
              }),
            l ? { ...v, errorMessage: o, uploadProgress: u } : null
          );
        };
      var lm = t(1481);
      let lz = "ViewSwitch-module__tabNavLink--PdqAj",
        lu = "ViewSwitch-module__active--kUKgZ",
        lp = ({
          selectedView: c,
          onViewSelect: e,
          onLoadPreview: t,
          ...
          let l = (c) => {
            ((0, tY.BI)("markdown_editor.select_view", { mode: c }), e?.(c));
          };
          return (0, r.jsx)("div", {
            className: "ViewSwitch-module__viewSwitch--qZjLs",
            children: (0, r.jsxs)(lm.A, {
              "aria-label": "View mode",
              children: [
                (0, r.jsx)(lm.A.Link, {
                  as: "button",
                ...
                (0, r.jsx)(lm.A.Link, {
                  ...
                  selected: "preview" === c,
                  disabled: a,
                  className: (0, N.$)(lz, "preview" === c && lu),
                  onClick: () => l?.("preview"),
                  onMouseOver: () => t?.(),
                  onFocus: () => t?.(),
                  children: "Preview",
                }),
                (0, y.G7)("markdown_experience_hybrid_editor") &&
                  (0, r.jsxs)(lm.A.Link, {
                    as: "button",
                    selected: "hybrid" === c,
                    disabled: a,
                    className: (0, N.$)(lz, "hybrid" === c && lu),
                    onClick: () => l?.("hybrid"),
                    children: [
                      "Hybrid",
                      (0, r.jsx)(tQ.Z, {
                        className: "ViewSwitch-module__lifecycleLabel--GDgv5",
                      }),
                    ],
                  }),
              ],
      ...
      try {
        lp.displayName || (lp.displayName = "ViewSwitch");
      } catch {}
      let lf = Symbol(),
        lh = [],
        lM = (0, n.forwardRef)(
          (
            {
              ...
              emojiSuggestions: x,
              emojiTone: C,
              mentionSuggestions: w,
              referenceSuggestions: b,
              monospace: k = !1,
              required: j = !1,
              name: _,
              children: S,
              savedReplies: I,
              pasteUrlsAsPlainText: E = !1,
              teamHovercardsEnabled: T = !1,
              onSavedRepliesOpen: L = c2.l,
              errorMessage: A,
              containerRef: P,
              onChange: R,
              onUploadFile: D,
            ...
            let [B] = (0, z.H)(S, { toolbar: a9 }),
              V = (0, n.useId)(),
              U = (0, y.G7)("mardown_editor_use_on_input"),
              W = (0, y.G7)("markdown_experience_hybrid_editor"),
              {
                inputRef: q,
                inputKey: K,
                reset: G,
                ...
                e.current &&
                  ...
                  (l.current = e.current.offsetHeight);
                let r = (0, n.useCallback)(
                  ...
                  s = (0, lt.H)({ inputRef: e, fallbackEventHandler: r });
                return {
                  inputRef: e,
                  inputKey: t,
                  inputHeight: l,
              ...
              })(R),
              {
                ...
                return (
                  ...
                  }, [c]),
                  {
                    html: t,
                    setHtml: a,
                    loadPreview: (0, n.useCallback)(async () => {
                      r.current && ((r.current = !1), l(null), l(await e(c)));
                    }, [c, e, l]),
                    previewStale: r,
                  }
                );
            ...
            ((0, n.useEffect)(() => {
              "preview" === h && J.current && X();
            }),
              (0, n.useImperativeHandle)(
                H,
                () => ({
                  focus: (c) => q.current?.focus(c),
                  moveCursorToEnd: () => {
                    if (q.current) {
                      let c = q.current.value.length;
                      q.current.setSelectionRange(c, c);
                    }
                  },
                  scrollIntoView: (c) => P.current?.scrollIntoView(c),
                  reset: () => G(),
                  [lf]: void 0,
                }),
                [P, q, G],
            ...
            q.current &&
              ...
              (cc.current = q.current.offsetHeight);
            let ce = ld({
                emitChange: Z,
                value: c,
                inputRef: q,
                ...
                onUploadFile: D,
                acceptedFileTypes: $,
                onFilesRejected: (0, n.useCallback)(
                  (c) => {
                    let e = [];
                    for (let t of c) {
                      let c = t.name.includes(".")
                        ? `.${t.name.split(".").pop()}`
                        : "no-extension";
                      ((0, tY.BI)(
                        "markdown_editor.file_upload.rejected_file_type",
                        {
                          rejected_file_type: c,
                          mime_type: t.type || "unknown",
                        },
                      ),
                        e.push(c));
                    }
              ...
              ct = ce?.uploadProgress !== void 0,
              ca = (0, la.KI)({ emitChange: Z }),
              cl = (({ emitChange: c }) => ({
                onKeyDown: (0, n.useCallback)(
                  (e) => {
                    ...
                    if (
                      e.defaultPrevented ||
                      "Tab" !== e.key ||
                      t.selectionEnd - t.selectionStart == 0
                    )
                      return;
                    e.preventDefault();
                    let [a, l] = (0, lc.ty)(t),
                ...
                onKeyDown: (0, n.useCallback)(
                  (e) => {
                    if ("Enter" === e.key) {
                      let t = e.currentTarget,
                        a = t.selectionStart;
                      if (a !== t.selectionEnd) return;
                      let { output: l, newCursorIndex: r } = (function (c) {
                        var e;
                        let t,
                          a,
                          l = c.selectionStart;
                        if (
                          !(function (c, e) {
                            let t = [],
                              ...
                              l = -1;
                            for (; (l = ln(lr, c, a)) > -1; ) {
                              let e = ln(li, c, (a = l + ll.length));
                              if (-1 === e) return !1;
                              ((a = e + 3), t.push([l, e]));
                            }
                            return t.some((c) => e > c[0] && e < c[1]);
                          })(c.value, l)
                        )
                          return { output: "", newCursorIndex: 0 };
                        let r =
                          ((e = c.value),
                          (t = e.slice(0, l).split(`
`)),
...
`)[t.length - 1]);
                        if (null === r)
                          return { output: "", newCursorIndex: 0 };
                        let i = ((a = /^(\s+)/.exec(r)) && a[0]) || "",
                          n = `
${i}`,
                          s = l + n.length;
                        return { output: n, newCursorIndex: s };
                      })(t);
                      "" !== l && (e.preventDefault(), c(l, [a, a], [r, r]));
                    }
                  },
                  [c],
                ),
                ...
                () =>
                  I
                    ? {
                        savedReplies: I,
                        onSelect: (c) => {
                          requestAnimationFrame(() => Z(c.content));
                        },
                        onOpen: L,
                        ref: ci,
                      }
              ...
              cs = (0, a_._)((c) => {
                ...
                if (!t)
                  if (c.ctrlKey && "." === c.key)
                    ...
                    if ("Enter" !== c.key || ct)
                      if ("b" === c.key) e?.bold();
                      else if ("i" === c.key) e?.italic();
                      else if (c.shiftKey && "." === c.key) e?.quote();
                      else if ("e" === c.key) e?.code();
                      else if ("k" === c.key) e?.link();
                      else if ("8" === c.key) e?.unorderedList();
                      else if (c.shiftKey && "7" === c.key) e?.orderedList();
                      else if (c.shiftKey && ["l", "L"].includes(c.key))
                        e?.taskList();
                      else {
                        if (!(c.shiftKey && ["p", "P"].includes(c.key))) return;
                        M?.("preview");
                      }
                    else f?.();
                    (c.preventDefault(), c.stopPropagation());
                  } else (ca.onKeyDown(c), cl.onKeyDown(c), cr.onKeyDown(c));
              });
            (0, n.useEffect)(() => {
              if ("preview" === h) {
                lh.push(V);
            ...
            let co = (0, n.useRef)(null),
              cd = (0, n.useMemo)(
                () => ({
                  disabled: t,
                  formattingToolsRef: co,
                  required: j,
                  fileDraggedOver: ce?.isDraggedOver ?? !1,
                  fileUploadProgress: ce?.uploadProgress,
                  uploadButtonProps: ce?.clickTargetProps ?? null,
                  errorMessage: ce?.errorMessage,
                  previewMode: "preview" === h,
                }),
                [
                  t,
                  j,
            ...
            return (0, r.jsxs)(s.Provider, {
              value: cd,
              children: [
                (0, r.jsx)(aE, { ref: co, forInputId: V }),
                A &&
                  (0, r.jsxs)(aN.A, {
                    variant: "danger",
                    className: "mb-2",
                    children: [(0, r.jsx)(m.StopIcon, {}), A],
                  }),
                (0, r.jsxs)("div", {
                  className: (0, N.$)(
                    p,
                    "edit" === h
                      ? "MarkdownEditor-module__inputWrapper--L6JTI"
                      : "MarkdownEditor-module__previewWrapper--Bfk_2",
                    t && "MarkdownEditor-module__disabled--jxhXI",
                    d && aT,
                  ),
                  children: [
                    (0, r.jsxs)("div", {
                      className: (0, N.$)(
                        "MarkdownEditor-module__header--OuWiJ",
                      ),
                      children: [
                        !W &&
                          (0, r.jsxs)("div", {
                            className:
                              "MarkdownEditor-module__viewSwitchWrapper--oQoLo",
                            children: [
                              (0, r.jsx)(lp, {
                                selectedView: h,
                                onViewSelect: M,
                                disabled: ce?.uploadProgress !== void 0,
                                onLoadPreview: X,
                              }),
                              (0, r.jsx)("div", {
                                className:
                                  "MarkdownEditor-module__viewSwitchBorder--S43Dz",
                              }),
                            ],
                          }),
                        (0, r.jsx)(a0.Provider, {
                        ...
                        W &&
                          (0, r.jsx)("div", {
                            className:
                              "MarkdownEditor-module__hybridViewSwitchWrapper--Urx4K",
                            children: (0, r.jsx)(t0, {
                              selectedView: h,
                              onViewSelect: M,
                              disabled: ce?.uploadProgress !== void 0,
                    ...
                    (0, r.jsx)(
                      aQ,
                      {
                        ...
                        ref: q,
                        fullHeight: d,
                        isDraggedOver: ce?.isDraggedOver ?? !1,
                        minHeightLines: g,
                        maxHeightLines: v,
                        visible: "edit" === h,
                        monospace: k,
                    ...
                    (0, r.jsx)("div", {
                      role: "alert",
                      children:
                        "edit" === h && ce?.errorMessage
                          ? (0, r.jsx)(aS, { children: ce.errorMessage })
                          : null,
                    }),
                    "preview" === h &&
                      (0, r.jsxs)("div", {
                        ...
                        tabIndex: -1,
                        className: (0, N.$)(
                          "MarkdownEditor-module__previewViewerWrapper--rhH_h",
                          d && aT,
                        ),
                        style: { minHeight: cc.current },
                        children: [
                          (0, r.jsx)("h2", {
                            className:
                              "MarkdownEditor-module__previewHeader--ktZV6",
                            children: "Rendered Markdown Preview",
                          }),
                          (0, r.jsx)(aj.G, {
                            verifiedHTML: Y || "Nothing to preview",
                            loading: null === Y,
                            teamHovercardsEnabled: T,
                            openLinksInNewTab: !0,
                          }),
                        ],
                      }),
      ...
      lM.displayName = "ClassicMarkdownEditor";
      let lg = (0, n.forwardRef)((c, e) => {
        let { footer: t, ...a } = c,
          l = (0, n.useMemo)(
            () => ({
        ...
        return (
          (0, n.useImperativeHandle)(
            ...
            () => ({
              ...
              moveCursorToEnd: () => i.current?.moveCursorToEnd(),
              reset: () => i.current?.reset(),
              scrollIntoView: (c) => i.current?.scrollIntoView(c),
              [lf]: void 0,
            }),
            [],
          ),
          (0, r.jsxs)(s.Provider, {
            value: l,
            children: [(0, r.jsx)(ak, { ref: i, ...a }), t],
          })
        );
      });
      lg.displayName = "HybridMarkdownEditorWithFooter";
      let lv = (0, n.forwardRef)((c, e) => {
        let t,
          {
            disabled: a = !1,
            "aria-describedby": l,
          ...
          [M, g] = (0, n.useState)("edit"),
          [v, C] = void 0 === s ? [M, g] : [s, d],
          w =
            ((t = (0, y.G7)("markdown_experience_hybrid_editor")),
            "hybrid" === v && t ? "hybrid" : "classic"),
          b = (0, n.useId)(),
          k = {
            footer:
              f.footer ??
              (0, r.jsx)(u, {
                children:
                  (0, n.isValidElement)(f.actions) && f.actions.props.children,
              }),
            "aria-describedby": l ? `${b} ${l}` : b,
          };
        (0, n.useEffect)(
          () => (0, tY.BI)("markdown_editor.mount", { editorType: w }),
          [w],
        );
        let j = (0, n.useRef)(null),
          _ =
            "hybrid" === w
              ? (0, r.jsx)(lg, { ...c, ref: e, onChangeViewMode: C, ...k })
              : (0, r.jsx)(lM, {
                  ...c,
                  viewMode: "hybrid" === v ? "edit" : v,
                  onChangeViewMode: C,
                  ref: e,
                  containerRef: j,
                  ...k,
        ...
        return (0, r.jsxs)("fieldset", {
          "aria-disabled": a,
          className: (0, N.$)(
            "MarkdownEditor-module__fieldSet--QLrYu",
            i && aT,
          ),
          children: [
            (0, r.jsx)("div", {
              className: "MarkdownEditor-module__hidden--tMY1v",
              children: h,
            }),
            f.label,
            (0, r.jsxs)("div", {
              ref: j,
              className: "MarkdownEditor-module__container--xSX9w",
              children: [
                (0, r.jsx)("span", {
                  className: "sr-only",
                  id: b,
                  "aria-live": "polite",
                  children: `Markdown input: ${"hybrid" === v ? "hybrid mode selected." : "preview" === v ? " preview mode selected." : " edit mode selected."}`,
                }),
                _,
              ],
            }),
      ...
      lv.displayName = "MarkdownEditor";
      let lx = Object.assign(lv, {
        Label: x,
        Toolbar: a9,
        ToolbarButton: a1,
        DefaultToolbarButtons: a7,
        Footer: p,
        FooterButton: f,
        Actions: o,
        ActionButton: d,
        MarkdownEditorContext: s,
      });
    },
    45007: (c, e, t) => {
      t.d(e, { S: () => r });
      ...
      let r = ({
        ...
        let [n, s] = (0, l.useState)(void 0),
          ...
          d = (0, l.useCallback)(() => {
            ...
            s(
              `calc(${e.scrollHeight}px - ${t.paddingTop} - ${t.paddingBottom})`,
            );
          }, [c, r, o, i]);
        return (
          (0, a.N)(d, [d]),
          ...
          {
            height: n,
            minHeight: e ? `${e}lh` : void 0,
            maxHeight: t ? `${t}lh` : void 0,
    ...
    62173: (c, e, t) => {
      ...
      async function r({
        ...
        (u.append("text", c),
          u.append("issue", e),
          u.append("repository", t),
          u.append("project", l),
          i && u.append("path", i),
          n && u.append("line_number", n.toString()),
          s && u.append("start_commit_oid", s),
          o && u.append("end_commit_oid", o),
          d && u.append("base_commit_oid", d),
          m && u.append("subject", m.toString()),
          z && u.append("start_line_number", z.toString()),
          r && u.append("subject_type", r));
        let p = await (0, a.DI)("/preview", { body: u, method: "POST" });
        return p.ok
          ? Promise.resolve(await p.text())
          : Promise.resolve("Markdown preview unavailable");
      }
      function i({
        subjectId: c,
        subjectType: e,
    ...
    65826: (c, e, t) => {
      ...
      var a = t(74848),
        ...
        s = t(74508);
      function o(c) {
        return "character" in c && void 0 !== c.character;
      }
      let d = new Set(["+1", "thumbsup", "-1"]),
        m = { triggerChar: ":", keepTriggerCharOnCommit: !1 },
        z = (c, e) => {
          let t = e.name.toLowerCase(),
            a = c.toLowerCase(),
            l = 0;
          return (
            t.includes(a) && ((l += 5), t.startsWith(a) && (l += 5)),
            0 === l ? r.IP : l
          );
        },
        u = (c, e) => {
          let t = c.name.toLowerCase(),
            a = e.name.toLowerCase();
          return d.has(t) && !d.has(a) ? -1 : d.has(a) && !d.has(t) ? 1 : 0;
        },
        p = (c, e) => ({
          calculateSuggestions: (0, n.useMemo)(() => {
            let t;
      ...
      try {
        d.displayName || (d.displayName = "PRIORITIZED_EMOJIS");
      } catch {}
    },
    66964: (c, e, t) => {
      t.d(e, { f: () => l });
      ...
      let l = (c) => {
        let [e, t] = (0, a.useState)(null),
          l = (0, a.useMemo)(() => c.map(({ trigger: c }) => c), [c]);
        return {
          triggers: l,
          suggestions: (0, a.useMemo)(() => {
            if (!e) return null;
            for (let { trigger: t, suggestionsCalculator: a } of c)
              if (e.trigger.triggerChar === t.triggerChar) return a(e.query);
            return null;
          }, [e, c]),
          setSuggestionEvent: t,
          active: !!e,
        };
      };
    },
    71381: (c, e, t) => {
      ...
      var a = t(15874),
        ...
        r = t(24774);
      let i = (c) => {
        let e = [l.$t.tabSize.of(c.indentUnit)];
        return (
          c.indentWithTabs
            ? e.push(a.Xt.of("	"))
            : e.push(a.Xt.of(" ".repeat(c.indentUnit))),
          c.lineWrapping && e.push(r.Lz.lineWrapping),
          e
        );
      };
    },
...
`,
        ...
        C =
          (...c) =>
          (e) => {
            for (let t of [...c].reverse()) e.isDefaultPrevented() || t?.(e);
          },
        w = () =>
          (0, a.jsxs)(a.Fragment, {
            children: [
        ...
        b = ({
          ...
          let i = {
            id: l,
            children: x(c),
            role: "menu" === r ? "menuitem" : "option",
            active: t,
            className: "AutocompleteSuggestions-module__suggestion--ted1j",
            "aria-selected": ("listbox" === r && !!t) || void 0,
            onMouseDown: (c) => {
              (c.preventDefault(), e());
            },
          };
        ...
        k = ({
          ...
          let g = (0, u.useRef)(null),
            [v, x] = (0, u.useState)(0),
            [C, k] = (0, u.useState)("auto");
          (0, f.A)(
            function () {
              k("auto");
              let c = g.current?.offsetHeight ?? 0,
                e = t.top + t.height,
                a = e + c > window.innerHeight,
                l = t.top - c,
                r = l < 0,
                i = { below: a && !r ? l : e, above: r && !a ? e : l }[s];
              if ((Number.isNaN(i) && (i = 0), x(Math.max(0, i)), a && r)) {
                let c =
                  "above" === s
            ...
            [t.top, t.height, c, n, s],
          );
          let j = (0, a.jsx)(a.Fragment, {
              children:
                "loading" === c
                  ? (0, a.jsx)(w, {})
                  : c?.map((c) =>
          ...
          return n
            ? (0, a.jsx)(h.Ay, {
                ...
                left: t.left,
                ref: g,
                className: "AutocompleteSuggestions-module__Overlay_0--LMGK_",
                children: (0, a.jsx)(p.l, {
                  role: M,
                  id: m,
                  "aria-label": z ? void 0 : "Autocomplete suggestions",
                  "aria-labelledby": z ? _ : void 0,
                  className:
                    "AutocompleteSuggestions-module__ActionList_0--iXEKc",
                  style: { height: C },
                  children: z
                    ? (0, a.jsxs)(p.l.Group, {
                        children: [
                          (0, a.jsx)(p.l.GroupHeading, { id: _, children: z }),
                          j,
                        ],
                      })
                    : j,
      ...
      try {
        w.displayName || (w.displayName = "LoadingIndicator");
      } catch {}
      try {
        b.displayName || (b.displayName = "SuggestionListItem");
      } catch {}
      try {
        k.displayName || (k.displayName = "AutocompleteSuggestions");
      } catch {}
      let j = (c) => {
          try {
            return c.selectionStart;
          } catch (c) {
            if (c instanceof TypeError) return null;
            throw c;
          }
        },
        _ = () => {},
        N = ({
          ...
          onShowSuggestions: t,
          onHideSuggestions: p,
          onSelectSuggestion: f,
          style: h,
          children: M,
          tabInsertsSuggestions: w = !1,
          suggestionsPlacement: b = "below",
          portalName: N,
          fullWidth: S = !1,
          title: I,
          asMenu: E,
          ...
          let [, L] = (0, u.useState)(0),
            A = (0, s.Lf)(T),
            P = (0, u.useRef)(null);
          u.version.startsWith("19")
            ? (0, o.T)(M.props.ref ?? _, P)
            : (0, o.T)(M.ref ?? _, P);
          let R = (function (c, e) {
              if (
                (u.Children.only(c),
                e.current &&
                  !(e.current instanceof HTMLInputElement) &&
                  !(e.current instanceof HTMLTextAreaElement))
              )
                throw TypeError(
            ...
            D = (0, n.H)({
              inputRef: P,
              fallbackEventHandler: R.props.onChange ?? _,
            }),
            $ = (0, u.useRef)(null),
            O = null !== e && e.length > 0,
            [F, H] = (0, u.useState)(),
            B = Array.isArray(e) ? (e.find((c) => y(c) === F) ?? e[0]) : void 0;
          (F && !O && H(void 0),
            (0, u.useEffect)(() => {
              if (O) {
                let c = (0, l.n)(() => L((c) => c + 1), 100);
                return (
                  document.addEventListener("scroll", c, { capture: !0 }),
                  () => {
                    document.removeEventListener("scroll", c, { capture: !0 });
                  }
                );
              }
            }, [O]));
          let V =
              P.current && $.current && O
                ? new z.Qr(
                    P.current,
                    (j(P.current) ?? 0) - $.current.query.length,
                  ).getBoundingClientRect()
                : { top: 0, left: 0, height: 0 },
            U = (c) => {
              if (!B || !Array.isArray(e)) return;
              let t = (c) => {
                H(c ? y(c) : void 0);
              };
              switch (c) {
                case "up":
                  t(e[e.indexOf(B) - 1] ?? e.at(-1));
                  break;
                case "down":
                  t(e[e.indexOf(B) + 1] ?? e[0]);
                  break;
                case "start":
                  t(e[0]);
                  break;
            ...
            W = (c = B) => {
              if (!c) return;
              let e = "object" == typeof c && null === c.value,
                t = x(c) ?? "";
              if (!P.current || !$.current) return;
              let { query: a, trigger: l } = $.current,
                r = j(P.current) ?? 0,
                i = a.length + l.triggerChar.length,
                n = r - i,
                s = e || (l.keepTriggerCharOnCommit ?? !0) ? l.triggerChar : "",
                o = !e && (l.insertSpaceOnCommit ?? !0),
                d = `${s}${t}${o ? " " : ""}`;
              (p(),
                D(d, [n, n + i]),
                f?.({
            ...
            K = (c) => `${q}-${y(c)}`,
            G = !E,
            Z = (0, u.cloneElement)(R, {
              ...A,
              onBlur: C(R.props.onBlur, () => {
                p();
              }),
              onKeyDownCapture: C(R.props.onKeyDownCapture, (c) => {
                if (O)
                  switch (c.key) {
                    case "ArrowRight":
                    case "ArrowLeft":
              ...
              onChange: C(R.props.onChange, (e) => {
                let a = j(e.currentTarget);
                if (null === a) return void p();
                let l = ((c, e, t) => {
                  let a = c.sort(
                    (c, e) => e.triggerChar.length - c.triggerChar.length,
                  );
                  for (
                    let c = t - 1, l = "", r = a;
                    c >= 0 && r.length > 0;
                    ...
                    let t = e[c] ?? "";
                    for (let a of ((l = t + l),
                    g.has(t) && (r = r.filter((c) => c.multiWord)),
                    v.has(t) && (r = r.filter((c) => !c.multiWord)),
                    r.filter((c) => l.startsWith(c.triggerChar)))) {
                      let t = e[c - 1] ?? "",
                        i = l[1] ?? "";
                      if ((!t || /[\s([]/.test(t)) && (!i || !/\s/.test(i)))
                        return {
                          trigger: a,
                          query: l.slice(a.triggerChar.length),
                        };
                      r = r.filter((c) => c !== a);
                    }
                  }
                  return null;
                })(c, e.currentTarget.value, a);
                (($.current = l && { ...l, target: e.currentTarget }),
                  $.current ? t($.current) : p());
              }),
              ref: P,
              role: O && G ? "combobox" : R.props.role,
              "aria-expanded": O && G ? "true" : R.props["aria-expanded"],
              "aria-activedescendant": B
                ? K(B)
                : R.props["aria-activedescendant"],
              "aria-controls": O && G ? q : R.props["aria-controls"],
              "aria-owns": O && E ? q : R.props["aria-owns"],
              "aria-autocomplete":
                O && G ? "list" : R.props["aria-autocomplete"],
              "aria-haspopup": O && G ? "listbox" : R.props["aria-haspopup"],
            }),
            Q = O
              ? "loading" === e
                ? "Loading autocomplete suggestions\u2026"
                : G
                  ? `${e.length} autocomplete ${1 === e.length ? "suggestion" : "suggestions"} available; "${x(e[0])}" is highlighted. Press ${w ? "Enter or Tab" : "Enter"} to select.`
                  : ""
              : "";
          return (0, a.jsxs)(i.tL, {
            commands: O
              ? {
                  "github:cancel": () => p(),
                  "github:select": () => W(),
                  "github:focus-next": w ? () => W() : void 0,
                  "github:down": () => U("down"),
                  "github:up": () => U("up"),
              ...
              : {},
            className: (0, m.$)(
              "InlineAutocomplete-module__container--lzMAk",
              S && "InlineAutocomplete-module__fullWidth--xhTmc",
            ),
            style: h,
            children: [
              Z,
              ...
              r.KJ &&
                (0, a.jsx)(d.ZL, {
                  children: (0, a.jsx)("span", {
                    "aria-live": "assertive",
                    "aria-atomic": !0,
                    style: { clipPath: "circle(0)", position: "absolute" },
                    children: Q,
                  }),
                }),
            ],
      ...
      let l = (c, e, t, l, r) => (i) => {
        ...
        let n = i
          ? c
              .map((c) => [e(i, c), c])
              .filter(([c]) => c > a.IP)
              .sort(([c, e], [a, l]) => (a === c ? -t(l, e) : a - c))
              .slice(0, 5)
              .map(([, c]) => c)
          : c.slice(0, 5);
        return (r && n.sort(t), n.map(l));
      };
    },
    74807: (c, e, t) => {
      t.d(e, { N: () => _, L: () => k });
      var a = t(74848),
        ...
        n = t(34164),
        s = t(96540);
      let o = "CopilotAnimation-module__activate--dz7l9";
      function d(c) {
        let e,
          t,
          r,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                height: m,
                viewBox: "0 0 32 1088",
                className: "Celebrate-module__celebrate--W7jkS",
                "data-animation-state": s,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t],
              })),
      ...
      try {
        d.displayName || (d.displayName = "CopilotAnimationCelebrate");
      } catch {}
      function m(c) {
        let e,
          t,
        ...
        return (
          n[0] !== m || n[1] !== o
            ? ((e = (0, a.jsx)("div", {
                className: "Activate-module__copilot--dZWRK",
                children: (0, a.jsx)(d, { scale: m, state: o }),
              })),
              (n[0] = m),
              (n[1] = o),
              (n[2] = e))
          ...
          n[3] === Symbol.for("react.memo_cache_sentinel")
            ? ((t = Array.from({ length: 10 })), (n[3] = t))
            : (t = n[3]),
          n[4] !== m
            ? ((r = (0, a.jsx)("div", {
                className: "Activate-module__sparkles--DWcVb",
                children: t.map((c, e) => {
                  let t = `${(0.1 * Math.random() + 0.2).toFixed(2)}s`,
                    l = `${(0.4 + 0.2 * Math.random()).toFixed(2)}s`;
                  return (0, a.jsxs)(
                    "div",
                    {
                      className: "Activate-module__sparkle--xUJlF",
                      style: { animationDelay: t, animationDuration: l },
                      children: [
                        (0, a.jsx)("div", {
                          className: "Activate-module__sparkleTrail--J3ZVZ",
                          style: { animationDelay: t, animationDuration: l },
                        }),
                        (0, a.jsx)("svg", {
                          xmlns: "http://www.w3.org/2000/svg",
                          ...
                          style: {
                            animationDelay: t,
                            transform: `scale(${(0.2 * Math.random() + 0.8).toFixed(2)})`,
                          },
                          "aria-hidden": "true",
          ...
          n[6] !== o || n[7] !== e || n[8] !== r
            ? ((i = (0, a.jsxs)("div", {
                className: "Activate-module__activate--w81cr",
                "data-animation-state": o,
                children: [e, r],
              })),
              (n[6] = o),
              (n[7] = e),
      ...
      try {
        m.displayName || (m.displayName = "CopilotAnimationActivate");
      } catch {}
      function z(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                height: m,
                viewBox: "0 0 32 672",
                className: "Affirmative-module__affirmative--yLQwP",
                "data-animation-state": s,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t],
      ...
      try {
        z.displayName || (z.displayName = "CopilotAnimationAffirmative");
      } catch {}
      function u(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                height: m,
                viewBox: "0 0 32 928",
                className: "Confirm-module__confirm--rF0fe",
                "data-animation-state": s,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t],
      ...
      try {
        u.displayName || (u.displayName = "CopilotAnimationConfirm");
      } catch {}
      function p(c) {
        let e,
          t,
          ...
          eJ = 1728 * eY;
        return (
          eG[0] === Symbol.for("react.memo_cache_sentinel")
            ? ((cW = (0, a.jsx)("path", {
                d: `M6.6001,824.5119c-0.089-0.5707-0.1786-1.1451-0.2719-1.7432c-0.8697-0.4698-1.557-1.1616-2.2357-1.9298
	...
	C14.1865,817.7276,14.2125,817.1884,14.2409,816.6492z`,
              })),
              (c2 = (0, a.jsx)("path", {
                d: `M28.0277,788.5572c-0.6411,0.7672-1.2733,1.4255-2.0705,1.9158c-0.1323,0.6168-0.1276,1.25-0.3384,1.8839
	...
	C23.0738,782.6024,23.0008,782.4673,22.9552,782.3282z`,
              })),
              (ea = (0, a.jsx)("path", {
                d: `M6.2754,856.1013c-0.0955-0.5927-0.1946-1.2077-0.2991-1.856c-0.5564-0.3773-1.0321-0.8679-1.4983-1.3732
	...
	c0.0283-1.1614,0.2635-2.4128-1.1918-2.5753C11.3064,845.4222,9.1578,845.4224,8.6717,846.2044z`,
              })),
              (ep = (0, a.jsx)("path", {
                d: `M6.8513,751.2731c0.4383-2.515,1.5601-4.5708,3.5891-6.1442c0.0571-0.1176,0.1111-0.2288,0.1655-0.3409
	...
	C23.7741,752.2266,23.7091,751.1005,23.4667,749.9858z`,
              })),
              (ek = (0, a.jsx)("path", {
                d: `M6.1097,887.8563c-0.0995-0.6056-0.204-1.2412-0.3068-1.8672c-0.4017-0.4263-0.7897-0.8595-1.2013-1.2689
	...
	c0.4646,0.1014,0.9455,0.1345,1.4208,0.1783C11.4799,883.0083,11.787,882.9472,12.0665,882.8058z`,
              })),
              (eR = (0, a.jsx)("path", {
                d: `M6.0235,919.7028c-0.1108-0.6584-0.2212-1.3141-0.3223-1.9151c-0.4392-0.5082-0.8428-0.983-1.2553-1.45
	...
	C12.5061,909.9504,12.4395,909.667,12.2833,909.3859z`,
              })),
              (e = (0, a.jsx)("path", {
                d: `M7.7038,729.1519c-0.2102-0.477-0.4113-0.9333-0.6127-1.3903c-0.9931-0.5479-2.0069-1.1201-2.7657-1.9693
	...
	c1.3955,0.0514,3.0556-0.1395,3.2855-1.8102C24.0471,719.8474,23.9345,718.7586,23.7235,717.6929z`,
              })),
              (p = (0, a.jsx)("path", {
                d: `M5.9737,951.5944c-0.103-0.6139-0.2164-1.2897-0.3242-1.9318c-0.3933-0.4692-0.7645-0.9169-1.1413-1.3599
	...
	C9.852,946.504,10.5539,946.5737,11.2599,946.4626z`,
              })),
              (k = (0, a.jsx)("path", {
                d: `M5.9297,974.7081c0.2928-1.074,0.35-2.1476,1.0276-3.0363c0.5607-0.7258,1.1289-0.9808,1.9863-1.1981
	...
	C11.9811,976.192,12.06,975.3011,12.1343,974.5573z`,
              })),
              (R = (0, a.jsx)("path", {
                d: `M7.1203,695.7664c-0.2415-0.126-0.4767-0.2595-0.7208-0.374c-0.7289-0.3416-1.3082-0.8823-1.8971-1.4106
	...
	C24.2002,687.7123,24.096,686.5657,23.8229,685.4305z`,
              })),
              (K = (0, a.jsx)("path", {
                d: `M25.2858,1007.4966c0.1709,0.0731,0.3394,0.1533,0.5136,0.2183c1.0317,0.364,1.4812,1.421,2.0664,2.257
	...
	c0.0764-0.7451,0.1455-1.4911,0.2086-2.2375C12.1142,1005.8617,12.1747,1005.4013,11.9155,1004.9366z`,
              })),
              (cl = (0, a.jsx)("path", {
                d: `M5.5975,1077.5391c-0.4032-0.5023-0.7558-0.9391-1.1054-1.3782c-0.2549-0.3202-0.3785-0.6859-0.3927-1.0966
	...
	C12.0917,1069.6097,12.0612,1069.2656,11.9242,1068.9425z`,
              })),
              (cf = (0, a.jsx)("path", {
                d: `M25.2173,1039.4583c0.1986,0.0905,0.3439,0.1709,0.4986,0.2247c1.0679,0.3468,1.5426,1.4103,2.1344,2.2688
	...
	C12.0964,1037.6703,12.0874,1037.3007,11.9118,1036.9149z`,
              })),
              (cC = (0, a.jsx)("path", {
                d: `M5.6237,1109.6156c-0.4354-0.5377-0.8016-0.99-1.1677-1.4423c-0.2309-0.2854-0.3388-0.614-0.3601-0.9786
	...
	C12.1713,1101.5421,12.0638,1101.1945,11.9999,1100.9081z`,
              })),
              (cw = (0, a.jsx)("path", {
                d: `M6.8297,655.4318c0.3561-2.2888,1.2705-4.367,3.059-5.882c0.2225-0.194,0.4282-0.3926,0.5037-0.6672
	...
	c-0.9108-0.3813-1.9187-0.3832-2.8856-0.2911C20.2002,652.6492,19.9247,652.7831,19.7027,653.0638z`,
              })),
              (cb = (0, a.jsx)("path", {
                d: `M5.646,1141.6771c-0.4092-0.4841-0.7689-0.9147-1.1343-1.3405c-0.2828-0.3296-0.4145-0.709-0.4423-1.1411
	...
	C12.2151,1133.2943,12.1543,1133.0969,12.1143,1132.9183z`,
              })),
              (ck = (0, a.jsx)("path", {
                d: `M6.8499,591.4273c0.3343-2.5018,1.394-4.5851,3.3399-6.1443c0.0691-0.1406,0.1232-0.2526,0.1794-0.3635
	...
	C19.4482,588.7483,19.6348,589.3318,19.6283,590.2834z`,
              })),
              (cj = (0, a.jsx)("path", {
                d: `M7.1596,631.7974c-0.1576-0.0848-0.2995-0.1746-0.4516-0.2407c-0.7973-0.3461-1.4434-0.9031-2.0826-1.4724
	...
	C23.8612,620.4899,22.485,620.6147,21.6191,620.4529z`,
              })),
              (c_ = (0, a.jsx)("path", {
                d: `M7.1503,567.782c-0.1483-0.0828-0.2706-0.1646-0.4032-0.2228c-0.774-0.3395-1.4141-0.8671-2.0441-1.416
	...
	C20.1747,556.5449,19.9168,556.6738,19.7388,556.8923z`,
              })),
              (cN = (0, a.jsx)("path", {
                d: `M6.0084,1175.6343c-0.1005-0.5995-0.2035-1.2144-0.3051-1.8207c-0.3889-0.4369-0.7692-0.8768-1.1638-1.3035
	...
	C10.4323,1164.465,8.8745,1164.4159,8.1534,1165.1934z`,
              })),
              (cS = (0, a.jsx)("path", {
                d: `M26.4153,533.6667c-0.1144,0.6823-0.2176,1.2975-0.3206,1.9116c-1.9155,2.6268-4.8655,4.527-8.1244,4.8784
	...
	C24.0309,529.6615,24.0964,528.4063,24.1631,527.3612z`,
              })),
              (cI = (0, a.jsx)("path", {
                d: `M7.076,503.6653c-1.0867-0.4452-1.9795-1.1485-2.7287-1.9308c-0.2124-0.4093-0.2384-0.7866-0.2915-1.1565
	...
	c-0.1289-1.0175-0.1557-1.2343-1.3797-1.5377C22.1555,492.4062,21.6906,492.3994,21.2373,492.3461z`,
              })),
              (cE = (0, a.jsx)("path", {
                d: `M25.0576,1207.5861c-0.2075,0.4523-0.3809,0.8302-0.5573,1.2148c-1.7832,1.434-3.8826,2.4476-6.0641,3.1262
	...
	C12.6444,1199.7991,12.6574,1199.3838,12.6803,1198.9692z`,
              })),
              (cT = (0, a.jsx)("path", {
                d: `M7.0627,471.6352c-1.0604-0.4632-1.9731-1.1412-2.7563-1.987c-0.2066-0.4307-0.2502-0.8921-0.2817-1.3451
	...
	C24.0996,463.3443,23.9798,462.2208,23.7183,461.1117z`,
              })),
              (cL = (0, a.jsx)("path", {
                d: `M10.4132,425.0785c0.0583-0.1381,0.0983-0.2327,0.1355-0.3208c3.1356-2.0091,6.8125-2.1691,10.1194-0.5018
	...
	C23.8671,432.0654,23.9034,431.5718,23.92,431.0692z`,
              })),
              (cA = (0, a.jsx)("path", {
                d: `M21.4215,1224.6814c0.0184,0.2764,0.2432,0.4106,0.4342,0.5687c1.9621,1.6052,2.8312,3.399,3.3534,5.8368
	...
	C9.2055,1228.634,8.7848,1228.79,8.5503,1229.2178z`,
              })),
              (cP = (0, a.jsx)("path", {
                d: `M6.8532,399.1863c0.4364-2.3215,1.3635-4.2978,3.2137-5.8214c0.2209-0.1854,0.4777-0.3445,0.5251-0.6522
	...
	c-0.8483-0.2373-1.7162-0.2949-2.5913-0.2077C19.5244,396.1727,19.2155,396.3961,19.0201,396.8297z`,
              })),
              (cR = (0, a.jsx)("path", {
                d: `M7.4143,376.4822c-0.1554-0.3448-0.3089-0.6851-0.4652-1.032c-0.1652-0.0939-0.3226-0.1964-0.4906-0.2766
	...
	C23.5643,369.1685,23.6225,367.8069,23.6843,366.7769z`,
              })),
              (cD = (0, a.jsx)("path", {
                d: `M27.9953,1265.3275c0.0322,1.2906,0.0361,2.5387-0.0257,3.8116c-0.7389,0.9415-1.7592,1.5676-2.7705,2.184
	...
	C9.2606,1260.4436,9.075,1260.5809,8.9304,1260.8354z`,
              })),
              (c$ = (0, a.jsx)("path", {
                d: `M4.1477,341.2629c-0.1562-1.3235-0.2141-2.5866-0.0524-3.8197c0.3418-0.5275,0.6967-0.9879,1.0722-1.4344
	...
	C23.5987,334.8192,23.4832,333.693,23.2498,332.5725z`,
              })),
              (cO = (0, a.jsx)("path", {
                d: `M27.9877,308.7002c-0.6233,0.7039-1.2518,1.3676-2.0489,1.8595c-0.0674,0.3713-0.134,0.7384-0.205,1.1295
	...
	C18.9434,299.2222,18.5196,299.4301,18.2556,299.9962z`,
              })),
              (cF = (0, a.jsx)("path", {
                d: `M6.5565,1303.7563c-0.0667-0.3591-0.1195-0.6437-0.1743-0.9386c-0.8731-0.493-1.5875-1.1533-2.2201-1.8676
	...
	C14.1352,1293.8308,14.1823,1292.8689,14.1171,1291.9772z`,
              })),
              (cH = (0, a.jsx)("path", {
                d: `M25.4724,270.7905c1.0401,0.4773,1.1185,0.5373,1.8475,1.4601c0.7883,0.9978,0.6449,0.8071,0.7375,1.8539
	...
	c-0.65-0.1355-1.3072-0.2363-1.9621-0.3477C18.7818,266.6302,18.1682,266.799,17.8957,267.5277z`,
              })),
              (cB = (0, a.jsx)("path", {
                d: `M10.64,1320.8334c0.054-0.097,0.1039-0.1866,0.1678-0.3014c3.4585-1.9984,6.967-1.9313,10.4473-0.0305
	...
	c-0.0371-0.8647-0.8344-1.1548-1.5928-1.0941C11.7276,1322.6919,10.1537,1322.8973,9.4019,1323.6638z`,
              })),
              (cV = (0, a.jsx)("path", {
                d: `M6.67,1367.3611c-0.0424-0.1357-0.0854-0.2732-0.1403-0.4485c-0.9205-0.4691-1.6889-1.1631-2.4105-1.9683
	...
	c0.728,0.0012,1.4499-0.0422,2.1479-0.2832C14.588,1358.9399,14.3702,1357.7435,14.4376,1356.5692z`,
              })),
              (cU = (0, a.jsx)("path", {
                d: `M25.474,238.8378c0.1491,0.0587,0.2641,0.1066,0.381,0.1494c0.3398,0.1242,0.6363,0.3203,0.8699,0.591
	...
	c-0.9904-0.5487-2.1243-0.7322-3.2372-0.8291C18.379,234.0845,17.9347,234.2998,17.6432,234.8759z`,
              })),
              (cq = (0, a.jsx)("path", {
                d: `M6.7238,1399.2832c-0.0758-0.1385-0.135-0.2466-0.2015-0.368c-0.9385-0.4719-1.6975-1.1754-2.4124-1.9833
	...
	C14.4508,1389.2177,14.4639,1388.7181,14.4946,1388.2205z`,
              })),
              (cK = (0, a.jsx)("path", {
                d: `M24.4053,1420.2772c0.3521,0.8702,0.6797,1.6799,1.0253,2.5341c0.0903,0.0396,0.2185,0.1066,0.3537,0.1525
	...
	C14.4944,1421.1071,14.4875,1420.5861,14.4789,1420.0653z`,
              })),
              (cG = (0, a.jsx)("path", {
                d: `M25.4665,1454.8464c0.4447,0.1615,0.9181,0.3303,1.2294,0.7032c0.3825,0.4393,0.7453,0.8958,1.114,1.347
	...
	c0.4111-0.2068,0.6838-0.5411,0.7702-1.0029C14.4962,1452.9985,14.4981,1452.4574,14.4849,1451.9158z`,
              })),
              (cZ = (0, a.jsx)("path", {
                d: `M25.4905,206.8541c0.4072,0.1487,0.8591,0.3209,1.1623,0.6539c0.4787,0.4941,0.9053,1.0317,1.3073,1.6215
	...
	c-1.0154,0.0359-2.0251,0.2574-2.9734,0.6257C10.1073,202.5332,9.7965,202.6671,9.5252,203.0328z`,
              })),
              (cQ = (0, a.jsx)("path", {
                d: `M24.4162,1484.2842c0.3569,0.8634,0.6903,1.6702,1.0515,2.5438c0.062,0.0283,0.1883,0.098,0.3226,0.1448
	...
	C9.7115,1482.6068,9.5176,1482.7949,9.4045,1483.1141z`,
              })),
              (cY = (0, a.jsx)("path", {
                d: `M6.6008,1518.849c0.2315-0.5784,0.4149-1.0645,0.6211-1.5406c0.1178-0.2721,0.1773-0.5444,0.196-0.842
	...
	C14.4956,1516.8131,14.4996,1516.293,14.4868,1515.7738z`,
              })),
              (cX = (0, a.jsx)("path", {
                d: `M4.1134,180.9529c-0.1099-1.2857-0.0431-2.5526,0.019-3.8225c0.3857-0.5811,0.8136-1.1167,1.2932-1.6097
	...
	C14.5915,173.9299,14.4992,172.7797,14.4894,171.7494z`,
              })),
              (cJ = (0, a.jsx)("path", {
                d: `M6.5937,1550.8488c0.2445-0.6021,0.4776-1.1567,0.6932-1.7183c0.0657-0.171,0.1002-0.3586,0.1194-0.5417
	...
	C14.4996,1548.6934,14.4963,1548.1936,14.4873,1547.6948z`,
              })),
              (c1 = (0, a.jsx)("path", {
                d: `M24.4214,1580.3396c0.341,0.7734,0.7601,1.567,0.9989,2.4653c0.138,0.0623,0.2849,0.135,0.4368,0.1954
	...
	C14.4896,1580.7117,14.5,1580.2124,14.4862,1579.714z`,
              })),
              (c0 = (0, a.jsx)("path", {
                d: `M4.1145,1652.949c-0.1149-1.2618-0.0488-2.5284,0.0174-3.8175c0.3863-0.5828,0.8152-1.1456,1.3283-1.6342
	...
	C14.4985,1644.6719,14.4935,1644.1707,14.484,1643.6713z`,
              })),
              (c3 = (0, a.jsx)("path", {
                d: `M4.169,1617.0226c0.3484-0.4249,0.7129-0.8789,1.0881-1.324c0.273-0.3239,0.6137-0.5587,1.011-0.7101
	...
	c0.8478-0.0273,1.7195-0.1088,2.4985-0.4678C14.5496,1613.8141,14.4941,1612.6086,14.4839,1611.6732z`,
              })),
              (c4 = (0, a.jsx)("path", {
                d: `M24.4234,76.3456c0.3325,0.7565,0.7598,1.547,0.9915,2.4477c0.1159,0.0571,0.2395,0.132,0.3726,0.1811
	...
	C14.5491,77.8127,14.4938,76.6207,14.4838,75.679z`,
              })),
              (c5 = (0, a.jsx)("path", {
                d: `M25.4238,142.8225c0.1974,0.0816,0.3512,0.1448,0.5047,0.2087c0.3123,0.13,0.5926,0.3148,0.8135,0.5672
	...
	C14.5496,141.8139,14.4941,140.6086,14.4839,139.6731z`,
              })),
              (c6 = (0, a.jsx)("path", {
                d: `M28.0021,20.9007c-0.9679,1.2023-2.1327,1.9287-3.446,2.5544c-1.7353,0.9311-3.5585,1.6296-5.4952,1.9959
	...
	C14.5462,13.8173,14.495,12.622,14.4837,11.6819z`,
              })),
              (c7 = (0, a.jsx)("path", {
                d: `M6.5895,46.8494c0.2369-0.5872,0.4289-1.0918,0.6447-1.5861c0.1191-0.2729,0.1699-0.5454,0.1843-0.8431
	...
	C14.545,45.8192,14.4954,44.6249,14.4836,43.6843z`,
              })),
              (c8 = (0, a.jsx)("path", {
                d: `M27.9701,116.9417c-0.7862,0.9567-1.7529,1.6959-2.8747,2.238c-0.1872,0.0905-0.3717,0.187-0.5553,0.2847
	...
	C14.4964,108.6718,14.4964,108.1492,14.4851,107.6294z`,
              })),
              (c9 = (0, a.jsx)("path", {
                d: `M28.0051,1716.8949c-0.9612,1.201-2.1278,1.9308-3.4397,2.5549c-1.7169,0.9198-3.5178,1.6154-5.4332,1.985
	...
	c0.8684-0.0253,1.7627-0.1016,2.5618-0.4662C14.5486,1709.8135,14.4939,1708.6216,14.4838,1707.6798z`,
              })),
              (ec = (0, a.jsx)("path", {
                d: `M24.4282,1676.3574c0.3444,0.7688,0.7604,1.5632,0.9947,2.4528c0.0907,0.0438,0.179,0.0989,0.2751,0.1309
	...
	C14.4963,1676.684,14.4963,1676.1615,14.4848,1675.6415z`,
              })),
              (ee = (0, a.jsx)("path", {
                d: `M12.6271,824.7814c-0.1115-0.6715-0.1202-1.3365-0.1133-2.0015c0.0012-0.1198,0.0485-0.2391,0.0707-0.3411
	...
	C13.1826,825.3536,12.8622,825.1815,12.6271,824.7814z`,
              })),
              (et = (0, a.jsx)("path", {
                d: `M17.012,824.8911c0-0.5195,0-1.057,0-1.597c0.2676-0.1912,0.5741-0.1337,0.851-0.1974
	...
	C17.288,825.2728,17.2333,825.2184,17.012,824.8911z`,
              })),
              (el = (0, a.jsx)("path", {
                d: `M13.5887,790.6611c0.2721-0.0992,0.5206,0.0728,0.7845,0.0879c0.2679,0.0153,0.5339,0.0627,0.8217,0.0987
	...
	C13.5072,792.3281,13.4701,791.1992,13.5887,790.6611z`,
              })),
              (er = (0, a.jsx)("path", {
                d: `M18.0615,791.2171c0.5461-0.1455,1.0418-0.2776,1.5717-0.4188c0.0305,0.0724,0.0856,0.1426,0.0852,0.2125
	c-0.0021,0.4345-0.0123,0.8691-0.0283,1.3034c0.0274,0.9693-1.6691,1.3854-1.6836,0.2415
	C18.0292,792.1242,17.9822,791.6891,18.0615,791.2171z`,
              })),
              (ei = (0, a.jsx)("path", {
                d: `M11.7914,854.0692c0.5017,0.0974,0.9828,0.1907,1.4557,0.2825c0.0396,0.0781,0.0882,0.1311,0.0914,0.1867
	...
	C11.7016,854.2997,11.7539,854.2023,11.7914,854.0692z`,
              })),
              (en = (0, a.jsx)("path", {
                d: `M16.1195,855.1567c0.3462-0.1072,1.3983-0.255,1.6934-0.2408c0.017,0.0743,0.0494,0.1532,0.0507,0.2327
	...
	C16.102,856.2589,16.0865,855.7017,16.1195,855.1567z`,
              })),
              (es = (0, a.jsx)("path", {
                d: `M14.3467,758.7624c0.2773-0.0797,0.5298,0.0552,0.7926,0.0846c0.2654,0.0297,0.5311,0.0566,0.7843,0.0835
	...
	C14.2837,759.2549,14.2176,759.0026,14.3467,758.7624z`,
              })),
              (eo = (0, a.jsx)("path", {
                d: `M18.8053,759.0404c0.5126-0.1778,1.0155-0.3523,1.5209-0.5276c0.127,0.5369,0.1059,1.3105-0.0437,1.8008
	c-0.4523,0.1139-0.9101,0.2291-1.3984,0.3521c-0.0385-0.0596-0.1138-0.1229-0.1171-0.1897
	C18.7436,760.0009,18.7374,759.5253,18.8053,759.0404z`,
              })),
              (ed = (0, a.jsx)("path", {
                d: `M11.2813,885.7745c0.5204,0.1176,0.9623,0.2173,1.432,0.3234c0.0242,0.124,0.0616,0.2407,0.0675,0.3589
	...
	c-0.0605-0.6393-0.0752-1.2833-0.0942-1.9258C11.1645,886.0326,11.2356,885.9171,11.2813,885.7745z`,
              })),
              (em = (0, a.jsx)("path", {
                d: `M15.5517,886.9095c0.5602-0.0697,1.0925-0.1359,1.6538-0.2057c0.0243,0.1091,0.0627,0.2051,0.0644,0.3018
	...
	c-0.0863-0.0819-0.1704-0.2019-0.1877-0.3148C15.4797,888.0369,15.4657,887.4813,15.5517,886.9095z`,
              })),
              (ez = (0, a.jsx)("path", {
                d: `M10.9552,917.5526c0.4853,0.1108,0.9424,0.215,1.4225,0.3246c0.0242,0.1354,0.0591,0.254,0.0645,0.3739
	...
	C10.861,917.7751,10.9156,917.6811,10.9552,917.5526z`,
              })),
              (eu = (0, a.jsx)("path", {
                d: `M15.1724,918.7182c0.5773-0.063,1.1089-0.121,1.6653-0.1818c0.0246,0.1077,0.0662,0.2056,0.0661,0.3034
	...
	C15.1255,919.7394,15.1055,919.2608,15.1724,918.7182z`,
              })),
              (ef = (0, a.jsx)("path", {
                d: `M14.7114,727.2189c0.6053,0.0167,1.1809,0.0325,1.7726,0.0488c0.1579,0.3947,0.1429,0.7664,0.0171,1.134
	c-0.4799,0.09-1.2849,0.0977-1.7366,0.0214C14.6036,728.0228,14.5944,727.8668,14.7114,727.2189z`,
              })),
              (eh = (0, a.jsx)("path", {
                d: `M20.7556,727.8386c-0.5239,0.1198-1.0382,0.2695-1.5938,0.3362c-0.0881-0.3497-0.0619-0.6714,0.0064-1.0101
	c0.5474-0.1573,1.0811-0.3107,1.6451-0.4727C20.9066,727.1033,20.8831,727.4624,20.7556,727.8386z`,
              })),
              (eM = (0, a.jsx)("path", {
                d: `M10.7822,949.3776c0.4842,0.1151,0.9064,0.2154,1.3587,0.3229c0.0307,0.1049,0.089,0.2186,0.0938,0.3346
	...
	c-0.1174-0.7172-0.1781-1.4437-0.1073-2.1725C10.6797,949.5553,10.7345,949.4841,10.7822,949.3776z`,
              })),
              (eg = (0, a.jsx)("path", {
                d: `M14.9569,950.5404c0.6018-0.0294,1.0762-0.0701,1.6458-0.1489c0.0342,0.0912,0.0715,0.1464,0.0733,0.2026
	...
	c-0.102-0.0909-0.2021-0.232-0.2194-0.3614C14.9111,951.7193,14.8746,951.1635,14.9569,950.5404z`,
              })),
              (ev = (0, a.jsx)("path", {
                d: `M12.1128,984.1284c-0.1912,0.2973-0.4457,0.3459-0.729,0.2693c-0.3945-0.1067-0.6821-0.3646-0.7337-0.7672
	...
	C12.1503,984.0182,12.1305,984.0587,12.1128,984.1284z`,
              })),
              (ex = (0, a.jsx)("path", {
                d: `M14.822,982.4386c0.583-0.0541,1.0981-0.1018,1.6236-0.1506c0.0268,0.0499,0.0784,0.1022,0.0805,0.1566
	...
	C14.7674,983.6367,14.7414,983.062,14.822,982.4386z`,
              })),
              (ey = (0, a.jsx)("path", {
                d: `M17.3053,695.7092c-0.0281,0.0989-0.0494,0.174-0.0676,0.2382c-0.6134,0.1102-1.8552,0.1324-2.6923,0.0524
	...
	C17.1619,695.64,17.1996,695.668,17.3053,695.7092z`,
              })),
              (eC = (0, a.jsx)("path", {
                d: `M21.3817,695.056c-0.0469,0.1277-0.074,0.2016-0.1134,0.3088c-0.6982,0.2234-1.4206,0.3455-2.1822,0.4304
	c-0.0376-0.1202-0.0645-0.2062-0.0907-0.2902C19.3212,695.3817,20.8773,695.0866,21.3817,695.056z`,
              })),
              (ew = (0, a.jsx)("path", {
                d: `M10.5584,1013.1666c0.515,0.123,0.955,0.2281,1.4164,0.3384c0.1073,0.6641,0.087,1.3254,0.1266,1.9938
	...
	c-0.021-0.4991-0.0338-0.9987-0.0392-1.4983C10.484,1013.483,10.5239,1013.3633,10.5584,1013.1666z`,
              })),
              (eb = (0, a.jsx)("path", {
                d: `M14.7425,1014.3286c0.6043,0.0502,1.1272-0.127,1.6631-0.0932c0.0317,0.0878,0.0691,0.1446,0.0705,0.2024
	...
	C14.7302,1015.4083,14.6927,1014.9137,14.7425,1014.3286z`,
              })),
              (ej = (0, a.jsx)("path", {
                d: `M10.5328,1077.1185c0.4656,0.1068,0.9034,0.2072,1.3735,0.3149c0.029,0.1038,0.0842,0.217,0.0892,0.3325
	...
	c-0.0319-0.5782-0.0539-1.1575-0.0653-1.7366C10.4461,1077.4374,10.4982,1077.2976,10.5328,1077.1185z`,
              })),
              (e_ = (0, a.jsx)("path", {
                d: `M16.3681,1078.152c0.0951,0.3702,0.0631,0.7018,0.0757,1.028c0.0103,0.2682,0.0194,0.5403-0.0138,0.8052
	c-0.0814,0.8593-1.5522,0.8682-1.6931,0.0697c-0.0936-0.5667-0.1285-1.1417-0.0373-1.7485
	C15.2527,1078.2551,15.7809,1078.2063,16.3681,1078.152z`,
              })),
              (eN = (0, a.jsx)("path", {
                d: `M10.5476,1045.1556c0.4648,0.026,0.8794,0.2429,1.3547,0.2635c0.0371,0.1266,0.0942,0.2393,0.0997,0.3544
	...
	c-0.0254-0.6613-0.0442-1.3228-0.0573-1.9844C10.4713,1045.3313,10.5175,1045.2531,10.5476,1045.1556z`,
              })),
              (eS = (0, a.jsx)("path", {
                d: `M14.7137,1046.301c0.5746-0.0295,1.0454-0.0645,1.5755-0.135c0.135,0.0597,0.149,0.1646,0.1516,0.2675
	...
	c-0.1029-0.0913-0.2112-0.226-0.2304-0.3539C14.6656,1047.5122,14.6311,1046.9382,14.7137,1046.301z`,
              })),
              (eI = (0, a.jsx)("path", {
                d: `M10.5048,1109.6195c0.5349,0.0525,1.0642,0.2411,1.6318,0.2849c0.035,0.1135,0.0856,0.2083,0.0905,0.3055
	...
	c-0.1249-0.5486-0.164-1.1086-0.0949-1.6709C10.4159,1109.7129,10.4576,1109.6826,10.5048,1109.6195z`,
              })),
              (eE = (0, a.jsx)("path", {
                d: `M14.6919,1110.5995c0.2906-0.1099,0.6081-0.0488,0.9136-0.0895c0.3081-0.0411,0.6183-0.0669,0.9618-0.1029
	...
	C14.5993,1111.5563,14.6158,1110.9629,14.6919,1110.5995z`,
              })),
              (eT = (0, a.jsx)("path", {
                d: `M21.2072,661.7713c0.0549,0.2061,0.1144,0.3417,0.1225,0.4803c0.0134,0.2277-0.0006,0.4576-0.0135,0.686
	...
	c0.3002-0.1063,0.6178-0.2042,0.9233-0.3311C20.5767,662.0953,20.8495,661.9459,21.2072,661.7713z`,
              })),
              (eL = (0, a.jsx)("path", {
                d: `M14.8231,663.2112c0.0728-0.0338,0.1089-0.0648,0.1454-0.0653c0.6998-0.0098,1.3997-0.0159,2.1296-0.0231
	c0.0909,0.2518,0.0798,0.4964,0.0268,0.7349c-0.0558,0.2508-0.2069,0.4484-0.4736,0.6298c-0.3992,0-0.8513,0-1.3605,0
	C14.887,664.2917,14.6728,663.6359,14.8231,663.2112z`,
              })),
              (eA = (0, a.jsx)("path", {
                d: `M12.5479,1142.6373c0.1611,0.4943,0.1823,0.9581-0.2563,1.3568c-0.5072,0.0503-0.9805-0.118-1.4469-0.1665
	...
	C12.0499,1142.525,12.3045,1142.4974,12.5479,1142.6373z`,
              })),
              (eP = (0, a.jsx)("path", {
                d: `M16.2102,1144.2554c-0.2711,0-0.5409,0-0.8312,0c-0.3131-0.0981-0.5783-0.2906-0.7425-0.5994
	...
	C17.2025,1143.3199,16.9843,1143.8143,16.2102,1144.2554z`,
              })),
              (eD = (0, a.jsx)("path", {
                d: `M19.6579,600.0674c-0.0425-0.1044-0.0856-0.2327-0.0825-0.3508c0.0102-0.5176,0.0222-1.0353,0.038-1.5527
	...
	C20.2329,600.3828,19.9164,600.3959,19.6579,600.0674z`,
              })),
              (e$ = (0, a.jsx)("path", {
                d: `M16.8425,598.8096c0.1445,0.4332,0.0583,0.8815,0.0438,1.3255c-0.2099,0.4327-0.5501,0.6124-1.0109,0.5473
	...
	C15.9125,598.8065,16.3637,598.8096,16.8425,598.8096z`,
              })),
              (eO = (0, a.jsx)("path", {
                d: `M19.6321,630.0346c0.4983-0.2686,0.9652-0.5202,1.4645-0.7893c0.0316,0.1456,0.0782,0.2617,0.0783,0.3777
	...
	C19.6031,631.0907,19.6182,630.5544,19.6321,630.0346z`,
              })),
              (eF = (0, a.jsx)("path", {
                d: `M15.237,630.8452c0.5233-0.0123,1.0555-0.0248,1.6156-0.038c0.147,0.4683,0.0756,0.9369,0.0345,1.3593
	c-0.2355,0.5031-0.7906,0.66-1.2533,0.4479c-0.2219-0.0956-0.3699-0.2614-0.4274-0.5029
	C15.1465,631.8596,15.1549,631.2662,15.237,630.8452z`,
              })),
              (eH = (0, a.jsx)("path", {
                d: `M21.0527,565.2231c0.0374,0.1325,0.068,0.1907,0.068,0.2488c0,0.5607,0.0011,1.1214-0.0127,1.6818
	...
	c0.0177-0.5587,0.0385-1.1173,0.0582-1.6689C20.0659,565.7454,20.5336,565.4979,21.0527,565.2231z`,
              })),
              (eB = (0, a.jsx)("path", {
                d: `M15.1565,566.7897c0.6131,0,1.0389,0,1.6396,0c0.023,0.0776,0.0712,0.171,0.0748,0.2661
	...
	C15.1042,567.6349,15.0748,567.2418,15.1565,566.7897z`,
              })),
              (eV = (0, a.jsx)("path", {
                d: `M14.7704,1175.667c-0.0466-0.0964-0.0811-0.1677-0.1125-0.2328c0.0394-0.0432,0.0629-0.0939,0.0939-0.0989
	...
	C16.6837,1175.7052,15.5512,1175.752,14.7704,1175.667z`,
              })),
              (eU = (0, a.jsx)("path", {
                d: `M12.9877,1175.3165c-0.0169,0.0797-0.0327,0.1544-0.0466,0.2201c-0.6269,0.0726-1.9842-0.1289-2.5093-0.3678
	...
	C12.8627,1175.2449,12.9154,1175.2842,12.9877,1175.3165z`,
              })),
              (eW = (0, a.jsx)("path", {
                d: `M19.4989,533.9736c0.5378-0.2835,0.9932-0.5237,1.4571-0.7682c0.0312,0.0704,0.0717,0.1236,0.0773,0.1803
	...
	C19.4857,534.4062,19.4932,534.1791,19.4989,533.9736z`,
              })),
              (eq = (0, a.jsx)("path", {
                d: `M16.7,534.7396c0.0833,0.3935,0.1083,1.038,0.062,1.2713c-0.034,0.1714-0.1227,0.309-0.257,0.4142
	...
	C15.7111,534.7373,16.1884,534.7396,16.7,534.7396z`,
              })),
              (t = (0, a.jsx)("path", {
                d: `M19.3875,503.8371c0-0.6326,0-1.2744,0-1.9011c0.5016-0.2638,0.9748-0.5126,1.4719-0.7741
	...
	C20.0177,504.3517,19.5364,504.2686,19.3875,503.8371z`,
              })),
              (r = (0, a.jsx)("path", {
                d: `M15.0341,502.6735c0.5148,0,1.0475,0,1.5963,0c0.1085,0.4418,0.0763,0.8728,0.0218,1.3021
	...
	c-0.0179-0.3711-0.0113-0.7434-0.009-1.1151C14.9491,502.7646,14.9928,502.7316,15.0341,502.6735z`,
              })),
              (i = (0, a.jsx)("path", {
                d: `M17.6744,1207.1587c-0.037,0.1484-0.056,0.2249-0.0726,0.2916c-0.5864,0.1708-1.7491,0.2267-2.4983,0.1187
	...
	C16.0771,1207.201,16.8374,1207.1815,17.6744,1207.1587z`,
              })),
              (n = (0, a.jsx)("path", {
                d: `M13.281,1207.1997c0,0.1222,0,0.1809,0,0.234c-0.0402,0.0297-0.0701,0.0686-0.1056,0.0746
	...
	C11.6638,1207.0106,12.4491,1207.0717,13.281,1207.1997z`,
              })),
              (s = (0, a.jsx)("path", {
                d: `M19.2881,469.8479c0.5297-0.2671,0.9888-0.4986,1.4364-0.7243c0.1315,0.0593,0.1471,0.1661,0.1466,0.2684
	c-0.0023,0.5619-0.006,1.1239-0.0203,1.6856c-0.0037,0.1436-0.0332,0.2906-0.0756,0.4284
	c-0.1742,0.7444-1.4789,1.0224-1.5274,0.0749C19.237,471.0074,19.249,470.4185,19.2881,469.8479z`,
              })),
              (o = (0, a.jsx)("path", {
                d: `M14.8039,470.6013c0.6447,0,1.0753,0,1.7026,0c0.0214,0.0886,0.063,0.1835,0.0637,0.2788
	c0.0024,0.3111,0.014,0.6251-0.0228,0.9326c-0.1192,0.9314-1.6112,0.9008-1.7131-0.0233
	C14.7936,471.364,14.8052,471.0623,14.8039,470.6013z`,
              })),
              (d = (0, a.jsx)("path", {
                d: `M19.184,437.7076c0.2579-0.1091,0.5047-0.2142,0.7521-0.3178c0.2412-0.101,0.4231-0.3243,0.7081-0.3715
	...
	C19.1356,438.2421,19.0894,437.9696,19.184,437.7076z`,
              })),
              (m = (0, a.jsx)("path", {
                d: `M14.7136,438.5184c0.0623-0.0223,0.101-0.0481,0.1398-0.0483c0.4942-0.0027,0.9884-0.0018,1.4733-0.0018
	...
	C14.653,438.6588,14.6951,438.5816,14.7136,438.5184z`,
              })),
              (z = (0, a.jsx)("path", {
                d: `M15.5657,1239.355c-0.031-0.0977-0.0544-0.1713-0.071-0.2235c0.0469-0.0518,0.0694-0.1003,0.0991-0.1051
	...
	C17.4961,1239.3754,16.4688,1239.4396,15.5657,1239.355z`,
              })),
              (u = (0, a.jsx)("path", {
                d: `M13.7453,1239.0638c-0.0041,0.0723-0.0085,0.1486-0.0129,0.226c-0.0743,0.028-0.1318,0.0701-0.1872,0.0674
	c-0.7853-0.0367-1.5696-0.0862-2.3774-0.2483c-0.0187-0.0924-0.0362-0.1793-0.0507-0.2509
	C11.2407,1238.7766,13.2917,1238.9548,13.7453,1239.0638z`,
              })),
              (f = (0, a.jsx)("path", {
                d: `M19.0003,405.6095c0.5046-0.2453,0.9664-0.4698,1.4446-0.7023c0.1056,0.0208,0.1343,0.1251,0.1392,0.2251
	...
	C18.9515,406.812,18.9513,406.1913,19.0003,405.6095z`,
              })),
              (h = (0, a.jsx)("path", {
                d: `M14.5509,406.3063c0.5577,0,1.0742,0,1.5828,0c0.0355,0.0381,0.0863,0.067,0.0874,0.0975
	...
	c-0.0356-0.2026-0.0294-0.4138-0.0298-0.6211C14.4869,406.7505,14.446,406.541,14.5509,406.3063z`,
              })),
              (M = (0, a.jsx)("path", {
                d: `M18.7687,373.3394c0.523-0.2332,1.007-0.4491,1.5251-0.6801c0.0346,0.0903,0.0853,0.1614,0.0857,0.2329
	...
	c-0.0181-0.3924,0.0017-0.7867,0.0071-1.1801C18.7558,373.7711,18.7636,373.5457,18.7687,373.3394z`,
              })),
              (g = (0, a.jsx)("path", {
                d: `M14.31,373.9959c0.5771,0,1.0923,0,1.6349,0c0.0279,0.1053,0.072,0.1996,0.0747,0.2951
	...
	c-0.0151-0.3105-0.0202-0.6216-0.0219-0.9326C14.2605,374.1989,14.2873,374.1204,14.31,373.9959z`,
              })),
              (v = (0, a.jsx)("path", {
                d: `M13.9629,1269.6284c0.2758,0.4408,0.3009,0.854,0.1268,1.3066c-0.3712,0.0931-0.7328-0.0624-1.1001-0.0522
	...
	C12.6468,1269.5499,13.2874,1269.5887,13.9629,1269.6284z`,
              })),
              (x = (0, a.jsx)("path", {
                d: `M16.384,1270.9828c-0.2179-0.1826-0.2645-0.4025-0.2698-0.6364c-0.0057-0.2489-0.0137-0.5006,0.2184-0.7352
	...
	c-0.3239,0.0929-0.6791,0.0105-1.0265,0.0422C17.022,1270.9353,16.6925,1270.9583,16.384,1270.9828z`,
              })),
              (y = (0, a.jsx)("path", {
                d: `M18.5055,340.8394c0.531-0.1995,0.9937-0.3733,1.4877-0.5588c0.0502,0.1141,0.1371,0.2213,0.1385,0.3296
	...
	C18.4909,342.1788,18.4982,341.5182,18.5055,340.8394z`,
              })),
              (C = (0, a.jsx)("path", {
                d: `M14.0689,341.4051c0.5516,0,1.0672,0,1.6114,0c0.0278,0.1129,0.0693,0.2082,0.0717,0.3045
	...
	C13.9734,342.7985,13.9882,341.8221,14.0689,341.4051z`,
              })),
              (w = (0, a.jsx)("path", {
                d: `M18.2249,308.0975c0.4702-0.1312,0.9054-0.2527,1.3681-0.3818c0.0718,0.1112,0.1584,0.2034,0.1947,0.3123
	...
	C18.1692,308.3166,18.1976,308.2366,18.2249,308.0975z`,
              })),
              (b = (0, a.jsx)("path", {
                d: `M13.6986,308.5526c0.5787-0.0283,1.1075-0.0358,1.6324,0.0203c0.0295,0.0883,0.0639,0.145,0.0652,0.2025
	...
	C13.6478,308.7792,13.674,308.6992,13.6986,308.5526z`,
              })),
              (j = (0, a.jsx)("path", {
                d: `M18.1316,1299.6483c0.4385,0.1907,0.6389,0.4675,0.6494,0.8539c0.0136,0.4977,0.0017,0.9962-0.0079,1.4941
	...
	C17.6132,1299.6851,17.8803,1299.6661,18.1316,1299.6483z`,
              })),
              (_ = (0, a.jsx)("path", {
                d: `M14.2491,1302.2902c-0.294-0.021-0.6008-0.0558-0.9082-0.0613c-0.2878-0.0051-0.5762,0.021-0.8852,0.0344
	...
	c0.0417,0.5344,0.0293,1.0731,0.0348,1.61C14.3339,1302.207,14.2877,1302.2395,14.2491,1302.2902z`,
              })),
              (N = (0, a.jsx)("path", {
                d: `M18.0885,275.1403c0.3098-0.0572,0.634-0.1171,0.9341-0.1725c0.3,0.1035,0.4108,0.3199,0.4663,0.5703
	...
	C17.8383,275.4714,17.8907,275.3118,18.0885,275.1403z`,
              })),
              (S = (0, a.jsx)("path", {
                d: `M13.424,275.4944c0.5056-0.0242,0.9984-0.0175,1.5137-0.0048c0.0383,0.1425,0.0925,0.2569,0.0963,0.3728
	...
	c-0.0158-0.4975-0.0337-0.9951-0.0421-1.4928C13.2967,275.9568,13.2685,275.7449,13.424,275.4944z`,
              })),
              (I = (0, a.jsx)("path", {
                d: `M18.7955,1333.6779c-0.2824-0.0153-0.5496-0.0569-0.812-0.0363c-0.2622,0.0205-0.5196,0.1031-0.8062,0.1644
	...
	c0.005,0.6,0.003,1.2001-0.0031,1.8C18.859,1333.515,18.8195,1333.5919,18.7955,1333.6779z`,
              })),
              (E = (0, a.jsx)("path", {
                d: `M14.3014,1333.7319c-0.4933-0.1172-0.9842-0.1469-1.451-0.0034c-0.1652-0.0668-0.1739-0.1974-0.1775-0.3192
	...
	C14.3726,1333.6019,14.3314,1333.6571,14.3014,1333.7319z`,
              })),
              (T = (0, a.jsx)("path", {
                d: `M18.9058,1365.2672c-0.3521-0.0178-0.6201-0.0547-0.8846-0.0376c-0.2427,0.0154-0.4817,0.0892-0.7474,0.1423
	...
	c0.2075-0.8455,1.4156-0.8573,1.6424-0.0161C18.9805,1363.6512,18.9552,1364.4336,18.9058,1365.2672z`,
              })),
              (L = (0, a.jsx)("path", {
                d: `M14.4149,1365.2822c-0.5297-0.0449-1.0418-0.1039-1.5671,0.0461c-0.039-0.0956-0.0914-0.1659-0.0933-0.2374
	...
	C14.4638,1365.0968,14.4352,1365.1752,14.4149,1365.2822z`,
              })),
              (A = (0, a.jsx)("path", {
                d: `M17.5111,244.071c0.0062-0.715-0.1558-1.8465,0.8436-1.8986c0.5134-0.032,0.8735,0.4323,0.882,0.9236
	...
	c-0.0056-0.2897-0.0017-0.5796-0.0017-0.8694C17.5125,244.071,17.5118,244.071,17.5111,244.071z`,
              })),
              (P = (0, a.jsx)("path", {
                d: `M13.3394,242.4234c0.3659,0,0.7145,0,1.0623,0c0.2508,0.1763,0.3446,0.4205,0.3491,0.7018
	...
	c-0.0158-0.5592-0.0345-1.1186-0.0363-1.6779C13.0093,242.8543,13.0275,242.8356,13.3394,242.4234z`,
              })),
              (D = (0, a.jsx)("path", {
                d: `M18.9014,1396.9865c-0.798-0.0811-0.8433-0.1049-1.6081,0.1097c-0.0198-0.1149-0.0498-0.2106-0.0507-0.3064
	...
	c0.0039,0.6007,0.0035,1.2013-0.0014,1.802C18.9632,1396.796,18.9283,1396.8746,18.9014,1396.9865z`,
              })),
              ($ = (0, a.jsx)("path", {
                d: `M14.4304,1396.9952c-0.2669-0.025-0.5318-0.0724-0.796-0.0684c-0.2438,0.0037-0.4869,0.0625-0.6957,0.092
	...
	C14.4876,1396.8538,14.4549,1396.9126,14.4304,1396.9952z`,
              })),
              (O = (0, a.jsx)("path", {
                d: `M18.8936,1428.8209c-0.5488-0.1421-1.0563-0.1091-1.5793,0.0735c-0.0258-0.1338-0.0595-0.23-0.0605-0.3264
	...
	C18.9777,1428.6329,18.9404,1428.6895,18.8936,1428.8209z`,
              })),
              (F = (0, a.jsx)("path", {
                d: `M14.4444,1428.7808c-0.2687-0.0165-0.5331-0.0499-0.7966-0.0438c-0.245,0.0057-0.489,0.0536-0.7639,0.0864
	...
	C14.501,1428.642,14.4687,1428.6997,14.4444,1428.7808z`,
              })),
              (H = (0, a.jsx)("path", {
                d: `M18.9242,1460.637c-0.7738-0.0972-0.8495-0.087-1.617,0.0929c-0.0196-0.1331-0.0503-0.249-0.0516-0.3651
	...
	c0.006,0.6007,0.0041,1.2013-0.0008,1.802C18.9854,1460.447,18.9509,1460.5254,18.9242,1460.637z`,
              })),
              (B = (0, a.jsx)("path", {
                d: `M14.424,1460.6456c-0.5092-0.0856-1.0013-0.0918-1.446,0.0402c-0.1616-0.0634-0.1782-0.1705-0.1809-0.2717
	...
	C14.5014,1460.4769,14.4551,1460.5518,14.424,1460.6456z`,
              })),
              (V = (0, a.jsx)("path", {
                d: `M19.1099,211.5573c-0.0282,0.4137-0.0235,0.8331-0.0925,1.2399c-0.0979,0.5771-0.7678,0.8598-1.2601,0.5618
	...
	C19.0811,211.5564,19.0955,211.5568,19.1099,211.5573z`,
              })),
              (U = (0, a.jsx)("path", {
                d: `M14.6132,211.649c-0.0092,0.3922,0.0252,0.7915-0.0247,1.1806c-0.0751,0.3732-0.3617,0.6375-0.7182,0.6785
	...
	C14.5951,211.649,14.6041,211.649,14.6132,211.649z`,
              })),
              (W = (0, a.jsx)("path", {
                d: `M18.9083,1492.5293c-0.2879-0.0205-0.5556-0.0647-0.8203-0.0514c-0.2425,0.0122-0.4818,0.0864-0.7099,0.1309
	...
	C18.9774,1492.402,18.9478,1492.4386,18.9083,1492.5293z`,
              })),
              (q = (0, a.jsx)("path", {
                d: `M14.4404,1492.5372c-0.5125-0.0697-1.0067-0.1057-1.4587,0.0453c-0.1532-0.0559-0.1793-0.1589-0.1822-0.2625
	...
	c0.0092,0.6226,0.0109,1.2452,0.0123,1.8678C14.5018,1492.3939,14.477,1492.4319,14.4404,1492.5372z`,
              })),
              (G = (0, a.jsx)("path", {
                d: `M18.9316,1524.4644c-0.7286-0.1008-0.7286-0.1008-1.6162,0.0626c-0.0194-0.0715-0.0561-0.1453-0.0568-0.2192
	...
	c0.0154,0.5812,0.0034,1.1632-0.0017,1.7449C18.9864,1524.272,18.9556,1524.3513,18.9316,1524.4644z`,
              })),
              (Z = (0, a.jsx)("path", {
                d: `M14.4421,1524.467c-0.5108-0.1122-1.0204-0.1061-1.4851,0.0352c-0.1525-0.0826-0.1578-0.1941-0.1607-0.2932
	...
	C14.5007,1524.3229,14.4678,1524.3815,14.4421,1524.467z`,
              })),
              (Q = (0, a.jsx)("path", {
                d: `M17.2618,179.2488c0-0.2702-0.0046-0.5406,0.0019-0.8107c0.0034-0.1443,0.0074-0.2929,0.0434-0.4312
	...
	C17.2651,179.2488,17.2635,179.2488,17.2618,179.2488z`,
              })),
              (Y = (0, a.jsx)("path", {
                d: `M14.5223,179.3327c0,0.3321,0.0076,0.6645-0.0036,0.9962c-0.0048,0.1421-0.0262,0.2921-0.0794,0.4225
	...
	C14.5097,179.3327,14.516,179.3327,14.5223,179.3327z`,
              })),
              (X = (0, a.jsx)("path", {
                d: `M17.3061,1556.4907c-0.0227-0.13-0.0481-0.21-0.0488-0.2902c-0.0052-0.6243-0.0079-1.2484-0.0055-1.8727
	...
	C17.849,1556.3558,17.6083,1556.4312,17.3061,1556.4907z`,
              })),
              (J = (0, a.jsx)("path", {
                d: `M12.8606,1556.4491c-0.0306-0.1298-0.0635-0.209-0.0657-0.2889c-0.0167-0.6016-0.035-1.2034-0.0373-1.8051
	...
	C13.4042,1556.353,13.1612,1556.4073,12.8606,1556.4491z`,
              })),
              (cc = (0, a.jsx)("path", {
                d: `M18.9078,1588.3741c-0.285-0.0309-0.5507-0.0924-0.8125-0.0787c-0.2614,0.0134-0.5189,0.1023-0.7982,0.1625
	...
	C18.9811,1588.2073,18.9373,1588.2816,18.9078,1588.3741z`,
              })),
              (ce = (0, a.jsx)("path", {
                d: `M12.8666,1588.4209c-0.0316-0.1433-0.0759-0.2583-0.0795-0.3748c-0.0175-0.5605-0.0315-1.1215-0.0296-1.6823
	...
	C13.3824,1588.3062,13.1417,1588.3739,12.8666,1588.4209z`,
              })),
              (ct = (0, a.jsx)("path", {
                d: `M16.931,1652.0654c-0.0412-0.0756-0.089-0.1632-0.1542-0.2826c0.0538-0.0385,0.0987-0.0958,0.1518-0.1047
	c0.3445-0.0581,2.0154-0.0465,2.442,0.0133c-0.0149,0.1067-0.0297,0.2136-0.0428,0.3075
	C18.8308,1652.1042,17.6005,1652.1365,16.931,1652.0654z`,
              })),
              (ca = (0, a.jsx)("path", {
                d: `M12.3327,1652.1866c-0.0363-0.1125-0.055-0.1702-0.0719-0.2225c0.0308-0.0396,0.0506-0.0923,0.0808-0.099
	...
	c-0.7066,0.0338-1.4134,0.0653-2.1204,0.0913C12.6585,1652.214,12.5149,1652.1959,12.3327,1652.1866z`,
              })),
              (cr = (0, a.jsx)("path", {
                d: `M12.6809,1620.3843c-0.2811-0.4017-0.1722-0.8066-0.1974-1.1869c-0.0196-0.2961,0.0339-0.5779,0.2877-0.8342
	c0.5355-0.098,1.1084-0.108,1.6451-0.0911c0.2295,0.1831,0.3361,0.387,0.3487,0.6195c0.0243,0.4468,0.1065,0.9-0.0632,1.3679
	C14.0327,1620.2583,13.3715,1620.1807,12.6809,1620.3843z`,
              })),
              (ci = (0, a.jsx)("path", {
                d: `M19.0561,1620.2791c-0.3418-0.0315-0.65-0.0808-0.9585-0.0824c-0.2887-0.0016-0.5777,0.0472-0.903,0.0773
	...
	C19.231,1619.3689,19.3165,1619.8116,19.0561,1620.2791z`,
              })),
              (cn = (0, a.jsx)("path", {
                d: `M16.9014,84.0646c-0.0407-0.1123-0.0735-0.2027-0.1085-0.2993c0.0829-0.0465,0.1333-0.099,0.1848-0.1
	...
	C18.8503,84.1042,17.6684,84.1389,16.9014,84.0646z`,
              })),
              (cs = (0, a.jsx)("path", {
                d: `M12.3033,84.1328c-0.0127-0.0709-0.0258-0.1446-0.0385-0.2152c0.5381-0.158,2.1845-0.2244,2.8085-0.1117
	c-0.0117,0.0881-0.0237,0.1781-0.0349,0.2626c-0.0872,0.0311-0.143,0.0671-0.1998,0.0689
	c-0.7828,0.0252-1.5657,0.0471-2.3487,0.0642C12.4335,84.2028,12.3763,84.1609,12.3033,84.1328z`,
              })),
              (co = (0, a.jsx)("path", {
                d: `M18.1033,145.2827c0.6754,0.1843,0.8642,0.4016,0.8831,1.0799c0.0156,0.5611,0.0092,1.1231-0.0001,1.6845
	c0.0218,1.4265-1.7836,1.422-1.7345,0.0627c-0.0027-0.6032-0.0084-1.2064-0.0023-1.8095
	C17.256,145.66,17.4367,145.4514,18.1033,145.2827z`,
              })),
              (cd = (0, a.jsx)("path", {
                d: `M14.5087,147.3001c-0.0089,0.3921,0.0232,0.7909-0.021,1.1804c-0.074,0.3883-0.397,0.6589-0.7861,0.6725
	...
	C14.496,147.3001,14.5024,147.3001,14.5087,147.3001z`,
              })),
              (cm = (0, a.jsx)("path", {
                d: `M18.0877,17.2732c0.6846,0.2012,0.8768,0.4142,0.8964,1.0472c0.0187,0.6026,0.0088,1.2062-0.0003,1.8092
	c-0.0183,1.2512-1.6218,1.3402-1.7292,0.1474c-0.0023-0.7071-0.0142-1.4145-0.0013-2.1214
	C17.2503,17.654,17.5947,17.3449,18.0877,17.2732z`,
              })),
              (cz = (0, a.jsx)("path", {
                d: `M14.5025,19.3243c0,0.3524,0.022,0.7065-0.0052,1.0569c-0.0496,0.9147-1.3548,1.0555-1.628,0.2088
	...
	c0.0071,0.3109,0.0022,0.622,0.0022,0.933C14.4941,19.3243,14.4983,19.3243,14.5025,19.3243z`,
              })),
              (cu = (0, a.jsx)("path", {
                d: `M13.9237,49.6348c0.4848,0.1909,0.6727,0.556,0.6842,1.0306c0.0111,0.4559,0.0135,0.912,0.0167,1.368
	...
	C13.6511,49.6313,13.7958,49.6348,13.9237,49.6348z`,
              })),
              (cp = (0, a.jsx)("path", {
                d: `M17.7359,49.6033c0.6826-0.1068,1.2147,0.0643,1.3196,0.8228c-0.0003,0.5603,0.015,1.1215-0.0101,1.6808
	...
	C17.1471,50.2119,17.2816,49.8615,17.7359,49.6033z`,
              })),
              (ch = (0, a.jsx)("path", {
                d: `M12.7791,114.2197c0.5685-0.0845,1.1226-0.1157,1.7016-0.0584c0.0306,0.1345,0.0763,0.2516,0.081,0.3704
	...
	C12.6995,114.3538,12.7329,114.3166,12.7791,114.2197z`,
              })),
              (cM = (0, a.jsx)("path", {
                d: `M18.7221,116.7564c-0.4135,0-0.8254,0-1.2134,0c-0.2256-0.1355-0.3023-0.3315-0.3046-0.5413
	...
	C19.0331,116.2927,18.9853,116.5354,18.7221,116.7564z`,
              })),
              (cg = (0, a.jsx)("path", {
                d: `M13.1918,1713.7344c0.3028,0,0.591,0,0.868,0c0.4008,0.2139,0.5776,0.5406,0.5822,0.9701
	...
	C12.6045,1714.3254,12.7757,1713.9932,13.1918,1713.7344z`,
              })),
              (cv = (0, a.jsx)("path", {
                d: `M17.7413,1713.636c0.2473,0,0.4754,0,0.6967,0c0.4571,0.17,0.6508,0.5221,0.6719,0.9677
	...
	c-0.0324-0.5388-0.0259-1.0817-0.0059-1.6216C17.1454,1714.1102,17.3526,1713.8301,17.7413,1713.636z`,
              })),
              (cx = (0, a.jsx)("path", {
                d: `M12.5506,1682.9004c0.6916-0.0922,1.4078-0.0698,2.0953-0.1123c0.2692,0.2023,0.2869,0.48,0.3003,0.7455
	...
	C12.3318,1683.5361,12.3003,1683.1982,12.5506,1682.9004z`,
              })),
              (cy = (0, a.jsx)("path", {
                d: `M19.2099,1682.7675c0.254,0.6693,0.1686,1.2161-0.3322,1.6964c-0.4998,0.0532-0.9937,0.0371-1.4735,0.0161
	c-0.5576-0.467-0.6623-0.9355-0.3752-1.6827c0.3464-0.1426,0.7224-0.0599,1.0883-0.0688
	C18.4658,1682.72,18.8184,1682.6926,19.2099,1682.7675z`,
              })),
              (eG[0] = e),
              (eG[1] = t),
              (eG[2] = r),
            ...
            : ((e = eG[0]),
              ...
              (eW = eG[160]),
              (eq = eG[161])),
          eG[162] !== eQ || eG[163] !== eX || eG[164] !== eJ
            ? ((eK = (0, a.jsxs)("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                width: eX,
                height: eJ,
                viewBox: "0 0 32 1728",
                className: "Idle-module__idle--_WWNO",
                "data-animation-state": eQ,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [
                  cW,
      ...
      try {
        p.displayName || (p.displayName = "CopilotAnimationIdle");
      } catch {}
      function f(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                viewBox: "0 0 32 1248",
                fill: "currentColor",
                className: "JumpWiggle-module__jumpWiggle--rDQC4",
                "data-animation-state": s,
                "aria-hidden": !0,
                children: [e, t],
              })),
      ...
      try {
        f.displayName || (f.displayName = "CopilotAnimationJumpWiggle");
      } catch {}
      function h(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                height: m,
                viewBox: "0 0 32 832",
                className: "Negative-module__negative--CW3iF",
                "data-animation-state": s,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t],
      ...
      try {
        h.displayName || (h.displayName = "CopilotAnimationNegative");
      } catch {}
      function M(c) {
        let e,
          t,
        ...
        return (
          n[0] === Symbol.for("react.memo_cache_sentinel")
            ? ((e = (0, a.jsx)("path", {
                d: `M24.4234,12.3467c0.3362,0.7559,0.7565,1.5491,0.9952,2.4495c0.1135,0.0555,0.2374,0.1299,0.3706,0.1789
	...
	C14.5481,13.8163,14.4949,12.6065,14.4839,11.6733z`,
              })),
              (t = (0, a.jsx)("path", {
                d: `M18.0801,17.2702c0.613,0,0.884,0.4186,0.9043,1.0525c0.0186,0.5818,0.0107,1.1647,0.001,1.7469
	...
	C17.2531,17.6478,17.5713,17.2702,18.0801,17.2702z`,
              })),
              (r = (0, a.jsx)("path", {
                d: `M14.4848,20.4914c0,0.4172-0.4046,0.6532-0.7945,0.6624c-0.6615-0.0026-0.9038-0.3537-0.9038-1.1018
	...
	C14.4974,19.3114,14.4848,20.1128,14.4848,20.4914z`,
              })),
              (n[0] = e),
              (n[1] = t),
              (n[2] = r))
          ...
          n[3] !== o || n[4] !== m || n[5] !== z
            ? ((i = (0, a.jsxs)("svg", {
                ...
                height: z,
                viewBox: "0 0 32 32",
                className: "Static-module__static--XPULt",
                "data-animation-state": o,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t, r],
      ...
      try {
        M.displayName || (M.displayName = "CopilotAnimationStatic");
      } catch {}
      function g(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                height: m,
                viewBox: "0 0 32 2240",
                className: "Thinking-module__thinking--S6ZhG",
                "data-animation-state": s,
                fill: "currentColor",
                "aria-hidden": !0,
                children: [e, t],
      ...
      try {
        g.displayName || (g.displayName = "CopilotAnimationThinking");
      } catch {}
      function v(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                viewBox: "0 0 32 1184",
                fill: "currentColor",
                className: "Tickle-module__tickle--rmq_s",
                "data-animation-state": s,
                "aria-hidden": !0,
                children: [e, t],
              })),
      ...
      try {
        v.displayName || (v.displayName = "CopilotAnimationTickle");
      } catch {}
      function x(c) {
        let e,
          t,
        ...
        return (
          ...
          i[2] !== s || i[3] !== d || i[4] !== m
            ? ((r = (0, a.jsxs)("svg", {
                ...
                viewBox: "0 0 32 928",
                fill: "currentColor",
                className: "UserInput-module__userInput--zF2uw",
                "data-animation-state": s,
                "aria-hidden": !0,
                children: [e, t],
              })),
      ...
      try {
        x.displayName || (x.displayName = "CopilotAnimationUserInput");
      } catch {}
      let y = "idle",
        C = "starting",
        w = "running",
        ...
        j = {
          [k.Thinking]: { [y]: 33, [C]: 429, [w]: 1390, [b]: 429 },
          [k.Affirmative]: { [y]: 33, [w]: 627 },
          [k.Celebrate]: { [y]: 33, [w]: 1056 },
          [k.Negative]: { [y]: 250, [w]: 792 },
          [k.Idle]: { [w]: 13483 },
          [k.Confirm]: { [y]: 33, [w]: 627 },
          [k.UserInput]: { [y]: 33, [C]: 363, [w]: 3e3, [b]: 528 },
          [k.Tickle]: { [y]: 33, [w]: 1188 },
          [k.JumpWiggle]: { [y]: 33, [w]: 1254 },
          [k.Activate]: { [y]: 33, [w]: 2e3 },
        },
        _ = (0, s.memo)(function (c) {
          let e,
            t,
            _,
            N,
          ...
          (R[0] === Symbol.for("react.memo_cache_sentinel")
            ? ((e = () => {
              ...
              (R[0] = e))
            : (e = R[0]),
            R[1] !== D ? ((t = [D]), (R[1] = D), (R[2] = t)) : (t = R[2]),
            (0, s.useEffect)(e, t));
          let Z = (0, i.M)($);
          (R[3] !== U || R[4] !== D || R[5] !== O || R[6] !== Z
            ? ((_ = () => {
                let c,
                  e = j[D];
                if (e && D !== k.Static) {
                  if (
                    ...
                    U === C &&
                      (c = setTimeout(() => {
                        (W(w), (q.current = Date.now()));
                      }, e[C] || 0)),
                    U === w && !O)
                  ) {
                    let t = q.current ? Date.now() - q.current : 0,
                      a = e[w] || 0;
                    c = setTimeout(
                      () => {
                        W(b);
          ...
          (R[42] !== F || R[43] !== Y
            ? ((I = (0, n.$)(
                F,
                "CopilotAnimation-module__copilotAnimationHolder--y50tP",
                Y,
              )),
              (R[42] = F),
              (R[43] = Y),
            ...
            R[45] === Symbol.for("react.memo_cache_sentinel")
              ? ((E = (0, r.G)("copilot-animation")), (R[45] = E))
              : (E = R[45]),
            R[46] !== G || R[47] !== H
              ? ((T = { ...H, "--copilot-animation-scale": G }),
                (R[46] = G),
                (R[47] = H),
                (R[48] = T))
              : (T = R[48]));
          let X = D === k.Activate && o;
          return (
            R[49] !== X
              ? ((L = (0, n.$)(
                  "CopilotAnimation-module__copilotAnimation--JSfrc",
                  X,
                )),
                (R[49] = X),
                (R[50] = L))
              : (L = R[50]),
            R[51] !== Q || R[52] !== L
              ? ((A = (0, a.jsx)("div", { className: L, children: Q })),
                (R[51] = Q),
                (R[52] = L),
                (R[53] = A))
              : (A = R[53]),
            R[54] !== T || R[55] !== A || R[56] !== I
              ? ((P = (0, a.jsx)("div", {
                  className: I,
                  ...E,
                  style: T,
      ...
      try {
        _.displayName || (_.displayName = "CopilotAnimation");
      } catch {}
    },
    80752: (c, e, t) => {
      t.d(e, { KI: () => o, VB: () => n, a1: () => s });
      var a = t(96540),
        l = t(88567);
      let r =
          /^(\s*(?:>\s*)*(?:[*-]\s{1,4})*)([*-]|(\d+)\.)(\s{1,4})(?:(\[[\sx]\])\s)?(.*)/i,
        i = (c) => "number" == typeof c?.delimeter,
        n = (c) => {
          let e = r.exec(c);
          if (!e) return null;
          let [, t = "", a, l = "", i, n = null, s] = e,
            o = Number.parseInt(l, 10);
          return {
            leadingWhitespace: t,
            text: s,
            delimeter: Number.isNaN(o) ? a : o,
            middleWhitespace: i,
            taskBox: n,
          };
        },
        s = (c) =>
          "number" == typeof c.delimeter
            ? `${c.leadingWhitespace}${c.delimeter}.${c.middleWhitespace}${c.taskBox ? `${c.taskBox} ` : ""}${c.text}`
            : `${c.leadingWhitespace}${c.delimeter}${c.middleWhitespace}${c.taskBox || ""} ${c.text}`,
        o = ({ emitChange: c }) => {
          let e = (0, a.useCallback)(
            (e, t) => {
              let [a, r] = t || (0, l.ty)(e),
                o = n(e.value.slice(a, r));
              if (!i(o)) return;
              let d = e.value.slice(r + 1).split(/\r?\n/),
                m = [],
                z = o.delimeter;
              for (let c of d) {
                let e = n(c);
                if (!i(e) || e.delimeter !== z) break;
                (m.push(e), z++);
              }
...
`)}`;
              c(u, [r, r + u.length + 1], e.selectionStart);
            },
            [c],
          );
          return {
            onKeyDown: (0, a.useCallback)(
              (t) => {
                if ("Enter" === t.key && !t.shiftKey && !t.defaultPrevented) {
                  let a = t.currentTarget,
                    [r, i] = (0, l.ty)(a),
                    s = n(
                      a.value.slice(r, a.selectionStart) +
                        a.value.slice(a.selectionEnd, i),
                    );
                  if (s)
                    if ((t.preventDefault(), a.selectionStart === r)) {
                      let t = (({
                        leadingWhitespace: c = "",
                        delimeter: e,
                        taskBox: t,
                      }) => {
                        let a = "number" == typeof e ? `${e}.` : e;
                        return `${a}${c}${t ? " [ ]" : " "}
`;
                      })(s);
                      null === t
                        ? c("", [r, a.selectionEnd])
                        : (c(t), e(a, [r, r + t.length - 1]));
                    } else {
                      let t = (({
                        leadingWhitespace: c = "",
                        delimeter: e,
                        ...
                        if (!a) return null;
                        let l = "number" == typeof e ? `${e + 1}.` : e;
                        return `
${c}${l}${t ? " [ ]" : ""} `;
                      })(s);
                      null === t ? c("", [r, a.selectionEnd]) : (c(t), e(a));
                    }
                }
              },
              [c, e],
    ...
    84174: (c, e, t) => {
      ...
      var a = t(74848),
        l = t(46251);
      let r = ({ label: c, link: e, className: t }) =>
        e
          ? (0, a.jsxs)(l.B, {
          ...
          : t
            ? (0, a.jsx)("span", { className: t, children: c })
            : (0, a.jsx)(a.Fragment, { children: c });
      try {
        r.displayName || (r.displayName = "LabelWithLink");
      } catch {}
    },
    88567: (c, e, t) => {
      t.d(e, {
...
`,
          ...
          return (-1 === t && (t = c.value.length), [e, t]);
        },
        i = (c) => (0, l.nf)(c),
        n = (c, e) => (0, l.iQ)(c, e),
        s = (c) => ((0, a.U0)() ? c.metaKey : c.ctrlKey),
        o = async (c) => {
          let e = await (0, l.pF)(c);
          return e
            ? { width: e.width, height: e.height, ppi: e.pixelsPerInch }
            : null;
        },
        d = (c, e, t = "Image") =>
          (0, l.TG)(
            { width: c.width, height: c.height, pixelsPerInch: c.ppi },
            e,
            t,
          );
    },
    91446: (c, e, t) => {
      t.d(e, { TG: () => s, iQ: () => n, nf: () => i, pF: () => r });
      var a = t(50467);
      let PNGScanner = class PNGScanner {
        advance(c) {
          this.pos += c;
        }
        readInt(c) {
        ...
        readString(c) {
          let e = new Uint8Array(this.dataview.buffer, this.pos, c);
          return (this.advance(c), new TextDecoder("ascii").decode(e));
        }
        scan(c) {
          let e = [137, 80, 78, 71, 13, 10, 26, 10];
          for (let c = 0; c < e.length; c++)
            if (this.dataview.getUint8(this.pos + c) !== e[c])
              throw Error("Invalid PNG file: header signature mismatch");
          for (this.advance(8); this.pos < this.dataview.byteLength; ) {
            let e = this.readLong(),
              t = this.readString(4),
              a = this.pos + e + 4;
            if (!1 === c.call(this, t, e) || "IEND" === t) break;
            this.pos = a;
          }
        }
        constructor(c) {
          ((0, a._)(this, "dataview", void 0),
            (0, a._)(this, "pos", void 0),
      ...
      let l = (c) =>
        ...
        r = async (c) => {
          ...
          return a
            ? ((e = new PNGScanner(a)),
              (t = { width: 0, height: 0, pixelsPerInch: 72 }),
              e.scan(function (c) {
                switch (c) {
                  case "IHDR":
                    ((t.width = this.readLong()), (t.height = this.readLong()));
                    break;
                  case "pHYs": {
                    let c = this.readLong(),
                      e = this.readLong();
                    return (
                      1 === this.readChar() &&
                        (t.pixelsPerInch = Math.round(((c + e) / 2) * 0.0254)),
                      !1
                    );
                  }
                  case "IDAT":
        ...
        i = (c) => `<!-- ${c.replaceAll("--", "\\-\\-")} -->`,
        n = (c, e) =>
          `[${c.replaceAll("[", "\\[").replaceAll("]", "\\]")}](${e.replaceAll("(", "\\(").replaceAll(")", "\\)")})`,
        s = (c, e, t = "Image") => {
          let a = l(t),
            r = l(e);
          if (144 === c.pixelsPerInch) {
            let e = Math.round(c.width / 2),
              t = Math.round(c.height / 2);
            return `<img width="${e}" height="${t}" alt="${a}" src="${r}" />`;
          }
          return c && c.width > 0 && c.height > 0
            ? `<img width="${c.width}" height="${c.height}" alt="${a}" src="${r}" />`
            : `![${a}](${r})`;
        };
    },
    98211: (c, e, t) => {
      ...
      var a = t(88431),
        l = t(96540);
      let r = Symbol("callbackCancelledResult"),
        i = (c, e = !1) => {
          let t = (0, l.useRef)(c);
          (0, a.N)(() => {
            t.current = c;
          ...
          return (
            ...
            (0, l.useCallback)((...c) => (i.current ? t.current(...c) : r), [])
          );
        };
    },
  },
]);
//# sourceMappingURL=34028-74d1bf2cccf4.js.map
