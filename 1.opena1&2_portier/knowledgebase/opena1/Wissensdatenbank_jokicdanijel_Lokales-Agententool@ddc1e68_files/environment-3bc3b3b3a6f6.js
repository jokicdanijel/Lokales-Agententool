...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [75294],
  {
    ...
    11083: (e, t, n) => {
      ...
      function l(e, t = !1, n = 0.5) {
        if (!r.X3 && !0 !== (0, i.G7)("browser_stats_disabled")) {
          ...
          (void 0 === e.timestamp && (e.timestamp = Date.now()),
            ...
            (e.staff = h()),
            (e.bundler = a.v),
            Math.random() < n && s.push(e),
            t ? d() : m());
        }
      }
      let f = null,
        m = (0, u.n)(async function () {
          (await o.K, null == f && (f = window.requestIdleCallback(d)));
        }, 5e3);
      function d() {
        if (((f = null), !s.length)) return;
      ...
      (r.XC?.addEventListener("pagehide", d),
        r.XC?.addEventListener("visibilitychange", d));
    },
    13523: (e, t, n) => {
      n.d(t, {
        $r: () => i,
    ...
    38102: (e, t, n) => {
        ...
        if (t) {
          if (
            e.error.stacktrace.some(
              (e) => E.test(e.filename) || E.test(e.function),
            )
          ) {
            d = !0;
            return;
          ...
          Object.assign(
            {
              ...
              sanitizedUrl:
                `${window.location.protocol}//${window.location.host}${
                  ((n = c("meta[name=analytics-location]"))
                    ? n.content
                  ...
                  (function () {
                    ...
                    let n = c("meta[name=analytics-location-params]");
      ...
      let E = /(chrome|moz|safari)-extension:\/\//,
        b = !1;
      (s.cg?.addEventListener("pageshow", () => (b = !1)),
        s.cg?.addEventListener("pagehide", () => (b = !0)),
    ...
    59368: (e, t, n) => {
      ...
      if (
        ...
        let Message = class Message {
          ...
          message;
          priority = "normal";
          constructor({ element: e, message: t, priority: n = "normal" }) {
            ((this.element = e), (this.message = t), (this.priority = n));
          }
          #e() {
            return (
        ...
        let r = new (class MessageQueue {
          ...
          enqueue(e) {
            let { priority: t } = e;
            if ("high" === t) {
              let t = this.#t.findLastIndex((e) => "high" === e.priority);
        ...
        (customElements.define(n, LiveRegionCustomElement),
          "ariaNotify" in Element.prototype ||
            (Element.prototype.ariaNotify = function (
              ...
              r.enqueue(
                new Message({ element: this, message: e, priority: t }),
              );
            }),
          "ariaNotify" in Document.prototype ||
      ...
      let m = window.fetch,
        d = (e, t) => {
          if (e instanceof Request) {
            ...
            return m(new Request(e, { headers: t }));
          }
          {
            let n = { ...(t?.headers ?? {}), ...(0, f.kt)() };
            return m(new Request(e, { ...t, headers: n }));
          }
        };
        ...
        if (
          (o.cg &&
            (o.cg.fetch = async (e, t) => {
              try {
                let n = await i(e, t);
                return (c({ input: e, error: !n.ok, status: n.status }), n);
              } catch (t) {
                throw (c({ input: e, error: !0, status: "unknown" }), t);
              }
            }),
          ...
          ((u = Date.now()),
            ...
            c
              ...
              : ((o && f < t) || !o) &&
                ...
                (i = setTimeout(
                  () => {
                    ((u = Date.now()), e.apply(this, r), a && l.cancel());
                  },
                  o ? t - f : t,
                ))));
        }
        ...
        return {
          getItem: function (e, t = Date.now()) {
            try {
              ...
              if (o && t > o)
                return (m(e), m(r), f("SAFE_STORAGE_VALUE_EXPIRED"), null);
...
//# sourceMappingURL=environment-cba29ce96225.js.map
