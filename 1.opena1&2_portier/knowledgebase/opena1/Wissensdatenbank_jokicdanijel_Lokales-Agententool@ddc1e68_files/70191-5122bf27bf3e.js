...
(globalThis.webpackChunk_github_ui_github_ui =
  ...
  [70191],
  {
      ...
      function c(e, t) {
        r ||
          ...
          "undefined" != typeof document &&
            document.addEventListener("submit", l));
        let n = r.get(e) || [];
        r.set(e, [...n, t]);
      }
      function l(e) {
      ...
      async function f(e, t, n, r) {
        ...
        for (let s of e) {
          let [e, a] = i(),
            ...
            c = {
              text: u,
              json: () => (n.headers.set("Accept", "application/json"), u()),
              html: () => (n.headers.set("Accept", "text/html"), u()),
            };
            ...
            get html() {
              ...
              return (
                ...
                (this.html =
                  ((r = document),
                  (i = this.text),
                  ((e = r.createElement("template")).innerHTML = i),
    ...
    74043: (e, t, n) => {
      ...
      var f = { type: c(o), id: c(s), transports: l(o) },
        h = { appid: l(o), appidExclude: l(o), credProps: l(o) },
        d = { appid: l(o), appidExclude: l(o), credProps: l(o) },
        p = {
          publicKey: c({
            rp: c(o),
    ...
    97797: (e, t, n) => {
          ...
          if ((l.exec(""), (i = l.exec(c)) && ((c = i[3]), i[2] || !c))) {
            for (n = 0; n < u; n++)
              if ((s = (a = e[n]).selector(i[1]))) {
                for (r = f.length, o = !1; r--; )
                  if (f[r].index === a && f[r].key === s) {
                    o = !0;
                    break;
                  }
                o || f.push({ index: a, key: s });
                break;
              }
          }
        while (i);
      ...
      ((r.prototype.logDefaultIndexUsed = function () {}),
            ...
            for (
              ...
              ((s = (l = c[r]).key),
                (a = (function (e, t) {
                  ...
                  (((a = Object.create(o)).map = new i()), h.push(a)),
        ...
        (r.prototype.remove = function (e, t) {
          if ("string" == typeof e) {
            ...
            for (i = 0, n = f(this.indexes, e); i < n.length; i++)
              for (r = n[i], o = l.length; o--; )
                if (((a = l[o]), r.index.isPrototypeOf(a))) {
                  if ((u = a.map.get(r.key)))
                    for (s = u.length; s--; )
                      (c = u[s]).selector === e &&
                        (g || c.data === t) &&
                        (u.splice(s, 1), (p[c.id] = !0));
                  break;
                }
            for (i in p) (delete d[i], this.size--);
            for (i in d) h.push(d[i].selector);
          }
        }),
        (r.prototype.queryAll = function (e) {
          ...
          for (t = 0, r = f.length; t < r; t++)
            for (n = 0, o = f[t], i = (s = this.matches(o)).length; n < i; n++)
              (c[(u = s[n]).id]
                ? (a = c[u.id])
                : ((a = {
                    id: u.id,
          ...
          if (t) {
            ...
            if (n.length) {
              (b(e, "stopPropagation", w),
                b(e, "stopImmediatePropagation", x),
                S(e, E));
              for (var r = 0, i = n.length; r < i && !g.get(e); r++) {
                var o = n[r];
                y.set(e, o.node);
                for (var s = 0, a = o.observers.length; s < a && !m.get(e); s++)
      ...
      function k(e, t, n) {
        var i =
          ...
          s = o ? p : d,
          a = s[e];
        (a || ((a = new r()), (s[e] = a), document.addEventListener(e, j, o)),
          a.add(t, n));
      }
      function O(e, t, n) {
