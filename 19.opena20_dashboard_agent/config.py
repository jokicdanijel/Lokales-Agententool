...
class SSEConfig(BaseModel):
    ...
    event_types: list[str] = Field(
        default=["agent_status", "safepoint", "alert", "metric", "notification"], description="Erlaubte Event-Typen"
    )
...
def get_agent_by_kuerzel(kuerzel: str) -> AgentInfo | None:
...
def get_agent_url(agent_id: str, endpoint: str = "/health") -> str | None:
