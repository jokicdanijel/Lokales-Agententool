...
def test_command():
    ...
    payload = {"command": "test_command", "context": {"test": "data"}, "timeout": 10}

    try:
        resp = requests.post(f"{BASE_URL}/command", json=payload, headers=headers, timeout=10)
...
def test_invalid_json():
    ...
    payload = {"command": "test", "extra_field": "should_be_rejected"}
