...
class ModelRegistry:
    ...
    def __init__(self, custom_models: Optional[Dict[str, Dict[str, Any]]] = None):
    ...
    def get_model(self, alias: str) -> Optional[ModelInfo]:
...
class RetryConfig(BaseModel):
    ...
    retryable_status_codes: List[int] = Field(
        default=[502, 503, 504],
        description="HTTP-Status-Codes, bei denen Retry durchgeführt wird"
    )
