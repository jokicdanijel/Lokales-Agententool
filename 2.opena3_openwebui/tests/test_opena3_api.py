...
class TestModelsEndpoint:
    ...
    def test_default_model_exists(self, client):
        ...
        has_default = data["default_model"] is not None or any(m.get("default", False) for m in data["models"])
        assert has_default
...
class TestChatEndpoint:
    ...
    def test_chat_with_auth_and_valid_model(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/chat", json={"message": "Hello", "model": "llama3.1"}, headers=auth_headers)

            assert response.status_code == 200

    def test_chat_with_invalid_model_returns_422(self, client, auth_headers):
        """Chat mit unbekanntem Modell sollte 422 zurückgeben"""
        response = client.post("/chat", json={"message": "Hello", "model": "invalid-model-xyz"}, headers=auth_headers)
    ...
    def test_v1_chat_completions_alias(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/v1/chat/completions", json={"message": "Test"}, headers=auth_headers)
...
class TestChatStreamEndpoint:
    ...
    def test_stream_returns_event_stream(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {"choices": [{"message": {"content": "Streamed content"}}]}
            mock_post.return_value = mock_response

            response = client.post("/chat/stream", json={"message": "Test stream"}, headers=auth_headers)
    ...
    def test_stream_contains_start_event(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            ...
            response = client.post("/chat/stream", json={"message": "Test"}, headers=auth_headers)
...
class TestRateLimiting:
    ...
    def test_rate_limit_429_contains_retry_after(self, client):
        ...
        rate_limit_tracker["overloaded:default"] = {"count": 1000, "reset_at": time.time() + 60}
    ...
    def test_http_request_with_retry_retries_on_502(self):
        ...
        with patch("main_openwebui_agent.requests.request") as mock_request:
            with patch("main_openwebui_agent.time.sleep"):  # Skip delays
                # Erst 502, dann 200
                responses = [Mock(status_code=502), Mock(status_code=200)]
...
class TestModelRegistry:
    ...
    def test_add_custom_model(self, model_registry):
        ...
        new_model = ModelInfo(id="custom:latest", name="Custom Model", type="llm")
...
class TestSafepoints:
    ...
    def test_mask_secrets_masks_sensitive_keys(self):
        ...
        data = {"message": "Hello", "token": "secret-token", "password": "secret-pass", "api_key": "sk-12345"}
    ...
    def test_mask_secrets_handles_nested_dicts(self):
        ...
        data = {"config": {"token": "secret", "name": "test"}}
    ...
    def test_mask_secrets_handles_lists(self):
        ...
        data = {"items": [{"token": "secret1"}, {"name": "test"}]}
...
class TestLogRotation:
    ...
    def test_log_rotation_config_applied(self):
        ...
        from main_openwebui_agent import get_logging_config, setup_logging
...
class TestCommandEndpoint:
    ...
    def test_command_with_auth(self, client, auth_headers):
        ...
        response = client.post("/command", json={"command": "echo test"}, headers=auth_headers)
...
class TestInvokeEndpoint:
    ...
    def test_invoke_requires_auth(self, client):
        ...
        try:
            response = client.post("/invoke", json={"tool": "test", "parameters": {}})
            assert response.status_code in [401, 403, 422, 500]
        except Exception:
            pass  # Test bestanden - Fehler wurde erkannt
    ...
    def test_invoke_success(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/invoke", json={"tool": "test_tool", "parameters": {"x": 1}}, headers=auth_headers)
    ...
    def test_invoke_upstream_error_mapped(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/invoke", json={"tool": "failing_tool", "parameters": {}}, headers=auth_headers)
    ...
    def test_invoke_exception_creates_500(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/invoke", json={"tool": "broken_tool", "parameters": {}}, headers=auth_headers)
...
class TestChatStreamErrors:
    ...
    def test_chat_stream_timeout_produces_error_event(self, client):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            ...
            response = client.post("/chat/stream", json={"message": "Hello timeout test"})
    ...
    def test_chat_stream_connection_error_produces_error_event(self, client):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            ...
            response = client.post("/chat/stream", json={"message": "Hello connection test"})
    ...
    def test_chat_stream_generic_exception_produces_internal_error(self, client):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            ...
            response = client.post("/chat/stream", json={"message": "Hello error test"})
    ...
    def test_chat_stream_backend_error_status_produces_error_event(self, client):
        ...
        with patch("main_openwebui_agent.requests.post") as mock_post:
            ...
            response = client.post("/chat/stream", json={"message": "Hello backend error test"})
...
class TestChatErrorHandling:
    ...
    def test_chat_upstream_error_maps_correctly(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/chat", json={"message": "Hello error test"}, headers=auth_headers)
    ...
    def test_chat_generic_exception_creates_error_and_500(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/chat", json={"message": "Hello exception test"}, headers=auth_headers)
    ...
    def test_chat_with_5xx_upstream_error(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/chat", json={"message": "Hello 503 test"}, headers=auth_headers)
    ...
    def test_chat_with_404_upstream_error(self, client, auth_headers):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post("/chat", json={"message": "Hello 404 test"}, headers=auth_headers)
...
class TestModelValidation:
    ...
    def test_chat_request_unknown_model_raises_422(self, client, auth_headers):
        ...
        response = client.post(
            "/chat", json={"message": "Hello", "model": "unknown-model-xyz-123"}, headers=auth_headers
        )
    ...
    def test_stream_request_unknown_model_raises_422(self, client):
        ...
        response = client.post("/chat/stream", json={"message": "Hello", "model": "invalid-model-abc"})
...
class TestTokenValidation:
    ...
    def test_command_with_invalid_token_returns_401(self, client):
        ...
        response = client.post(
            "/command", json={"command": "test"}, headers={"Authorization": "Bearer INVALID_TOKEN_12345"}
        )
    ...
    def test_chat_with_invalid_token_returns_401(self, client):
        ...
        with patch("main_openwebui_agent.http_request_with_retry") as mock_request:
            ...
            response = client.post(
                "/chat", json={"message": "Hello"}, headers={"Authorization": "Bearer WRONG_TOKEN_ABCDEF"}
            )
    ...
    def test_invoke_with_invalid_token_returns_401(self, client):
        ...
        response = client.post(
            "/invoke", json={"tool": "test", "parameters": {}}, headers={"Authorization": "Bearer BAD_TOKEN_XYZ"}
        )
...
class TestCommandErrorHandling:
    ...
    def test_command_exception_creates_500(self, client, auth_headers):
        ...
        response = client.post("/command", json={"command": "echo hello"}, headers=auth_headers)
