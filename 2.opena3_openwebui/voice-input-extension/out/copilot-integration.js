...
class CopilotIntegrationHandler {
    ...
    async sendToCopilotChat(transcript) {
        try {
            ...
            try {
                await vscode.commands.executeCommand('github.copilot.chat.openSymbolFromWorkspace', transcript);
            }
            catch {
                // Method 2: Fallback to inline chat
                await vscode.commands.executeCommand('github.copilot.interactiveEditor.makeRequest', transcript);
            }
