...
export declare class CommandHandler {
    ...
    constructor(settings: VoiceInputSettings, copilotHandler: CopilotIntegrationHandler, analytics: AnalyticsManager, eventLogger: EventLogger, outputChannel: vscode.OutputChannel);
    /**
     * Show settings panel
     */
