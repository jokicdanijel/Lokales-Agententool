...
class AdvancedVoiceInputManager {
    constructor() {
        ...
        this.copilotHandler = new copilot_integration_1.CopilotIntegrationHandler(this.outputChannel);
        ...
        this.recognitionEngine = new recognition_engine_1.VoiceRecognitionEngine(defaultLanguage);
        // Create command handler
        this.commandHandler = new commands_1.CommandHandler(this.settings, this.copilotHandler, this.analytics, this.eventLogger, this.outputChannel);
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('voiceInput.toggle', () => {
        manager.toggle();
    ...
    analytics_1.globalEventLogger.info('Advanced extension activated successfully');
}
/**
