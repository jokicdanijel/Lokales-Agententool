...
class TestToolCalling:
    ...
    def test_read_file_tool(self):
        ...
        requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": "Erstelle read_test.txt\nTest content"}
                ]
            },
            timeout=TIMEOUT
        )
        ...
        response = requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": "Lies read_test.txt"}
                ]
            },
            timeout=TIMEOUT
        )
    ...
    def test_delete_file_tool(self):
        ...
        requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": "Erstelle delete_test.txt\nTo be deleted"}
                ]
            },
            timeout=TIMEOUT
        )
        ...
        response = requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": "Lösche delete_test.txt"}
                ]
            },
            timeout=TIMEOUT
        )
...
class TestRequestDeduplication:
    ...
    def test_duplicate_request_detection(self):
        ...
        request_data = {
            "messages": [
                {"role": "user", "content": "Unique message for dedup test"}
            ]
        }
...
class TestIntegrationWorkflow:
    ...
    def test_complete_file_workflow(self):
        ...
        response = requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": f"Erstelle {filename}\n{content}"}
                ]
            },
            timeout=TIMEOUT
        )
        ...
        response = requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": f"Lies {filename}"}
                ]
            },
            timeout=TIMEOUT
        )
        ...
        response = requests.post(
            ...
            json={
                "messages": [
                    {"role": "user", "content": f"Lösche {filename}"}
                ]
            },
            timeout=TIMEOUT
        )
