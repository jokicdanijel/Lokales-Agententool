...
from app.models import MediaObject, MediaType, MessageDirection, MessageType, SentimentType, WhatsAppMessage
...
class MediaHandler:
    ...
    @staticmethod
    async def download_media(media_id: str, url: str | None) -> bytes | None:
        ...
        try:
            ...
            headers: dict[str, str] = {"Authorization": f"Bearer {config.META_ACCESS_TOKEN}"}
...
class WhatsAppClient:
    ...
    async def parse_webhook_event(self, event_dict: dict[str, Any]) -> WhatsAppMessage | None:
    ...
    async def send_message(self, to_phone: str, body: str) -> tuple[bool, str | None, str | None]:
    ...
    async def send_media(self, to_phone: str, media_url: str, media_type: str) -> tuple[bool, str | None, str | None]:
