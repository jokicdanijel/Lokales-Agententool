...
class TestModels:
    ...
    def test_step_definition_valid(self):
        ...
        try:
            from models import ActionType, StepDefinition

            step = StepDefinition(name="test_step", action=ActionType.CALL_AGENT, agent="opena3", timeout=30)
    ...
    def test_workflow_definition_valid(self):
        ...
        try:
            from models import ActionType, StepDefinition, WorkflowDefinition

            workflow = WorkflowDefinition(
                name="test_workflow",
                description="Test Workflow",
                steps=[StepDefinition(name="step1", action=ActionType.CALL_AGENT, agent="opena3")],
            )
...
class TestResponseModels:
    ...
    def test_execute_request_model(self):
        ...
        try:
            ...
            req = ExecuteRequest(workflow_name="test_workflow", inputs={"key": "value"}, mode="sync")
