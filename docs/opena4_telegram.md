...
| -------------------- | ------------------------------------------------------ | ------------- |
| **Lokal (API)**      | http://127.0.0.1:12346                                 | ✅ Production |
| **Swagger Docs**     | http://127.0.0.1:12346/docs                            | ✅ Available  |
...
```bash
curl -X POST http://127.0.0.1:12346/workflows \
...
```bash
curl http://127.0.0.1:12346/workflows?bot_key=browser_opena6_bot | jq .
```
...
1. ✅ Services running (telegram_multi:12346)
...
**API Docs:** http://127.0.0.1:12346/docs (Swagger UI)
**External URL:** https://hyperdashboard-one.de/opena4
