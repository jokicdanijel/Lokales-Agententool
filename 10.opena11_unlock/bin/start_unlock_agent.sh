#!/bin/bash
# ====================================================
# 🔐 OPENA11 Unlock Master - Start Script
# PORTIER PAS-6.0
# ====================================================
...
LOG_FILE="${LOG_DIR}/opena11_unlock.log"
...
echo -e "${GREEN}🔐 Starting OPENA11 Unlock Master (PAS-6.0)${NC}"
...
if kill -0 "$NEW_PID" 2>/dev/null; then
    echo -e "${GREEN}✅ OPENA11 Unlock Master started successfully${NC}"
