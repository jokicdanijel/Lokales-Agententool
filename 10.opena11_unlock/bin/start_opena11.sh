#!/bin/bash
#
# Start opena11 (Unlock Master Agent)
# Port: 12356
# Kürzel: unlockp
#
...
AGENT_DIR="$PROJECT_ROOT/10.opena11_unlock"

PID_FILE="$PROJECT_ROOT/logs/opena11.pid"
LOG_FILE="$PROJECT_ROOT/logs/opena11.nohup.log"
...
main() {
    ...
    log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    log_info "Service:  $SERVICE_NAME (unlockp)"
    log_info "Port:     $PORT"
