...
class SocialMetrics:
    ...
    def __init__(self):
        ...
        self.timings = {"average_post_time_ms": 0, "last_post_time_ms": 0, "average_generation_time_ms": 0}
    ...
    def increment_platform(self, platform: str, status: str):
        ...
        if platform in self.platform_posts:
            if status == "success":
                self.platform_posts[platform]["sent"] += 1
            else:
                self.platform_posts[platform]["failed"] += 1
    ...
    def get_detailed(self) -> dict[str, Any]:
        ...
        summary["platforms"] = self.platform_posts.copy()
    ...
    def to_prometheus_format(self) -> str:
        ...
        for platform, stats in self.platform_posts.items():
