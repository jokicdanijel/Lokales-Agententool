...
from typing import TYPE_CHECKING, Any, Dict, Literal, NamedTuple, NoReturn, Protocol, Tuple, TypeVar, Union, overload
...
# Type aliases
_NestedStr = Union[str, Iterable[str | Iterable["_NestedStr"]]]
...
_NSHandlerType = Callable[[_T, str, str, types.ModuleType], str | None]
