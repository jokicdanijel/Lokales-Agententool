...
from typing import TYPE_CHECKING, Any, BinaryIO, ContextManager, Generic, Literal, NamedTuple, NewType, TextIO, TypeVar
...
class RenderableColumn(ProgressColumn):
    ...
    def __init__(self, renderable: RenderableType = "", *, table_column: Column | None = None):
