...
class InstallRequirement:
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__} object: " f"{self!s} editable={self.editable!r}>"
    ...
    def load_pyproject_toml(self) -> None:
        ...
        """
        pyproject_toml_data = load_pyproject_toml(self.pyproject_toml_path, self.setup_py_path, str(self))
