...
from pip._internal.metadata.base import BaseDistribution, BaseEntryPoint, InfoPath, Wheel
...
class Distribution(BaseDistribution):
    ...
    def version(self) -> Version:
        try:
            version = parse_name_and_version_from_info_directory(self._dist)[1] or self._dist.version
