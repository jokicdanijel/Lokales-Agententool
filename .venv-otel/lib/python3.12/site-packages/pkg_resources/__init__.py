...
from typing import TYPE_CHECKING, Any, BinaryIO, Literal, NamedTuple, NoReturn, Protocol, TypeVar, Union, overload
        ...
        if not hasattr(self, "_parsed_version"):
            try:
                ...
                if hasattr(ex, "add_note"):
                    ...
                    raise
                raise packaging.version.InvalidVersion(f"{ex!s} {info}") from None
    ...
    def check_version_conflict(self):
        ...
        for modname in self._get_metadata("top_level.txt"):
            ...
            if fn and (normalize_path(fn).startswith(loc) or fn.startswith(self.location)):
                continue
            issue_warning(
                f"Module {modname} was already imported from {fn}, " f"but {self.location} is being added to sys.path",
            )
