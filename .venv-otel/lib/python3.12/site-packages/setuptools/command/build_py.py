...
class build_py(orig.build_py):
    ...
    def analyze_manifest(self) -> None:
        ...
        if self.existing_egg_info_dir and Path(self.existing_egg_info_dir, "SOURCES.txt").exists():
    ...
    def _filter_build_files(self, files: Iterable[str], egg_info: StrPath) -> Iterator[str]:
        """
