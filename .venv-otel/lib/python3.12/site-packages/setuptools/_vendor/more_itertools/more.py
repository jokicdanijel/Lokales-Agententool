...
def sort_together(iterables, key_list=(0,), key=None, reverse=False):
    ...
    return list(zip(*sorted(zip(*iterables, strict=False), key=key_argument, reverse=reverse), strict=False))
...
class numeric_range(abc.Sequence, abc.Hashable):
    ...
    def __init__(self, *args):
        ...
        if argc == 1:
            ...
            raise TypeError("numeric_range expected at least " f"1 argument, got {argc}")
        else:
            raise TypeError("numeric_range expected at most " f"3 arguments, got {argc}")
...
def _sample_weighted(iterable, k, weights):
    ...
    reservoir = take(k, zip(weight_keys, iterable, strict=False))
    heapify(reservoir)
    ...
    for weight, element in zip(weights, iterable, strict=False):
