...
from collections.abc import Callable, Container, Hashable, Iterable, Iterator, Mapping, Reversible, Sequence, Sized
from types import TracebackType
from typing import Any, ContextManager, Generic, Protocol, TypeVar, overload, type_check_only
...
def distinct_permutations(iterable: Iterable[_T], r: int | None = ...) -> Iterator[tuple[_T, ...]]: ...
def intersperse(e: _U, iterable: Iterable[_T], n: int = ...) -> Iterator[_T | _U]: ...
def unique_to_each(*iterables: Iterable[_T]) -> list[list[_T]]: ...
@overload
def windowed(seq: Iterable[_T], n: int, *, step: int = ...) -> Iterator[tuple[_T | None, ...]]: ...
@overload
def windowed(seq: Iterable[_T], n: int, fillvalue: _U, step: int = ...) -> Iterator[tuple[_T | _U, ...]]: ...
def substrings(iterable: Iterable[_T]) -> Iterator[tuple[_T, ...]]: ...
def substrings_indexes(seq: Sequence[_T], reverse: bool = ...) -> Iterator[tuple[Sequence[_T], int, int]]: ...
...
def interleave_evenly(iterables: list[Iterable[_T]], lengths: list[int] | None = ...) -> Iterator[_T]: ...
def collapse(
...
def split_before(iterable: Iterable[_T], pred: Callable[[_T], object], maxsplit: int = ...) -> Iterator[list[_T]]: ...
def split_after(iterable: Iterable[_T], pred: Callable[[_T], object], maxsplit: int = ...) -> Iterator[list[_T]]: ...
def split_when(
    iterable: Iterable[_T],
    pred: Callable[[_T, _T], object],
    maxsplit: int = ...,
) -> Iterator[list[_T]]: ...
def split_into(iterable: Iterable[_T], sizes: Iterable[int | None]) -> Iterator[list[_T]]: ...
@overload
def padded(
    iterable: Iterable[_T],
    *,
...
def count_cycle(iterable: Iterable[_T], n: int | None = ...) -> Iterable[tuple[int, _T]]: ...
def mark_ends(
    iterable: Iterable[_T],
...
def consecutive_groups(iterable: Iterable[_T], ordering: Callable[[_T], int] = ...) -> Iterator[Iterator[_T]]: ...
@overload
def difference(
    iterable: Iterable[_T],
...
@overload
def difference(iterable: Iterable[_T], func: Callable[[_T, _T], _U] = ..., *, initial: _U) -> Iterator[_U]: ...
...
def exactly_n(iterable: Iterable[_T], n: int, predicate: Callable[[_T], object] = ...) -> bool: ...
...
def set_partitions(iterable: Iterable[_T], k: int | None = ...) -> Iterator[list[list[_T]]]: ...
...
@overload
def only(iterable: Iterable[_T], default: _U, too_long: _Raisable | None = ...) -> _T | _U: ...
def ichunked(iterable: Iterable[_T], n: int) -> Iterator[Iterator[_T]]: ...
def distinct_combinations(iterable: Iterable[_T], r: int) -> Iterator[tuple[_T, ...]]: ...
def filter_except(
...
def all_unique(iterable: Iterable[_T], key: Callable[[_T], _U] | None = ...) -> bool: ...
def nth_product(index: int, *args: Iterable[_T]) -> tuple[_T, ...]: ...
def nth_combination_with_replacement(iterable: Iterable[_T], r: int, index: int) -> tuple[_T, ...]: ...
...
def combination_with_replacement_index(element: Iterable[_T], iterable: Iterable[_T]) -> int: ...
...
def unique_in_window(iterable: Iterable[_T], n: int, key: Callable[[_T], _U] | None = ...) -> Iterator[_T]: ...
def duplicates_everseen(iterable: Iterable[_T], key: Callable[[_T], _U] | None = ...) -> Iterator[_T]: ...
def duplicates_justseen(iterable: Iterable[_T], key: Callable[[_T], _U] | None = ...) -> Iterator[_T]: ...
def classify_unique(
...
@overload
def minmax(iterable_or_value: Iterable[_T], *, key: Callable[[_T], _SupportsLessThan]) -> tuple[_T, _T]: ...
@overload
def minmax(
...
def takewhile_inclusive(predicate: Callable[[_T], bool], iterable: Iterable[_T]) -> Iterator[_T]: ...
def outer_product(
