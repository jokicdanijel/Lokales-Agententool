...
from typing import TYPE_CHECKING, Any, ForwardRef, Union, cast, final
...
if sys.version_info >= (3, 13):
    ...
    def evaluate_forwardref(forwardref: ForwardRef, memo: TypeCheckMemo) -> Any:
        return forwardref._evaluate(memo.globals, memo.locals, type_params=(), recursive_guard=frozenset())
    ...
    evaluate_extra_args: tuple[frozenset[Any], ...] = (frozenset(),) if sys.version_info >= (3, 9) else ()
    ...
    def evaluate_forwardref(forwardref: ForwardRef, memo: TypeCheckMemo) -> Any:
        ...
        try:
            ...
            if sys.version_info < (3, 10):
                ...
                return forwardref._evaluate(new_globals, memo.locals or new_globals, *evaluate_extra_args)
