...
from typing import IO, AbstractSet, Any, BinaryIO, ForwardRef, NewType, TextIO, TypeVar, Union
...
if sys.version_info >= (3, 11):
    ...
    from typing import Annotated, NotRequired, TypeAlias, get_args, get_origin
    from typing import Any as SubclassableAny
...
TypeCheckLookupCallback: TypeAlias = Callable[[Any, tuple[Any, ...], tuple[Any, ...]], TypeCheckerCallable | None]
...
def check_tuple(
    ...
    if use_ellipsis:
        ...
        for i, (element, element_type) in enumerate(zip(value, tuple_params, strict=False)):
            try:
                check_type_internal(element, element_type, memo)
            except TypeCheckError as exc:
                exc.append_path_element(f"item {i}")
