...
def result_invoke(action: Callable[[_R], Any]) -> Callable[[Callable[_P, _R]], Callable[_P, _R]]: ...
...
def save_method_args(method: Callable[Concatenate[_S, _P], _R]) -> Callable[Concatenate[_S, _P], _R]: ...
def except_(
