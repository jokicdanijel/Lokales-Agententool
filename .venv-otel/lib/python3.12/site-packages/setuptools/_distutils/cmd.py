...
class Command:
    ...
    sub_commands: ClassVar[list[tuple[str, Callable[[Any], bool] | None]]] = []  # Any to work around variance issues
    ...
    @overload
    def move_file(self, src: str | os.PathLike[str], dst: _StrPathT, level: int = 1) -> _StrPathT | str: ...
    @overload
    def move_file(self, src: bytes | os.PathLike[bytes], dst: _BytesPathT, level: int = 1) -> _BytesPathT | bytes: ...
    def move_file(
        self,
    ...
    def spawn(self, cmd: MutableSequence[str], search_path: bool = True, level: int = 1) -> None:
