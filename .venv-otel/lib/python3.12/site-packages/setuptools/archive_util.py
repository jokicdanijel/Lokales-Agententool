...
def unpack_archive(filename, extract_dir, progress_filter=default_filter, drivers=None) -> None:
...
def unpack_tarfile(filename, extract_dir, progress_filter=default_filter) -> bool:
    ...
    try:
        ...
        raise UnrecognizedFormat(f"{filename} is not a compressed or uncompressed tar file") from e
