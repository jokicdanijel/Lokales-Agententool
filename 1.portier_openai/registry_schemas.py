...
class ToolResponse71(BaseModel):
    ...
    cmd_safepoint: Optional[str] = Field(default=None, description="Command safepoint path")
    resp_safepoint: Optional[str] = Field(default=None, description="Response safepoint path")
...
class DispatchRequest(BaseModel):
    ...
    request_id: Optional[str] = Field(default=None, description="Request ID (auto-generated if not provided)")
...
class ToolListResponse(BaseModel):
    ...
    ok: bool = Field(default=True)
    timestamp: str = Field(default_factory=lambda: datetime.utcnow().isoformat() + "Z")
    agent_id: Optional[str] = Field(default=None, description="If filtered by agent")
