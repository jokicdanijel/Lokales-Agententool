...
class TestModels:
    ...
    def test_contact_create_valid(self):
        ...
        try:
            ...
            contact = ContactCreate(first_name="Max", last_name="Mustermann", email="max@example.com")
    ...
    def test_organization_create_valid(self):
        ...
        try:
            ...
            org = OrganizationCreate(name="ACME Corp", size=OrganizationSize.MEDIUM)
    ...
    def test_deal_create_valid(self):
        ...
        try:
            ...
            deal = DealCreate(title="Enterprise Deal", value=50000.0, stage=DealStage.PROPOSAL)
    ...
    def test_activity_create_valid(self):
        ...
        try:
            ...
            activity = ActivityCreate(activity_type=ActivityType.CALL, subject="Follow-up Call")
...
class TestSecurity:
    ...
    def test_gdpr_manager_consent(self):
        ...
        try:
            ...
            consent = manager.record_consent("contact123", "marketing", True)
