...
PORT=12363
MAIN_FILE="$PROJECT_DIR/main_crm_agent.py"
PID_FILE="$PROJECT_DIR/logs/opena18.pid"
LOG_FILE="$PROJECT_DIR/logs/opena18.nohup.log"
...
for pkg in "${REQUIRED_PACKAGES[@]}"; do
    # email_validator verwendet Underscore in Python
    py_pkg="${pkg//-/_}"
    if ! python3 -c "import ${py_pkg}" 2>/dev/null; then
