...
from app.mail_client import AttachmentHandler, MailClassifier
...
class TestMailMessage:
    ...
    def test_mail_message_with_attachments(self):
        ...
        attachments = [
            AttachmentInfo(filename="report.pdf", mime_type="application/pdf", size_bytes=512000),
            AttachmentInfo(filename="data.csv", mime_type="text/csv", size_bytes=8192),
        ]
...
class TestMailRunRequest:
    ...
    def test_fetch_action_request(self):
        ...
        request = MailRunRequest(
            request_id="test-001", action=MailAction.FETCH, payload={"mailbox": "INBOX", "max_count": 10}
        )
    ...
    def test_send_action_request(self):
        ...
        request = MailRunRequest(
            ...
            payload={"recipient": "user@example.org", "subject": "Test Email", "body_text": "This is a test email."},
        )
