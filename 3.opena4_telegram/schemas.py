...
class Routing(BaseModel):
    ...
    resolved_path: str | None = Field(None, description="Resolved file or URL path")
    notes: str | None = Field(None, description="Routing notes")
...
class Project(BaseModel):
    ...
    id: str | None = Field(default="telegram_relay", description="Project identifier")
...
class Command71(BaseModel):
    ...
    target_preference: str | None = Field(None, description="Preferred target (opena1, opena3, etc.)")
