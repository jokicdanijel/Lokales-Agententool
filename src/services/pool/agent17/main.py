#!/usr/bin/env python3
"""
Agent17 — Pool Service (Port 12366)
...
SERVICE_NAME = os.getenv("SERVICE_NAME", "agent17")
PROGRAM_TARGET = os.getenv("PROGRAM_TARGET", "agent17p")
...
app = FastAPI(
    title=f"{SERVICE_NAME.upper()} — {PROGRAM_TARGET}", description="Pool Service Agent17 (Port 12366)", version="1.0.0"
)
