#!/usr/bin/env python3
"""
Agent18 — Pool Service (Port 12367)
...
SERVICE_NAME = os.getenv("SERVICE_NAME", "agent18")
PROGRAM_TARGET = os.getenv("PROGRAM_TARGET", "agent18p")
PORT = int(os.getenv("PORT", "12367"))
...
app = FastAPI(
    title=f"{SERVICE_NAME.upper()} — {PROGRAM_TARGET}", description="Pool Service Agent18 (Port 12367)", version="1.0.0"
)
