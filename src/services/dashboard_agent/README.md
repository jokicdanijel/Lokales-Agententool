# Service: dashboard_agent

## Identity

- **program_target**: `dashp`
- **endpoint_base**: `http://localhost:12344-12399/dashp`
...
dashboard_agent/
  README.md          (this file)
  main_dashboard_agent.py    (entry point)
...
```bash
curl http://127.0.0.1:12344-12399/dashp/health | jq
```
