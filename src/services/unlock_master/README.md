# Service: unlock_master

## Identity
- **program_target**: `onlockp`
- **endpoint_base**: `http://localhost:12344-12399/onlockp`
...
unlock_master/
  README.md          (this file)
  main_unlock_master.py    (entry point)
...
## Health Endpoint
```bash
curl http://127.0.0.1:12344-12399/onlockp/health | jq
```
