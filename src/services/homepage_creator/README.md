# Service: homepage_creator

## Identity

- **program_target**: `homep`
- **endpoint_base**: `http://localhost:12344-12399/homep`
...
homepage_creator/
  README.md          (this file)
  main_homepage_creator.py    (entry point)
...
```bash
curl http://127.0.0.1:12344-12399/homep/health | jq
```
