# Service: chatbot_email

## Identity

- **program_target**: `emailp`
- **endpoint_base**: `http://localhost:12344-12399/emailp`
...
chatbot_email/
  README.md          (this file)
  main_chatbot_email.py    (entry point)
...
```bash
curl http://127.0.0.1:12344-12399/emailp/health | jq
```
