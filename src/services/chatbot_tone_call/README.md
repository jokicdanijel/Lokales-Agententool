# Service: chatbot_tone_call

## Identity

- **program_target**: `answp`
- **endpoint_base**: `http://localhost:12344-12399/answp`
...
chatbot_tone_call/
  README.md          (this file)
  main_chatbot_tone_call.py    (entry point)
...
```bash
curl http://127.0.0.1:12344-12399/answp/health | jq
```
