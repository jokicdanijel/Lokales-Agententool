...
class AgentRegistry:
    ...
    async def register(self, agent_id: str, endpoint: str, meta: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    async def get_agent_details(self, agent_id: str) -> dict[str, Any] | None:
        async with self._lock:
    ...
    async def get_all_status(self) -> dict[str, Any]:
        async with self._lock:
            return {
                k: {"endpoint": v["endpoint"], "registered_at": v["registered_at"], "last_health": v["last_health"]}
    ...
    async def register_if_absent(
        self, agent_id: str, endpoint: str, meta: dict[str, Any] | None = None
    ) -> dict[str, Any]:
    ...
    async def list_agents(self) -> dict[str, Any]:
        ...
        async with self._lock:
            return {
                k: {"endpoint": v["endpoint"], "registered_at": v["registered_at"]} for k, v in self._agents.items()
            }
