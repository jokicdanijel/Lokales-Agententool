...
@app.get("/health")
def health():
    return {"service": AGENT, "status": "healthy", "timestamp": datetime.utcnow().isoformat() + "Z", "port": 12348}
...
async def message(request: Request):
    ...
    try:
        ...
        return JSONResponse({"status": "forwarded", "code": r.status_code, "strict": True})
