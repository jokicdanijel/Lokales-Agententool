...
class AgentAPIClient:
    ...
    async def register_agent(
        self, port: int, capabilities: list, metadata: dict[str, Any] | None = None
    ) -> dict[str, Any]:
        """
    ...
    async def update_status(self, status: str, metadata: dict[str, Any] | None = None) -> dict[str, Any]:
        """
        ...
        payload = {"status": status, "timestamp": datetime.now(UTC).isoformat(), "metadata": metadata or {}}
    ...
    async def publish_sse_event(self, event_type: str, data: dict[str, Any]) -> dict[str, Any]:
        """
    ...
    async def forward_command(self, target_agent: str, command: str, params: dict[str, Any]) -> dict[str, Any]:
        """
        ...
        payload = {"agent_id": target_agent, "command": command, "params": params, "source": self.agent_id}
