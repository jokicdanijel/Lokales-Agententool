...
if __name__ == "__main__":
    ...
    result1 = post("/api/agent/register", {"agent_id": "opena1", "endpoint": "http://127.0.0.1:12344"})
    print(json.dumps(result1, indent=2))
    print()

    # Register opena2 (Archivator)
    print("Registering opena2 (Archivator)...")
    result2 = post("/api/agent/register", {"agent_id": "opena2", "endpoint": "http://127.0.0.1:12345"})
