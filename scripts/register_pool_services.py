...
SERVICES = [
    {"service_name": "agent17", "endpoint": "http://127.0.0.1:12366", "program_target": "agent17p"},
    {"service_name": "agent18", "endpoint": "http://127.0.0.1:12367", "program_target": "agent18p"},
    {"service_name": "agent19", "endpoint": "http://127.0.0.1:12368", "program_target": "agent19p"},
    {"service_name": "agent20", "endpoint": "http://127.0.0.1:12369", "program_target": "agent20p"},
]
...
async def register_service(client: httpx.AsyncClient, service: dict[str, str]) -> dict[str, Any]:
...
async def verify_service_health(client: httpx.AsyncClient, service: dict[str, str]) -> bool:
