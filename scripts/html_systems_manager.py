...
class HTMLSystemsManager:
    ...
    async def check_system_health(self) -> Dict[str, bool]:
        ...
        try:
            response = await self.client.get(
                f"{DASHBOARD_URL}/api/self_cleaning/health",
    ...
    async def list_available_workflows(self) -> List[Dict[str, Any]]:
        ...
        try:
            response = await self.client.get(
                f"{WORKFLOW_ENGINE_URL}/workflows/list",
                headers=self.headers
            )
    ...
    async def execute_workflow(self, workflow_name: str, inputs: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Workflow erfolgreich über Dashboard API")
    ...
    async def _execute_self_cleaning_workflow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status_response = await self.client.get(
                f"{DASHBOARD_URL}/api/self_cleaning/status",
                headers=self.headers
            )
            ...
            if status_response.status_code == 200:
                ...
                if status_data.get("health_score", 0) < 80:
                    scan_response = await self.client.post(
                        f"{DASHBOARD_URL}/api/self_cleaning/scan",
                        headers=self.headers
                    )
    ...
    async def _fallback_workflow_execution(self, workflow_config: Dict[str, Any], payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Workflow erfolgreich über Workflow Engine")
    ...
    async def get_workflow_statistics(self) -> Dict[str, Any]:
        ...
        try:
            response = await self.client.get(
                f"{WORKFLOW_ENGINE_URL}/workflows/executions",
                headers=self.headers
            )
