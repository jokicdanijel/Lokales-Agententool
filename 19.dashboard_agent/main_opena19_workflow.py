...
app = FastAPI(
    title="opena19_Workflow",
    version="1.0.0",
    description="Workflow Agent - Orchestration & Scheduling"
)
...
class WorkflowStep(BaseModel):
    ...
    target: Optional[str] = None  # agent name or service
...
async def workflow_status(workflow_id: str, authorization: str = Header(None)):
    ...
    try:
        ...
        related_executions = [
            e for e in _executions.values() if e["workflow_id"] == workflow_id
        ]
