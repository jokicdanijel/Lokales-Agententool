...
class TestBasicStructure:
    ...
    def test_readme_exists(self):
        ...
        readme_file = Path(
            "/home/danijel-jd/Dokumente/Workspace/Projekte/Gesamtprojekt/18.opena19_Aktien&Crypto/README.md"
        )
    ...
    def test_main_agent_exists(self):
        ...
        main_file = Path(
            "/home/danijel-jd/Dokumente/Workspace/Projekte/Gesamtprojekt/18.opena19_Aktien&Crypto/main_stocks_crypto_agent.py"
        )
...
class TestModels:
    ...
    def test_price_request_valid(self):
        ...
        try:
            from models import MarketType, PriceRequest

            req = PriceRequest(symbols=["AAPL", "TSLA"], market=MarketType.STOCK)
    ...
    def test_position_create_valid(self):
        ...
        try:
            from models import MarketType, PositionCreate

            pos = PositionCreate(symbol="BTC", market=MarketType.CRYPTO, quantity=0.5, avg_price=50000.0)
    ...
    def test_alert_create_valid(self):
        ...
        try:
            from models import AlertCondition, AlertCreate, MarketType

            alert = AlertCreate(
                symbol="ETH", market=MarketType.CRYPTO, condition=AlertCondition.ABOVE, threshold=4000.0
            )
...
class TestResponseModels:
    ...
    def test_portfolio_model(self):
        ...
        try:
            from models import MarketType, Portfolio, Position, PositionStatus
