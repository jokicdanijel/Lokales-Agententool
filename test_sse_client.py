...
from src.pkg.shared.sse_client import (
    SSEClient, SafepointClient, SSEEvent,
    create_sse_client, create_safepoint_client,
...
class TestSafepointClient:
    ...
    async def test_write_safepoint_auto_request_id(self):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            result = await client.write_safepoint(
                category='CMD',
                destination='opena5',
                payload={'action': 'test'}
            )
...
class TestFactoryFunctions:
    ...
    def test_create_safepoint_client(self):
        ...
        client = create_safepoint_client(
            source_agent='opena7',
            base_url='http://test:12345'
        )
