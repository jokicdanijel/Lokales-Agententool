...
| Agent | main_*.py | config.py | security.py | models.py | sse_client.py | requirements.txt | bin/start | bin/stop | tests/ | data/ | logs/ | .env |
|-------|-----------|-----------|-------------|-----------|---------------|------------------|-----------|----------|--------|-------|-------|------|
| **opena1&2** | 🟩 | 🟥 | 🟥 | 🟥 | 🟥 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 |
| **opena3** | 🟩 | 🟩 | 🟥 | 🟥 | 🟩 | 🟨 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 |
| **opena4** | 🟩 | 🟩 | 🟥 | 🟥 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 | 🟩 |
...
| 🗑️ **__pycache__** | Diverse `__pycache__/` Ordner | LÖSCHEN |
