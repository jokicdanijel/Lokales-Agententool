...
from app.models import CallDirection, CallRecord, CallStatus, SIPAccount
...
class SIPClient:
    ...
    async def send_invite(self, to_number: str, caller_id: str) -> str | None:
...
class CallManager:
    ...
    async def initiate_call(self, to_number: str, caller_id: str, duration_limit: int = 300) -> str | None:
