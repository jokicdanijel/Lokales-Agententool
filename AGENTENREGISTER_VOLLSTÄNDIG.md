...
_Dieser Plan folgt Option 2 der Portier-Architektur:_
_Hinweg: OpenAI → opena1 → opena2 → kordp → Ziel-Agent_
_Rückweg: Ziel-Agent → opena2 → opena1 → OpenAI_
_Alles archiviert, alle Bewegungen nachverfolgbar._
