    ...
    def search(self, collection_name: str, vectors: list[list[float | int]], limit: int) -> SearchResult | None:
        ...
        try:
            ...
            if collection:
                ...
                return SearchResult(
                    ids=result["ids"], distances=distances, documents=result["documents"], metadatas=result["metadatas"]
                )
            return None
        except Exception:
            return None
    ...
    def query(self, collection_name: str, filter: dict, limit: int | None = None) -> GetResult | None:
        ...
        try:
            ...
            if collection:
                ...
                return GetResult(ids=[result["ids"]], documents=[result["documents"]], metadatas=[result["metadatas"]])
            return None
        except:
            return None
