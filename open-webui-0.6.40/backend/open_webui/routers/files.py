...
def has_access_to_file(file_id: str | None, access_type: str, user=Depends(get_verified_user)) -> bool:
        ...
        if file.content_type:
            ...
            if any(
                ...
                for content_type in (
                    ...
                    if stt_supported_content_types and any(t.strip() for t in stt_supported_content_types)
