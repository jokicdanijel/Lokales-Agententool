...
from open_webui.models.folders import FolderForm, FolderModel, FolderNameIdResponse, Folders, FolderUpdateForm
            ...
            try:
                ...
                for folder_id in folder_ids:
                    if delete_contents:
                        ...
                        Chats.move_chats_by_user_id_and_folder_id(user.id, folder_id, None)
