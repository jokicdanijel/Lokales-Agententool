...
from open_webui.routers.images import CreateImageForm, EditImageForm, image_edits, image_generations
...
from open_webui.socket.main import get_active_status_by_user_id, get_event_call, get_event_emitter
from open_webui.utils.chat import generate_chat_completion
from open_webui.utils.code_interpreter import execute_code_jupyter
from open_webui.utils.files import convert_markdown_base64_images, get_file_url_from_base64, get_image_url_from_base64
...
from open_webui.utils.task import get_task_model_id, rag_template, tools_function_calling_generation_template
            ...
            if tool_id.startswith("server:mcp:"):
                try:
                    ...
                    function_name_filter_list = (
                        mcp_server_connection.get("config", {}).get("function_name_filter_list", "").split(",")
                    )
    ...
    if len(sources) > 0:
        ...
        for source in sources:
            if "document" in source:
                for document_text, document_metadata in zip(source["document"], source["metadata"], strict=False):
