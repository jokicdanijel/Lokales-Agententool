...
export const toggleGlobalById = async (token: string, id: string) => {
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/toggle/global`,
    {
      method: "POST",
      headers: {
        Accept: "application/json",
...
export const getFunctionValvesSpecById = async (token: string, id: string) => {
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/valves/spec`,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const updateFunctionValvesById = async (
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/valves/update`,
    {
      method: "POST",
      headers: {
        Accept: "application/json",
...
export const getUserValvesById = async (token: string, id: string) => {
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/valves/user`,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const getUserValvesSpecById = async (token: string, id: string) => {
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/valves/user/spec`,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
...
export const updateUserValvesById = async (
  ...
  const res = await fetch(
    `${WEBUI_API_BASE_URL}/functions/id/${id}/valves/user/update`,
    {
      method: "POST",
      headers: {
        Accept: "application/json",
