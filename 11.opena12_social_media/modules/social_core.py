...
class SocialCore:
    ...
    def platforms_info(self) -> List[Dict[str, Any]]:
        ...
        return [
            {
                "name": name,
                "character_limit": PLATFORM_LIMITS.get(name, 0),
                "status": "connected"
            }
    ...
    async def post_now(self, platforms: List[str], text: str, 
        ...
        try:
            ...
            response = await client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"Erstelle einen Social Media Post zum Thema: {topic}"
                    }
                ],
                max_tokens=500,
                temperature=0.7
        ...
        try:
            ...
            response = await client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"Generiere 5-10 relevante Hashtags für: {topic}"
                    }
                ],
                max_tokens=100,
                temperature=0.5
    ...
    async def analyze_engagement(self, post_id: Optional[str] = None) -> Dict[str, Any]:
