...
class InstagramPlatform:
    ...
    def _mock_publish(self, text: str, hashtags: list[str] | None, media: list[str] | None) -> dict[str, Any]:
    ...
    async def delete(self, post_id: str) -> dict[str, Any]:
        ...
        return {"platform": self.name, "status": "deleted", "post_id": post_id, "timestamp": datetime.now().isoformat()}
    ...
    async def publish_story(self, media: str, stickers: list[dict] | None = None) -> dict[str, Any]:
    ...
    async def publish_reel(self, video: str, caption: str, audio: str | None = None) -> dict[str, Any]:
