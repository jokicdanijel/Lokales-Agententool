...
def test_get_status():
    ...
    try:
        # First create a post
        payload = {"platforms": ["x"], "text": "Status check test post"}
...
def test_delete_post():
    ...
    try:
        # First create a post
        payload = {"platforms": ["facebook"], "text": "Post to be deleted"}
        ...
        # Now delete it
        delete_payload = {"post_id": post_id, "platform": "facebook"}
...
def test_character_limit():
    ...
    try:
        ...
        payload = {"platforms": ["x"], "text": long_text}
...
def test_command_endpoint():
    ...
    try:
        payload = {"command": "post", "params": {"platforms": ["linkedin"], "text": "Command endpoint test"}}
...
def test_strict_json():
    ...
    try:
        ...
        payload = {"platforms": ["linkedin"], "text": "Test post", "extra_field": "this_should_fail"}  # Not allowed
